...
test_simde_mm_xxx_epi16(const MunitParameter params[], void* data) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / (sizeof(test_vec[0]))) ; i++) {
    ...
    printf("    { simde_mm_set_epi16(%6hd, %6hd, %6hd, %6hd, %6hd, %6hd, %6hd, %6hd),\n",
...
test_simde_mm_xxx_epi32(const MunitParameter params[], void* data) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / (sizeof(test_vec[0]))) ; i++) {
    ...
    printf("    { simde_mm_set_epi32(UINT32_C(%11d), UINT32_C(%11d), UINT32_C(%11d), UINT32_C(%11d)),\n",
...
test_simde_mm_xxx_epi64(const MunitParameter params[], void* data) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])); i++) {
    ...
    printf("    { simde_mm_set_epi64x(UINT64_C(%20ld), UINT64_C(%20ld)),\n", a.i64[1], a.i64[0]);
    printf("      simde_mm_set_epi64x(UINT64_C(%20ld), UINT64_C(%20ld)),\n", b.i64[1], b.i64[0]);
    printf("      simde_mm_set_epi64x(UINT64_C(%20ld), UINT64_C(%20ld)) },\n", r.i64[1], r.i64[0]);
  }
  return MUNIT_FAIL;
...
test_simde_mm_xxx_epu8(const MunitParameter params[], void* data) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / (sizeof(test_vec[0]))) ; i++) {
    ...
    printf("    { simde_x_mm_set_epu8(%3hhu, %3hhu, %3hhu, %3hhu, %3hhu, %3hhu, %3hhu, %3hhu,\n"
...
test_simde_mm_xxx_epu16(const MunitParameter params[], void* data) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / (sizeof(test_vec[0]))) ; i++) {
    ...
    printf("    { simde_x_mm_set_epu16(%5hu, %5hu, %5hu, %5hu, %5hu, %5hu, %5hu, %5hu),\n",
