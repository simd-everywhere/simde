...
test_simde_vrndih_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    {          SIMDE_MATH_NANF,
               SIMDE_MATH_NANF },
    #endif
    {   -SIMDE_FLOAT16_C(   1.971),
        -SIMDE_FLOAT16_C(   2.000) },
    {    SIMDE_FLOAT16_C(  10.750),
         SIMDE_FLOAT16_C(  11.000) },
    {    SIMDE_FLOAT16_C(   6.608),
         SIMDE_FLOAT16_C(   7.000) },
    {   -SIMDE_FLOAT16_C(  13.543),
        -SIMDE_FLOAT16_C(  14.000) },
    {    SIMDE_FLOAT16_C(  10.939),
         SIMDE_FLOAT16_C(  11.000) },
    {   -SIMDE_FLOAT16_C(  14.116),
        -SIMDE_FLOAT16_C(  14.000) },
    {    SIMDE_FLOAT16_C(  13.529),
         SIMDE_FLOAT16_C(  14.000) },
    {    SIMDE_FLOAT16_C(   0.532),
...
test_simde_vrndi_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF },
      {            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF } },
    #endif
    { { -SIMDE_FLOAT16_C(   0.772), -SIMDE_FLOAT16_C(   2.967), -SIMDE_FLOAT16_C(  14.520), -SIMDE_FLOAT16_C(   7.674) },
      { -SIMDE_FLOAT16_C(   1.000), -SIMDE_FLOAT16_C(   3.000), -SIMDE_FLOAT16_C(  15.000), -SIMDE_FLOAT16_C(   8.000) } },
    { { -SIMDE_FLOAT16_C(   5.485),  SIMDE_FLOAT16_C(   1.193), -SIMDE_FLOAT16_C(   7.297), -SIMDE_FLOAT16_C(   4.643) },
      { -SIMDE_FLOAT16_C(   5.000),  SIMDE_FLOAT16_C(   1.000), -SIMDE_FLOAT16_C(   7.000), -SIMDE_FLOAT16_C(   5.000) } },
    { {  SIMDE_FLOAT16_C(   4.768),  SIMDE_FLOAT16_C(  14.009),  SIMDE_FLOAT16_C(   1.689), -SIMDE_FLOAT16_C(   3.233) },
      {  SIMDE_FLOAT16_C(   5.000),  SIMDE_FLOAT16_C(  14.000),  SIMDE_FLOAT16_C(   2.000), -SIMDE_FLOAT16_C(   3.000) } },
    { {  SIMDE_FLOAT16_C(   8.019),  SIMDE_FLOAT16_C(  11.641),  SIMDE_FLOAT16_C(  10.139), -SIMDE_FLOAT16_C(  11.385) },
      {  SIMDE_FLOAT16_C(   8.000),  SIMDE_FLOAT16_C(  12.000),  SIMDE_FLOAT16_C(  10.000), -SIMDE_FLOAT16_C(  11.000) } },
    { {  SIMDE_FLOAT16_C(  12.787),  SIMDE_FLOAT16_C(  12.399),  SIMDE_FLOAT16_C(  13.944), -SIMDE_FLOAT16_C(   0.689) },
      {  SIMDE_FLOAT16_C(  13.000),  SIMDE_FLOAT16_C(  12.000),  SIMDE_FLOAT16_C(  14.000), -SIMDE_FLOAT16_C(   1.000) } },
    { {  SIMDE_FLOAT16_C(  14.477), -SIMDE_FLOAT16_C(   1.853),  SIMDE_FLOAT16_C(  10.022),  SIMDE_FLOAT16_C(   3.184) },
      {  SIMDE_FLOAT16_C(  14.000), -SIMDE_FLOAT16_C(   2.000),  SIMDE_FLOAT16_C(  10.000),  SIMDE_FLOAT16_C(   3.000) } },
    { { -SIMDE_FLOAT16_C(  12.263), -SIMDE_FLOAT16_C(   7.845), -SIMDE_FLOAT16_C(   5.720),  SIMDE_FLOAT16_C(   7.138) },
      { -SIMDE_FLOAT16_C(  12.000), -SIMDE_FLOAT16_C(   8.000), -SIMDE_FLOAT16_C(   6.000),  SIMDE_FLOAT16_C(   7.000) } },
    { {  SIMDE_FLOAT16_C(   4.031), -SIMDE_FLOAT16_C(  14.863), -SIMDE_FLOAT16_C(   8.408),  SIMDE_FLOAT16_C(  13.835) },
      {  SIMDE_FLOAT16_C(   4.000), -SIMDE_FLOAT16_C(  15.000), -SIMDE_FLOAT16_C(   8.000),  SIMDE_FLOAT16_C(  14.000) } },
  };
...
test_simde_vrndiq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF,            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF },
      {            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF,            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF } },
    #endif
    { { -SIMDE_FLOAT16_C(  13.333), -SIMDE_FLOAT16_C(   6.534),  SIMDE_FLOAT16_C(   1.461),  SIMDE_FLOAT16_C(   8.065),
        -SIMDE_FLOAT16_C(   7.773),  SIMDE_FLOAT16_C(   3.880),  SIMDE_FLOAT16_C(   3.879),  SIMDE_FLOAT16_C(   1.629) },
      { -SIMDE_FLOAT16_C(  13.000), -SIMDE_FLOAT16_C(   7.000),  SIMDE_FLOAT16_C(   1.000),  SIMDE_FLOAT16_C(   8.000),
        -SIMDE_FLOAT16_C(   8.000),  SIMDE_FLOAT16_C(   4.000),  SIMDE_FLOAT16_C(   4.000),  SIMDE_FLOAT16_C(   2.000) } },
    { {  SIMDE_FLOAT16_C(  13.649), -SIMDE_FLOAT16_C(   9.254),  SIMDE_FLOAT16_C(   7.250), -SIMDE_FLOAT16_C(   5.024),
        -SIMDE_FLOAT16_C(   0.041),  SIMDE_FLOAT16_C(  10.824), -SIMDE_FLOAT16_C(   6.603), -SIMDE_FLOAT16_C(   6.021) },
      {  SIMDE_FLOAT16_C(  14.000), -SIMDE_FLOAT16_C(   9.000),  SIMDE_FLOAT16_C(   7.000), -SIMDE_FLOAT16_C(   5.000),
         SIMDE_FLOAT16_C(  -0.000),  SIMDE_FLOAT16_C(  11.000), -SIMDE_FLOAT16_C(   7.000), -SIMDE_FLOAT16_C(   6.000) } },
    { {  SIMDE_FLOAT16_C(   2.544), -SIMDE_FLOAT16_C(   0.663), -SIMDE_FLOAT16_C(  14.560),  SIMDE_FLOAT16_C(   4.351),
         SIMDE_FLOAT16_C(   4.475),  SIMDE_FLOAT16_C(   4.862),  SIMDE_FLOAT16_C(  11.744), -SIMDE_FLOAT16_C(  12.948) },
      {  SIMDE_FLOAT16_C(   3.000), -SIMDE_FLOAT16_C(   1.000), -SIMDE_FLOAT16_C(  15.000),  SIMDE_FLOAT16_C(   4.000),
         SIMDE_FLOAT16_C(   4.000),  SIMDE_FLOAT16_C(   5.000),  SIMDE_FLOAT16_C(  12.000), -SIMDE_FLOAT16_C(  13.000) } },
    { { -SIMDE_FLOAT16_C(   8.052),  SIMDE_FLOAT16_C(   9.711),  SIMDE_FLOAT16_C(  10.144),  SIMDE_FLOAT16_C(   0.454),
        -SIMDE_FLOAT16_C(   9.812), -SIMDE_FLOAT16_C(   3.705),  SIMDE_FLOAT16_C(  11.255),  SIMDE_FLOAT16_C(   6.389) },
      { -SIMDE_FLOAT16_C(   8.000),  SIMDE_FLOAT16_C(  10.000),  SIMDE_FLOAT16_C(  10.000),  SIMDE_FLOAT16_C(   0.000),
        -SIMDE_FLOAT16_C(  10.000), -SIMDE_FLOAT16_C(   4.000),  SIMDE_FLOAT16_C(  11.000),  SIMDE_FLOAT16_C(   6.000) } },
    { { -SIMDE_FLOAT16_C(  11.469),  SIMDE_FLOAT16_C(   8.987),  SIMDE_FLOAT16_C(  14.997), -SIMDE_FLOAT16_C(   6.383),
        -SIMDE_FLOAT16_C(   8.802),  SIMDE_FLOAT16_C(  10.679), -SIMDE_FLOAT16_C(   0.238),  SIMDE_FLOAT16_C(   0.873) },
      { -SIMDE_FLOAT16_C(  11.000),  SIMDE_FLOAT16_C(   9.000),  SIMDE_FLOAT16_C(  15.000), -SIMDE_FLOAT16_C(   6.000),
        -SIMDE_FLOAT16_C(   9.000),  SIMDE_FLOAT16_C(  11.000),  SIMDE_FLOAT16_C(  -0.000),  SIMDE_FLOAT16_C(   1.000) } },
    { { -SIMDE_FLOAT16_C(  12.111),  SIMDE_FLOAT16_C(   3.012),  SIMDE_FLOAT16_C(   6.714), -SIMDE_FLOAT16_C(  14.491),
         SIMDE_FLOAT16_C(   5.915),  SIMDE_FLOAT16_C(   7.081), -SIMDE_FLOAT16_C(   6.477), -SIMDE_FLOAT16_C(  11.878) },
      { -SIMDE_FLOAT16_C(  12.000),  SIMDE_FLOAT16_C(   3.000),  SIMDE_FLOAT16_C(   7.000), -SIMDE_FLOAT16_C(  14.000),
         SIMDE_FLOAT16_C(   6.000),  SIMDE_FLOAT16_C(   7.000), -SIMDE_FLOAT16_C(   6.000), -SIMDE_FLOAT16_C(  12.000) } },
    { { -SIMDE_FLOAT16_C(   2.943), -SIMDE_FLOAT16_C(  12.268), -SIMDE_FLOAT16_C(   0.653), -SIMDE_FLOAT16_C(  12.643),
        -SIMDE_FLOAT16_C(  10.790), -SIMDE_FLOAT16_C(   0.174),  SIMDE_FLOAT16_C(   9.143),  SIMDE_FLOAT16_C(  10.740) },
      { -SIMDE_FLOAT16_C(   3.000), -SIMDE_FLOAT16_C(  12.000), -SIMDE_FLOAT16_C(   1.000), -SIMDE_FLOAT16_C(  13.000),
        -SIMDE_FLOAT16_C(  11.000),  SIMDE_FLOAT16_C(  -0.000),  SIMDE_FLOAT16_C(   9.000),  SIMDE_FLOAT16_C(  11.000) } },
    { {  SIMDE_FLOAT16_C(   9.915), -SIMDE_FLOAT16_C(   6.208), -SIMDE_FLOAT16_C(  14.325), -SIMDE_FLOAT16_C(   6.559),
         SIMDE_FLOAT16_C(   4.518),  SIMDE_FLOAT16_C(   5.550), -SIMDE_FLOAT16_C(  11.703),  SIMDE_FLOAT16_C(  13.945) },
      {  SIMDE_FLOAT16_C(  10.000), -SIMDE_FLOAT16_C(   6.000), -SIMDE_FLOAT16_C(  14.000), -SIMDE_FLOAT16_C(   7.000),
         SIMDE_FLOAT16_C(   5.000),  SIMDE_FLOAT16_C(   6.000), -SIMDE_FLOAT16_C(  12.000),  SIMDE_FLOAT16_C(  14.000) } },
  };
