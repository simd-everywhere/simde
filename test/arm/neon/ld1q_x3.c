...
test_simde_vld1q_f32_x3 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    { { SIMDE_FLOAT32_C(  -515.90), SIMDE_FLOAT32_C(   731.52), SIMDE_FLOAT32_C(  -780.92), SIMDE_FLOAT32_C(   142.16),
        SIMDE_FLOAT32_C(   627.25), SIMDE_FLOAT32_C(  -141.20), SIMDE_FLOAT32_C(   307.79), SIMDE_FLOAT32_C(   103.46),
        SIMDE_FLOAT32_C(  -620.20), SIMDE_FLOAT32_C(   503.81), SIMDE_FLOAT32_C(   -88.13), SIMDE_FLOAT32_C(   835.95) },
        { { SIMDE_FLOAT32_C(  -515.90), SIMDE_FLOAT32_C(   731.52), SIMDE_FLOAT32_C(  -780.92), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(   142.16), SIMDE_FLOAT32_C(   627.25), SIMDE_FLOAT32_C(  -141.20), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(   307.79), SIMDE_FLOAT32_C(   103.46), SIMDE_FLOAT32_C(  -620.20), SIMDE_FLOAT32_C(     0.00) } },
    },
    { { SIMDE_FLOAT32_C(   626.38), SIMDE_FLOAT32_C(  -175.74), SIMDE_FLOAT32_C(  -840.27), SIMDE_FLOAT32_C(  -621.57),
        SIMDE_FLOAT32_C(   807.94), SIMDE_FLOAT32_C(  -467.50), SIMDE_FLOAT32_C(  -218.92), SIMDE_FLOAT32_C(   469.26),
        SIMDE_FLOAT32_C(  -992.44), SIMDE_FLOAT32_C(    78.79), SIMDE_FLOAT32_C(  -656.27), SIMDE_FLOAT32_C(  -293.61) },
        { { SIMDE_FLOAT32_C(   626.38), SIMDE_FLOAT32_C(  -175.74), SIMDE_FLOAT32_C(  -840.27), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(  -621.57), SIMDE_FLOAT32_C(   807.94), SIMDE_FLOAT32_C(  -467.50), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(  -218.92), SIMDE_FLOAT32_C(   469.26), SIMDE_FLOAT32_C(  -992.44), SIMDE_FLOAT32_C(     0.00) } },
    },
    { { SIMDE_FLOAT32_C(    -6.73), SIMDE_FLOAT32_C(   417.39), SIMDE_FLOAT32_C(  -265.86), SIMDE_FLOAT32_C(   508.50),
        SIMDE_FLOAT32_C(   409.86), SIMDE_FLOAT32_C(   862.64), SIMDE_FLOAT32_C(  -837.97), SIMDE_FLOAT32_C(   893.96),
        SIMDE_FLOAT32_C(   594.16), SIMDE_FLOAT32_C(  -618.89), SIMDE_FLOAT32_C(    36.11), SIMDE_FLOAT32_C(   221.41) },
        { { SIMDE_FLOAT32_C(    -6.73), SIMDE_FLOAT32_C(   417.39), SIMDE_FLOAT32_C(  -265.86), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(   508.50), SIMDE_FLOAT32_C(   409.86), SIMDE_FLOAT32_C(   862.64), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(  -837.97), SIMDE_FLOAT32_C(   893.96), SIMDE_FLOAT32_C(   594.16), SIMDE_FLOAT32_C(     0.00) } },
    },
    { { SIMDE_FLOAT32_C(   239.91), SIMDE_FLOAT32_C(  -656.10), SIMDE_FLOAT32_C(  -675.13), SIMDE_FLOAT32_C(   619.71),
        SIMDE_FLOAT32_C(   847.71), SIMDE_FLOAT32_C(   236.74), SIMDE_FLOAT32_C(   455.66), SIMDE_FLOAT32_C(   474.09),
        SIMDE_FLOAT32_C(  -939.00), SIMDE_FLOAT32_C(   615.40), SIMDE_FLOAT32_C(   852.52), SIMDE_FLOAT32_C(   868.94) },
        { { SIMDE_FLOAT32_C(   239.91), SIMDE_FLOAT32_C(  -656.10), SIMDE_FLOAT32_C(  -675.13), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(   619.71), SIMDE_FLOAT32_C(   847.71), SIMDE_FLOAT32_C(   236.74), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(   455.66), SIMDE_FLOAT32_C(   474.09), SIMDE_FLOAT32_C(  -939.00), SIMDE_FLOAT32_C(     0.00) } },
    },
    { { SIMDE_FLOAT32_C(  -852.10), SIMDE_FLOAT32_C(  -366.40), SIMDE_FLOAT32_C(   338.20), SIMDE_FLOAT32_C(  -844.54),
        SIMDE_FLOAT32_C(   712.39), SIMDE_FLOAT32_C(   681.93), SIMDE_FLOAT32_C(  -138.15), SIMDE_FLOAT32_C(  -294.34),
        SIMDE_FLOAT32_C(    99.32), SIMDE_FLOAT32_C(   595.99), SIMDE_FLOAT32_C(  -785.84), SIMDE_FLOAT32_C(  -490.82) },
        { { SIMDE_FLOAT32_C(  -852.10), SIMDE_FLOAT32_C(  -366.40), SIMDE_FLOAT32_C(   338.20), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(  -844.54), SIMDE_FLOAT32_C(   712.39), SIMDE_FLOAT32_C(   681.93), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(  -138.15), SIMDE_FLOAT32_C(  -294.34), SIMDE_FLOAT32_C(    99.32), SIMDE_FLOAT32_C(     0.00) } },
    },
    { { SIMDE_FLOAT32_C(   458.63), SIMDE_FLOAT32_C(  -623.81), SIMDE_FLOAT32_C(  -596.86), SIMDE_FLOAT32_C(    52.79),
        SIMDE_FLOAT32_C(  -242.70), SIMDE_FLOAT32_C(   439.25), SIMDE_FLOAT32_C(  -725.80), SIMDE_FLOAT32_C(   997.21),
        SIMDE_FLOAT32_C(   783.15), SIMDE_FLOAT32_C(  -400.93), SIMDE_FLOAT32_C(   616.92), SIMDE_FLOAT32_C(   630.87) },
        { { SIMDE_FLOAT32_C(   458.63), SIMDE_FLOAT32_C(  -623.81), SIMDE_FLOAT32_C(  -596.86), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(    52.79), SIMDE_FLOAT32_C(  -242.70), SIMDE_FLOAT32_C(   439.25), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(  -725.80), SIMDE_FLOAT32_C(   997.21), SIMDE_FLOAT32_C(   783.15), SIMDE_FLOAT32_C(     0.00) } },
    },
    { { SIMDE_FLOAT32_C(   835.81), SIMDE_FLOAT32_C(    72.58), SIMDE_FLOAT32_C(   104.96), SIMDE_FLOAT32_C(   896.80),
        SIMDE_FLOAT32_C(  -312.02), SIMDE_FLOAT32_C(   -42.52), SIMDE_FLOAT32_C(   765.74), SIMDE_FLOAT32_C(  -164.12),
        SIMDE_FLOAT32_C(   591.08), SIMDE_FLOAT32_C(   103.94), SIMDE_FLOAT32_C(    -8.66), SIMDE_FLOAT32_C(   303.47) },
        { { SIMDE_FLOAT32_C(   835.81), SIMDE_FLOAT32_C(    72.58), SIMDE_FLOAT32_C(   104.96), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(   896.80), SIMDE_FLOAT32_C(  -312.02), SIMDE_FLOAT32_C(   -42.52), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(   765.74), SIMDE_FLOAT32_C(  -164.12), SIMDE_FLOAT32_C(   591.08), SIMDE_FLOAT32_C(     0.00) } },
    },
    { { SIMDE_FLOAT32_C(  -214.13), SIMDE_FLOAT32_C(   853.19), SIMDE_FLOAT32_C(  -990.87), SIMDE_FLOAT32_C(   885.20),
        SIMDE_FLOAT32_C(   449.19), SIMDE_FLOAT32_C(  -776.71), SIMDE_FLOAT32_C(  -605.62), SIMDE_FLOAT32_C(   -92.18),
        SIMDE_FLOAT32_C(  -400.52), SIMDE_FLOAT32_C(  -202.48), SIMDE_FLOAT32_C(   960.61), SIMDE_FLOAT32_C(   356.78) },
        { { SIMDE_FLOAT32_C(  -214.13), SIMDE_FLOAT32_C(   853.19), SIMDE_FLOAT32_C(  -990.87), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(   885.20), SIMDE_FLOAT32_C(   449.19), SIMDE_FLOAT32_C(  -776.71), SIMDE_FLOAT32_C(     0.00) },
          { SIMDE_FLOAT32_C(  -605.62), SIMDE_FLOAT32_C(   -92.18), SIMDE_FLOAT32_C(  -400.52), SIMDE_FLOAT32_C(     0.00) } },
    },
  };
...
test_simde_vld1q_f64_x3 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    { { SIMDE_FLOAT64_C(  -763.23), SIMDE_FLOAT64_C(  -765.18), SIMDE_FLOAT64_C(   353.99) },
        { { SIMDE_FLOAT64_C(  -763.23), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -765.18), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(   353.99), SIMDE_FLOAT64_C(     0.00) } },
    },
    { { SIMDE_FLOAT64_C(  -980.07), SIMDE_FLOAT64_C(  -166.11), SIMDE_FLOAT64_C(   -29.09) },
        { { SIMDE_FLOAT64_C(  -980.07), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -166.11), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(   -29.09), SIMDE_FLOAT64_C(     0.00) } },
    },
    { { SIMDE_FLOAT64_C(   650.80), SIMDE_FLOAT64_C(  -330.31), SIMDE_FLOAT64_C(  -956.51) },
        { { SIMDE_FLOAT64_C(   650.80), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -330.31), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -956.51), SIMDE_FLOAT64_C(     0.00) } },
    },
    { { SIMDE_FLOAT64_C(  -244.24), SIMDE_FLOAT64_C(  -433.50), SIMDE_FLOAT64_C(  -268.54) },
        { { SIMDE_FLOAT64_C(  -244.24), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -433.50), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -268.54), SIMDE_FLOAT64_C(     0.00) } },
    },
    { { SIMDE_FLOAT64_C(   713.24), SIMDE_FLOAT64_C(  -667.76), SIMDE_FLOAT64_C(   567.34) },
        { { SIMDE_FLOAT64_C(   713.24), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -667.76), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(   567.34), SIMDE_FLOAT64_C(     0.00) } },
    },
    { { SIMDE_FLOAT64_C(   304.31), SIMDE_FLOAT64_C(   436.18), SIMDE_FLOAT64_C(  -441.32) },
        { { SIMDE_FLOAT64_C(   304.31), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(   436.18), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -441.32), SIMDE_FLOAT64_C(     0.00) } },
    },
    { { SIMDE_FLOAT64_C(  -392.22), SIMDE_FLOAT64_C(  -777.95), SIMDE_FLOAT64_C(  -588.13) },
        { { SIMDE_FLOAT64_C(  -392.22), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -777.95), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -588.13), SIMDE_FLOAT64_C(     0.00) } },
    },
    { { SIMDE_FLOAT64_C(  -383.10), SIMDE_FLOAT64_C(  -892.76), SIMDE_FLOAT64_C(   861.05) },
        { { SIMDE_FLOAT64_C(  -383.10), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(  -892.76), SIMDE_FLOAT64_C(     0.00) },
          { SIMDE_FLOAT64_C(   861.05), SIMDE_FLOAT64_C(     0.00) } },
    },
  };
