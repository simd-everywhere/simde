...
test_simde_vst3_s32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    { { -INT32_C(  1517512639),  INT32_C(   409266462) },
      {  INT32_C(  1032266682),  INT32_C(  1155651163) },
      { -INT32_C(  1458111847), -INT32_C(  1093491914) },
      {
      -INT32_C(  1517512639),
       INT32_C(  1032266682),
      -INT32_C(  1458111847),
    ...
    { {  INT32_C(   867875150),  INT32_C(   163592648) },
      { -INT32_C(   273789487), -INT32_C(   267972042) },
      { -INT32_C(  1859285194), -INT32_C(    19591579) },
      {
       INT32_C(   867875150),
      -INT32_C(   273789487),
      -INT32_C(  1859285194),
    ...
    { {  INT32_C(  1068034824), -INT32_C(   570590578) },
      { -INT32_C(    66013389), -INT32_C(  1056583184) },
      {  INT32_C(  1420866590), -INT32_C(    62605114) },
      {
       INT32_C(  1068034824),
      -INT32_C(    66013389),
       INT32_C(  1420866590),
    ...
    { { -INT32_C(  1400016313), -INT32_C(  1985256832) },
      { -INT32_C(   590851250),  INT32_C(    28952013) },
      {  INT32_C(  1845348988), -INT32_C(  1188167013) },
      {
      -INT32_C(  1400016313),
      -INT32_C(   590851250),
       INT32_C(  1845348988),
    ...
    { {  INT32_C(  2098061238), -INT32_C(   562474601) },
      {  INT32_C(  1149896643), -INT32_C(  1211288215) },
      {  INT32_C(  1452578184), -INT32_C(   698921638) },
      {
       INT32_C(  2098061238),
       INT32_C(  1149896643),
       INT32_C(  1452578184),
    ...
    { { -INT32_C(  1304210409),  INT32_C(   225145430) },
      { -INT32_C(   393578415), -INT32_C(  1916402742) },
      {  INT32_C(  1959874570),  INT32_C(   237739654) },
      {
      -INT32_C(  1304210409),
      -INT32_C(   393578415),
       INT32_C(  1959874570),
    ...
    { { -INT32_C(  1922777293),  INT32_C(   610581261) },
      {  INT32_C(  1725409039),  INT32_C(  1785938457) },
      { -INT32_C(  2058158661),  INT32_C(   185735168) },
      {
      -INT32_C(  1922777293),
       INT32_C(  1725409039),
      -INT32_C(  2058158661),
    ...
    { { -INT32_C(   276831127), -INT32_C(  1224889726) },
      {  INT32_C(  2000904810),  INT32_C(   765175581) },
      {  INT32_C(  1754493519),  INT32_C(  1892878005) },
      {
      -INT32_C(   276831127),
       INT32_C(  2000904810),
       INT32_C(  1754493519),
...
test_simde_vst3_u32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    { { UINT32_C(1642910889), UINT32_C( 907418618) },
      { UINT32_C(  63212934), UINT32_C(1366492658) },
      { UINT32_C(3933179207), UINT32_C(1073701694) },
      {
      UINT32_C(1642910889),
      UINT32_C(  63212934),
      UINT32_C(3933179207),
    ...
    { { UINT32_C( 553386178), UINT32_C(2180425176) },
      { UINT32_C(1944249209), UINT32_C(2225731838) },
      { UINT32_C(2005364101), UINT32_C(3117021810) },
      {
      UINT32_C( 553386178),
      UINT32_C(1944249209),
      UINT32_C(2005364101),
    ...
    { { UINT32_C(3315808391), UINT32_C(1560650395) },
      { UINT32_C(2055078306), UINT32_C( 536573094) },
      { UINT32_C(1435688279), UINT32_C(1524251861) },
      {
      UINT32_C(3315808391),
      UINT32_C(2055078306),
      UINT32_C(1435688279),
    ...
    { { UINT32_C( 483549609), UINT32_C(3822426972) },
      { UINT32_C(1873377747), UINT32_C(3201084955) },
      { UINT32_C(1446529711), UINT32_C( 376779967) },
      {
      UINT32_C( 483549609),
      UINT32_C(1873377747),
      UINT32_C(1446529711),
    ...
    { { UINT32_C(3882616849), UINT32_C(3980478020) },
      { UINT32_C(  50926503), UINT32_C(2196234158) },
      { UINT32_C(1945210968), UINT32_C(3979459902) },
      {
      UINT32_C(3882616849),
      UINT32_C(  50926503),
      UINT32_C(1945210968),
    ...
    { { UINT32_C(3343084040), UINT32_C(2950543774) },
      { UINT32_C(  93735361), UINT32_C( 938662031) },
      { UINT32_C(2587557099), UINT32_C( 857481691) },
      {
      UINT32_C(3343084040),
      UINT32_C(  93735361),
      UINT32_C(2587557099),
    ...
    { { UINT32_C(4020637105), UINT32_C(3537754314) },
      { UINT32_C(3768131650), UINT32_C(2593093593) },
      { UINT32_C(1352607424), UINT32_C(3917976318) },
      {
      UINT32_C(4020637105),
      UINT32_C(3768131650),
      UINT32_C(1352607424),
    ...
    { { UINT32_C(1770242446), UINT32_C(2493292515) },
      { UINT32_C(2005156524), UINT32_C(1548312858) },
      { UINT32_C(1530717057), UINT32_C( 452316250) },
      {
      UINT32_C(1770242446),
      UINT32_C(2005156524),
      UINT32_C(1530717057),
