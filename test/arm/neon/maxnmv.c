...
test_simde_vmaxnmv_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { -SIMDE_FLOAT16_C(     3.738),  SIMDE_FLOAT16_C(     1.455),  SIMDE_FLOAT16_C(    14.120),  SIMDE_FLOAT16_C(    10.392) },
         SIMDE_FLOAT16_C(    14.120) },
    { { -SIMDE_FLOAT16_C(    28.221), -SIMDE_FLOAT16_C(    24.836),  SIMDE_FLOAT16_C(     1.975),  SIMDE_FLOAT16_C(    15.527) },
         SIMDE_FLOAT16_C(    15.527) },
    { {  SIMDE_FLOAT16_C(    29.824),  SIMDE_FLOAT16_C(    13.759), -SIMDE_FLOAT16_C(    15.380),  SIMDE_FLOAT16_C(    21.745) },
         SIMDE_FLOAT16_C(    29.824) },
    { { -SIMDE_FLOAT16_C(     2.636),  SIMDE_FLOAT16_C(    17.047), -SIMDE_FLOAT16_C(    17.906), -SIMDE_FLOAT16_C(     2.426) },
         SIMDE_FLOAT16_C(    17.047) },
    { { -SIMDE_FLOAT16_C(    23.268), -SIMDE_FLOAT16_C(     0.613), -SIMDE_FLOAT16_C(     5.015),  SIMDE_FLOAT16_C(    14.077) },
         SIMDE_FLOAT16_C(    14.077) },
    { { -SIMDE_FLOAT16_C(    18.977),  SIMDE_FLOAT16_C(    18.537),  SIMDE_FLOAT16_C(    27.393), -SIMDE_FLOAT16_C(    14.588) },
         SIMDE_FLOAT16_C(    27.393) },
    { {  SIMDE_FLOAT16_C(     8.490), -SIMDE_FLOAT16_C(    16.011),  SIMDE_FLOAT16_C(    19.419),  SIMDE_FLOAT16_C(     7.979) },
         SIMDE_FLOAT16_C(    19.419) },
    { {  SIMDE_FLOAT16_C(    15.064),  SIMDE_FLOAT16_C(    18.001), -SIMDE_FLOAT16_C(    17.423), -SIMDE_FLOAT16_C(    12.709) },
         SIMDE_FLOAT16_C(    18.001) },
  };
...
test_simde_vmaxnmvq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { -SIMDE_FLOAT16_C(    27.209),  SIMDE_FLOAT16_C(    27.139), -SIMDE_FLOAT16_C(     8.487),  SIMDE_FLOAT16_C(    29.647),
         SIMDE_FLOAT16_C(     4.093), -SIMDE_FLOAT16_C(    12.946),  SIMDE_FLOAT16_C(    19.678), -SIMDE_FLOAT16_C(    17.130) },
         SIMDE_FLOAT16_C(    29.647) },
    { { -SIMDE_FLOAT16_C(    10.565),  SIMDE_FLOAT16_C(    24.408), -SIMDE_FLOAT16_C(    20.684), -SIMDE_FLOAT16_C(    23.760),
        -SIMDE_FLOAT16_C(    14.685),  SIMDE_FLOAT16_C(    10.925), -SIMDE_FLOAT16_C(    23.577), -SIMDE_FLOAT16_C(     2.002) },
         SIMDE_FLOAT16_C(    24.408) },
    { {  SIMDE_FLOAT16_C(    12.637),  SIMDE_FLOAT16_C(     0.627), -SIMDE_FLOAT16_C(     1.251), -SIMDE_FLOAT16_C(    18.692),
        -SIMDE_FLOAT16_C(     0.956), -SIMDE_FLOAT16_C(    28.618), -SIMDE_FLOAT16_C(    21.850), -SIMDE_FLOAT16_C(    22.646) },
         SIMDE_FLOAT16_C(    12.637) },
    { {  SIMDE_FLOAT16_C(    28.637), -SIMDE_FLOAT16_C(    15.186),  SIMDE_FLOAT16_C(    29.860), -SIMDE_FLOAT16_C(     4.792),
         SIMDE_FLOAT16_C(     7.802), -SIMDE_FLOAT16_C(    20.342),  SIMDE_FLOAT16_C(    26.549), -SIMDE_FLOAT16_C(    12.132) },
         SIMDE_FLOAT16_C(    29.860) },
    { { -SIMDE_FLOAT16_C(    24.535),  SIMDE_FLOAT16_C(    19.959), -SIMDE_FLOAT16_C(     2.053),  SIMDE_FLOAT16_C(    21.915),
        -SIMDE_FLOAT16_C(    12.173),  SIMDE_FLOAT16_C(    25.143), -SIMDE_FLOAT16_C(    15.516), -SIMDE_FLOAT16_C(     1.281) },
         SIMDE_FLOAT16_C(    25.143) },
    { {  SIMDE_FLOAT16_C(     4.415),  SIMDE_FLOAT16_C(     8.990), -SIMDE_FLOAT16_C(     7.033), -SIMDE_FLOAT16_C(     1.069),
         SIMDE_FLOAT16_C(     9.131), -SIMDE_FLOAT16_C(    25.759), -SIMDE_FLOAT16_C(     2.994),  SIMDE_FLOAT16_C(    11.418) },
         SIMDE_FLOAT16_C(    11.418) },
    { { -SIMDE_FLOAT16_C(     8.941),  SIMDE_FLOAT16_C(    22.113),  SIMDE_FLOAT16_C(    14.990), -SIMDE_FLOAT16_C(     1.598),
         SIMDE_FLOAT16_C(     7.272),  SIMDE_FLOAT16_C(     8.508), -SIMDE_FLOAT16_C(    26.884), -SIMDE_FLOAT16_C(    27.776) },
         SIMDE_FLOAT16_C(    22.113) },
    { { -SIMDE_FLOAT16_C(    17.691), -SIMDE_FLOAT16_C(     7.633), -SIMDE_FLOAT16_C(     1.437),  SIMDE_FLOAT16_C(     1.893),
        -SIMDE_FLOAT16_C(    26.187),  SIMDE_FLOAT16_C(    26.083), -SIMDE_FLOAT16_C(     0.446), -SIMDE_FLOAT16_C(     7.923) },
         SIMDE_FLOAT16_C(    26.083) },
  };
