...
test_simde_vminnmv_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {  SIMDE_FLOAT16_C(    20.218), -SIMDE_FLOAT16_C(     6.853), -SIMDE_FLOAT16_C(     5.794),  SIMDE_FLOAT16_C(     8.347) },
        -SIMDE_FLOAT16_C(     6.853) },
    { { -SIMDE_FLOAT16_C(     2.093), -SIMDE_FLOAT16_C(     3.578), -SIMDE_FLOAT16_C(    25.522), -SIMDE_FLOAT16_C(    21.689) },
        -SIMDE_FLOAT16_C(    25.522) },
    { {  SIMDE_FLOAT16_C(    13.305),  SIMDE_FLOAT16_C(    15.886), -SIMDE_FLOAT16_C(    16.955),  SIMDE_FLOAT16_C(    14.481) },
        -SIMDE_FLOAT16_C(    16.955) },
    { { -SIMDE_FLOAT16_C(    18.484),  SIMDE_FLOAT16_C(    29.793), -SIMDE_FLOAT16_C(     0.842),  SIMDE_FLOAT16_C(    19.516) },
        -SIMDE_FLOAT16_C(    18.484) },
    { { -SIMDE_FLOAT16_C(    22.777),  SIMDE_FLOAT16_C(     4.641), -SIMDE_FLOAT16_C(    20.779), -SIMDE_FLOAT16_C(    21.506) },
        -SIMDE_FLOAT16_C(    22.777) },
    { { -SIMDE_FLOAT16_C(    28.388), -SIMDE_FLOAT16_C(    10.209),  SIMDE_FLOAT16_C(    17.384),  SIMDE_FLOAT16_C(    29.067) },
        -SIMDE_FLOAT16_C(    28.388) },
    { { -SIMDE_FLOAT16_C(     3.619), -SIMDE_FLOAT16_C(    13.964),  SIMDE_FLOAT16_C(    10.205),  SIMDE_FLOAT16_C(    26.305) },
        -SIMDE_FLOAT16_C(    13.964) },
    { {  SIMDE_FLOAT16_C(    15.202),  SIMDE_FLOAT16_C(    15.144),  SIMDE_FLOAT16_C(    25.308), -SIMDE_FLOAT16_C(    28.303) },
        -SIMDE_FLOAT16_C(    28.303) },
  };
...
test_simde_vminnmvq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { -SIMDE_FLOAT16_C(    11.968),  SIMDE_FLOAT16_C(     0.700),  SIMDE_FLOAT16_C(     1.342),  SIMDE_FLOAT16_C(     5.319),
         SIMDE_FLOAT16_C(     1.058), -SIMDE_FLOAT16_C(     3.121),  SIMDE_FLOAT16_C(     9.615), -SIMDE_FLOAT16_C(    29.989) },
        -SIMDE_FLOAT16_C(    29.989) },
    { {  SIMDE_FLOAT16_C(    18.972), -SIMDE_FLOAT16_C(    13.189), -SIMDE_FLOAT16_C(    24.616), -SIMDE_FLOAT16_C(    11.420),
         SIMDE_FLOAT16_C(    29.006),  SIMDE_FLOAT16_C(    18.310), -SIMDE_FLOAT16_C(     2.603),  SIMDE_FLOAT16_C(     5.305) },
        -SIMDE_FLOAT16_C(    24.616) },
    { {  SIMDE_FLOAT16_C(    25.793), -SIMDE_FLOAT16_C(    25.154),  SIMDE_FLOAT16_C(    16.638), -SIMDE_FLOAT16_C(    16.495),
        -SIMDE_FLOAT16_C(    26.285),  SIMDE_FLOAT16_C(     8.955), -SIMDE_FLOAT16_C(    23.971), -SIMDE_FLOAT16_C(    28.845) },
        -SIMDE_FLOAT16_C(    28.845) },
    { {  SIMDE_FLOAT16_C(     9.945),  SIMDE_FLOAT16_C(     9.819),  SIMDE_FLOAT16_C(     7.833), -SIMDE_FLOAT16_C(    12.584),
         SIMDE_FLOAT16_C(     2.684), -SIMDE_FLOAT16_C(    25.996), -SIMDE_FLOAT16_C(    12.605),  SIMDE_FLOAT16_C(    18.119) },
        -SIMDE_FLOAT16_C(    25.996) },
    { { -SIMDE_FLOAT16_C(     7.772),  SIMDE_FLOAT16_C(    22.902),  SIMDE_FLOAT16_C(    26.436), -SIMDE_FLOAT16_C(    20.216),
         SIMDE_FLOAT16_C(    16.707),  SIMDE_FLOAT16_C(     5.188), -SIMDE_FLOAT16_C(     9.754), -SIMDE_FLOAT16_C(    28.714) },
        -SIMDE_FLOAT16_C(    28.714) },
    { { -SIMDE_FLOAT16_C(    19.900),  SIMDE_FLOAT16_C(     6.812),  SIMDE_FLOAT16_C(    18.439),  SIMDE_FLOAT16_C(    23.239),
        -SIMDE_FLOAT16_C(    21.049), -SIMDE_FLOAT16_C(    21.265),  SIMDE_FLOAT16_C(     7.079),  SIMDE_FLOAT16_C(    29.200) },
        -SIMDE_FLOAT16_C(    21.265) },
    { {  SIMDE_FLOAT16_C(    19.055), -SIMDE_FLOAT16_C(    11.939),  SIMDE_FLOAT16_C(    22.429),  SIMDE_FLOAT16_C(    27.392),
         SIMDE_FLOAT16_C(     0.849),  SIMDE_FLOAT16_C(     8.276),  SIMDE_FLOAT16_C(    15.737),  SIMDE_FLOAT16_C(     2.775) },
        -SIMDE_FLOAT16_C(    11.939) },
    { { -SIMDE_FLOAT16_C(    25.103), -SIMDE_FLOAT16_C(     1.612), -SIMDE_FLOAT16_C(    16.030), -SIMDE_FLOAT16_C(    16.356),
         SIMDE_FLOAT16_C(    15.013), -SIMDE_FLOAT16_C(    18.179),  SIMDE_FLOAT16_C(    11.449), -SIMDE_FLOAT16_C(     3.686) },
        -SIMDE_FLOAT16_C(    25.103) },
  };
