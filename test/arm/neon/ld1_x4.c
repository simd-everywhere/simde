...
test_simde_vld1_f16_x4 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
   ...
   { {  SIMDE_FLOAT16_VALUE(1.49), SIMDE_FLOAT16_VALUE(-9.73), SIMDE_FLOAT16_VALUE(7.36), SIMDE_FLOAT16_VALUE(3.11),
        ...
        SIMDE_FLOAT16_VALUE(-6.30), SIMDE_FLOAT16_VALUE(-2.80), SIMDE_FLOAT16_VALUE(3.23), SIMDE_FLOAT16_VALUE(5.48),
        SIMDE_FLOAT16_VALUE(4.45), SIMDE_FLOAT16_VALUE(-3.47), SIMDE_FLOAT16_VALUE(7.65), SIMDE_FLOAT16_VALUE(3.68) },
   { {  SIMDE_FLOAT16_VALUE(1.49), SIMDE_FLOAT16_VALUE(-9.73), SIMDE_FLOAT16_VALUE(7.36), SIMDE_FLOAT16_VALUE(3.11) },
     {  SIMDE_FLOAT16_VALUE(7.22), SIMDE_FLOAT16_VALUE(-2.45), SIMDE_FLOAT16_VALUE(3.68), SIMDE_FLOAT16_VALUE(-1.35) },
     {  SIMDE_FLOAT16_VALUE(-6.30), SIMDE_FLOAT16_VALUE(-2.80), SIMDE_FLOAT16_VALUE(3.23), SIMDE_FLOAT16_VALUE(5.48) },
     {  SIMDE_FLOAT16_VALUE(4.45), SIMDE_FLOAT16_VALUE(-3.47), SIMDE_FLOAT16_VALUE(7.65), SIMDE_FLOAT16_VALUE(3.68) } } },
   { {  SIMDE_FLOAT16_VALUE(-8.94), SIMDE_FLOAT16_VALUE(-1.95), SIMDE_FLOAT16_VALUE(7.40), SIMDE_FLOAT16_VALUE(4.23),
        SIMDE_FLOAT16_VALUE(1.06), SIMDE_FLOAT16_VALUE(-0.17), SIMDE_FLOAT16_VALUE(-7.00), SIMDE_FLOAT16_VALUE(9.69),
        SIMDE_FLOAT16_VALUE(-1.56), SIMDE_FLOAT16_VALUE(2.45), SIMDE_FLOAT16_VALUE(-4.16), SIMDE_FLOAT16_VALUE(-6.16),
        SIMDE_FLOAT16_VALUE(6.09), SIMDE_FLOAT16_VALUE(3.06), SIMDE_FLOAT16_VALUE(-0.57), SIMDE_FLOAT16_VALUE(4.51) },
   { {  SIMDE_FLOAT16_VALUE(-8.94), SIMDE_FLOAT16_VALUE(-1.95), SIMDE_FLOAT16_VALUE(7.40), SIMDE_FLOAT16_VALUE(4.23) },
     {  SIMDE_FLOAT16_VALUE(1.06), SIMDE_FLOAT16_VALUE(-0.17), SIMDE_FLOAT16_VALUE(-7.00), SIMDE_FLOAT16_VALUE(9.69) },
     {  SIMDE_FLOAT16_VALUE(-1.56), SIMDE_FLOAT16_VALUE(2.45), SIMDE_FLOAT16_VALUE(-4.16), SIMDE_FLOAT16_VALUE(-6.16) },
     {  SIMDE_FLOAT16_VALUE(6.09), SIMDE_FLOAT16_VALUE(3.06), SIMDE_FLOAT16_VALUE(-0.57), SIMDE_FLOAT16_VALUE(4.51) } } },
   { {  SIMDE_FLOAT16_VALUE(6.06), SIMDE_FLOAT16_VALUE(-0.83), SIMDE_FLOAT16_VALUE(-8.07), SIMDE_FLOAT16_VALUE(-8.13),
        SIMDE_FLOAT16_VALUE(-2.78), SIMDE_FLOAT16_VALUE(-9.03), SIMDE_FLOAT16_VALUE(0.63), SIMDE_FLOAT16_VALUE(-6.69),
        SIMDE_FLOAT16_VALUE(3.21), SIMDE_FLOAT16_VALUE(-7.11), SIMDE_FLOAT16_VALUE(2.09), SIMDE_FLOAT16_VALUE(5.06),
        SIMDE_FLOAT16_VALUE(-0.76), SIMDE_FLOAT16_VALUE(4.49), SIMDE_FLOAT16_VALUE(-8.49), SIMDE_FLOAT16_VALUE(-9.25) },
   { {  SIMDE_FLOAT16_VALUE(6.06), SIMDE_FLOAT16_VALUE(-0.83), SIMDE_FLOAT16_VALUE(-8.07), SIMDE_FLOAT16_VALUE(-8.13) },
     {  SIMDE_FLOAT16_VALUE(-2.78), SIMDE_FLOAT16_VALUE(-9.03), SIMDE_FLOAT16_VALUE(0.63), SIMDE_FLOAT16_VALUE(-6.69) },
     {  SIMDE_FLOAT16_VALUE(3.21), SIMDE_FLOAT16_VALUE(-7.11), SIMDE_FLOAT16_VALUE(2.09), SIMDE_FLOAT16_VALUE(5.06) },
     {  SIMDE_FLOAT16_VALUE(-0.76), SIMDE_FLOAT16_VALUE(4.49), SIMDE_FLOAT16_VALUE(-8.49), SIMDE_FLOAT16_VALUE(-9.25) } } },
   { {  SIMDE_FLOAT16_VALUE(9.79), SIMDE_FLOAT16_VALUE(2.62), SIMDE_FLOAT16_VALUE(-9.19), SIMDE_FLOAT16_VALUE(3.73),
        SIMDE_FLOAT16_VALUE(1.03), SIMDE_FLOAT16_VALUE(8.35), SIMDE_FLOAT16_VALUE(-3.15), SIMDE_FLOAT16_VALUE(0.58),
        SIMDE_FLOAT16_VALUE(-3.14), SIMDE_FLOAT16_VALUE(-8.78), SIMDE_FLOAT16_VALUE(7.54), SIMDE_FLOAT16_VALUE(-1.07),
        SIMDE_FLOAT16_VALUE(-8.37), SIMDE_FLOAT16_VALUE(7.13), SIMDE_FLOAT16_VALUE(-5.82), SIMDE_FLOAT16_VALUE(8.91) },
   { {  SIMDE_FLOAT16_VALUE(9.79), SIMDE_FLOAT16_VALUE(2.62), SIMDE_FLOAT16_VALUE(-9.19), SIMDE_FLOAT16_VALUE(3.73) },
     {  SIMDE_FLOAT16_VALUE(1.03), SIMDE_FLOAT16_VALUE(8.35), SIMDE_FLOAT16_VALUE(-3.15), SIMDE_FLOAT16_VALUE(0.58) },
     {  SIMDE_FLOAT16_VALUE(-3.14), SIMDE_FLOAT16_VALUE(-8.78), SIMDE_FLOAT16_VALUE(7.54), SIMDE_FLOAT16_VALUE(-1.07) },
     {  SIMDE_FLOAT16_VALUE(-8.37), SIMDE_FLOAT16_VALUE(7.13), SIMDE_FLOAT16_VALUE(-5.82), SIMDE_FLOAT16_VALUE(8.91) } } },
   { {  SIMDE_FLOAT16_VALUE(-9.77), SIMDE_FLOAT16_VALUE(6.23), SIMDE_FLOAT16_VALUE(3.40), SIMDE_FLOAT16_VALUE(-7.45),
        SIMDE_FLOAT16_VALUE(7.00), SIMDE_FLOAT16_VALUE(-0.92), SIMDE_FLOAT16_VALUE(3.60), SIMDE_FLOAT16_VALUE(3.19),
        SIMDE_FLOAT16_VALUE(3.24), SIMDE_FLOAT16_VALUE(8.21), SIMDE_FLOAT16_VALUE(-1.51), SIMDE_FLOAT16_VALUE(4.81),
        SIMDE_FLOAT16_VALUE(2.05), SIMDE_FLOAT16_VALUE(-3.18), SIMDE_FLOAT16_VALUE(8.26), SIMDE_FLOAT16_VALUE(-6.38) },
   { {  SIMDE_FLOAT16_VALUE(-9.77), SIMDE_FLOAT16_VALUE(6.23), SIMDE_FLOAT16_VALUE(3.40), SIMDE_FLOAT16_VALUE(-7.45) },
     {  SIMDE_FLOAT16_VALUE(7.00), SIMDE_FLOAT16_VALUE(-0.92), SIMDE_FLOAT16_VALUE(3.60), SIMDE_FLOAT16_VALUE(3.19) },
     {  SIMDE_FLOAT16_VALUE(3.24), SIMDE_FLOAT16_VALUE(8.21), SIMDE_FLOAT16_VALUE(-1.51), SIMDE_FLOAT16_VALUE(4.81) },
     {  SIMDE_FLOAT16_VALUE(2.05), SIMDE_FLOAT16_VALUE(-3.18), SIMDE_FLOAT16_VALUE(8.26), SIMDE_FLOAT16_VALUE(-6.38) } } },
  ...
  for (size_t i = 0; i < (sizeof(test_vec) / sizeof(test_vec[0])); i++) {
    simde_float16x4x4_t r = simde_vld1_f16_x4(test_vec[i].buf);
    simde_float16x4x4_t expected = {{
        ...
        simde_vld1_f16(test_vec[i].expected[3]),
    }};
    simde_test_arm_neon_assert_equal_f16x4x4(r, expected, 1);
  }
...
static int
test_simde_vld1_p8_x4 (SIMDE_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    SIMDE_ALIGN_TO_16 simde_poly8_t buf[32];
    SIMDE_ALIGN_TO_16 simde_poly8_t expected[4][8];
  } test_vec[] = {
    { { SIMDE_POLY8_C(115), SIMDE_POLY8_C(157), SIMDE_POLY8_C(202), SIMDE_POLY8_C(158), SIMDE_POLY8_C(229), SIMDE_POLY8_C( 49), SIMDE_POLY8_C( 33), SIMDE_POLY8_C(150),
        SIMDE_POLY8_C(241), SIMDE_POLY8_C(209), SIMDE_POLY8_C(252), SIMDE_POLY8_C(130), SIMDE_POLY8_C( 25), SIMDE_POLY8_C(177), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(  7),
        SIMDE_POLY8_C( 29), SIMDE_POLY8_C( 90), SIMDE_POLY8_C(165),    SIMDE_POLY8_C(UINT8_MAX), SIMDE_POLY8_C( 67), SIMDE_POLY8_C(227), SIMDE_POLY8_C(235), SIMDE_POLY8_C( 48),
        SIMDE_POLY8_C( 96), SIMDE_POLY8_C( 16), SIMDE_POLY8_C( 58), SIMDE_POLY8_C( 52), SIMDE_POLY8_C(159), SIMDE_POLY8_C(228), SIMDE_POLY8_C(158), SIMDE_POLY8_C( 18) },
        { { SIMDE_POLY8_C(115), SIMDE_POLY8_C(157), SIMDE_POLY8_C(202), SIMDE_POLY8_C(158), SIMDE_POLY8_C(229), SIMDE_POLY8_C( 49), SIMDE_POLY8_C( 33), SIMDE_POLY8_C(150) },
          { SIMDE_POLY8_C(241), SIMDE_POLY8_C(209), SIMDE_POLY8_C(252), SIMDE_POLY8_C(130), SIMDE_POLY8_C( 25), SIMDE_POLY8_C(177), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(  7) },
          { SIMDE_POLY8_C( 29), SIMDE_POLY8_C( 90), SIMDE_POLY8_C(165),    SIMDE_POLY8_C(UINT8_MAX), SIMDE_POLY8_C( 67), SIMDE_POLY8_C(227), SIMDE_POLY8_C(235), SIMDE_POLY8_C( 48) },
          { SIMDE_POLY8_C( 96), SIMDE_POLY8_C( 16), SIMDE_POLY8_C( 58), SIMDE_POLY8_C( 52), SIMDE_POLY8_C(159), SIMDE_POLY8_C(228), SIMDE_POLY8_C(158), SIMDE_POLY8_C( 18) } },
    },
    { { SIMDE_POLY8_C(129), SIMDE_POLY8_C(104), SIMDE_POLY8_C(177), SIMDE_POLY8_C(103), SIMDE_POLY8_C(153), SIMDE_POLY8_C(210), SIMDE_POLY8_C(253), SIMDE_POLY8_C(138),
        SIMDE_POLY8_C(163), SIMDE_POLY8_C(250), SIMDE_POLY8_C( 13), SIMDE_POLY8_C(189), SIMDE_POLY8_C(171), SIMDE_POLY8_C( 42), SIMDE_POLY8_C(196), SIMDE_POLY8_C(201),
        SIMDE_POLY8_C(132), SIMDE_POLY8_C(105), SIMDE_POLY8_C(200), SIMDE_POLY8_C(199), SIMDE_POLY8_C( 76), SIMDE_POLY8_C(179), SIMDE_POLY8_C(247), SIMDE_POLY8_C(172),
        SIMDE_POLY8_C(195), SIMDE_POLY8_C( 49), SIMDE_POLY8_C(224), SIMDE_POLY8_C( 98), SIMDE_POLY8_C( 21), SIMDE_POLY8_C(126), SIMDE_POLY8_C(117), SIMDE_POLY8_C(150) },
        { { SIMDE_POLY8_C(129), SIMDE_POLY8_C(104), SIMDE_POLY8_C(177), SIMDE_POLY8_C(103), SIMDE_POLY8_C(153), SIMDE_POLY8_C(210), SIMDE_POLY8_C(253), SIMDE_POLY8_C(138) },
          { SIMDE_POLY8_C(163), SIMDE_POLY8_C(250), SIMDE_POLY8_C( 13), SIMDE_POLY8_C(189), SIMDE_POLY8_C(171), SIMDE_POLY8_C( 42), SIMDE_POLY8_C(196), SIMDE_POLY8_C(201) },
          { SIMDE_POLY8_C(132), SIMDE_POLY8_C(105), SIMDE_POLY8_C(200), SIMDE_POLY8_C(199), SIMDE_POLY8_C( 76), SIMDE_POLY8_C(179), SIMDE_POLY8_C(247), SIMDE_POLY8_C(172) },
          { SIMDE_POLY8_C(195), SIMDE_POLY8_C( 49), SIMDE_POLY8_C(224), SIMDE_POLY8_C( 98), SIMDE_POLY8_C( 21), SIMDE_POLY8_C(126), SIMDE_POLY8_C(117), SIMDE_POLY8_C(150) } },
    },
    { { SIMDE_POLY8_C(231), SIMDE_POLY8_C( 38), SIMDE_POLY8_C(253), SIMDE_POLY8_C(128), SIMDE_POLY8_C(248), SIMDE_POLY8_C(251), SIMDE_POLY8_C( 11), SIMDE_POLY8_C(156),
        SIMDE_POLY8_C(245), SIMDE_POLY8_C( 24), SIMDE_POLY8_C( 89), SIMDE_POLY8_C(160), SIMDE_POLY8_C( 66), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(105), SIMDE_POLY8_C(198),
        SIMDE_POLY8_C(134), SIMDE_POLY8_C( 49), SIMDE_POLY8_C(141), SIMDE_POLY8_C(211), SIMDE_POLY8_C(229), SIMDE_POLY8_C(132), SIMDE_POLY8_C(127), SIMDE_POLY8_C(168),
        SIMDE_POLY8_C(181), SIMDE_POLY8_C( 96), SIMDE_POLY8_C( 11), SIMDE_POLY8_C(202), SIMDE_POLY8_C(222), SIMDE_POLY8_C(128), SIMDE_POLY8_C( 96), SIMDE_POLY8_C(197) },
        { { SIMDE_POLY8_C(231), SIMDE_POLY8_C( 38), SIMDE_POLY8_C(253), SIMDE_POLY8_C(128), SIMDE_POLY8_C(248), SIMDE_POLY8_C(251), SIMDE_POLY8_C( 11), SIMDE_POLY8_C(156) },
          { SIMDE_POLY8_C(245), SIMDE_POLY8_C( 24), SIMDE_POLY8_C( 89), SIMDE_POLY8_C(160), SIMDE_POLY8_C( 66), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(105), SIMDE_POLY8_C(198) },
          { SIMDE_POLY8_C(134), SIMDE_POLY8_C( 49), SIMDE_POLY8_C(141), SIMDE_POLY8_C(211), SIMDE_POLY8_C(229), SIMDE_POLY8_C(132), SIMDE_POLY8_C(127), SIMDE_POLY8_C(168) },
          { SIMDE_POLY8_C(181), SIMDE_POLY8_C( 96), SIMDE_POLY8_C( 11), SIMDE_POLY8_C(202), SIMDE_POLY8_C(222), SIMDE_POLY8_C(128), SIMDE_POLY8_C( 96), SIMDE_POLY8_C(197) } },
    },
    { { SIMDE_POLY8_C(166), SIMDE_POLY8_C( 94), SIMDE_POLY8_C( 70), SIMDE_POLY8_C(158), SIMDE_POLY8_C( 89), SIMDE_POLY8_C( 81), SIMDE_POLY8_C( 58), SIMDE_POLY8_C( 78),
        SIMDE_POLY8_C(105), SIMDE_POLY8_C(147), SIMDE_POLY8_C(238), SIMDE_POLY8_C(171), SIMDE_POLY8_C(176), SIMDE_POLY8_C( 88), SIMDE_POLY8_C(113), SIMDE_POLY8_C( 55),
        SIMDE_POLY8_C(137), SIMDE_POLY8_C(254), SIMDE_POLY8_C( 10), SIMDE_POLY8_C(110), SIMDE_POLY8_C(130), SIMDE_POLY8_C(137), SIMDE_POLY8_C( 23), SIMDE_POLY8_C( 55),
        SIMDE_POLY8_C(233), SIMDE_POLY8_C( 34), SIMDE_POLY8_C(  1), SIMDE_POLY8_C(200), SIMDE_POLY8_C(162), SIMDE_POLY8_C( 97), SIMDE_POLY8_C(141), SIMDE_POLY8_C( 72) },
        { { SIMDE_POLY8_C(166), SIMDE_POLY8_C( 94), SIMDE_POLY8_C( 70), SIMDE_POLY8_C(158), SIMDE_POLY8_C( 89), SIMDE_POLY8_C( 81), SIMDE_POLY8_C( 58), SIMDE_POLY8_C( 78) },
          { SIMDE_POLY8_C(105), SIMDE_POLY8_C(147), SIMDE_POLY8_C(238), SIMDE_POLY8_C(171), SIMDE_POLY8_C(176), SIMDE_POLY8_C( 88), SIMDE_POLY8_C(113), SIMDE_POLY8_C( 55) },
          { SIMDE_POLY8_C(137), SIMDE_POLY8_C(254), SIMDE_POLY8_C( 10), SIMDE_POLY8_C(110), SIMDE_POLY8_C(130), SIMDE_POLY8_C(137), SIMDE_POLY8_C( 23), SIMDE_POLY8_C( 55) },
          { SIMDE_POLY8_C(233), SIMDE_POLY8_C( 34), SIMDE_POLY8_C(  1), SIMDE_POLY8_C(200), SIMDE_POLY8_C(162), SIMDE_POLY8_C( 97), SIMDE_POLY8_C(141), SIMDE_POLY8_C( 72) } },
    },
    { { SIMDE_POLY8_C(191), SIMDE_POLY8_C(211), SIMDE_POLY8_C(230), SIMDE_POLY8_C( 24), SIMDE_POLY8_C( 36), SIMDE_POLY8_C( 33), SIMDE_POLY8_C(102), SIMDE_POLY8_C(141),
        SIMDE_POLY8_C(180), SIMDE_POLY8_C( 85), SIMDE_POLY8_C( 56), SIMDE_POLY8_C(101), SIMDE_POLY8_C(173), SIMDE_POLY8_C(169), SIMDE_POLY8_C(156), SIMDE_POLY8_C( 54),
        SIMDE_POLY8_C(167), SIMDE_POLY8_C(166), SIMDE_POLY8_C(165), SIMDE_POLY8_C( 41), SIMDE_POLY8_C( 47), SIMDE_POLY8_C(188), SIMDE_POLY8_C( 96), SIMDE_POLY8_C( 25),
        SIMDE_POLY8_C(222), SIMDE_POLY8_C( 97), SIMDE_POLY8_C(225), SIMDE_POLY8_C(128), SIMDE_POLY8_C(195), SIMDE_POLY8_C(110), SIMDE_POLY8_C(200), SIMDE_POLY8_C(130) },
        { { SIMDE_POLY8_C(191), SIMDE_POLY8_C(211), SIMDE_POLY8_C(230), SIMDE_POLY8_C( 24), SIMDE_POLY8_C( 36), SIMDE_POLY8_C( 33), SIMDE_POLY8_C(102), SIMDE_POLY8_C(141) },
          { SIMDE_POLY8_C(180), SIMDE_POLY8_C( 85), SIMDE_POLY8_C( 56), SIMDE_POLY8_C(101), SIMDE_POLY8_C(173), SIMDE_POLY8_C(169), SIMDE_POLY8_C(156), SIMDE_POLY8_C( 54) },
          { SIMDE_POLY8_C(167), SIMDE_POLY8_C(166), SIMDE_POLY8_C(165), SIMDE_POLY8_C( 41), SIMDE_POLY8_C( 47), SIMDE_POLY8_C(188), SIMDE_POLY8_C( 96), SIMDE_POLY8_C( 25) },
          { SIMDE_POLY8_C(222), SIMDE_POLY8_C( 97), SIMDE_POLY8_C(225), SIMDE_POLY8_C(128), SIMDE_POLY8_C(195), SIMDE_POLY8_C(110), SIMDE_POLY8_C(200), SIMDE_POLY8_C(130) } },
    },
    { { SIMDE_POLY8_C( 66), SIMDE_POLY8_C(174), SIMDE_POLY8_C(155), SIMDE_POLY8_C(102), SIMDE_POLY8_C(207), SIMDE_POLY8_C(  1), SIMDE_POLY8_C(244), SIMDE_POLY8_C(132),
        SIMDE_POLY8_C( 86), SIMDE_POLY8_C( 44), SIMDE_POLY8_C(233), SIMDE_POLY8_C(  3), SIMDE_POLY8_C(214), SIMDE_POLY8_C(133), SIMDE_POLY8_C( 58), SIMDE_POLY8_C(125),
        SIMDE_POLY8_C( 43), SIMDE_POLY8_C(223), SIMDE_POLY8_C(167), SIMDE_POLY8_C( 90), SIMDE_POLY8_C(155), SIMDE_POLY8_C(  7), SIMDE_POLY8_C(115), SIMDE_POLY8_C(121),
        SIMDE_POLY8_C(105), SIMDE_POLY8_C( 84), SIMDE_POLY8_C(249), SIMDE_POLY8_C( 44), SIMDE_POLY8_C(195), SIMDE_POLY8_C(193), SIMDE_POLY8_C(174), SIMDE_POLY8_C(  5) },
        { { SIMDE_POLY8_C( 66), SIMDE_POLY8_C(174), SIMDE_POLY8_C(155), SIMDE_POLY8_C(102), SIMDE_POLY8_C(207), SIMDE_POLY8_C(  1), SIMDE_POLY8_C(244), SIMDE_POLY8_C(132) },
          { SIMDE_POLY8_C( 86), SIMDE_POLY8_C( 44), SIMDE_POLY8_C(233), SIMDE_POLY8_C(  3), SIMDE_POLY8_C(214), SIMDE_POLY8_C(133), SIMDE_POLY8_C( 58), SIMDE_POLY8_C(125) },
          { SIMDE_POLY8_C( 43), SIMDE_POLY8_C(223), SIMDE_POLY8_C(167), SIMDE_POLY8_C( 90), SIMDE_POLY8_C(155), SIMDE_POLY8_C(  7), SIMDE_POLY8_C(115), SIMDE_POLY8_C(121) },
          { SIMDE_POLY8_C(105), SIMDE_POLY8_C( 84), SIMDE_POLY8_C(249), SIMDE_POLY8_C( 44), SIMDE_POLY8_C(195), SIMDE_POLY8_C(193), SIMDE_POLY8_C(174), SIMDE_POLY8_C(  5) } },
    },
    { { SIMDE_POLY8_C(111), SIMDE_POLY8_C( 73), SIMDE_POLY8_C(107), SIMDE_POLY8_C( 63), SIMDE_POLY8_C( 75), SIMDE_POLY8_C( 95), SIMDE_POLY8_C(195), SIMDE_POLY8_C(161),
        SIMDE_POLY8_C(140), SIMDE_POLY8_C(172), SIMDE_POLY8_C(165), SIMDE_POLY8_C( 98), SIMDE_POLY8_C( 49), SIMDE_POLY8_C(223), SIMDE_POLY8_C(223), SIMDE_POLY8_C( 92),
        SIMDE_POLY8_C(190), SIMDE_POLY8_C(134), SIMDE_POLY8_C(182), SIMDE_POLY8_C( 89), SIMDE_POLY8_C(142), SIMDE_POLY8_C( 42), SIMDE_POLY8_C(210), SIMDE_POLY8_C(247),
        SIMDE_POLY8_C(126), SIMDE_POLY8_C(203), SIMDE_POLY8_C( 35), SIMDE_POLY8_C( 65), SIMDE_POLY8_C(140), SIMDE_POLY8_C(209), SIMDE_POLY8_C( 70), SIMDE_POLY8_C(251) },
        { { SIMDE_POLY8_C(111), SIMDE_POLY8_C( 73), SIMDE_POLY8_C(107), SIMDE_POLY8_C( 63), SIMDE_POLY8_C( 75), SIMDE_POLY8_C( 95), SIMDE_POLY8_C(195), SIMDE_POLY8_C(161) },
          { SIMDE_POLY8_C(140), SIMDE_POLY8_C(172), SIMDE_POLY8_C(165), SIMDE_POLY8_C( 98), SIMDE_POLY8_C( 49), SIMDE_POLY8_C(223), SIMDE_POLY8_C(223), SIMDE_POLY8_C( 92) },
          { SIMDE_POLY8_C(190), SIMDE_POLY8_C(134), SIMDE_POLY8_C(182), SIMDE_POLY8_C( 89), SIMDE_POLY8_C(142), SIMDE_POLY8_C( 42), SIMDE_POLY8_C(210), SIMDE_POLY8_C(247) },
          { SIMDE_POLY8_C(126), SIMDE_POLY8_C(203), SIMDE_POLY8_C( 35), SIMDE_POLY8_C( 65), SIMDE_POLY8_C(140), SIMDE_POLY8_C(209), SIMDE_POLY8_C( 70), SIMDE_POLY8_C(251) } },
    },
    { { SIMDE_POLY8_C( 27), SIMDE_POLY8_C(178), SIMDE_POLY8_C( 58), SIMDE_POLY8_C(102), SIMDE_POLY8_C( 17), SIMDE_POLY8_C(253), SIMDE_POLY8_C(  7), SIMDE_POLY8_C(157),
        SIMDE_POLY8_C(169), SIMDE_POLY8_C(172),    SIMDE_POLY8_C(UINT8_MAX), SIMDE_POLY8_C(218), SIMDE_POLY8_C(139), SIMDE_POLY8_C(223), SIMDE_POLY8_C( 54), SIMDE_POLY8_C( 73),
        SIMDE_POLY8_C(101), SIMDE_POLY8_C(237), SIMDE_POLY8_C(162), SIMDE_POLY8_C(243), SIMDE_POLY8_C( 23), SIMDE_POLY8_C(116), SIMDE_POLY8_C(234), SIMDE_POLY8_C(149),
        SIMDE_POLY8_C( 63), SIMDE_POLY8_C( 13), SIMDE_POLY8_C(215), SIMDE_POLY8_C(203), SIMDE_POLY8_C(223), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(199), SIMDE_POLY8_C(250) },
        { { SIMDE_POLY8_C( 27), SIMDE_POLY8_C(178), SIMDE_POLY8_C( 58), SIMDE_POLY8_C(102), SIMDE_POLY8_C( 17), SIMDE_POLY8_C(253), SIMDE_POLY8_C(  7), SIMDE_POLY8_C(157) },
          { SIMDE_POLY8_C(169), SIMDE_POLY8_C(172),    SIMDE_POLY8_C(UINT8_MAX), SIMDE_POLY8_C(218), SIMDE_POLY8_C(139), SIMDE_POLY8_C(223), SIMDE_POLY8_C( 54), SIMDE_POLY8_C( 73) },
          { SIMDE_POLY8_C(101), SIMDE_POLY8_C(237), SIMDE_POLY8_C(162), SIMDE_POLY8_C(243), SIMDE_POLY8_C( 23), SIMDE_POLY8_C(116), SIMDE_POLY8_C(234), SIMDE_POLY8_C(149) },
          { SIMDE_POLY8_C( 63), SIMDE_POLY8_C( 13), SIMDE_POLY8_C(215), SIMDE_POLY8_C(203), SIMDE_POLY8_C(223), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(199), SIMDE_POLY8_C(250) } },
  ...
  for (size_t i = 0; i < (sizeof(test_vec) / sizeof(test_vec[0])); i++) {
    SIMDE_ALIGN_TO_16 simde_poly8x8x4_t r = simde_vld1_p8_x4(test_vec[i].buf);
    SIMDE_ALIGN_TO_16 simde_poly8x8x4_t expected = {{
        simde_vld1_p8(test_vec[i].expected[0]),
        simde_vld1_p8(test_vec[i].expected[1]),
        simde_vld1_p8(test_vec[i].expected[2]),
        simde_vld1_p8(test_vec[i].expected[3]),
    }};
    simde_test_arm_neon_assert_equal_p8x8x4(r, expected);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    simde_test_codegen_random_memory(32, (uint8_t*)buf);
    simde_test_codegen_write_vp8(2, 32, buf, SIMDE_TEST_VEC_POS_FIRST);

    simde_poly8x8x4_t val = simde_vld1_p8_x4(buf);
    simde_test_arm_neon_write_p8x8x4(2, val, SIMDE_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_simde_vld1_p16_x4 (SIMDE_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    SIMDE_ALIGN_TO_16 simde_poly16_t buf[16];
    SIMDE_ALIGN_TO_16 simde_poly16_t expected[4][4];
  } test_vec[] = {
    { { SIMDE_POLY16_C(11057), SIMDE_POLY16_C(26146), SIMDE_POLY16_C(26897), SIMDE_POLY16_C(39509), SIMDE_POLY16_C(63640), SIMDE_POLY16_C(43715), SIMDE_POLY16_C(30007), SIMDE_POLY16_C(28763),
        SIMDE_POLY16_C(19543), SIMDE_POLY16_C(17162), SIMDE_POLY16_C(56535), SIMDE_POLY16_C(17014), SIMDE_POLY16_C(52473), SIMDE_POLY16_C(24636), SIMDE_POLY16_C(37539), SIMDE_POLY16_C(54708) },
        { { SIMDE_POLY16_C(11057), SIMDE_POLY16_C(26146), SIMDE_POLY16_C(26897), SIMDE_POLY16_C(39509) },
          { SIMDE_POLY16_C(63640), SIMDE_POLY16_C(43715), SIMDE_POLY16_C(30007), SIMDE_POLY16_C(28763) },
          { SIMDE_POLY16_C(19543), SIMDE_POLY16_C(17162), SIMDE_POLY16_C(56535), SIMDE_POLY16_C(17014) },
          { SIMDE_POLY16_C(52473), SIMDE_POLY16_C(24636), SIMDE_POLY16_C(37539), SIMDE_POLY16_C(54708) } },
    },
    { { SIMDE_POLY16_C(55229), SIMDE_POLY16_C(53051), SIMDE_POLY16_C(36928), SIMDE_POLY16_C(55401), SIMDE_POLY16_C(11401), SIMDE_POLY16_C(49282), SIMDE_POLY16_C(56994), SIMDE_POLY16_C(63793),
        SIMDE_POLY16_C(15146), SIMDE_POLY16_C(  317), SIMDE_POLY16_C(45847), SIMDE_POLY16_C( 4419), SIMDE_POLY16_C(32639), SIMDE_POLY16_C( 9073), SIMDE_POLY16_C( 9490), SIMDE_POLY16_C(53240) },
        { { SIMDE_POLY16_C(55229), SIMDE_POLY16_C(53051), SIMDE_POLY16_C(36928), SIMDE_POLY16_C(55401) },
          { SIMDE_POLY16_C(11401), SIMDE_POLY16_C(49282), SIMDE_POLY16_C(56994), SIMDE_POLY16_C(63793) },
          { SIMDE_POLY16_C(15146), SIMDE_POLY16_C(  317), SIMDE_POLY16_C(45847), SIMDE_POLY16_C( 4419) },
          { SIMDE_POLY16_C(32639), SIMDE_POLY16_C( 9073), SIMDE_POLY16_C( 9490), SIMDE_POLY16_C(53240) } },
    },
    { { SIMDE_POLY16_C(13308), SIMDE_POLY16_C(15518), SIMDE_POLY16_C( 2244), SIMDE_POLY16_C(19732), SIMDE_POLY16_C(38708), SIMDE_POLY16_C(54797), SIMDE_POLY16_C(15989), SIMDE_POLY16_C(40912),
        SIMDE_POLY16_C( 3450), SIMDE_POLY16_C(37280), SIMDE_POLY16_C(58304), SIMDE_POLY16_C(16290), SIMDE_POLY16_C( 4963), SIMDE_POLY16_C(30050), SIMDE_POLY16_C(23097), SIMDE_POLY16_C(13636) },
        { { SIMDE_POLY16_C(13308), SIMDE_POLY16_C(15518), SIMDE_POLY16_C( 2244), SIMDE_POLY16_C(19732) },
          { SIMDE_POLY16_C(38708), SIMDE_POLY16_C(54797), SIMDE_POLY16_C(15989), SIMDE_POLY16_C(40912) },
          { SIMDE_POLY16_C( 3450), SIMDE_POLY16_C(37280), SIMDE_POLY16_C(58304), SIMDE_POLY16_C(16290) },
          { SIMDE_POLY16_C( 4963), SIMDE_POLY16_C(30050), SIMDE_POLY16_C(23097), SIMDE_POLY16_C(13636) } },
    },
    { { SIMDE_POLY16_C(58254), SIMDE_POLY16_C(21106), SIMDE_POLY16_C(34539), SIMDE_POLY16_C( 8095), SIMDE_POLY16_C(44061), SIMDE_POLY16_C(37622), SIMDE_POLY16_C(50923), SIMDE_POLY16_C(25905),
        SIMDE_POLY16_C(53715), SIMDE_POLY16_C(37878), SIMDE_POLY16_C(39349), SIMDE_POLY16_C( 6354), SIMDE_POLY16_C(13740), SIMDE_POLY16_C(58765), SIMDE_POLY16_C(53647), SIMDE_POLY16_C( 7451) },
        { { SIMDE_POLY16_C(58254), SIMDE_POLY16_C(21106), SIMDE_POLY16_C(34539), SIMDE_POLY16_C( 8095) },
          { SIMDE_POLY16_C(44061), SIMDE_POLY16_C(37622), SIMDE_POLY16_C(50923), SIMDE_POLY16_C(25905) },
          { SIMDE_POLY16_C(53715), SIMDE_POLY16_C(37878), SIMDE_POLY16_C(39349), SIMDE_POLY16_C( 6354) },
          { SIMDE_POLY16_C(13740), SIMDE_POLY16_C(58765), SIMDE_POLY16_C(53647), SIMDE_POLY16_C( 7451) } },
    },
    { { SIMDE_POLY16_C(36276), SIMDE_POLY16_C(40815), SIMDE_POLY16_C( 3603), SIMDE_POLY16_C(12735), SIMDE_POLY16_C(46523), SIMDE_POLY16_C(42691), SIMDE_POLY16_C(62843), SIMDE_POLY16_C(19979),
        SIMDE_POLY16_C(  454), SIMDE_POLY16_C(31713), SIMDE_POLY16_C(45978), SIMDE_POLY16_C(18323), SIMDE_POLY16_C( 8424), SIMDE_POLY16_C(30764), SIMDE_POLY16_C(18418), SIMDE_POLY16_C(42645) },
        { { SIMDE_POLY16_C(36276), SIMDE_POLY16_C(40815), SIMDE_POLY16_C( 3603), SIMDE_POLY16_C(12735) },
          { SIMDE_POLY16_C(46523), SIMDE_POLY16_C(42691), SIMDE_POLY16_C(62843), SIMDE_POLY16_C(19979) },
          { SIMDE_POLY16_C(  454), SIMDE_POLY16_C(31713), SIMDE_POLY16_C(45978), SIMDE_POLY16_C(18323) },
          { SIMDE_POLY16_C( 8424), SIMDE_POLY16_C(30764), SIMDE_POLY16_C(18418), SIMDE_POLY16_C(42645) } },
    },
    { { SIMDE_POLY16_C( 1492), SIMDE_POLY16_C(59462), SIMDE_POLY16_C( 1299), SIMDE_POLY16_C(52761), SIMDE_POLY16_C(56506), SIMDE_POLY16_C(13684), SIMDE_POLY16_C(32721), SIMDE_POLY16_C(39043),
        SIMDE_POLY16_C(25729), SIMDE_POLY16_C( 6931), SIMDE_POLY16_C(42775), SIMDE_POLY16_C(   98), SIMDE_POLY16_C(36807), SIMDE_POLY16_C(47480), SIMDE_POLY16_C( 3542), SIMDE_POLY16_C(43872) },
        { { SIMDE_POLY16_C( 1492), SIMDE_POLY16_C(59462), SIMDE_POLY16_C( 1299), SIMDE_POLY16_C(52761) },
          { SIMDE_POLY16_C(56506), SIMDE_POLY16_C(13684), SIMDE_POLY16_C(32721), SIMDE_POLY16_C(39043) },
          { SIMDE_POLY16_C(25729), SIMDE_POLY16_C( 6931), SIMDE_POLY16_C(42775), SIMDE_POLY16_C(   98) },
          { SIMDE_POLY16_C(36807), SIMDE_POLY16_C(47480), SIMDE_POLY16_C( 3542), SIMDE_POLY16_C(43872) } },
    },
    { { SIMDE_POLY16_C(42514), SIMDE_POLY16_C( 9875), SIMDE_POLY16_C(44203), SIMDE_POLY16_C(26100), SIMDE_POLY16_C(27016), SIMDE_POLY16_C(23194), SIMDE_POLY16_C( 7656), SIMDE_POLY16_C(27122),
        SIMDE_POLY16_C( 1409), SIMDE_POLY16_C(39045), SIMDE_POLY16_C(59308), SIMDE_POLY16_C(29848), SIMDE_POLY16_C( 4214), SIMDE_POLY16_C(19757), SIMDE_POLY16_C(36126), SIMDE_POLY16_C(12536) },
        { { SIMDE_POLY16_C(42514), SIMDE_POLY16_C( 9875), SIMDE_POLY16_C(44203), SIMDE_POLY16_C(26100) },
          { SIMDE_POLY16_C(27016), SIMDE_POLY16_C(23194), SIMDE_POLY16_C( 7656), SIMDE_POLY16_C(27122) },
          { SIMDE_POLY16_C( 1409), SIMDE_POLY16_C(39045), SIMDE_POLY16_C(59308), SIMDE_POLY16_C(29848) },
          { SIMDE_POLY16_C( 4214), SIMDE_POLY16_C(19757), SIMDE_POLY16_C(36126), SIMDE_POLY16_C(12536) } },
    },
    { { SIMDE_POLY16_C(35635), SIMDE_POLY16_C(56918), SIMDE_POLY16_C(19255), SIMDE_POLY16_C(48963), SIMDE_POLY16_C(56756), SIMDE_POLY16_C(39961), SIMDE_POLY16_C( 3066), SIMDE_POLY16_C(31494),
        SIMDE_POLY16_C(35601), SIMDE_POLY16_C(48404), SIMDE_POLY16_C(44146), SIMDE_POLY16_C(59697), SIMDE_POLY16_C(24509), SIMDE_POLY16_C(56118), SIMDE_POLY16_C(12012), SIMDE_POLY16_C( 8203) },
        { { SIMDE_POLY16_C(35635), SIMDE_POLY16_C(56918), SIMDE_POLY16_C(19255), SIMDE_POLY16_C(48963) },
          { SIMDE_POLY16_C(56756), SIMDE_POLY16_C(39961), SIMDE_POLY16_C( 3066), SIMDE_POLY16_C(31494) },
          { SIMDE_POLY16_C(35601), SIMDE_POLY16_C(48404), SIMDE_POLY16_C(44146), SIMDE_POLY16_C(59697) },
          { SIMDE_POLY16_C(24509), SIMDE_POLY16_C(56118), SIMDE_POLY16_C(12012), SIMDE_POLY16_C( 8203) } },
    },
  };

  for (size_t i = 0; i < (sizeof(test_vec) / sizeof(test_vec[0])); i++) {
    SIMDE_ALIGN_TO_16 simde_poly16x4x4_t r = simde_vld1_p16_x4(test_vec[i].buf);
    SIMDE_ALIGN_TO_16 simde_poly16x4x4_t expected = {{
        simde_vld1_p16(test_vec[i].expected[0]),
        simde_vld1_p16(test_vec[i].expected[1]),
        simde_vld1_p16(test_vec[i].expected[2]),
        simde_vld1_p16(test_vec[i].expected[3]),
    }};
    simde_test_arm_neon_assert_equal_p16x4x4(r, expected);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    simde_test_codegen_random_memory(32, (uint8_t*)buf);
    simde_test_codegen_write_vp16(2, 16, buf, SIMDE_TEST_VEC_POS_FIRST);

    simde_poly16x4x4_t val = simde_vld1_p16_x4(buf);
    simde_test_arm_neon_write_p16x4x4(2, val, SIMDE_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_simde_vld1_p64_x4 (SIMDE_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    simde_poly64_t buf[4];
    simde_poly64_t expected[4][1];
  } test_vec[] = {
    { { SIMDE_POLY64_C(11161851323991035015), SIMDE_POLY64_C(11361295587426027948), SIMDE_POLY64_C(10586492551251052975), SIMDE_POLY64_C(10354254964168465566) },
        { { SIMDE_POLY64_C(11161851323991035015) },
          { SIMDE_POLY64_C(11361295587426027948) },
          { SIMDE_POLY64_C(10586492551251052975) },
          { SIMDE_POLY64_C(10354254964168465566) } },
    },
    { { SIMDE_POLY64_C( 7961968054553929280), SIMDE_POLY64_C( 6422826489033210720), SIMDE_POLY64_C( 2968999753558771135), SIMDE_POLY64_C( 4518438628330195485) },
        { { SIMDE_POLY64_C( 7961968054553929280) },
          { SIMDE_POLY64_C( 6422826489033210720) },
          { SIMDE_POLY64_C( 2968999753558771135) },
          { SIMDE_POLY64_C( 4518438628330195485) } },
    },
    { { SIMDE_POLY64_C( 6759518196046456221), SIMDE_POLY64_C(14906636656841955805), SIMDE_POLY64_C( 1620351352405293000), SIMDE_POLY64_C(15576525297564746734) },
        { { SIMDE_POLY64_C( 6759518196046456221) },
          { SIMDE_POLY64_C(14906636656841955805) },
          { SIMDE_POLY64_C( 1620351352405293000) },
          { SIMDE_POLY64_C(15576525297564746734) } },
    },
    { { SIMDE_POLY64_C(14748451979621059924), SIMDE_POLY64_C( 6592762510105022368), SIMDE_POLY64_C( 9238901067204193833), SIMDE_POLY64_C(13096633063648817838) },
        { { SIMDE_POLY64_C(14748451979621059924) },
          { SIMDE_POLY64_C( 6592762510105022368) },
          { SIMDE_POLY64_C( 9238901067204193833) },
          { SIMDE_POLY64_C(13096633063648817838) } },
    },
    { { SIMDE_POLY64_C(11502109884666018020), SIMDE_POLY64_C( 5490112400039276866), SIMDE_POLY64_C(13244142063545409210), SIMDE_POLY64_C(12911645100909541400) },
        { { SIMDE_POLY64_C(11502109884666018020) },
          { SIMDE_POLY64_C( 5490112400039276866) },
          { SIMDE_POLY64_C(13244142063545409210) },
          { SIMDE_POLY64_C(12911645100909541400) } },
    },
    { { SIMDE_POLY64_C( 3168042542726264153), SIMDE_POLY64_C(14737519685457167638), SIMDE_POLY64_C(12884769508922356750), SIMDE_POLY64_C( 2999497205207494430) },
        { { SIMDE_POLY64_C( 3168042542726264153) },
          { SIMDE_POLY64_C(14737519685457167638) },
          { SIMDE_POLY64_C(12884769508922356750) },
          { SIMDE_POLY64_C( 2999497205207494430) } },
    },
    { { SIMDE_POLY64_C( 7035599308422456975), SIMDE_POLY64_C(16256907048017175485), SIMDE_POLY64_C(13286403516927685910), SIMDE_POLY64_C( 8660780421289971256) },
        { { SIMDE_POLY64_C( 7035599308422456975) },
          { SIMDE_POLY64_C(16256907048017175485) },
          { SIMDE_POLY64_C(13286403516927685910) },
          { SIMDE_POLY64_C( 8660780421289971256) } },
    },
    { { SIMDE_POLY64_C(16724279027907474027), SIMDE_POLY64_C(17071549511957459766), SIMDE_POLY64_C(16527084378805560328), SIMDE_POLY64_C(12892995695718302093) },
        { { SIMDE_POLY64_C(16724279027907474027) },
          { SIMDE_POLY64_C(17071549511957459766) },
          { SIMDE_POLY64_C(16527084378805560328) },
          { SIMDE_POLY64_C(12892995695718302093) } },
    },
  };

  for (size_t i = 0; i < (sizeof(test_vec) / sizeof(test_vec[0])); i++) {
    simde_poly64x1x4_t r = simde_vld1_p64_x4(test_vec[i].buf);
    simde_poly64x1x4_t expected = {{
        ...
        simde_vld1_p64(test_vec[i].expected[3]),
    }};
    simde_test_arm_neon_assert_equal_p64x1x4(r, expected);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    simde_poly64_t buf[4];
    simde_test_codegen_random_memory(32, (uint8_t*)buf);
    simde_test_codegen_write_vp64(2, 4, buf, SIMDE_TEST_VEC_POS_FIRST);

    simde_poly64x1x4_t val = simde_vld1_p64_x4(buf);
    simde_test_arm_neon_write_p64x1x4(2, val, SIMDE_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
test_simde_vld1_bf16_x4 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    simde_bfloat16 buf[16];
    simde_bfloat16 expected[4][4];
  } test_vec[] = {
   { {  SIMDE_BFLOAT16_VALUE(1.49), SIMDE_BFLOAT16_VALUE(-9.73), SIMDE_BFLOAT16_VALUE(7.36), SIMDE_BFLOAT16_VALUE(3.11),
        SIMDE_BFLOAT16_VALUE(7.22), SIMDE_BFLOAT16_VALUE(-2.45), SIMDE_BFLOAT16_VALUE(3.68), SIMDE_BFLOAT16_VALUE(-1.35),
        SIMDE_BFLOAT16_VALUE(-6.30), SIMDE_BFLOAT16_VALUE(-2.80), SIMDE_BFLOAT16_VALUE(3.23), SIMDE_BFLOAT16_VALUE(5.48),
        SIMDE_BFLOAT16_VALUE(4.45), SIMDE_BFLOAT16_VALUE(-3.47), SIMDE_BFLOAT16_VALUE(7.65), SIMDE_BFLOAT16_VALUE(3.68) },
   { {  SIMDE_BFLOAT16_VALUE(1.49), SIMDE_BFLOAT16_VALUE(-9.73), SIMDE_BFLOAT16_VALUE(7.36), SIMDE_BFLOAT16_VALUE(3.11) },
     {  SIMDE_BFLOAT16_VALUE(7.22), SIMDE_BFLOAT16_VALUE(-2.45), SIMDE_BFLOAT16_VALUE(3.68), SIMDE_BFLOAT16_VALUE(-1.35) },
     {  SIMDE_BFLOAT16_VALUE(-6.30), SIMDE_BFLOAT16_VALUE(-2.80), SIMDE_BFLOAT16_VALUE(3.23), SIMDE_BFLOAT16_VALUE(5.48) },
     {  SIMDE_BFLOAT16_VALUE(4.45), SIMDE_BFLOAT16_VALUE(-3.47), SIMDE_BFLOAT16_VALUE(7.65), SIMDE_BFLOAT16_VALUE(3.68) } } },
   { {  SIMDE_BFLOAT16_VALUE(-8.94), SIMDE_BFLOAT16_VALUE(-1.95), SIMDE_BFLOAT16_VALUE(7.40), SIMDE_BFLOAT16_VALUE(4.23),
        SIMDE_BFLOAT16_VALUE(1.06), SIMDE_BFLOAT16_VALUE(-0.17), SIMDE_BFLOAT16_VALUE(-7.00), SIMDE_BFLOAT16_VALUE(9.69),
        SIMDE_BFLOAT16_VALUE(-1.56), SIMDE_BFLOAT16_VALUE(2.45), SIMDE_BFLOAT16_VALUE(-4.16), SIMDE_BFLOAT16_VALUE(-6.16),
        SIMDE_BFLOAT16_VALUE(6.09), SIMDE_BFLOAT16_VALUE(3.06), SIMDE_BFLOAT16_VALUE(-0.57), SIMDE_BFLOAT16_VALUE(4.51) },
   { {  SIMDE_BFLOAT16_VALUE(-8.94), SIMDE_BFLOAT16_VALUE(-1.95), SIMDE_BFLOAT16_VALUE(7.40), SIMDE_BFLOAT16_VALUE(4.23) },
     {  SIMDE_BFLOAT16_VALUE(1.06), SIMDE_BFLOAT16_VALUE(-0.17), SIMDE_BFLOAT16_VALUE(-7.00), SIMDE_BFLOAT16_VALUE(9.69) },
     {  SIMDE_BFLOAT16_VALUE(-1.56), SIMDE_BFLOAT16_VALUE(2.45), SIMDE_BFLOAT16_VALUE(-4.16), SIMDE_BFLOAT16_VALUE(-6.16) },
     {  SIMDE_BFLOAT16_VALUE(6.09), SIMDE_BFLOAT16_VALUE(3.06), SIMDE_BFLOAT16_VALUE(-0.57), SIMDE_BFLOAT16_VALUE(4.51) } } },
   { {  SIMDE_BFLOAT16_VALUE(6.06), SIMDE_BFLOAT16_VALUE(-0.83), SIMDE_BFLOAT16_VALUE(-8.07), SIMDE_BFLOAT16_VALUE(-8.13),
        SIMDE_BFLOAT16_VALUE(-2.78), SIMDE_BFLOAT16_VALUE(-9.03), SIMDE_BFLOAT16_VALUE(0.63), SIMDE_BFLOAT16_VALUE(-6.69),
        SIMDE_BFLOAT16_VALUE(3.21), SIMDE_BFLOAT16_VALUE(-7.11), SIMDE_BFLOAT16_VALUE(2.09), SIMDE_BFLOAT16_VALUE(5.06),
        SIMDE_BFLOAT16_VALUE(-0.76), SIMDE_BFLOAT16_VALUE(4.49), SIMDE_BFLOAT16_VALUE(-8.49), SIMDE_BFLOAT16_VALUE(-9.25) },
   { {  SIMDE_BFLOAT16_VALUE(6.06), SIMDE_BFLOAT16_VALUE(-0.83), SIMDE_BFLOAT16_VALUE(-8.07), SIMDE_BFLOAT16_VALUE(-8.13) },
     {  SIMDE_BFLOAT16_VALUE(-2.78), SIMDE_BFLOAT16_VALUE(-9.03), SIMDE_BFLOAT16_VALUE(0.63), SIMDE_BFLOAT16_VALUE(-6.69) },
     {  SIMDE_BFLOAT16_VALUE(3.21), SIMDE_BFLOAT16_VALUE(-7.11), SIMDE_BFLOAT16_VALUE(2.09), SIMDE_BFLOAT16_VALUE(5.06) },
     {  SIMDE_BFLOAT16_VALUE(-0.76), SIMDE_BFLOAT16_VALUE(4.49), SIMDE_BFLOAT16_VALUE(-8.49), SIMDE_BFLOAT16_VALUE(-9.25) } } },
   { {  SIMDE_BFLOAT16_VALUE(9.79), SIMDE_BFLOAT16_VALUE(2.62), SIMDE_BFLOAT16_VALUE(-9.19), SIMDE_BFLOAT16_VALUE(3.73),
        SIMDE_BFLOAT16_VALUE(1.03), SIMDE_BFLOAT16_VALUE(8.35), SIMDE_BFLOAT16_VALUE(-3.15), SIMDE_BFLOAT16_VALUE(0.58),
        SIMDE_BFLOAT16_VALUE(-3.14), SIMDE_BFLOAT16_VALUE(-8.78), SIMDE_BFLOAT16_VALUE(7.54), SIMDE_BFLOAT16_VALUE(-1.07),
        SIMDE_BFLOAT16_VALUE(-8.37), SIMDE_BFLOAT16_VALUE(7.13), SIMDE_BFLOAT16_VALUE(-5.82), SIMDE_BFLOAT16_VALUE(8.91) },
   { {  SIMDE_BFLOAT16_VALUE(9.79), SIMDE_BFLOAT16_VALUE(2.62), SIMDE_BFLOAT16_VALUE(-9.19), SIMDE_BFLOAT16_VALUE(3.73) },
     {  SIMDE_BFLOAT16_VALUE(1.03), SIMDE_BFLOAT16_VALUE(8.35), SIMDE_BFLOAT16_VALUE(-3.15), SIMDE_BFLOAT16_VALUE(0.58) },
     {  SIMDE_BFLOAT16_VALUE(-3.14), SIMDE_BFLOAT16_VALUE(-8.78), SIMDE_BFLOAT16_VALUE(7.54), SIMDE_BFLOAT16_VALUE(-1.07) },
     {  SIMDE_BFLOAT16_VALUE(-8.37), SIMDE_BFLOAT16_VALUE(7.13), SIMDE_BFLOAT16_VALUE(-5.82), SIMDE_BFLOAT16_VALUE(8.91) } } },
   { {  SIMDE_BFLOAT16_VALUE(-9.77), SIMDE_BFLOAT16_VALUE(6.23), SIMDE_BFLOAT16_VALUE(3.40), SIMDE_BFLOAT16_VALUE(-7.45),
        SIMDE_BFLOAT16_VALUE(7.00), SIMDE_BFLOAT16_VALUE(-0.92), SIMDE_BFLOAT16_VALUE(3.60), SIMDE_BFLOAT16_VALUE(3.19),
        SIMDE_BFLOAT16_VALUE(3.24), SIMDE_BFLOAT16_VALUE(8.21), SIMDE_BFLOAT16_VALUE(-1.51), SIMDE_BFLOAT16_VALUE(4.81),
        SIMDE_BFLOAT16_VALUE(2.05), SIMDE_BFLOAT16_VALUE(-3.18), SIMDE_BFLOAT16_VALUE(8.26), SIMDE_BFLOAT16_VALUE(-6.38) },
   { {  SIMDE_BFLOAT16_VALUE(-9.77), SIMDE_BFLOAT16_VALUE(6.23), SIMDE_BFLOAT16_VALUE(3.40), SIMDE_BFLOAT16_VALUE(-7.45) },
     {  SIMDE_BFLOAT16_VALUE(7.00), SIMDE_BFLOAT16_VALUE(-0.92), SIMDE_BFLOAT16_VALUE(3.60), SIMDE_BFLOAT16_VALUE(3.19) },
     {  SIMDE_BFLOAT16_VALUE(3.24), SIMDE_BFLOAT16_VALUE(8.21), SIMDE_BFLOAT16_VALUE(-1.51), SIMDE_BFLOAT16_VALUE(4.81) },
     {  SIMDE_BFLOAT16_VALUE(2.05), SIMDE_BFLOAT16_VALUE(-3.18), SIMDE_BFLOAT16_VALUE(8.26), SIMDE_BFLOAT16_VALUE(-6.38) } } },
  ...
  for (size_t i = 0; i < (sizeof(test_vec) / sizeof(test_vec[0])); i++) {
    simde_bfloat16x4x4_t r = simde_vld1_bf16_x4(test_vec[i].buf);
    simde_bfloat16x4x4_t expected = {{
        ...
        simde_vld1_bf16(test_vec[i].expected[3]),
    }};
    simde_test_arm_neon_assert_equal_bf16x4x4(r, expected, 1);
  }
...
#if !defined(SIMDE_BUG_INTEL_857088)
SIMDE_TEST_FUNC_LIST_ENTRY(vld1_f16_x4)
