...
test_simde_vld1_s16_x4 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    { { -INT16_C( 27748),  INT16_C(  7941), -INT16_C( 11645),  INT16_C(  6510),  INT16_C( 24581),  INT16_C( 11214),  INT16_C( 23789), -INT16_C( 28289),
         INT16_C( 16355),  INT16_C( 12353), -INT16_C( 16043), -INT16_C( 29021),  INT16_C( 18481),  INT16_C( 21748), -INT16_C(  5981),  INT16_C( 16207) },
        { { -INT16_C( 27748),  INT16_C(  7941), -INT16_C( 11645),  INT16_C(  6510) },
          {  INT16_C( 24581),  INT16_C( 11214),  INT16_C( 23789), -INT16_C( 28289) },
          {  INT16_C( 16355),  INT16_C( 12353), -INT16_C( 16043), -INT16_C( 29021) },
          {  INT16_C( 18481),  INT16_C( 21748), -INT16_C(  5981),  INT16_C( 16207) } },
    },
    { {  INT16_C( 21627), -INT16_C(   418), -INT16_C( 13274),  INT16_C( 11032), -INT16_C(  6612),  INT16_C(  6742), -INT16_C( 10942),  INT16_C(  9899),
        -INT16_C(  5099),  INT16_C( 27222), -INT16_C(  1619), -INT16_C(  8455), -INT16_C(  4799), -INT16_C(  7118), -INT16_C( 32299),  INT16_C( 20771) },
        { {  INT16_C( 21627), -INT16_C(   418), -INT16_C( 13274),  INT16_C( 11032) },
          { -INT16_C(  6612),  INT16_C(  6742), -INT16_C( 10942),  INT16_C(  9899) },
          { -INT16_C(  5099),  INT16_C( 27222), -INT16_C(  1619), -INT16_C(  8455) },
          { -INT16_C(  4799), -INT16_C(  7118), -INT16_C( 32299),  INT16_C( 20771) } },
    },
    { { -INT16_C( 32043), -INT16_C(   945),  INT16_C( 26446),  INT16_C( 31527),  INT16_C( 32333), -INT16_C( 28523),  INT16_C( 16467),  INT16_C( 26806),
         INT16_C(  3116), -INT16_C(  9773), -INT16_C( 13306),  INT16_C( 18359), -INT16_C(  5447), -INT16_C( 28884),  INT16_C( 20331),  INT16_C( 16864) },
        { { -INT16_C( 32043), -INT16_C(   945),  INT16_C( 26446),  INT16_C( 31527) },
          {  INT16_C( 32333), -INT16_C( 28523),  INT16_C( 16467),  INT16_C( 26806) },
          {  INT16_C(  3116), -INT16_C(  9773), -INT16_C( 13306),  INT16_C( 18359) },
          { -INT16_C(  5447), -INT16_C( 28884),  INT16_C( 20331),  INT16_C( 16864) } },
    },
    { {  INT16_C( 12241),  INT16_C(  8253),  INT16_C( 25751), -INT16_C(  7013),  INT16_C( 12514),  INT16_C( 13940),  INT16_C( 10864), -INT16_C( 25442),
         INT16_C( 28983),  INT16_C( 15733),  INT16_C( 11325), -INT16_C(  2172), -INT16_C( 20458), -INT16_C( 32122),  INT16_C( 26112), -INT16_C( 11837) },
        { {  INT16_C( 12241),  INT16_C(  8253),  INT16_C( 25751), -INT16_C(  7013) },
          {  INT16_C( 12514),  INT16_C( 13940),  INT16_C( 10864), -INT16_C( 25442) },
          {  INT16_C( 28983),  INT16_C( 15733),  INT16_C( 11325), -INT16_C(  2172) },
          { -INT16_C( 20458), -INT16_C( 32122),  INT16_C( 26112), -INT16_C( 11837) } },
    },
    { {  INT16_C(   149),  INT16_C( 11505), -INT16_C( 29596),  INT16_C( 18193), -INT16_C( 31300),  INT16_C( 11389),  INT16_C(  7088), -INT16_C(  6200),
         INT16_C( 15757), -INT16_C( 13788), -INT16_C( 22422), -INT16_C( 32575),  INT16_C( 18265),  INT16_C( 22786), -INT16_C( 14931),  INT16_C( 17194) },
        { {  INT16_C(   149),  INT16_C( 11505), -INT16_C( 29596),  INT16_C( 18193) },
          { -INT16_C( 31300),  INT16_C( 11389),  INT16_C(  7088), -INT16_C(  6200) },
          {  INT16_C( 15757), -INT16_C( 13788), -INT16_C( 22422), -INT16_C( 32575) },
          {  INT16_C( 18265),  INT16_C( 22786), -INT16_C( 14931),  INT16_C( 17194) } },
    },
    { {  INT16_C(  7365),  INT16_C( 10863), -INT16_C( 32600),  INT16_C( 25969), -INT16_C(  4602), -INT16_C( 18799),  INT16_C( 23049), -INT16_C( 26979),
        -INT16_C( 15977),  INT16_C(   353),  INT16_C(  8809), -INT16_C( 15742), -INT16_C( 31638),  INT16_C(  5915),  INT16_C( 17994),  INT16_C(  3930) },
        { {  INT16_C(  7365),  INT16_C( 10863), -INT16_C( 32600),  INT16_C( 25969) },
          { -INT16_C(  4602), -INT16_C( 18799),  INT16_C( 23049), -INT16_C( 26979) },
          { -INT16_C( 15977),  INT16_C(   353),  INT16_C(  8809), -INT16_C( 15742) },
          { -INT16_C( 31638),  INT16_C(  5915),  INT16_C( 17994),  INT16_C(  3930) } },
    },
    { { -INT16_C( 13726),  INT16_C(  2617), -INT16_C( 21942),  INT16_C( 20591),  INT16_C(   408), -INT16_C( 24058), -INT16_C( 23717), -INT16_C(  3528),
        -INT16_C( 26268), -INT16_C( 12556),  INT16_C( 30396),  INT16_C(  9872), -INT16_C( 21254),  INT16_C( 17469), -INT16_C( 26382),  INT16_C( 21588) },
        { { -INT16_C( 13726),  INT16_C(  2617), -INT16_C( 21942),  INT16_C( 20591) },
          {  INT16_C(   408), -INT16_C( 24058), -INT16_C( 23717), -INT16_C(  3528) },
          { -INT16_C( 26268), -INT16_C( 12556),  INT16_C( 30396),  INT16_C(  9872) },
          { -INT16_C( 21254),  INT16_C( 17469), -INT16_C( 26382),  INT16_C( 21588) } },
    },
    { { -INT16_C( 29342), -INT16_C( 21410), -INT16_C( 12744), -INT16_C( 12035),  INT16_C(   975),  INT16_C( 10866), -INT16_C( 21593),  INT16_C(  2844),
         INT16_C(  4164),  INT16_C(   217),  INT16_C( 27270), -INT16_C( 32474),  INT16_C( 25622),  INT16_C(  2245),  INT16_C(  6652),  INT16_C( 24156) },
        { { -INT16_C( 29342), -INT16_C( 21410), -INT16_C( 12744), -INT16_C( 12035) },
          {  INT16_C(   975),  INT16_C( 10866), -INT16_C( 21593),  INT16_C(  2844) },
          {  INT16_C(  4164),  INT16_C(   217),  INT16_C( 27270), -INT16_C( 32474) },
          {  INT16_C( 25622),  INT16_C(  2245),  INT16_C(  6652),  INT16_C( 24156) } },
    },
  };
