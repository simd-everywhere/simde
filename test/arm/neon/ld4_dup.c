...
test_simde_vld4_dup_p8 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    simde_poly8_t r[4][8];
     ...
     { {  SIMDE_POLY8_C(113), SIMDE_POLY8_C(73), SIMDE_POLY8_C(82), SIMDE_POLY8_C(124) },
       {  SIMDE_POLY8_C(97), SIMDE_POLY8_C(44), SIMDE_POLY8_C(46), SIMDE_POLY8_C(6)},
     { {  SIMDE_POLY8_C(113), SIMDE_POLY8_C(113), SIMDE_POLY8_C(113), SIMDE_POLY8_C(113),
        SIMDE_POLY8_C(113), SIMDE_POLY8_C(113), SIMDE_POLY8_C(113), SIMDE_POLY8_C(113) },
       {  SIMDE_POLY8_C(73), SIMDE_POLY8_C(73), SIMDE_POLY8_C(73), SIMDE_POLY8_C(73),
        SIMDE_POLY8_C(73), SIMDE_POLY8_C(73), SIMDE_POLY8_C(73), SIMDE_POLY8_C(73) },
       {  SIMDE_POLY8_C(82), SIMDE_POLY8_C(82), SIMDE_POLY8_C(82), SIMDE_POLY8_C(82),
        SIMDE_POLY8_C(82), SIMDE_POLY8_C(82), SIMDE_POLY8_C(82), SIMDE_POLY8_C(82) },
       {  SIMDE_POLY8_C(124), SIMDE_POLY8_C(124), SIMDE_POLY8_C(124), SIMDE_POLY8_C(124),
        SIMDE_POLY8_C(124), SIMDE_POLY8_C(124), SIMDE_POLY8_C(124), SIMDE_POLY8_C(124) } } },
     { {  SIMDE_POLY8_C(123), SIMDE_POLY8_C(99), SIMDE_POLY8_C(73), SIMDE_POLY8_C(31) },
       {  SIMDE_POLY8_C(12), SIMDE_POLY8_C(196), SIMDE_POLY8_C(169), SIMDE_POLY8_C(0)},
     { {  SIMDE_POLY8_C(123), SIMDE_POLY8_C(123), SIMDE_POLY8_C(123), SIMDE_POLY8_C(123),
        SIMDE_POLY8_C(123), SIMDE_POLY8_C(123), SIMDE_POLY8_C(123), SIMDE_POLY8_C(123) },
       {  SIMDE_POLY8_C(99), SIMDE_POLY8_C(99), SIMDE_POLY8_C(99), SIMDE_POLY8_C(99),
        SIMDE_POLY8_C(99), SIMDE_POLY8_C(99), SIMDE_POLY8_C(99), SIMDE_POLY8_C(99) },
       {  SIMDE_POLY8_C(73), SIMDE_POLY8_C(73), SIMDE_POLY8_C(73), SIMDE_POLY8_C(73),
        SIMDE_POLY8_C(73), SIMDE_POLY8_C(73), SIMDE_POLY8_C(73), SIMDE_POLY8_C(73) },
       {  SIMDE_POLY8_C(31), SIMDE_POLY8_C(31), SIMDE_POLY8_C(31), SIMDE_POLY8_C(31),
        SIMDE_POLY8_C(31), SIMDE_POLY8_C(31), SIMDE_POLY8_C(31), SIMDE_POLY8_C(31) } } },
     { {  SIMDE_POLY8_C(49), SIMDE_POLY8_C(131), SIMDE_POLY8_C(102), SIMDE_POLY8_C(104) },
       {  SIMDE_POLY8_C(85), SIMDE_POLY8_C(1), SIMDE_POLY8_C(54), SIMDE_POLY8_C(25)},
     { {  SIMDE_POLY8_C(49), SIMDE_POLY8_C(49), SIMDE_POLY8_C(49), SIMDE_POLY8_C(49),
        SIMDE_POLY8_C(49), SIMDE_POLY8_C(49), SIMDE_POLY8_C(49), SIMDE_POLY8_C(49) },
       {  SIMDE_POLY8_C(131), SIMDE_POLY8_C(131), SIMDE_POLY8_C(131), SIMDE_POLY8_C(131),
        SIMDE_POLY8_C(131), SIMDE_POLY8_C(131), SIMDE_POLY8_C(131), SIMDE_POLY8_C(131) },
       {  SIMDE_POLY8_C(102), SIMDE_POLY8_C(102), SIMDE_POLY8_C(102), SIMDE_POLY8_C(102),
        SIMDE_POLY8_C(102), SIMDE_POLY8_C(102), SIMDE_POLY8_C(102), SIMDE_POLY8_C(102) },
       {  SIMDE_POLY8_C(104), SIMDE_POLY8_C(104), SIMDE_POLY8_C(104), SIMDE_POLY8_C(104),
        SIMDE_POLY8_C(104), SIMDE_POLY8_C(104), SIMDE_POLY8_C(104), SIMDE_POLY8_C(104) } } },
     { {  SIMDE_POLY8_C(188), SIMDE_POLY8_C(156), SIMDE_POLY8_C(48), SIMDE_POLY8_C(9) },
       {  SIMDE_POLY8_C(54), SIMDE_POLY8_C(21), SIMDE_POLY8_C(63), SIMDE_POLY8_C(114)},
     { {  SIMDE_POLY8_C(188), SIMDE_POLY8_C(188), SIMDE_POLY8_C(188), SIMDE_POLY8_C(188),
       ...
       {  SIMDE_POLY8_C(156), SIMDE_POLY8_C(156), SIMDE_POLY8_C(156), SIMDE_POLY8_C(156),
        SIMDE_POLY8_C(156), SIMDE_POLY8_C(156), SIMDE_POLY8_C(156), SIMDE_POLY8_C(156) },
       {  SIMDE_POLY8_C(48), SIMDE_POLY8_C(48), SIMDE_POLY8_C(48), SIMDE_POLY8_C(48),
        SIMDE_POLY8_C(48), SIMDE_POLY8_C(48), SIMDE_POLY8_C(48), SIMDE_POLY8_C(48) },
       {  SIMDE_POLY8_C(9), SIMDE_POLY8_C(9), SIMDE_POLY8_C(9), SIMDE_POLY8_C(9),
        SIMDE_POLY8_C(9), SIMDE_POLY8_C(9), SIMDE_POLY8_C(9), SIMDE_POLY8_C(9) } } },
     { {  SIMDE_POLY8_C(110), SIMDE_POLY8_C(3), SIMDE_POLY8_C(48), SIMDE_POLY8_C(70) },
       {  SIMDE_POLY8_C(139), SIMDE_POLY8_C(154), SIMDE_POLY8_C(160), SIMDE_POLY8_C(139)},
     { {  SIMDE_POLY8_C(110), SIMDE_POLY8_C(110), SIMDE_POLY8_C(110), SIMDE_POLY8_C(110),
        SIMDE_POLY8_C(110), SIMDE_POLY8_C(110), SIMDE_POLY8_C(110), SIMDE_POLY8_C(110) },
       {  SIMDE_POLY8_C(3), SIMDE_POLY8_C(3), SIMDE_POLY8_C(3), SIMDE_POLY8_C(3),
        SIMDE_POLY8_C(3), SIMDE_POLY8_C(3), SIMDE_POLY8_C(3), SIMDE_POLY8_C(3) },
       {  SIMDE_POLY8_C(48), SIMDE_POLY8_C(48), SIMDE_POLY8_C(48), SIMDE_POLY8_C(48),
        SIMDE_POLY8_C(48), SIMDE_POLY8_C(48), SIMDE_POLY8_C(48), SIMDE_POLY8_C(48) },
       {  SIMDE_POLY8_C(70), SIMDE_POLY8_C(70), SIMDE_POLY8_C(70), SIMDE_POLY8_C(70),
        SIMDE_POLY8_C(70), SIMDE_POLY8_C(70), SIMDE_POLY8_C(70), SIMDE_POLY8_C(70) } } },
     { {  SIMDE_POLY8_C(29), SIMDE_POLY8_C(99), SIMDE_POLY8_C(185), SIMDE_POLY8_C(126) },
       {  SIMDE_POLY8_C(199), SIMDE_POLY8_C(190), SIMDE_POLY8_C(74), SIMDE_POLY8_C(66)},
     { {  SIMDE_POLY8_C(29), SIMDE_POLY8_C(29), SIMDE_POLY8_C(29), SIMDE_POLY8_C(29),
        SIMDE_POLY8_C(29), SIMDE_POLY8_C(29), SIMDE_POLY8_C(29), SIMDE_POLY8_C(29) },
       {  SIMDE_POLY8_C(99), SIMDE_POLY8_C(99), SIMDE_POLY8_C(99), SIMDE_POLY8_C(99),
        SIMDE_POLY8_C(99), SIMDE_POLY8_C(99), SIMDE_POLY8_C(99), SIMDE_POLY8_C(99) },
       {  SIMDE_POLY8_C(185), SIMDE_POLY8_C(185), SIMDE_POLY8_C(185), SIMDE_POLY8_C(185),
        SIMDE_POLY8_C(185), SIMDE_POLY8_C(185), SIMDE_POLY8_C(185), SIMDE_POLY8_C(185) },
       {  SIMDE_POLY8_C(126), SIMDE_POLY8_C(126), SIMDE_POLY8_C(126), SIMDE_POLY8_C(126),
        SIMDE_POLY8_C(126), SIMDE_POLY8_C(126), SIMDE_POLY8_C(126), SIMDE_POLY8_C(126) } } },
     { {  SIMDE_POLY8_C(78), SIMDE_POLY8_C(22), SIMDE_POLY8_C(96), SIMDE_POLY8_C(181) },
       {  SIMDE_POLY8_C(7), SIMDE_POLY8_C(36), SIMDE_POLY8_C(58), SIMDE_POLY8_C(159)},
     { {  SIMDE_POLY8_C(78), SIMDE_POLY8_C(78), SIMDE_POLY8_C(78), SIMDE_POLY8_C(78),
        SIMDE_POLY8_C(78), SIMDE_POLY8_C(78), SIMDE_POLY8_C(78), SIMDE_POLY8_C(78) },
       {  SIMDE_POLY8_C(22), SIMDE_POLY8_C(22), SIMDE_POLY8_C(22), SIMDE_POLY8_C(22),
        SIMDE_POLY8_C(22), SIMDE_POLY8_C(22), SIMDE_POLY8_C(22), SIMDE_POLY8_C(22) },
       {  SIMDE_POLY8_C(96), SIMDE_POLY8_C(96), SIMDE_POLY8_C(96), SIMDE_POLY8_C(96),
        SIMDE_POLY8_C(96), SIMDE_POLY8_C(96), SIMDE_POLY8_C(96), SIMDE_POLY8_C(96) },
       {  SIMDE_POLY8_C(181), SIMDE_POLY8_C(181), SIMDE_POLY8_C(181), SIMDE_POLY8_C(181),
        SIMDE_POLY8_C(181), SIMDE_POLY8_C(181), SIMDE_POLY8_C(181), SIMDE_POLY8_C(181) } } },
     { {  SIMDE_POLY8_C(15), SIMDE_POLY8_C(77), SIMDE_POLY8_C(33), SIMDE_POLY8_C(133) },
       {  SIMDE_POLY8_C(85), SIMDE_POLY8_C(81), SIMDE_POLY8_C(52), SIMDE_POLY8_C(199)},
     { {  SIMDE_POLY8_C(15), SIMDE_POLY8_C(15), SIMDE_POLY8_C(15), SIMDE_POLY8_C(15),
        SIMDE_POLY8_C(15), SIMDE_POLY8_C(15), SIMDE_POLY8_C(15), SIMDE_POLY8_C(15) },
       {  SIMDE_POLY8_C(77), SIMDE_POLY8_C(77), SIMDE_POLY8_C(77), SIMDE_POLY8_C(77),
        SIMDE_POLY8_C(77), SIMDE_POLY8_C(77), SIMDE_POLY8_C(77), SIMDE_POLY8_C(77) },
       {  SIMDE_POLY8_C(33), SIMDE_POLY8_C(33), SIMDE_POLY8_C(33), SIMDE_POLY8_C(33),
        SIMDE_POLY8_C(33), SIMDE_POLY8_C(33), SIMDE_POLY8_C(33), SIMDE_POLY8_C(33) },
       {  SIMDE_POLY8_C(133), SIMDE_POLY8_C(133), SIMDE_POLY8_C(133), SIMDE_POLY8_C(133),
        SIMDE_POLY8_C(133), SIMDE_POLY8_C(133), SIMDE_POLY8_C(133), SIMDE_POLY8_C(133) } } },
  };
...
test_simde_vld4_dup_p64 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    simde_poly64_t r[4][1];
     ...
     { {  SIMDE_POLY64_C(20635395), SIMDE_POLY64_C(181936279), SIMDE_POLY64_C(150662617), SIMDE_POLY64_C(10660679) },
       {  SIMDE_POLY64_C(136081342), SIMDE_POLY64_C(93194088), SIMDE_POLY64_C(54652239), SIMDE_POLY64_C(62950287)},
     { {  SIMDE_POLY64_C(20635395) },
       {  SIMDE_POLY64_C(181936279) },
       {  SIMDE_POLY64_C(150662617) },
       {  SIMDE_POLY64_C(10660679) } } },
     { {  SIMDE_POLY64_C(118865721), SIMDE_POLY64_C(67478211), SIMDE_POLY64_C(174461108), SIMDE_POLY64_C(129320325) },
       {  SIMDE_POLY64_C(102278144), SIMDE_POLY64_C(102266682), SIMDE_POLY64_C(49889150), SIMDE_POLY64_C(114118451)},
     { {  SIMDE_POLY64_C(118865721) },
       {  SIMDE_POLY64_C(67478211) },
       {  SIMDE_POLY64_C(174461108) },
       {  SIMDE_POLY64_C(129320325) } } },
     { {  SIMDE_POLY64_C(158221320), SIMDE_POLY64_C(137081001), SIMDE_POLY64_C(7782842), SIMDE_POLY64_C(7026400) },
       {  SIMDE_POLY64_C(177159024), SIMDE_POLY64_C(35276486), SIMDE_POLY64_C(99035872), SIMDE_POLY64_C(158572458)},
     { {  SIMDE_POLY64_C(158221320) },
       {  SIMDE_POLY64_C(137081001) },
       {  SIMDE_POLY64_C(7782842) },
       {  SIMDE_POLY64_C(7026400) } } },
     { {  SIMDE_POLY64_C(115136670), SIMDE_POLY64_C(35261105), SIMDE_POLY64_C(3380463), SIMDE_POLY64_C(197918324) },
       {  SIMDE_POLY64_C(69003240), SIMDE_POLY64_C(32166930), SIMDE_POLY64_C(11534227), SIMDE_POLY64_C(196165286)},
     { {  SIMDE_POLY64_C(115136670) },
       {  SIMDE_POLY64_C(35261105) },
       {  SIMDE_POLY64_C(3380463) },
       {  SIMDE_POLY64_C(197918324) } } },
     { {  SIMDE_POLY64_C(38362170), SIMDE_POLY64_C(7429842), SIMDE_POLY64_C(80558845), SIMDE_POLY64_C(1179078) },
       {  SIMDE_POLY64_C(101090282), SIMDE_POLY64_C(177527039), SIMDE_POLY64_C(180313574), SIMDE_POLY64_C(57773740)},
     { {  SIMDE_POLY64_C(38362170) },
       {  SIMDE_POLY64_C(7429842) },
       {  SIMDE_POLY64_C(80558845) },
       {  SIMDE_POLY64_C(1179078) } } },
     { {  SIMDE_POLY64_C(59418595), SIMDE_POLY64_C(76632207), SIMDE_POLY64_C(114062680), SIMDE_POLY64_C(87463453) },
       {  SIMDE_POLY64_C(184610108), SIMDE_POLY64_C(46058512), SIMDE_POLY64_C(140438761), SIMDE_POLY64_C(194086293)},
     { {  SIMDE_POLY64_C(59418595) },
       {  SIMDE_POLY64_C(76632207) },
       {  SIMDE_POLY64_C(114062680) },
       {  SIMDE_POLY64_C(87463453) } } },
     { {  SIMDE_POLY64_C(174190462), SIMDE_POLY64_C(48203683), SIMDE_POLY64_C(9296258), SIMDE_POLY64_C(59202338) },
       {  SIMDE_POLY64_C(8720854), SIMDE_POLY64_C(20468168), SIMDE_POLY64_C(170092521), SIMDE_POLY64_C(134729317)},
     { {  SIMDE_POLY64_C(174190462) },
       {  SIMDE_POLY64_C(48203683) },
       {  SIMDE_POLY64_C(9296258) },
       {  SIMDE_POLY64_C(59202338) } } },
     { {  SIMDE_POLY64_C(130903980), SIMDE_POLY64_C(23165997), SIMDE_POLY64_C(74136997), SIMDE_POLY64_C(23457473) },
       {  SIMDE_POLY64_C(19601344), SIMDE_POLY64_C(85184699), SIMDE_POLY64_C(189848367), SIMDE_POLY64_C(130732569)},
     { {  SIMDE_POLY64_C(130903980) },
       {  SIMDE_POLY64_C(23165997) },
       {  SIMDE_POLY64_C(74136997) },
       {  SIMDE_POLY64_C(23457473) } } },
  };
