...
test_simde_vcmla_lane_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  struct {
    ...
    { { SIMDE_FLOAT16_VALUE(   112.88), SIMDE_FLOAT16_VALUE(   271.25), SIMDE_FLOAT16_VALUE(  -248.75), SIMDE_FLOAT16_VALUE(  -177.25) },
      { SIMDE_FLOAT16_VALUE(  -178.00), SIMDE_FLOAT16_VALUE(   -19.94), SIMDE_FLOAT16_VALUE(  -239.88), SIMDE_FLOAT16_VALUE(   -76.19) },
      { SIMDE_FLOAT16_VALUE(   294.75), SIMDE_FLOAT16_VALUE(   123.19), SIMDE_FLOAT16_VALUE(   120.12), SIMDE_FLOAT16_VALUE(   -51.50) },
       INT32_C(           0),
      { SIMDE_FLOAT16_VALUE(-52352.00), SIMDE_FLOAT16_VALUE(-21664.00),     -SIMDE_INFINITYHF, SIMDE_FLOAT16_VALUE(-29728.00) } },
    { { SIMDE_FLOAT16_VALUE(   151.88), SIMDE_FLOAT16_VALUE(  -120.44), SIMDE_FLOAT16_VALUE(   -39.09), SIMDE_FLOAT16_VALUE(    20.62) },
      { SIMDE_FLOAT16_VALUE(   -71.44), SIMDE_FLOAT16_VALUE(    25.83), SIMDE_FLOAT16_VALUE(  -234.75), SIMDE_FLOAT16_VALUE(   -33.84) },
      { SIMDE_FLOAT16_VALUE(    14.48), SIMDE_FLOAT16_VALUE(  -165.75), SIMDE_FLOAT16_VALUE(  -123.44), SIMDE_FLOAT16_VALUE(   -67.19) },
       INT32_C(           1),
      { SIMDE_FLOAT16_VALUE(  8968.00), SIMDE_FLOAT16_VALUE(  4680.00), SIMDE_FLOAT16_VALUE( 28944.00), SIMDE_FLOAT16_VALUE( 15792.00) } },
    { { SIMDE_FLOAT16_VALUE(   179.75), SIMDE_FLOAT16_VALUE(   288.75), SIMDE_FLOAT16_VALUE(    -8.83), SIMDE_FLOAT16_VALUE(  -235.38) },
      { SIMDE_FLOAT16_VALUE(   241.12), SIMDE_FLOAT16_VALUE(   -49.94), SIMDE_FLOAT16_VALUE(    44.38), SIMDE_FLOAT16_VALUE(    63.94) },
      { SIMDE_FLOAT16_VALUE(    70.88), SIMDE_FLOAT16_VALUE(   123.69), SIMDE_FLOAT16_VALUE(   261.50), SIMDE_FLOAT16_VALUE(   126.56) },
       INT32_C(           0),
      { SIMDE_FLOAT16_VALUE( 17264.00), SIMDE_FLOAT16_VALUE( 30112.00), SIMDE_FLOAT16_VALUE(  3136.00), SIMDE_FLOAT16_VALUE(  5252.00) } },
    { { SIMDE_FLOAT16_VALUE(  -253.38), SIMDE_FLOAT16_VALUE(   254.75), SIMDE_FLOAT16_VALUE(  -247.00), SIMDE_FLOAT16_VALUE(  -184.25) },
      { SIMDE_FLOAT16_VALUE(    98.94), SIMDE_FLOAT16_VALUE(   119.25), SIMDE_FLOAT16_VALUE(    77.44), SIMDE_FLOAT16_VALUE(   154.38) },
      { SIMDE_FLOAT16_VALUE(  -190.00), SIMDE_FLOAT16_VALUE(   228.62), SIMDE_FLOAT16_VALUE(  -165.62), SIMDE_FLOAT16_VALUE(    41.88) },
       INT32_C(           1),
      { SIMDE_FLOAT16_VALUE(-16640.00), SIMDE_FLOAT16_VALUE(  4396.00), SIMDE_FLOAT16_VALUE(-13072.00), SIMDE_FLOAT16_VALUE(  3058.00) } },
    { { SIMDE_FLOAT16_VALUE(  -282.00), SIMDE_FLOAT16_VALUE(  -269.50), SIMDE_FLOAT16_VALUE(  -132.12), SIMDE_FLOAT16_VALUE(  -246.00) },
      { SIMDE_FLOAT16_VALUE(  -111.00), SIMDE_FLOAT16_VALUE(    19.27), SIMDE_FLOAT16_VALUE(   -92.62), SIMDE_FLOAT16_VALUE(  -193.25) },
      { SIMDE_FLOAT16_VALUE(    35.41), SIMDE_FLOAT16_VALUE(  -224.38), SIMDE_FLOAT16_VALUE(    35.88), SIMDE_FLOAT16_VALUE(   115.81) },
       INT32_C(           0),
      { SIMDE_FLOAT16_VALUE( -4212.00), SIMDE_FLOAT16_VALUE( 24640.00), SIMDE_FLOAT16_VALUE( -3412.00), SIMDE_FLOAT16_VALUE( 20544.00) } },
    { { SIMDE_FLOAT16_VALUE(  -173.38), SIMDE_FLOAT16_VALUE(   -42.41), SIMDE_FLOAT16_VALUE(   225.75), SIMDE_FLOAT16_VALUE(   246.62) },
      { SIMDE_FLOAT16_VALUE(  -226.62), SIMDE_FLOAT16_VALUE(  -299.75), SIMDE_FLOAT16_VALUE(  -151.62), SIMDE_FLOAT16_VALUE(   -29.17) },
      { SIMDE_FLOAT16_VALUE(   -43.62), SIMDE_FLOAT16_VALUE(  -200.00), SIMDE_FLOAT16_VALUE(   -61.44), SIMDE_FLOAT16_VALUE(  -120.75) },
       INT32_C(           1),
      { SIMDE_FLOAT16_VALUE( 13752.00), SIMDE_FLOAT16_VALUE( 27328.00), SIMDE_FLOAT16_VALUE(  9544.00), SIMDE_FLOAT16_VALUE( 18560.00) } },
    { { SIMDE_FLOAT16_VALUE(    58.81), SIMDE_FLOAT16_VALUE(  -187.38), SIMDE_FLOAT16_VALUE(   -55.22), SIMDE_FLOAT16_VALUE(   244.00) },
      { SIMDE_FLOAT16_VALUE(  -245.62), SIMDE_FLOAT16_VALUE(   181.50), SIMDE_FLOAT16_VALUE(  -276.00), SIMDE_FLOAT16_VALUE(  -264.25) },
      { SIMDE_FLOAT16_VALUE(    29.03), SIMDE_FLOAT16_VALUE(    87.75), SIMDE_FLOAT16_VALUE(  -105.00), SIMDE_FLOAT16_VALUE(   -52.62) },
       INT32_C(           0),
      { SIMDE_FLOAT16_VALUE( -7072.00), SIMDE_FLOAT16_VALUE(-21744.00), SIMDE_FLOAT16_VALUE( -8068.00), SIMDE_FLOAT16_VALUE(-23968.00) } },
    { { SIMDE_FLOAT16_VALUE(   258.00), SIMDE_FLOAT16_VALUE(  -252.62), SIMDE_FLOAT16_VALUE(   293.00), SIMDE_FLOAT16_VALUE(  -115.19) },
      { SIMDE_FLOAT16_VALUE(    99.00), SIMDE_FLOAT16_VALUE(   241.50), SIMDE_FLOAT16_VALUE(   163.00), SIMDE_FLOAT16_VALUE(   280.75) },
      { SIMDE_FLOAT16_VALUE(   148.00), SIMDE_FLOAT16_VALUE(  -217.50), SIMDE_FLOAT16_VALUE(    15.55), SIMDE_FLOAT16_VALUE(   283.50) },
       INT32_C(           1),
      { SIMDE_FLOAT16_VALUE(  1797.00), SIMDE_FLOAT16_VALUE( 27808.00), SIMDE_FLOAT16_VALUE(  2828.00), SIMDE_FLOAT16_VALUE( 46080.00) } }
  };
...
test_simde_vcmlaq_laneq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  struct {
    ...
    { { SIMDE_FLOAT16_VALUE(   -92.00), SIMDE_FLOAT16_VALUE(    40.94), SIMDE_FLOAT16_VALUE(   -33.00), SIMDE_FLOAT16_VALUE(   -35.25),
        SIMDE_FLOAT16_VALUE(   -81.88), SIMDE_FLOAT16_VALUE(  -165.62), SIMDE_FLOAT16_VALUE(  -266.50), SIMDE_FLOAT16_VALUE(   237.50) },
      { SIMDE_FLOAT16_VALUE(  -282.50), SIMDE_FLOAT16_VALUE(  -132.00), SIMDE_FLOAT16_VALUE(  -132.00), SIMDE_FLOAT16_VALUE(  -119.25),
        SIMDE_FLOAT16_VALUE(  -262.75), SIMDE_FLOAT16_VALUE(  -139.62), SIMDE_FLOAT16_VALUE(   239.38), SIMDE_FLOAT16_VALUE(  -123.62) },
      { SIMDE_FLOAT16_VALUE(   261.00), SIMDE_FLOAT16_VALUE(   257.00), SIMDE_FLOAT16_VALUE(  -287.00), SIMDE_FLOAT16_VALUE(   -31.45),
        SIMDE_FLOAT16_VALUE(  -103.44), SIMDE_FLOAT16_VALUE(    98.56), SIMDE_FLOAT16_VALUE(   218.88), SIMDE_FLOAT16_VALUE(  -284.50) },
       INT32_C(           0),
      {     -SIMDE_INFINITYHF,     -SIMDE_INFINITYHF, SIMDE_FLOAT16_VALUE(-34496.00), SIMDE_FLOAT16_VALUE(-33952.00),
            -SIMDE_INFINITYHF,     -SIMDE_INFINITYHF, SIMDE_FLOAT16_VALUE( 62208.00), SIMDE_FLOAT16_VALUE( 61760.00) } },
    { { SIMDE_FLOAT16_VALUE(   -33.47), SIMDE_FLOAT16_VALUE(   188.00), SIMDE_FLOAT16_VALUE(   288.50), SIMDE_FLOAT16_VALUE(  -133.62),
        SIMDE_FLOAT16_VALUE(   202.00), SIMDE_FLOAT16_VALUE(   237.12), SIMDE_FLOAT16_VALUE(   -96.44), SIMDE_FLOAT16_VALUE(   -98.06) },
      { SIMDE_FLOAT16_VALUE(   -79.12), SIMDE_FLOAT16_VALUE(   118.31), SIMDE_FLOAT16_VALUE(  -212.00), SIMDE_FLOAT16_VALUE(  -298.25),
        SIMDE_FLOAT16_VALUE(    11.81), SIMDE_FLOAT16_VALUE(  -123.50), SIMDE_FLOAT16_VALUE(  -215.25), SIMDE_FLOAT16_VALUE(  -212.75) },
      { SIMDE_FLOAT16_VALUE(    65.75), SIMDE_FLOAT16_VALUE(  -236.50), SIMDE_FLOAT16_VALUE(    68.75), SIMDE_FLOAT16_VALUE(   235.88),
        SIMDE_FLOAT16_VALUE(   107.94), SIMDE_FLOAT16_VALUE(  -172.12), SIMDE_FLOAT16_VALUE(   -10.75), SIMDE_FLOAT16_VALUE(   -68.00) },
       INT32_C(           1),
      { SIMDE_FLOAT16_VALUE( -5472.00), SIMDE_FLOAT16_VALUE(-18480.00), SIMDE_FLOAT16_VALUE(-14288.00), SIMDE_FLOAT16_VALUE(-50144.00),
        SIMDE_FLOAT16_VALUE(  1014.00), SIMDE_FLOAT16_VALUE(  3024.00), SIMDE_FLOAT16_VALUE(-14896.00), SIMDE_FLOAT16_VALUE(-50880.00) } },
    { { SIMDE_FLOAT16_VALUE(    96.19), SIMDE_FLOAT16_VALUE(  -238.88), SIMDE_FLOAT16_VALUE(  -155.38), SIMDE_FLOAT16_VALUE(  -248.25),
        SIMDE_FLOAT16_VALUE(  -287.50), SIMDE_FLOAT16_VALUE(  -213.38), SIMDE_FLOAT16_VALUE(   184.50), SIMDE_FLOAT16_VALUE(   -47.53) },
      { SIMDE_FLOAT16_VALUE(   -48.16), SIMDE_FLOAT16_VALUE(  -102.62), SIMDE_FLOAT16_VALUE(   -50.22), SIMDE_FLOAT16_VALUE(  -205.25),
        SIMDE_FLOAT16_VALUE(   175.00), SIMDE_FLOAT16_VALUE(   296.75), SIMDE_FLOAT16_VALUE(    87.50), SIMDE_FLOAT16_VALUE(    27.02) },
      { SIMDE_FLOAT16_VALUE(   278.00), SIMDE_FLOAT16_VALUE(    16.95), SIMDE_FLOAT16_VALUE(    31.42), SIMDE_FLOAT16_VALUE(    99.12),
        SIMDE_FLOAT16_VALUE(    16.22), SIMDE_FLOAT16_VALUE(   191.88), SIMDE_FLOAT16_VALUE(  -275.50), SIMDE_FLOAT16_VALUE(   262.00) },
       INT32_C(           2),
      { SIMDE_FLOAT16_VALUE(  -685.00), SIMDE_FLOAT16_VALUE( -9480.00), SIMDE_FLOAT16_VALUE(  -970.00), SIMDE_FLOAT16_VALUE( -9880.00),
        SIMDE_FLOAT16_VALUE(  2550.00), SIMDE_FLOAT16_VALUE( 33376.00), SIMDE_FLOAT16_VALUE(  1604.00), SIMDE_FLOAT16_VALUE( 16736.00) } },
    { { SIMDE_FLOAT16_VALUE(    85.62), SIMDE_FLOAT16_VALUE(  -222.00), SIMDE_FLOAT16_VALUE(   117.31), SIMDE_FLOAT16_VALUE(    50.78),
        SIMDE_FLOAT16_VALUE(  -249.50), SIMDE_FLOAT16_VALUE(  -252.38), SIMDE_FLOAT16_VALUE(  -247.75), SIMDE_FLOAT16_VALUE(   112.38) },
      { SIMDE_FLOAT16_VALUE(   -44.78), SIMDE_FLOAT16_VALUE(  -182.25), SIMDE_FLOAT16_VALUE(  -265.50), SIMDE_FLOAT16_VALUE(  -124.19),
        SIMDE_FLOAT16_VALUE(  -256.50), SIMDE_FLOAT16_VALUE(   -60.56), SIMDE_FLOAT16_VALUE(  -103.12), SIMDE_FLOAT16_VALUE(    75.12) },
      { SIMDE_FLOAT16_VALUE(  -159.25), SIMDE_FLOAT16_VALUE(     9.08), SIMDE_FLOAT16_VALUE(   190.25), SIMDE_FLOAT16_VALUE(  -192.00),
        SIMDE_FLOAT16_VALUE(    -9.62), SIMDE_FLOAT16_VALUE(  -235.25), SIMDE_FLOAT16_VALUE(   123.31), SIMDE_FLOAT16_VALUE(   227.12) },
       INT32_C(           3),
      { SIMDE_FLOAT16_VALUE( -5436.00), SIMDE_FLOAT16_VALUE(-10392.00), SIMDE_FLOAT16_VALUE(-32624.00), SIMDE_FLOAT16_VALUE(-60256.00),
        SIMDE_FLOAT16_VALUE(-31872.00), SIMDE_FLOAT16_VALUE(-58496.00), SIMDE_FLOAT16_VALUE(-12968.00), SIMDE_FLOAT16_VALUE(-23312.00) } },
    { { SIMDE_FLOAT16_VALUE(   232.62), SIMDE_FLOAT16_VALUE(  -280.00), SIMDE_FLOAT16_VALUE(  -167.25), SIMDE_FLOAT16_VALUE(   -13.09),
        SIMDE_FLOAT16_VALUE(   259.25), SIMDE_FLOAT16_VALUE(  -161.25), SIMDE_FLOAT16_VALUE(  -248.38), SIMDE_FLOAT16_VALUE(  -228.75) },
      { SIMDE_FLOAT16_VALUE(   146.38), SIMDE_FLOAT16_VALUE(   257.25), SIMDE_FLOAT16_VALUE(    60.28), SIMDE_FLOAT16_VALUE(  -146.12),
        SIMDE_FLOAT16_VALUE(     2.61), SIMDE_FLOAT16_VALUE(    13.89), SIMDE_FLOAT16_VALUE(    67.62), SIMDE_FLOAT16_VALUE(  -287.75) },
      { SIMDE_FLOAT16_VALUE(   277.00), SIMDE_FLOAT16_VALUE(  -200.62), SIMDE_FLOAT16_VALUE(   109.56), SIMDE_FLOAT16_VALUE(  -261.75),
        SIMDE_FLOAT16_VALUE(  -291.00), SIMDE_FLOAT16_VALUE(   -92.75), SIMDE_FLOAT16_VALUE(    77.38), SIMDE_FLOAT16_VALUE(    55.25) },
       INT32_C(           0),
      { SIMDE_FLOAT16_VALUE( 40768.00), SIMDE_FLOAT16_VALUE(-29648.00), SIMDE_FLOAT16_VALUE( 16528.00), SIMDE_FLOAT16_VALUE(-12104.00),
        SIMDE_FLOAT16_VALUE(   982.00), SIMDE_FLOAT16_VALUE(  -685.00), SIMDE_FLOAT16_VALUE( 18480.00), SIMDE_FLOAT16_VALUE(-13800.00) } },
    { { SIMDE_FLOAT16_VALUE(   155.00), SIMDE_FLOAT16_VALUE(    89.94), SIMDE_FLOAT16_VALUE(    61.66), SIMDE_FLOAT16_VALUE(   247.75),
        SIMDE_FLOAT16_VALUE(   251.38), SIMDE_FLOAT16_VALUE(   -73.44), SIMDE_FLOAT16_VALUE(    91.69), SIMDE_FLOAT16_VALUE(  -182.38) },
      { SIMDE_FLOAT16_VALUE(   167.75), SIMDE_FLOAT16_VALUE(   -43.59), SIMDE_FLOAT16_VALUE(  -136.75), SIMDE_FLOAT16_VALUE(   224.38),
        SIMDE_FLOAT16_VALUE(   123.12), SIMDE_FLOAT16_VALUE(  -220.75), SIMDE_FLOAT16_VALUE(     1.76), SIMDE_FLOAT16_VALUE(   102.44) },
      { SIMDE_FLOAT16_VALUE(  -204.62), SIMDE_FLOAT16_VALUE(  -185.25), SIMDE_FLOAT16_VALUE(   223.12), SIMDE_FLOAT16_VALUE(    12.98),
        SIMDE_FLOAT16_VALUE(  -175.00), SIMDE_FLOAT16_VALUE(  -131.50), SIMDE_FLOAT16_VALUE(   -75.00), SIMDE_FLOAT16_VALUE(  -271.25) },
       INT32_C(           1),
      { SIMDE_FLOAT16_VALUE( 37600.00), SIMDE_FLOAT16_VALUE(  2266.00), SIMDE_FLOAT16_VALUE(-30448.00), SIMDE_FLOAT16_VALUE( -1527.00),
        SIMDE_FLOAT16_VALUE( 27728.00), SIMDE_FLOAT16_VALUE(  1524.00), SIMDE_FLOAT16_VALUE(   484.25), SIMDE_FLOAT16_VALUE(  -159.50) } },
    { { SIMDE_FLOAT16_VALUE(   275.50), SIMDE_FLOAT16_VALUE(  -253.50), SIMDE_FLOAT16_VALUE(    11.95), SIMDE_FLOAT16_VALUE(  -164.12),
        SIMDE_FLOAT16_VALUE(  -149.62), SIMDE_FLOAT16_VALUE(   296.75), SIMDE_FLOAT16_VALUE(   119.50), SIMDE_FLOAT16_VALUE(   145.25) },
      { SIMDE_FLOAT16_VALUE(   243.62), SIMDE_FLOAT16_VALUE(  -249.50), SIMDE_FLOAT16_VALUE(   195.50), SIMDE_FLOAT16_VALUE(  -145.25),
        SIMDE_FLOAT16_VALUE(   -29.94), SIMDE_FLOAT16_VALUE(   262.50), SIMDE_FLOAT16_VALUE(  -143.38), SIMDE_FLOAT16_VALUE(   295.25) },
      { SIMDE_FLOAT16_VALUE(   132.75), SIMDE_FLOAT16_VALUE(   -25.73), SIMDE_FLOAT16_VALUE(    87.19), SIMDE_FLOAT16_VALUE(   170.00),
        SIMDE_FLOAT16_VALUE(   119.69), SIMDE_FLOAT16_VALUE(    28.31), SIMDE_FLOAT16_VALUE(   160.38), SIMDE_FLOAT16_VALUE(   190.12) },
       INT32_C(           2),
      { SIMDE_FLOAT16_VALUE( 29440.00), SIMDE_FLOAT16_VALUE(  6644.00), SIMDE_FLOAT16_VALUE( 23408.00), SIMDE_FLOAT16_VALUE(  5372.00),
        SIMDE_FLOAT16_VALUE( -3732.00), SIMDE_FLOAT16_VALUE(  -551.00), SIMDE_FLOAT16_VALUE(-17040.00), SIMDE_FLOAT16_VALUE( -3914.00) } },
    { { SIMDE_FLOAT16_VALUE(   222.88), SIMDE_FLOAT16_VALUE(   156.25), SIMDE_FLOAT16_VALUE(  -201.12), SIMDE_FLOAT16_VALUE(   167.62),
        SIMDE_FLOAT16_VALUE(   176.88), SIMDE_FLOAT16_VALUE(    41.19), SIMDE_FLOAT16_VALUE(  -111.25), SIMDE_FLOAT16_VALUE(  -253.75) },
      { SIMDE_FLOAT16_VALUE(  -205.75), SIMDE_FLOAT16_VALUE(  -249.62), SIMDE_FLOAT16_VALUE(   200.75), SIMDE_FLOAT16_VALUE(  -163.88),
        SIMDE_FLOAT16_VALUE(  -176.50), SIMDE_FLOAT16_VALUE(   -65.50), SIMDE_FLOAT16_VALUE(  -117.75), SIMDE_FLOAT16_VALUE(  -109.62) },
      { SIMDE_FLOAT16_VALUE(  -244.25), SIMDE_FLOAT16_VALUE(   -65.56), SIMDE_FLOAT16_VALUE(    45.97), SIMDE_FLOAT16_VALUE(   174.62),
        SIMDE_FLOAT16_VALUE(    70.75), SIMDE_FLOAT16_VALUE(    74.62), SIMDE_FLOAT16_VALUE(  -277.25), SIMDE_FLOAT16_VALUE(    -4.78) },
       INT32_C(           3),
      { SIMDE_FLOAT16_VALUE( 57280.00), SIMDE_FLOAT16_VALUE(  1140.00), SIMDE_FLOAT16_VALUE(-55872.00), SIMDE_FLOAT16_VALUE(  -792.00),
        SIMDE_FLOAT16_VALUE( 49120.00), SIMDE_FLOAT16_VALUE(   885.00), SIMDE_FLOAT16_VALUE( 32528.00), SIMDE_FLOAT16_VALUE(   309.25) } }
  };
