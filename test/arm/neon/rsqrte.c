...
test_simde_vrsqrteh_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { SIMDE_FLOAT16_C(5.50),
      SIMDE_FLOAT16_C(0.43) },
    { SIMDE_FLOAT16_C(1.00),
      SIMDE_FLOAT16_C(1.00) },
    { SIMDE_FLOAT16_C(9.20),
      SIMDE_FLOAT16_C(0.33) },
    { SIMDE_FLOAT16_C(8.40),
      SIMDE_FLOAT16_C(0.35) },
    { SIMDE_FLOAT16_C(19.59),
      SIMDE_FLOAT16_C(0.23)  },
    { SIMDE_FLOAT16_C(11.80),
      SIMDE_FLOAT16_C(0.29) },
    { SIMDE_FLOAT16_C(7.50),
      SIMDE_FLOAT16_C(0.37) },
    { SIMDE_FLOAT16_C(13.90),
      SIMDE_FLOAT16_C(0.27) },
    { SIMDE_FLOAT16_C(11.50),
      SIMDE_FLOAT16_C(0.29) },
    { SIMDE_FLOAT16_C(17.41),
      SIMDE_FLOAT16_C(0.24) },
  };
...
test_simde_vrsqrte_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(0.27), SIMDE_FLOAT16_C(15.80), SIMDE_FLOAT16_C(5.01), SIMDE_FLOAT16_C(5.52) },
      { SIMDE_FLOAT16_C(1.92), SIMDE_FLOAT16_C(0.25), SIMDE_FLOAT16_C(0.45), SIMDE_FLOAT16_C(0.43) } },
    { { SIMDE_FLOAT16_C(7.54), SIMDE_FLOAT16_C(6.66), SIMDE_FLOAT16_C(6.05), SIMDE_FLOAT16_C(16.09) },
      { SIMDE_FLOAT16_C(0.36), SIMDE_FLOAT16_C(0.39), SIMDE_FLOAT16_C(0.41), SIMDE_FLOAT16_C(0.25) } },
    { { SIMDE_FLOAT16_C(19.90), SIMDE_FLOAT16_C(2.34), SIMDE_FLOAT16_C(3.67), SIMDE_FLOAT16_C(3.92) },
      { SIMDE_FLOAT16_C(0.22), SIMDE_FLOAT16_C(0.65), SIMDE_FLOAT16_C(0.52), SIMDE_FLOAT16_C(0.51) } },
    { { SIMDE_FLOAT16_C(14.50), SIMDE_FLOAT16_C(16.47), SIMDE_FLOAT16_C(11.05), SIMDE_FLOAT16_C(4.20) },
      { SIMDE_FLOAT16_C(0.26), SIMDE_FLOAT16_C(0.25), SIMDE_FLOAT16_C(0.30), SIMDE_FLOAT16_C(0.49) } },
    { { SIMDE_FLOAT16_C(18.15), SIMDE_FLOAT16_C(1.15), SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(3.21) },
      { SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.93), SIMDE_FLOAT16_C(0.67), SIMDE_FLOAT16_C(0.56) } },
    { { SIMDE_FLOAT16_C(16.58), SIMDE_FLOAT16_C(18.76), SIMDE_FLOAT16_C(12.15), SIMDE_FLOAT16_C(18.22) },
      { SIMDE_FLOAT16_C(0.25), SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.29), SIMDE_FLOAT16_C(0.23) } },
    { { SIMDE_FLOAT16_C(17.57), SIMDE_FLOAT16_C(0.46), SIMDE_FLOAT16_C(15.00), SIMDE_FLOAT16_C(2.88) },
      { SIMDE_FLOAT16_C(0.24), SIMDE_FLOAT16_C(1.47), SIMDE_FLOAT16_C(0.26), SIMDE_FLOAT16_C(0.59) } },
    { { SIMDE_FLOAT16_C(4.86), SIMDE_FLOAT16_C(8.30), SIMDE_FLOAT16_C(8.66), SIMDE_FLOAT16_C(4.23) },
      { SIMDE_FLOAT16_C(0.45), SIMDE_FLOAT16_C(0.35), SIMDE_FLOAT16_C(0.34), SIMDE_FLOAT16_C(0.49) } },
    { { SIMDE_FLOAT16_C(8.89), SIMDE_FLOAT16_C(6.56), SIMDE_FLOAT16_C(4.22), SIMDE_FLOAT16_C(17.29) },
      { SIMDE_FLOAT16_C(0.34), SIMDE_FLOAT16_C(0.39), SIMDE_FLOAT16_C(0.49), SIMDE_FLOAT16_C(0.24) } },
    { { SIMDE_FLOAT16_C(9.95), SIMDE_FLOAT16_C(6.08), SIMDE_FLOAT16_C(7.59), SIMDE_FLOAT16_C(0.41) },
      { SIMDE_FLOAT16_C(0.32), SIMDE_FLOAT16_C(0.41), SIMDE_FLOAT16_C(0.36), SIMDE_FLOAT16_C(1.55) } },
  };
...
test_simde_vrsqrteq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(3.00), SIMDE_FLOAT16_C(13.00), SIMDE_FLOAT16_C(17.80), SIMDE_FLOAT16_C(3.50), SIMDE_FLOAT16_C(13.20), SIMDE_FLOAT16_C(3.80), SIMDE_FLOAT16_C(9.30), SIMDE_FLOAT16_C(12.70) },
      { SIMDE_FLOAT16_C(0.58), SIMDE_FLOAT16_C(0.28), SIMDE_FLOAT16_C(0.24), SIMDE_FLOAT16_C(0.53), SIMDE_FLOAT16_C(0.28), SIMDE_FLOAT16_C(0.51), SIMDE_FLOAT16_C(0.33), SIMDE_FLOAT16_C(0.28) } },
    { { SIMDE_FLOAT16_C(1.20), SIMDE_FLOAT16_C(16.09), SIMDE_FLOAT16_C(16.91), SIMDE_FLOAT16_C(3.50), SIMDE_FLOAT16_C(19.91), SIMDE_FLOAT16_C(15.40), SIMDE_FLOAT16_C(13.90), SIMDE_FLOAT16_C(15.00) },
      { SIMDE_FLOAT16_C(0.91), SIMDE_FLOAT16_C(0.25), SIMDE_FLOAT16_C(0.24), SIMDE_FLOAT16_C(0.53), SIMDE_FLOAT16_C(0.22), SIMDE_FLOAT16_C(0.25), SIMDE_FLOAT16_C(0.27), SIMDE_FLOAT16_C(0.26) } },
    { { SIMDE_FLOAT16_C(3.40), SIMDE_FLOAT16_C(14.60), SIMDE_FLOAT16_C(6.90), SIMDE_FLOAT16_C(18.00), SIMDE_FLOAT16_C(6.00), SIMDE_FLOAT16_C(9.00), SIMDE_FLOAT16_C(19.91), SIMDE_FLOAT16_C(1.50) },
      { SIMDE_FLOAT16_C(0.54), SIMDE_FLOAT16_C(0.26), SIMDE_FLOAT16_C(0.38), SIMDE_FLOAT16_C(0.24), SIMDE_FLOAT16_C(0.41), SIMDE_FLOAT16_C(0.33), SIMDE_FLOAT16_C(0.22), SIMDE_FLOAT16_C(0.82) } },
    { { SIMDE_FLOAT16_C(18.20), SIMDE_FLOAT16_C(7.10), SIMDE_FLOAT16_C(6.50), SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(9.40), SIMDE_FLOAT16_C(13.00), SIMDE_FLOAT16_C(13.40), SIMDE_FLOAT16_C(9.40) },
      { SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.38), SIMDE_FLOAT16_C(0.39), SIMDE_FLOAT16_C(0.67), SIMDE_FLOAT16_C(0.33), SIMDE_FLOAT16_C(0.28), SIMDE_FLOAT16_C(0.27), SIMDE_FLOAT16_C(0.33) } },
    { { SIMDE_FLOAT16_C(12.80), SIMDE_FLOAT16_C(14.40), SIMDE_FLOAT16_C(19.09), SIMDE_FLOAT16_C(14.60), SIMDE_FLOAT16_C(4.20), SIMDE_FLOAT16_C(5.30), SIMDE_FLOAT16_C(15.90), SIMDE_FLOAT16_C(3.60) },
      { SIMDE_FLOAT16_C(0.28), SIMDE_FLOAT16_C(0.26), SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.26), SIMDE_FLOAT16_C(0.49), SIMDE_FLOAT16_C(0.43), SIMDE_FLOAT16_C(0.25), SIMDE_FLOAT16_C(0.53) } },
    { { SIMDE_FLOAT16_C(19.70), SIMDE_FLOAT16_C(19.80), SIMDE_FLOAT16_C(8.10), SIMDE_FLOAT16_C(11.90), SIMDE_FLOAT16_C(4.90), SIMDE_FLOAT16_C(14.00), SIMDE_FLOAT16_C(12.60), SIMDE_FLOAT16_C(14.70) },
      { SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.22), SIMDE_FLOAT16_C(0.35), SIMDE_FLOAT16_C(0.29), SIMDE_FLOAT16_C(0.45), SIMDE_FLOAT16_C(0.27), SIMDE_FLOAT16_C(0.28), SIMDE_FLOAT16_C(0.26) } },
    { { SIMDE_FLOAT16_C(13.90), SIMDE_FLOAT16_C(3.00), SIMDE_FLOAT16_C(19.59), SIMDE_FLOAT16_C(12.30), SIMDE_FLOAT16_C(10.60), SIMDE_FLOAT16_C(2.70), SIMDE_FLOAT16_C(15.00), SIMDE_FLOAT16_C(5.30) },
      { SIMDE_FLOAT16_C(0.27), SIMDE_FLOAT16_C(0.58), SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.29), SIMDE_FLOAT16_C(0.31), SIMDE_FLOAT16_C(0.61), SIMDE_FLOAT16_C(0.26), SIMDE_FLOAT16_C(0.43) } },
    { { SIMDE_FLOAT16_C(7.60), SIMDE_FLOAT16_C(13.20), SIMDE_FLOAT16_C(14.20), SIMDE_FLOAT16_C(17.59), SIMDE_FLOAT16_C(16.91), SIMDE_FLOAT16_C(4.80), SIMDE_FLOAT16_C(4.70), SIMDE_FLOAT16_C(14.50) },
      { SIMDE_FLOAT16_C(0.36), SIMDE_FLOAT16_C(0.28), SIMDE_FLOAT16_C(0.27), SIMDE_FLOAT16_C(0.24), SIMDE_FLOAT16_C(0.24), SIMDE_FLOAT16_C(0.46), SIMDE_FLOAT16_C(0.46), SIMDE_FLOAT16_C(0.26) } },
    { { SIMDE_FLOAT16_C(17.80), SIMDE_FLOAT16_C(5.80), SIMDE_FLOAT16_C(1.60), SIMDE_FLOAT16_C(5.50), SIMDE_FLOAT16_C(11.30), SIMDE_FLOAT16_C(8.20), SIMDE_FLOAT16_C(10.10), SIMDE_FLOAT16_C(11.90) },
      { SIMDE_FLOAT16_C(0.24), SIMDE_FLOAT16_C(0.42), SIMDE_FLOAT16_C(0.79), SIMDE_FLOAT16_C(0.43), SIMDE_FLOAT16_C(0.30), SIMDE_FLOAT16_C(0.35), SIMDE_FLOAT16_C(0.31), SIMDE_FLOAT16_C(0.29) } },
    { { SIMDE_FLOAT16_C(0.90), SIMDE_FLOAT16_C(19.41), SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(17.59), SIMDE_FLOAT16_C(13.00), SIMDE_FLOAT16_C(9.90), SIMDE_FLOAT16_C(9.90), SIMDE_FLOAT16_C(13.80) },
      { SIMDE_FLOAT16_C(1.05), SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.52), SIMDE_FLOAT16_C(0.24), SIMDE_FLOAT16_C(0.28), SIMDE_FLOAT16_C(0.32), SIMDE_FLOAT16_C(0.32), SIMDE_FLOAT16_C(0.27) } },
  };
