...
test_simde_vminh_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    {    SIMDE_FLOAT16_C(     2.150),
         SIMDE_FLOAT16_C(    27.846),
         SIMDE_FLOAT16_C(     2.150) },
    {    SIMDE_FLOAT16_C(     2.072),
         SIMDE_FLOAT16_C(    22.002),
         SIMDE_FLOAT16_C(     2.072) },
    {    SIMDE_FLOAT16_C(     5.820),
        -SIMDE_FLOAT16_C(    13.192),
        -SIMDE_FLOAT16_C(    13.192) },
    {   -SIMDE_FLOAT16_C(     8.482),
        -SIMDE_FLOAT16_C(     5.316),
        -SIMDE_FLOAT16_C(     8.482) },
    {   -SIMDE_FLOAT16_C(     2.206),
         SIMDE_FLOAT16_C(     9.337),
        -SIMDE_FLOAT16_C(     2.206) },
    {    SIMDE_FLOAT16_C(     3.861),
         SIMDE_FLOAT16_C(     4.205),
         SIMDE_FLOAT16_C(     3.861) },
    {    SIMDE_FLOAT16_C(    23.398),
        -SIMDE_FLOAT16_C(     2.865),
        -SIMDE_FLOAT16_C(     2.865) },
    {   -SIMDE_FLOAT16_C(    20.857),
         SIMDE_FLOAT16_C(    13.101),
        -SIMDE_FLOAT16_C(    20.857) },
  };
