...
test_simde_vrndh_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    {            SIMDE_MATH_NANF,
                 SIMDE_MATH_NANF },
    #endif
    {   -SIMDE_FLOAT16_C(  14.261),
        -SIMDE_FLOAT16_C(  14.000) },
    {    SIMDE_FLOAT16_C(   6.574),
         SIMDE_FLOAT16_C(   6.000) },
    {   -SIMDE_FLOAT16_C(   0.878),
        -SIMDE_FLOAT16_C(   0.000) },
    {    SIMDE_FLOAT16_C(   4.926),
         SIMDE_FLOAT16_C(   4.000) },
    {    SIMDE_FLOAT16_C(   9.135),
         SIMDE_FLOAT16_C(   9.000) },
    {   -SIMDE_FLOAT16_C(   4.597),
        -SIMDE_FLOAT16_C(   4.000) },
    {   -SIMDE_FLOAT16_C(   7.602),
        -SIMDE_FLOAT16_C(   7.000) },
    {    SIMDE_FLOAT16_C(   5.002),
...
test_simde_vrnd_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF },
      {            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF } },
    #endif
    { { -SIMDE_FLOAT16_C(   6.827),  SIMDE_FLOAT16_C(  11.895),  SIMDE_FLOAT16_C(   9.704),  SIMDE_FLOAT16_C(   0.246) },
      { -SIMDE_FLOAT16_C(   6.000),  SIMDE_FLOAT16_C(  11.000),  SIMDE_FLOAT16_C(   9.000),  SIMDE_FLOAT16_C(   0.000) } },
    { { -SIMDE_FLOAT16_C(   2.253), -SIMDE_FLOAT16_C(   8.446),  SIMDE_FLOAT16_C(   7.552),  SIMDE_FLOAT16_C(   7.496) },
      { -SIMDE_FLOAT16_C(   2.000), -SIMDE_FLOAT16_C(   8.000),  SIMDE_FLOAT16_C(   7.000),  SIMDE_FLOAT16_C(   7.000) } },
    { {  SIMDE_FLOAT16_C(   7.468), -SIMDE_FLOAT16_C(   0.776),  SIMDE_FLOAT16_C(  13.568), -SIMDE_FLOAT16_C(   8.010) },
      {  SIMDE_FLOAT16_C(   7.000),  SIMDE_FLOAT16_C(  -0.000),  SIMDE_FLOAT16_C(  13.000), -SIMDE_FLOAT16_C(   8.000) } },
    { {  SIMDE_FLOAT16_C(   3.989), -SIMDE_FLOAT16_C(   9.543),  SIMDE_FLOAT16_C(   3.469),  SIMDE_FLOAT16_C(   7.344) },
      {  SIMDE_FLOAT16_C(   3.000), -SIMDE_FLOAT16_C(   9.000),  SIMDE_FLOAT16_C(   3.000),  SIMDE_FLOAT16_C(   7.000) } },
    { { -SIMDE_FLOAT16_C(   9.100), -SIMDE_FLOAT16_C(   2.248), -SIMDE_FLOAT16_C(  13.411),  SIMDE_FLOAT16_C(   0.798) },
      { -SIMDE_FLOAT16_C(   9.000), -SIMDE_FLOAT16_C(   2.000), -SIMDE_FLOAT16_C(  13.000),  SIMDE_FLOAT16_C(   0.000) } },
    { {  SIMDE_FLOAT16_C(  11.416), -SIMDE_FLOAT16_C(   6.437),  SIMDE_FLOAT16_C(   8.753),  SIMDE_FLOAT16_C(   7.841) },
      {  SIMDE_FLOAT16_C(  11.000), -SIMDE_FLOAT16_C(   6.000),  SIMDE_FLOAT16_C(   8.000),  SIMDE_FLOAT16_C(   7.000) } },
    { {  SIMDE_FLOAT16_C(   5.128), -SIMDE_FLOAT16_C(   2.616),  SIMDE_FLOAT16_C(   5.873),  SIMDE_FLOAT16_C(  14.800) },
      {  SIMDE_FLOAT16_C(   5.000), -SIMDE_FLOAT16_C(   2.000),  SIMDE_FLOAT16_C(   5.000),  SIMDE_FLOAT16_C(  14.000) } },
    { { -SIMDE_FLOAT16_C(  14.333), -SIMDE_FLOAT16_C(   1.856),  SIMDE_FLOAT16_C(  10.297), -SIMDE_FLOAT16_C(   9.342) },
      { -SIMDE_FLOAT16_C(  14.000), -SIMDE_FLOAT16_C(   1.000),  SIMDE_FLOAT16_C(  10.000), -SIMDE_FLOAT16_C(   9.000) } },
  };
...
test_simde_vrndq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF,            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF },
      {            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF,            SIMDE_MATH_NANF,           -SIMDE_MATH_NANF } },
    #endif
    { {  SIMDE_FLOAT16_C(  13.437),  SIMDE_FLOAT16_C(   9.082), -SIMDE_FLOAT16_C(   3.676),  SIMDE_FLOAT16_C(  13.196),
        -SIMDE_FLOAT16_C(  12.234),  SIMDE_FLOAT16_C(   6.022), -SIMDE_FLOAT16_C(   4.825),  SIMDE_FLOAT16_C(   3.346) },
      {  SIMDE_FLOAT16_C(  13.000),  SIMDE_FLOAT16_C(   9.000), -SIMDE_FLOAT16_C(   3.000),  SIMDE_FLOAT16_C(  13.000),
        -SIMDE_FLOAT16_C(  12.000),  SIMDE_FLOAT16_C(   6.000), -SIMDE_FLOAT16_C(   4.000),  SIMDE_FLOAT16_C(   3.000) } },
    { { -SIMDE_FLOAT16_C(  11.146), -SIMDE_FLOAT16_C(   4.889), -SIMDE_FLOAT16_C(   2.848),  SIMDE_FLOAT16_C(   9.379),
         SIMDE_FLOAT16_C(   1.540),  SIMDE_FLOAT16_C(   6.644), -SIMDE_FLOAT16_C(   0.849), -SIMDE_FLOAT16_C(  12.635) },
      { -SIMDE_FLOAT16_C(  11.000), -SIMDE_FLOAT16_C(   4.000), -SIMDE_FLOAT16_C(   2.000),  SIMDE_FLOAT16_C(   9.000),
         SIMDE_FLOAT16_C(   1.000),  SIMDE_FLOAT16_C(   6.000),  SIMDE_FLOAT16_C(  -0.000), -SIMDE_FLOAT16_C(  12.000) } },
    { {  SIMDE_FLOAT16_C(   9.172), -SIMDE_FLOAT16_C(   9.263),  SIMDE_FLOAT16_C(  14.449), -SIMDE_FLOAT16_C(   6.927),
         SIMDE_FLOAT16_C(   3.828), -SIMDE_FLOAT16_C(   7.774),  SIMDE_FLOAT16_C(   8.167), -SIMDE_FLOAT16_C(  10.535) },
      {  SIMDE_FLOAT16_C(   9.000), -SIMDE_FLOAT16_C(   9.000),  SIMDE_FLOAT16_C(  14.000), -SIMDE_FLOAT16_C(   6.000),
         SIMDE_FLOAT16_C(   3.000), -SIMDE_FLOAT16_C(   7.000),  SIMDE_FLOAT16_C(   8.000), -SIMDE_FLOAT16_C(  10.000) } },
    { { -SIMDE_FLOAT16_C(  10.830), -SIMDE_FLOAT16_C(   6.668),  SIMDE_FLOAT16_C(  11.719), -SIMDE_FLOAT16_C(  10.468),
        -SIMDE_FLOAT16_C(  14.566), -SIMDE_FLOAT16_C(   5.221), -SIMDE_FLOAT16_C(   0.440),  SIMDE_FLOAT16_C(  10.387) },
      { -SIMDE_FLOAT16_C(  10.000), -SIMDE_FLOAT16_C(   6.000),  SIMDE_FLOAT16_C(  11.000), -SIMDE_FLOAT16_C(  10.000),
        -SIMDE_FLOAT16_C(  14.000), -SIMDE_FLOAT16_C(   5.000),  SIMDE_FLOAT16_C(  -0.000),  SIMDE_FLOAT16_C(  10.000) } },
    { { -SIMDE_FLOAT16_C(   3.230), -SIMDE_FLOAT16_C(  11.258), -SIMDE_FLOAT16_C(   7.571),  SIMDE_FLOAT16_C(   1.131),
        -SIMDE_FLOAT16_C(   6.249),  SIMDE_FLOAT16_C(   1.441), -SIMDE_FLOAT16_C(  11.714),  SIMDE_FLOAT16_C(   4.947) },
      { -SIMDE_FLOAT16_C(   3.000), -SIMDE_FLOAT16_C(  11.000), -SIMDE_FLOAT16_C(   7.000),  SIMDE_FLOAT16_C(   1.000),
        -SIMDE_FLOAT16_C(   6.000),  SIMDE_FLOAT16_C(   1.000), -SIMDE_FLOAT16_C(  11.000),  SIMDE_FLOAT16_C(   4.000) } },
    { {  SIMDE_FLOAT16_C(   5.647),  SIMDE_FLOAT16_C(  11.152),  SIMDE_FLOAT16_C(  14.197),  SIMDE_FLOAT16_C(  14.850),
        -SIMDE_FLOAT16_C(   9.118),  SIMDE_FLOAT16_C(  14.401), -SIMDE_FLOAT16_C(   5.287), -SIMDE_FLOAT16_C(   6.947) },
      {  SIMDE_FLOAT16_C(   5.000),  SIMDE_FLOAT16_C(  11.000),  SIMDE_FLOAT16_C(  14.000),  SIMDE_FLOAT16_C(  14.000),
        -SIMDE_FLOAT16_C(   9.000),  SIMDE_FLOAT16_C(  14.000), -SIMDE_FLOAT16_C(   5.000), -SIMDE_FLOAT16_C(   6.000) } },
    { {  SIMDE_FLOAT16_C(   9.249), -SIMDE_FLOAT16_C(  12.980), -SIMDE_FLOAT16_C(   2.587),  SIMDE_FLOAT16_C(   5.904),
        -SIMDE_FLOAT16_C(   8.108), -SIMDE_FLOAT16_C(   6.401), -SIMDE_FLOAT16_C(  10.969),  SIMDE_FLOAT16_C(  13.376) },
      {  SIMDE_FLOAT16_C(   9.000), -SIMDE_FLOAT16_C(  12.000), -SIMDE_FLOAT16_C(   2.000),  SIMDE_FLOAT16_C(   5.000),
        -SIMDE_FLOAT16_C(   8.000), -SIMDE_FLOAT16_C(   6.000), -SIMDE_FLOAT16_C(  10.000),  SIMDE_FLOAT16_C(  13.000) } },
    { { -SIMDE_FLOAT16_C(   5.304), -SIMDE_FLOAT16_C(  12.597), -SIMDE_FLOAT16_C(   0.612), -SIMDE_FLOAT16_C(   6.978),
         SIMDE_FLOAT16_C(   5.831),  SIMDE_FLOAT16_C(   4.090), -SIMDE_FLOAT16_C(   4.397),  SIMDE_FLOAT16_C(  11.647) },
      { -SIMDE_FLOAT16_C(   5.000), -SIMDE_FLOAT16_C(  12.000),  SIMDE_FLOAT16_C(  -0.000), -SIMDE_FLOAT16_C(   6.000),
         SIMDE_FLOAT16_C(   5.000),  SIMDE_FLOAT16_C(   4.000), -SIMDE_FLOAT16_C(   4.000),  SIMDE_FLOAT16_C(  11.000) } },
  };
