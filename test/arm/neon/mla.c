...
test_simde_vmla_f64 (void) {
  struct {
    ...
    { { SIMDE_FLOAT64_C(386.574351) },
      { SIMDE_FLOAT64_C(-717.857261) },
      { SIMDE_FLOAT64_C(652.907487) },
      { SIMDE_FLOAT64_C(-181185225.827698) } },
    { { SIMDE_FLOAT64_C(996.430791) },
      { SIMDE_FLOAT64_C(13.517482) },
      { SIMDE_FLOAT64_C(-489.718705) },
      { SIMDE_FLOAT64_C(-6596136.438191) } },
    { { SIMDE_FLOAT64_C(-728.069741) },
      { SIMDE_FLOAT64_C(-844.292820) },
      { SIMDE_FLOAT64_C(-234.199224) },
      { SIMDE_FLOAT64_C(-143963212.617044) } },
    { { SIMDE_FLOAT64_C(-573.715736) },
      { SIMDE_FLOAT64_C(-686.977630) },
      { SIMDE_FLOAT64_C(-73.502661) },
      { SIMDE_FLOAT64_C(-28969594.712824) } },
    { { SIMDE_FLOAT64_C(351.777573) },
      { SIMDE_FLOAT64_C(-500.881287) },
      { SIMDE_FLOAT64_C(-556.755352) },
      { SIMDE_FLOAT64_C(98099626.855533) } },
    { { SIMDE_FLOAT64_C(6.980510) },
      { SIMDE_FLOAT64_C(457.595628) },
      { SIMDE_FLOAT64_C(-18.429025) },
      { SIMDE_FLOAT64_C(-58866.927338) } },
    { { SIMDE_FLOAT64_C(-491.044499) },
      { SIMDE_FLOAT64_C(-775.771875) },
      { SIMDE_FLOAT64_C(7.149284) },
      { SIMDE_FLOAT64_C(2723437.697282) } },
    { { SIMDE_FLOAT64_C(-604.772056) },
      { SIMDE_FLOAT64_C(832.793378) },
      { SIMDE_FLOAT64_C(923.396144) },
      { SIMDE_FLOAT64_C(-465068618.841999) } },
