...
test_simde_vmaxnm_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {            SIMDE_MATH_NANF, SIMDE_FLOAT16_VALUE(   656.90),            SIMDE_MATH_NANF, SIMDE_FLOAT16_VALUE(   116.96) },
      { SIMDE_FLOAT16_VALUE(   427.79),            SIMDE_MATH_NANF,            SIMDE_MATH_NANF, SIMDE_FLOAT16_VALUE(  -999.94) },
      { SIMDE_FLOAT16_VALUE(   427.79), SIMDE_FLOAT16_VALUE(   656.90),            SIMDE_MATH_NANF, SIMDE_FLOAT16_VALUE(   116.96) } },
    #endif
