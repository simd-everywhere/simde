...
static int
test_simde_vrev16_p8 (SIMDE_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    simde_poly8_t a[8];
    simde_poly8_t r[8];
  } test_vec[] = {
    { { SIMDE_POLY8_C( 67), SIMDE_POLY8_C(189), SIMDE_POLY8_C( 42), SIMDE_POLY8_C(175), SIMDE_POLY8_C(157), SIMDE_POLY8_C( 11), SIMDE_POLY8_C( 47), SIMDE_POLY8_C(  3) },
      { SIMDE_POLY8_C(189), SIMDE_POLY8_C( 67), SIMDE_POLY8_C(175), SIMDE_POLY8_C( 42), SIMDE_POLY8_C( 11), SIMDE_POLY8_C(157), SIMDE_POLY8_C(  3), SIMDE_POLY8_C( 47) } },
    { { SIMDE_POLY8_C( 70), SIMDE_POLY8_C( 82),    SIMDE_POLY8_C(UINT8_MAX), SIMDE_POLY8_C(181), SIMDE_POLY8_C(147), SIMDE_POLY8_C(218), SIMDE_POLY8_C(137), SIMDE_POLY8_C(243) },
      { SIMDE_POLY8_C( 82), SIMDE_POLY8_C( 70), SIMDE_POLY8_C(181),    SIMDE_POLY8_C(UINT8_MAX), SIMDE_POLY8_C(218), SIMDE_POLY8_C(147), SIMDE_POLY8_C(243), SIMDE_POLY8_C(137) } },
    { { SIMDE_POLY8_C(226), SIMDE_POLY8_C(250), SIMDE_POLY8_C( 97), SIMDE_POLY8_C(179), SIMDE_POLY8_C(177), SIMDE_POLY8_C( 24), SIMDE_POLY8_C(159), SIMDE_POLY8_C(204) },
      { SIMDE_POLY8_C(250), SIMDE_POLY8_C(226), SIMDE_POLY8_C(179), SIMDE_POLY8_C( 97), SIMDE_POLY8_C( 24), SIMDE_POLY8_C(177), SIMDE_POLY8_C(204), SIMDE_POLY8_C(159) } },
    { { SIMDE_POLY8_C( 69), SIMDE_POLY8_C( 24), SIMDE_POLY8_C(125), SIMDE_POLY8_C(199), SIMDE_POLY8_C( 65), SIMDE_POLY8_C( 54), SIMDE_POLY8_C(222), SIMDE_POLY8_C(133) },
      { SIMDE_POLY8_C( 24), SIMDE_POLY8_C( 69), SIMDE_POLY8_C(199), SIMDE_POLY8_C(125), SIMDE_POLY8_C( 54), SIMDE_POLY8_C( 65), SIMDE_POLY8_C(133), SIMDE_POLY8_C(222) } },
    { { SIMDE_POLY8_C(244), SIMDE_POLY8_C(  8), SIMDE_POLY8_C( 52), SIMDE_POLY8_C(145), SIMDE_POLY8_C( 19), SIMDE_POLY8_C( 99), SIMDE_POLY8_C(148), SIMDE_POLY8_C( 89) },
      { SIMDE_POLY8_C(  8), SIMDE_POLY8_C(244), SIMDE_POLY8_C(145), SIMDE_POLY8_C( 52), SIMDE_POLY8_C( 99), SIMDE_POLY8_C( 19), SIMDE_POLY8_C( 89), SIMDE_POLY8_C(148) } },
    { { SIMDE_POLY8_C(181), SIMDE_POLY8_C(147), SIMDE_POLY8_C( 14), SIMDE_POLY8_C( 72), SIMDE_POLY8_C(110), SIMDE_POLY8_C(151), SIMDE_POLY8_C( 60), SIMDE_POLY8_C( 80) },
      { SIMDE_POLY8_C(147), SIMDE_POLY8_C(181), SIMDE_POLY8_C( 72), SIMDE_POLY8_C( 14), SIMDE_POLY8_C(151), SIMDE_POLY8_C(110), SIMDE_POLY8_C( 80), SIMDE_POLY8_C( 60) } },
    { { SIMDE_POLY8_C(145), SIMDE_POLY8_C(157), SIMDE_POLY8_C(  4), SIMDE_POLY8_C( 66), SIMDE_POLY8_C(181), SIMDE_POLY8_C(163), SIMDE_POLY8_C( 14), SIMDE_POLY8_C(250) },
      { SIMDE_POLY8_C(157), SIMDE_POLY8_C(145), SIMDE_POLY8_C( 66), SIMDE_POLY8_C(  4), SIMDE_POLY8_C(163), SIMDE_POLY8_C(181), SIMDE_POLY8_C(250), SIMDE_POLY8_C( 14) } },
    { { SIMDE_POLY8_C(187), SIMDE_POLY8_C(139), SIMDE_POLY8_C(193), SIMDE_POLY8_C(253), SIMDE_POLY8_C(194), SIMDE_POLY8_C(159), SIMDE_POLY8_C(130), SIMDE_POLY8_C(182) },
      { SIMDE_POLY8_C(139), SIMDE_POLY8_C(187), SIMDE_POLY8_C(253), SIMDE_POLY8_C(193), SIMDE_POLY8_C(159), SIMDE_POLY8_C(194), SIMDE_POLY8_C(182), SIMDE_POLY8_C(130) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_poly8x8_t a = simde_vld1_p8(test_vec[i].a);
    simde_poly8x8_t r = simde_vrev16_p8(a);
...
static int
test_simde_vrev16q_p8 (SIMDE_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    simde_poly8_t a[16];
    simde_poly8_t r[16];
  } test_vec[] = {
    { { SIMDE_POLY8_C(141), SIMDE_POLY8_C( 21), SIMDE_POLY8_C(244), SIMDE_POLY8_C( 64), SIMDE_POLY8_C( 36), SIMDE_POLY8_C(190), SIMDE_POLY8_C( 14), SIMDE_POLY8_C(191),
        SIMDE_POLY8_C( 34), SIMDE_POLY8_C( 13), SIMDE_POLY8_C(227), SIMDE_POLY8_C(160), SIMDE_POLY8_C(212), SIMDE_POLY8_C(135), SIMDE_POLY8_C(239), SIMDE_POLY8_C(236) },
      { SIMDE_POLY8_C( 21), SIMDE_POLY8_C(141), SIMDE_POLY8_C( 64), SIMDE_POLY8_C(244), SIMDE_POLY8_C(190), SIMDE_POLY8_C( 36), SIMDE_POLY8_C(191), SIMDE_POLY8_C( 14),
        SIMDE_POLY8_C( 13), SIMDE_POLY8_C( 34), SIMDE_POLY8_C(160), SIMDE_POLY8_C(227), SIMDE_POLY8_C(135), SIMDE_POLY8_C(212), SIMDE_POLY8_C(236), SIMDE_POLY8_C(239) } },
    { { SIMDE_POLY8_C(  9), SIMDE_POLY8_C( 39), SIMDE_POLY8_C( 99), SIMDE_POLY8_C(250), SIMDE_POLY8_C(220), SIMDE_POLY8_C(252), SIMDE_POLY8_C(157), SIMDE_POLY8_C( 87),
        SIMDE_POLY8_C( 43), SIMDE_POLY8_C(133), SIMDE_POLY8_C(232), SIMDE_POLY8_C(139), SIMDE_POLY8_C(175), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(173), SIMDE_POLY8_C( 61) },
      { SIMDE_POLY8_C( 39), SIMDE_POLY8_C(  9), SIMDE_POLY8_C(250), SIMDE_POLY8_C( 99), SIMDE_POLY8_C(252), SIMDE_POLY8_C(220), SIMDE_POLY8_C( 87), SIMDE_POLY8_C(157),
        SIMDE_POLY8_C(133), SIMDE_POLY8_C( 43), SIMDE_POLY8_C(139), SIMDE_POLY8_C(232), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(175), SIMDE_POLY8_C( 61), SIMDE_POLY8_C(173) } },
    { { SIMDE_POLY8_C( 50), SIMDE_POLY8_C(161), SIMDE_POLY8_C(125), SIMDE_POLY8_C( 86), SIMDE_POLY8_C( 95), SIMDE_POLY8_C(140), SIMDE_POLY8_C( 21), SIMDE_POLY8_C(130),
        SIMDE_POLY8_C(153), SIMDE_POLY8_C(248), SIMDE_POLY8_C( 34), SIMDE_POLY8_C(110), SIMDE_POLY8_C(128), SIMDE_POLY8_C( 17), SIMDE_POLY8_C( 90), SIMDE_POLY8_C(137) },
      { SIMDE_POLY8_C(161), SIMDE_POLY8_C( 50), SIMDE_POLY8_C( 86), SIMDE_POLY8_C(125), SIMDE_POLY8_C(140), SIMDE_POLY8_C( 95), SIMDE_POLY8_C(130), SIMDE_POLY8_C( 21),
        SIMDE_POLY8_C(248), SIMDE_POLY8_C(153), SIMDE_POLY8_C(110), SIMDE_POLY8_C( 34), SIMDE_POLY8_C( 17), SIMDE_POLY8_C(128), SIMDE_POLY8_C(137), SIMDE_POLY8_C( 90) } },
    { { SIMDE_POLY8_C( 56), SIMDE_POLY8_C(189), SIMDE_POLY8_C(131), SIMDE_POLY8_C( 20), SIMDE_POLY8_C(185), SIMDE_POLY8_C( 33), SIMDE_POLY8_C(107), SIMDE_POLY8_C(229),
        SIMDE_POLY8_C(166), SIMDE_POLY8_C( 84), SIMDE_POLY8_C(112), SIMDE_POLY8_C( 86), SIMDE_POLY8_C(113), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(147), SIMDE_POLY8_C(163) },
      { SIMDE_POLY8_C(189), SIMDE_POLY8_C( 56), SIMDE_POLY8_C( 20), SIMDE_POLY8_C(131), SIMDE_POLY8_C( 33), SIMDE_POLY8_C(185), SIMDE_POLY8_C(229), SIMDE_POLY8_C(107),
        SIMDE_POLY8_C( 84), SIMDE_POLY8_C(166), SIMDE_POLY8_C( 86), SIMDE_POLY8_C(112), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(113), SIMDE_POLY8_C(163), SIMDE_POLY8_C(147) } },
    { { SIMDE_POLY8_C(191), SIMDE_POLY8_C( 16), SIMDE_POLY8_C(250), SIMDE_POLY8_C( 30), SIMDE_POLY8_C(156), SIMDE_POLY8_C( 15), SIMDE_POLY8_C(160), SIMDE_POLY8_C( 54),
        SIMDE_POLY8_C(  8), SIMDE_POLY8_C(195), SIMDE_POLY8_C(164), SIMDE_POLY8_C(136), SIMDE_POLY8_C(212), SIMDE_POLY8_C(254), SIMDE_POLY8_C( 17), SIMDE_POLY8_C( 13) },
      { SIMDE_POLY8_C( 16), SIMDE_POLY8_C(191), SIMDE_POLY8_C( 30), SIMDE_POLY8_C(250), SIMDE_POLY8_C( 15), SIMDE_POLY8_C(156), SIMDE_POLY8_C( 54), SIMDE_POLY8_C(160),
        SIMDE_POLY8_C(195), SIMDE_POLY8_C(  8), SIMDE_POLY8_C(136), SIMDE_POLY8_C(164), SIMDE_POLY8_C(254), SIMDE_POLY8_C(212), SIMDE_POLY8_C( 13), SIMDE_POLY8_C( 17) } },
    { { SIMDE_POLY8_C(187), SIMDE_POLY8_C(149), SIMDE_POLY8_C( 33), SIMDE_POLY8_C(116), SIMDE_POLY8_C(182), SIMDE_POLY8_C(141), SIMDE_POLY8_C( 89), SIMDE_POLY8_C( 92),
        SIMDE_POLY8_C(225), SIMDE_POLY8_C(201), SIMDE_POLY8_C(178), SIMDE_POLY8_C( 82), SIMDE_POLY8_C(231), SIMDE_POLY8_C( 69), SIMDE_POLY8_C(245), SIMDE_POLY8_C(166) },
      { SIMDE_POLY8_C(149), SIMDE_POLY8_C(187), SIMDE_POLY8_C(116), SIMDE_POLY8_C( 33), SIMDE_POLY8_C(141), SIMDE_POLY8_C(182), SIMDE_POLY8_C( 92), SIMDE_POLY8_C( 89),
        SIMDE_POLY8_C(201), SIMDE_POLY8_C(225), SIMDE_POLY8_C( 82), SIMDE_POLY8_C(178), SIMDE_POLY8_C( 69), SIMDE_POLY8_C(231), SIMDE_POLY8_C(166), SIMDE_POLY8_C(245) } },
    { { SIMDE_POLY8_C( 86), SIMDE_POLY8_C(239), SIMDE_POLY8_C(196), SIMDE_POLY8_C(242),    SIMDE_POLY8_C(UINT8_MAX), SIMDE_POLY8_C(101), SIMDE_POLY8_C( 40), SIMDE_POLY8_C(  7),
        SIMDE_POLY8_C( 40), SIMDE_POLY8_C(204), SIMDE_POLY8_C(143), SIMDE_POLY8_C(252), SIMDE_POLY8_C(202), SIMDE_POLY8_C(160), SIMDE_POLY8_C(  9), SIMDE_POLY8_C(133) },
      { SIMDE_POLY8_C(239), SIMDE_POLY8_C( 86), SIMDE_POLY8_C(242), SIMDE_POLY8_C(196), SIMDE_POLY8_C(101),    SIMDE_POLY8_C(UINT8_MAX), SIMDE_POLY8_C(  7), SIMDE_POLY8_C( 40),
        SIMDE_POLY8_C(204), SIMDE_POLY8_C( 40), SIMDE_POLY8_C(252), SIMDE_POLY8_C(143), SIMDE_POLY8_C(160), SIMDE_POLY8_C(202), SIMDE_POLY8_C(133), SIMDE_POLY8_C(  9) } },
    { { SIMDE_POLY8_C( 53), SIMDE_POLY8_C( 43), SIMDE_POLY8_C(250), SIMDE_POLY8_C(235), SIMDE_POLY8_C(184), SIMDE_POLY8_C( 83), SIMDE_POLY8_C( 72), SIMDE_POLY8_C(153),
        SIMDE_POLY8_C( 29), SIMDE_POLY8_C(250), SIMDE_POLY8_C(235), SIMDE_POLY8_C(  4), SIMDE_POLY8_C( 64), SIMDE_POLY8_C(224), SIMDE_POLY8_C(170), SIMDE_POLY8_C(150) },
      { SIMDE_POLY8_C( 43), SIMDE_POLY8_C( 53), SIMDE_POLY8_C(235), SIMDE_POLY8_C(250), SIMDE_POLY8_C( 83), SIMDE_POLY8_C(184), SIMDE_POLY8_C(153), SIMDE_POLY8_C( 72),
        SIMDE_POLY8_C(250), SIMDE_POLY8_C( 29), SIMDE_POLY8_C(  4), SIMDE_POLY8_C(235), SIMDE_POLY8_C(224), SIMDE_POLY8_C( 64), SIMDE_POLY8_C(150), SIMDE_POLY8_C(170) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_poly8x16_t a = simde_vld1q_p8(test_vec[i].a);
    simde_poly8x16_t r = simde_vrev16q_p8(a);
...
SIMDE_TEST_FUNC_LIST_ENTRY(vrev16_p8)
SIMDE_TEST_FUNC_LIST_ENTRY(vrev16q_p8)
