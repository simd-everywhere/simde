...
test_simde_vcaddq_rot270_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    { { SIMDE_FLOAT16_VALUE(   540.00), SIMDE_FLOAT16_VALUE(  -927.50), SIMDE_FLOAT16_VALUE(    17.94), SIMDE_FLOAT16_VALUE(   340.75),
      ...
      { SIMDE_FLOAT16_VALUE(75.000000), SIMDE_FLOAT16_VALUE( 9.000000), SIMDE_FLOAT16_VALUE(-330.000000), SIMDE_FLOAT16_VALUE(444.750000), 
        SIMDE_FLOAT16_VALUE(-379.500000), SIMDE_FLOAT16_VALUE(537.000000), SIMDE_FLOAT16_VALUE(-2.000000), SIMDE_FLOAT16_VALUE(98.500000) } },
    { { SIMDE_FLOAT16_VALUE(   251.25), SIMDE_FLOAT16_VALUE(   523.50), SIMDE_FLOAT16_VALUE(   -62.34), SIMDE_FLOAT16_VALUE(  -412.00),
      ...
      { SIMDE_FLOAT16_VALUE(-414.750000), SIMDE_FLOAT16_VALUE(-60.000000), SIMDE_FLOAT16_VALUE(320.250000), SIMDE_FLOAT16_VALUE(-1288.000000), 
        SIMDE_FLOAT16_VALUE(1193.000000), SIMDE_FLOAT16_VALUE(268.750000), SIMDE_FLOAT16_VALUE(991.000000), SIMDE_FLOAT16_VALUE(-564.500000) } },
    { { SIMDE_FLOAT16_VALUE(    83.19), SIMDE_FLOAT16_VALUE(   418.00), SIMDE_FLOAT16_VALUE(  -875.50), SIMDE_FLOAT16_VALUE(   830.50),
      ...
      { SIMDE_FLOAT16_VALUE(-747.500000), SIMDE_FLOAT16_VALUE(529.000000), SIMDE_FLOAT16_VALUE(95.000000), SIMDE_FLOAT16_VALUE(771.000000), 
        SIMDE_FLOAT16_VALUE(-1456.000000), SIMDE_FLOAT16_VALUE(309.500000), SIMDE_FLOAT16_VALUE(-1582.000000), SIMDE_FLOAT16_VALUE(238.750000) } },
    { { SIMDE_FLOAT16_VALUE(   648.50), SIMDE_FLOAT16_VALUE(   385.25), SIMDE_FLOAT16_VALUE(   479.25), SIMDE_FLOAT16_VALUE(  -793.50),
      ...
      { SIMDE_FLOAT16_VALUE(-29.000000), SIMDE_FLOAT16_VALUE(53.750000), SIMDE_FLOAT16_VALUE(427.250000), SIMDE_FLOAT16_VALUE(-891.000000), 
        SIMDE_FLOAT16_VALUE(-270.750000), SIMDE_FLOAT16_VALUE( 5.875000), SIMDE_FLOAT16_VALUE(1056.000000), SIMDE_FLOAT16_VALUE(430.250000) } },
    { { SIMDE_FLOAT16_VALUE(   226.38), SIMDE_FLOAT16_VALUE(   178.88), SIMDE_FLOAT16_VALUE(   181.75), SIMDE_FLOAT16_VALUE(   420.50),
      ...
      { SIMDE_FLOAT16_VALUE(-438.500000), SIMDE_FLOAT16_VALUE(-711.500000), SIMDE_FLOAT16_VALUE(372.500000), SIMDE_FLOAT16_VALUE(1038.000000), 
        SIMDE_FLOAT16_VALUE(-1028.000000), SIMDE_FLOAT16_VALUE(-369.250000), SIMDE_FLOAT16_VALUE(-848.000000), SIMDE_FLOAT16_VALUE(900.000000) } },
    { { SIMDE_FLOAT16_VALUE(  -378.00), SIMDE_FLOAT16_VALUE(  -695.50), SIMDE_FLOAT16_VALUE(   121.50), SIMDE_FLOAT16_VALUE(   -78.44),
      ...
      { SIMDE_FLOAT16_VALUE(-1352.000000), SIMDE_FLOAT16_VALUE(91.000000), SIMDE_FLOAT16_VALUE(490.750000), SIMDE_FLOAT16_VALUE(492.000000), 
        SIMDE_FLOAT16_VALUE(-1510.000000), SIMDE_FLOAT16_VALUE(-758.000000), SIMDE_FLOAT16_VALUE(533.000000), SIMDE_FLOAT16_VALUE(1131.000000) } },
    { { SIMDE_FLOAT16_VALUE(   352.25), SIMDE_FLOAT16_VALUE(   324.25), SIMDE_FLOAT16_VALUE(   485.50), SIMDE_FLOAT16_VALUE(   943.50),
      ...
      { SIMDE_FLOAT16_VALUE(192.625000), SIMDE_FLOAT16_VALUE(1297.000000), SIMDE_FLOAT16_VALUE(-367.500000), SIMDE_FLOAT16_VALUE(1320.000000), 
        SIMDE_FLOAT16_VALUE(-315.000000), SIMDE_FLOAT16_VALUE(-435.500000), SIMDE_FLOAT16_VALUE(791.000000), SIMDE_FLOAT16_VALUE(253.250000) } },
    { { SIMDE_FLOAT16_VALUE(   535.50), SIMDE_FLOAT16_VALUE(   621.50), SIMDE_FLOAT16_VALUE(   578.50), SIMDE_FLOAT16_VALUE(   430.50),
      ...
      { SIMDE_FLOAT16_VALUE(728.000000), SIMDE_FLOAT16_VALUE(347.000000), SIMDE_FLOAT16_VALUE(1081.000000), SIMDE_FLOAT16_VALUE(-248.500000), 
        SIMDE_FLOAT16_VALUE(-645.500000), SIMDE_FLOAT16_VALUE(298.750000), SIMDE_FLOAT16_VALUE(75.500000), SIMDE_FLOAT16_VALUE(845.000000) } }
  };
