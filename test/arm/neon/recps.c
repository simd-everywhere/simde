...
test_simde_vrecps_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(3.80), SIMDE_FLOAT16_C(-1.40), SIMDE_FLOAT16_C(1.60), SIMDE_FLOAT16_C(4.40) },
      { SIMDE_FLOAT16_C(0.50), SIMDE_FLOAT16_C(4.60), SIMDE_FLOAT16_C(-3.60), SIMDE_FLOAT16_C(4.90) },
      { SIMDE_FLOAT16_C(0.10), SIMDE_FLOAT16_C(8.45), SIMDE_FLOAT16_C(7.76), SIMDE_FLOAT16_C(-19.55) } },
    { { SIMDE_FLOAT16_C(4.20), SIMDE_FLOAT16_C(-3.50), SIMDE_FLOAT16_C(-1.60), SIMDE_FLOAT16_C(-2.90) },
      { SIMDE_FLOAT16_C(1.40), SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(2.50), SIMDE_FLOAT16_C(-4.90) },
      { SIMDE_FLOAT16_C(-3.88), SIMDE_FLOAT16_C(-7.10), SIMDE_FLOAT16_C(6.00), SIMDE_FLOAT16_C(-12.21) } },
    { { SIMDE_FLOAT16_C(0.10), SIMDE_FLOAT16_C(-0.30), SIMDE_FLOAT16_C(-1.80), SIMDE_FLOAT16_C(-2.40) },
      { SIMDE_FLOAT16_C(4.70), SIMDE_FLOAT16_C(0.40), SIMDE_FLOAT16_C(-3.60), SIMDE_FLOAT16_C(1.70) },
      { SIMDE_FLOAT16_C(1.53), SIMDE_FLOAT16_C(2.12), SIMDE_FLOAT16_C(-4.48), SIMDE_FLOAT16_C(6.08) } },
    { { SIMDE_FLOAT16_C(4.40), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(4.90), SIMDE_FLOAT16_C(1.40) },
      { SIMDE_FLOAT16_C(-1.30), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(2.10), SIMDE_FLOAT16_C(3.20) },
      { SIMDE_FLOAT16_C(7.72), SIMDE_FLOAT16_C(0.60), SIMDE_FLOAT16_C(-8.28), SIMDE_FLOAT16_C(-2.48) } },
    { { SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(2.50), SIMDE_FLOAT16_C(-1.20), SIMDE_FLOAT16_C(3.40) },
      { SIMDE_FLOAT16_C(-0.80), SIMDE_FLOAT16_C(0.80), SIMDE_FLOAT16_C(3.50), SIMDE_FLOAT16_C(-4.20) },
      { SIMDE_FLOAT16_C(4.96), SIMDE_FLOAT16_C(0.00), SIMDE_FLOAT16_C(6.20), SIMDE_FLOAT16_C(16.28) } },
    { { SIMDE_FLOAT16_C(-2.90), SIMDE_FLOAT16_C(-4.30), SIMDE_FLOAT16_C(-1.80), SIMDE_FLOAT16_C(-3.00) },
      { SIMDE_FLOAT16_C(-1.90), SIMDE_FLOAT16_C(0.50), SIMDE_FLOAT16_C(0.60), SIMDE_FLOAT16_C(-2.40) },
      { SIMDE_FLOAT16_C(-3.51), SIMDE_FLOAT16_C(4.15), SIMDE_FLOAT16_C(3.08), SIMDE_FLOAT16_C(-5.20) } },
    { { SIMDE_FLOAT16_C(4.60), SIMDE_FLOAT16_C(4.20), SIMDE_FLOAT16_C(-2.80), SIMDE_FLOAT16_C(-4.10) },
      { SIMDE_FLOAT16_C(1.40), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(-4.60), SIMDE_FLOAT16_C(-2.60) },
      { SIMDE_FLOAT16_C(-4.45), SIMDE_FLOAT16_C(4.94), SIMDE_FLOAT16_C(-10.89), SIMDE_FLOAT16_C(-8.66) } },
    { { SIMDE_FLOAT16_C(2.60), SIMDE_FLOAT16_C(0.20), SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(2.20) },
      { SIMDE_FLOAT16_C(2.40), SIMDE_FLOAT16_C(-3.30), SIMDE_FLOAT16_C(0.30), SIMDE_FLOAT16_C(-2.60) },
      { SIMDE_FLOAT16_C(-4.24), SIMDE_FLOAT16_C(2.66), SIMDE_FLOAT16_C(0.89), SIMDE_FLOAT16_C(7.72) } },
    { { SIMDE_FLOAT16_C(4.60), SIMDE_FLOAT16_C(3.30), SIMDE_FLOAT16_C(-4.40), SIMDE_FLOAT16_C(-0.80) },
      { SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(-0.10), SIMDE_FLOAT16_C(-4.70), SIMDE_FLOAT16_C(0.70) },
      { SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(2.33), SIMDE_FLOAT16_C(-18.67), SIMDE_FLOAT16_C(2.56) } },
    { { SIMDE_FLOAT16_C(4.50), SIMDE_FLOAT16_C(-4.60), SIMDE_FLOAT16_C(-3.80), SIMDE_FLOAT16_C(-4.30) },
      { SIMDE_FLOAT16_C(4.10), SIMDE_FLOAT16_C(4.50), SIMDE_FLOAT16_C(-1.00), SIMDE_FLOAT16_C(4.40) },
      { SIMDE_FLOAT16_C(-16.45), SIMDE_FLOAT16_C(22.70), SIMDE_FLOAT16_C(-1.80), SIMDE_FLOAT16_C(20.92) } },
  };
...
test_simde_vrecpsq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(-3.10), SIMDE_FLOAT16_C(-3.20), SIMDE_FLOAT16_C(-4.50), SIMDE_FLOAT16_C(-1.50), SIMDE_FLOAT16_C(-3.30), SIMDE_FLOAT16_C(-0.80), SIMDE_FLOAT16_C(-0.60), SIMDE_FLOAT16_C(4.10) },
      { SIMDE_FLOAT16_C(-3.30), SIMDE_FLOAT16_C(1.20), SIMDE_FLOAT16_C(2.40), SIMDE_FLOAT16_C(-4.90), SIMDE_FLOAT16_C(-0.30), SIMDE_FLOAT16_C(-1.90), SIMDE_FLOAT16_C(-0.80), SIMDE_FLOAT16_C(1.10) },
      { SIMDE_FLOAT16_C(-8.23), SIMDE_FLOAT16_C(5.84), SIMDE_FLOAT16_C(12.80), SIMDE_FLOAT16_C(-5.35), SIMDE_FLOAT16_C(1.01), SIMDE_FLOAT16_C(0.48), SIMDE_FLOAT16_C(1.52), SIMDE_FLOAT16_C(-2.51) } },
    { { SIMDE_FLOAT16_C(-0.30), SIMDE_FLOAT16_C(1.40), SIMDE_FLOAT16_C(4.30), SIMDE_FLOAT16_C(3.50), SIMDE_FLOAT16_C(3.00), SIMDE_FLOAT16_C(4.80), SIMDE_FLOAT16_C(-0.40), SIMDE_FLOAT16_C(3.40) },
      { SIMDE_FLOAT16_C(2.60), SIMDE_FLOAT16_C(-4.40), SIMDE_FLOAT16_C(0.30), SIMDE_FLOAT16_C(3.30), SIMDE_FLOAT16_C(4.10), SIMDE_FLOAT16_C(-3.00), SIMDE_FLOAT16_C(-2.40), SIMDE_FLOAT16_C(1.00) },
      { SIMDE_FLOAT16_C(2.78), SIMDE_FLOAT16_C(8.16), SIMDE_FLOAT16_C(0.71), SIMDE_FLOAT16_C(-9.55), SIMDE_FLOAT16_C(-10.30), SIMDE_FLOAT16_C(16.41), SIMDE_FLOAT16_C(1.04), SIMDE_FLOAT16_C(-1.40) } },
    { { SIMDE_FLOAT16_C(-4.30), SIMDE_FLOAT16_C(-1.20), SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(-2.40), SIMDE_FLOAT16_C(0.30), SIMDE_FLOAT16_C(-0.00), SIMDE_FLOAT16_C(1.60) },
      { SIMDE_FLOAT16_C(-0.80), SIMDE_FLOAT16_C(-4.50), SIMDE_FLOAT16_C(0.70), SIMDE_FLOAT16_C(-2.40), SIMDE_FLOAT16_C(0.40), SIMDE_FLOAT16_C(-4.30), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(-2.40) },
      { SIMDE_FLOAT16_C(-1.44), SIMDE_FLOAT16_C(-3.40), SIMDE_FLOAT16_C(-0.59), SIMDE_FLOAT16_C(-2.80), SIMDE_FLOAT16_C(2.96), SIMDE_FLOAT16_C(3.29), SIMDE_FLOAT16_C(2.00), SIMDE_FLOAT16_C(5.84) } },
    { { SIMDE_FLOAT16_C(1.70), SIMDE_FLOAT16_C(-0.60), SIMDE_FLOAT16_C(2.10), SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(1.90), SIMDE_FLOAT16_C(2.30), SIMDE_FLOAT16_C(4.00), SIMDE_FLOAT16_C(1.90) },
      { SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(-1.70), SIMDE_FLOAT16_C(-4.80), SIMDE_FLOAT16_C(-3.60), SIMDE_FLOAT16_C(4.50), SIMDE_FLOAT16_C(-4.50), SIMDE_FLOAT16_C(4.70), SIMDE_FLOAT16_C(-0.30) },
      { SIMDE_FLOAT16_C(6.59), SIMDE_FLOAT16_C(0.98), SIMDE_FLOAT16_C(12.08), SIMDE_FLOAT16_C(15.31), SIMDE_FLOAT16_C(-6.55), SIMDE_FLOAT16_C(12.35), SIMDE_FLOAT16_C(-16.80), SIMDE_FLOAT16_C(2.57) } },
    { { SIMDE_FLOAT16_C(0.20), SIMDE_FLOAT16_C(2.10), SIMDE_FLOAT16_C(-5.00), SIMDE_FLOAT16_C(-4.80), SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(-2.60) },
      { SIMDE_FLOAT16_C(-0.40), SIMDE_FLOAT16_C(4.00), SIMDE_FLOAT16_C(4.00), SIMDE_FLOAT16_C(-3.00), SIMDE_FLOAT16_C(-3.40), SIMDE_FLOAT16_C(-3.00), SIMDE_FLOAT16_C(3.90), SIMDE_FLOAT16_C(2.80) },
      { SIMDE_FLOAT16_C(2.08), SIMDE_FLOAT16_C(-6.40), SIMDE_FLOAT16_C(22.00), SIMDE_FLOAT16_C(-12.41), SIMDE_FLOAT16_C(-7.18), SIMDE_FLOAT16_C(-0.10), SIMDE_FLOAT16_C(12.14), SIMDE_FLOAT16_C(9.28) } },
    { { SIMDE_FLOAT16_C(-3.10), SIMDE_FLOAT16_C(2.70), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(0.10), SIMDE_FLOAT16_C(2.60), SIMDE_FLOAT16_C(3.40), SIMDE_FLOAT16_C(-4.80), SIMDE_FLOAT16_C(0.80) },
      { SIMDE_FLOAT16_C(1.50), SIMDE_FLOAT16_C(2.60), SIMDE_FLOAT16_C(0.80), SIMDE_FLOAT16_C(0.40), SIMDE_FLOAT16_C(-1.70), SIMDE_FLOAT16_C(-3.70), SIMDE_FLOAT16_C(1.50), SIMDE_FLOAT16_C(-3.50) },
      { SIMDE_FLOAT16_C(6.65), SIMDE_FLOAT16_C(-5.02), SIMDE_FLOAT16_C(2.56), SIMDE_FLOAT16_C(1.96), SIMDE_FLOAT16_C(6.42), SIMDE_FLOAT16_C(14.58), SIMDE_FLOAT16_C(9.20), SIMDE_FLOAT16_C(4.80) } },
    { { SIMDE_FLOAT16_C(0.50), SIMDE_FLOAT16_C(-3.80), SIMDE_FLOAT16_C(-4.10), SIMDE_FLOAT16_C(-0.30), SIMDE_FLOAT16_C(3.80), SIMDE_FLOAT16_C(-1.30), SIMDE_FLOAT16_C(4.90), SIMDE_FLOAT16_C(1.90) },
      { SIMDE_FLOAT16_C(-4.00), SIMDE_FLOAT16_C(-0.30), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(4.70), SIMDE_FLOAT16_C(-3.60), SIMDE_FLOAT16_C(1.30), SIMDE_FLOAT16_C(2.90), SIMDE_FLOAT16_C(2.70) },
      { SIMDE_FLOAT16_C(4.00), SIMDE_FLOAT16_C(0.86), SIMDE_FLOAT16_C(-0.87), SIMDE_FLOAT16_C(3.41), SIMDE_FLOAT16_C(15.68), SIMDE_FLOAT16_C(3.69), SIMDE_FLOAT16_C(-12.21), SIMDE_FLOAT16_C(-3.13) } },
    { { SIMDE_FLOAT16_C(2.30), SIMDE_FLOAT16_C(-3.80), SIMDE_FLOAT16_C(4.20), SIMDE_FLOAT16_C(3.10), SIMDE_FLOAT16_C(-5.00), SIMDE_FLOAT16_C(1.50), SIMDE_FLOAT16_C(3.20), SIMDE_FLOAT16_C(-2.80) },
      { SIMDE_FLOAT16_C(-0.50), SIMDE_FLOAT16_C(4.40), SIMDE_FLOAT16_C(1.90), SIMDE_FLOAT16_C(-0.90), SIMDE_FLOAT16_C(-4.50), SIMDE_FLOAT16_C(4.70), SIMDE_FLOAT16_C(-4.00), SIMDE_FLOAT16_C(-3.20) },
      { SIMDE_FLOAT16_C(3.15), SIMDE_FLOAT16_C(18.72), SIMDE_FLOAT16_C(-5.98), SIMDE_FLOAT16_C(4.79), SIMDE_FLOAT16_C(-20.50), SIMDE_FLOAT16_C(-5.05), SIMDE_FLOAT16_C(14.80), SIMDE_FLOAT16_C(-6.96) } },
    { { SIMDE_FLOAT16_C(1.10), SIMDE_FLOAT16_C(-4.20), SIMDE_FLOAT16_C(-4.90), SIMDE_FLOAT16_C(-1.00), SIMDE_FLOAT16_C(-1.10), SIMDE_FLOAT16_C(-3.60), SIMDE_FLOAT16_C(-0.90), SIMDE_FLOAT16_C(3.60) },
      { SIMDE_FLOAT16_C(-1.30), SIMDE_FLOAT16_C(3.00), SIMDE_FLOAT16_C(3.30), SIMDE_FLOAT16_C(2.30), SIMDE_FLOAT16_C(0.00), SIMDE_FLOAT16_C(-0.90), SIMDE_FLOAT16_C(-4.70), SIMDE_FLOAT16_C(-1.00) },
      { SIMDE_FLOAT16_C(3.43), SIMDE_FLOAT16_C(14.59), SIMDE_FLOAT16_C(18.17), SIMDE_FLOAT16_C(4.30), SIMDE_FLOAT16_C(2.00), SIMDE_FLOAT16_C(-1.24), SIMDE_FLOAT16_C(-2.23), SIMDE_FLOAT16_C(5.60) } },
    { { SIMDE_FLOAT16_C(-0.80), SIMDE_FLOAT16_C(-0.40), SIMDE_FLOAT16_C(-2.10), SIMDE_FLOAT16_C(-1.70), SIMDE_FLOAT16_C(4.10), SIMDE_FLOAT16_C(4.50), SIMDE_FLOAT16_C(2.80), SIMDE_FLOAT16_C(-1.80) },
      { SIMDE_FLOAT16_C(3.40), SIMDE_FLOAT16_C(0.70), SIMDE_FLOAT16_C(2.40), SIMDE_FLOAT16_C(-0.50), SIMDE_FLOAT16_C(-1.40), SIMDE_FLOAT16_C(0.80), SIMDE_FLOAT16_C(3.80), SIMDE_FLOAT16_C(-3.70) },
      { SIMDE_FLOAT16_C(4.72), SIMDE_FLOAT16_C(2.28), SIMDE_FLOAT16_C(7.04), SIMDE_FLOAT16_C(1.15), SIMDE_FLOAT16_C(7.74), SIMDE_FLOAT16_C(-1.60), SIMDE_FLOAT16_C(-8.65), SIMDE_FLOAT16_C(-4.66) } },
  };
