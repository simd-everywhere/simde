...
test_simde_vfmaq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(31.59), SIMDE_FLOAT16_C(4.80), SIMDE_FLOAT16_C(4.80), SIMDE_FLOAT16_C(25.00), SIMDE_FLOAT16_C(-8.30), SIMDE_FLOAT16_C(23.00), SIMDE_FLOAT16_C(-12.00), SIMDE_FLOAT16_C(19.80) },
      { SIMDE_FLOAT16_C(4.50), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(3.00), SIMDE_FLOAT16_C(-2.20), SIMDE_FLOAT16_C(0.60), SIMDE_FLOAT16_C(-4.20), SIMDE_FLOAT16_C(4.20), SIMDE_FLOAT16_C(0.00) },
      { SIMDE_FLOAT16_C(-3.60), SIMDE_FLOAT16_C(-1.80), SIMDE_FLOAT16_C(4.00), SIMDE_FLOAT16_C(-4.70), SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(0.00), SIMDE_FLOAT16_C(-1.30), SIMDE_FLOAT16_C(-0.80) },
      { SIMDE_FLOAT16_C(15.39), SIMDE_FLOAT16_C(3.00), SIMDE_FLOAT16_C(16.80), SIMDE_FLOAT16_C(35.34), SIMDE_FLOAT16_C(-9.91), SIMDE_FLOAT16_C(23.00), SIMDE_FLOAT16_C(-17.45), SIMDE_FLOAT16_C(19.80) } },
    { { SIMDE_FLOAT16_C(18.30), SIMDE_FLOAT16_C(-39.00), SIMDE_FLOAT16_C(-47.69), SIMDE_FLOAT16_C(-43.50), SIMDE_FLOAT16_C(24.20), SIMDE_FLOAT16_C(11.80), SIMDE_FLOAT16_C(-18.20), SIMDE_FLOAT16_C(27.70) },
      { SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(-2.30), SIMDE_FLOAT16_C(-2.80), SIMDE_FLOAT16_C(3.50), SIMDE_FLOAT16_C(-2.40), SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(3.20) },
      { SIMDE_FLOAT16_C(0.40), SIMDE_FLOAT16_C(4.90), SIMDE_FLOAT16_C(-0.30), SIMDE_FLOAT16_C(-4.50), SIMDE_FLOAT16_C(-4.10), SIMDE_FLOAT16_C(2.70), SIMDE_FLOAT16_C(-0.00), SIMDE_FLOAT16_C(-3.70) },
      { SIMDE_FLOAT16_C(18.70), SIMDE_FLOAT16_C(-48.81), SIMDE_FLOAT16_C(-47.00), SIMDE_FLOAT16_C(-30.91), SIMDE_FLOAT16_C(9.84), SIMDE_FLOAT16_C(5.32), SIMDE_FLOAT16_C(-18.20), SIMDE_FLOAT16_C(15.87) } },
    { { SIMDE_FLOAT16_C(-27.00), SIMDE_FLOAT16_C(-35.59), SIMDE_FLOAT16_C(-37.59), SIMDE_FLOAT16_C(31.50), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(-26.59), SIMDE_FLOAT16_C(13.80), SIMDE_FLOAT16_C(-5.40) },
      { SIMDE_FLOAT16_C(-4.80), SIMDE_FLOAT16_C(-4.20), SIMDE_FLOAT16_C(3.10), SIMDE_FLOAT16_C(-3.10), SIMDE_FLOAT16_C(2.80), SIMDE_FLOAT16_C(0.50), SIMDE_FLOAT16_C(-0.20), SIMDE_FLOAT16_C(1.60) },
      { SIMDE_FLOAT16_C(1.70), SIMDE_FLOAT16_C(-4.70), SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(3.50), SIMDE_FLOAT16_C(2.50), SIMDE_FLOAT16_C(1.40), SIMDE_FLOAT16_C(-1.90), SIMDE_FLOAT16_C(-3.70) },
      { SIMDE_FLOAT16_C(-35.16), SIMDE_FLOAT16_C(-15.86), SIMDE_FLOAT16_C(-30.78), SIMDE_FLOAT16_C(20.66), SIMDE_FLOAT16_C(8.00), SIMDE_FLOAT16_C(-25.89), SIMDE_FLOAT16_C(14.18), SIMDE_FLOAT16_C(-11.31) } },
    { { SIMDE_FLOAT16_C(-24.30), SIMDE_FLOAT16_C(-8.70), SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(-7.60), SIMDE_FLOAT16_C(-3.10), SIMDE_FLOAT16_C(10.10), SIMDE_FLOAT16_C(-49.41), SIMDE_FLOAT16_C(49.59) },
      { SIMDE_FLOAT16_C(1.90), SIMDE_FLOAT16_C(0.40), SIMDE_FLOAT16_C(1.80), SIMDE_FLOAT16_C(1.60), SIMDE_FLOAT16_C(-4.50), SIMDE_FLOAT16_C(1.30), SIMDE_FLOAT16_C(-4.00), SIMDE_FLOAT16_C(-3.00) },
      { SIMDE_FLOAT16_C(-2.40), SIMDE_FLOAT16_C(-0.10), SIMDE_FLOAT16_C(-1.10), SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(4.60), SIMDE_FLOAT16_C(0.30), SIMDE_FLOAT16_C(-1.50), SIMDE_FLOAT16_C(-3.20) },
      { SIMDE_FLOAT16_C(-28.86), SIMDE_FLOAT16_C(-8.74), SIMDE_FLOAT16_C(-4.68), SIMDE_FLOAT16_C(-11.92), SIMDE_FLOAT16_C(-23.80), SIMDE_FLOAT16_C(10.49), SIMDE_FLOAT16_C(-43.41), SIMDE_FLOAT16_C(59.19) } },
    { { SIMDE_FLOAT16_C(32.19), SIMDE_FLOAT16_C(0.70), SIMDE_FLOAT16_C(10.60), SIMDE_FLOAT16_C(47.50), SIMDE_FLOAT16_C(-22.59), SIMDE_FLOAT16_C(-47.59), SIMDE_FLOAT16_C(38.91), SIMDE_FLOAT16_C(-10.10) },
      { SIMDE_FLOAT16_C(1.10), SIMDE_FLOAT16_C(2.90), SIMDE_FLOAT16_C(-2.80), SIMDE_FLOAT16_C(5.00), SIMDE_FLOAT16_C(1.10), SIMDE_FLOAT16_C(3.30), SIMDE_FLOAT16_C(2.40), SIMDE_FLOAT16_C(2.10) },
      { SIMDE_FLOAT16_C(0.80), SIMDE_FLOAT16_C(-4.30), SIMDE_FLOAT16_C(-3.30), SIMDE_FLOAT16_C(1.40), SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(-0.30), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(-0.90) },
      { SIMDE_FLOAT16_C(33.06), SIMDE_FLOAT16_C(-11.77), SIMDE_FLOAT16_C(19.84), SIMDE_FLOAT16_C(54.50), SIMDE_FLOAT16_C(-20.17), SIMDE_FLOAT16_C(-48.59), SIMDE_FLOAT16_C(34.09), SIMDE_FLOAT16_C(-11.99) } },
    { { SIMDE_FLOAT16_C(-16.59), SIMDE_FLOAT16_C(4.30), SIMDE_FLOAT16_C(45.59), SIMDE_FLOAT16_C(-28.00), SIMDE_FLOAT16_C(-14.90), SIMDE_FLOAT16_C(-45.59), SIMDE_FLOAT16_C(22.20), SIMDE_FLOAT16_C(30.80) },
      { SIMDE_FLOAT16_C(-0.20), SIMDE_FLOAT16_C(2.60), SIMDE_FLOAT16_C(4.90), SIMDE_FLOAT16_C(4.80), SIMDE_FLOAT16_C(-3.00), SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(4.80) },
      { SIMDE_FLOAT16_C(1.60), SIMDE_FLOAT16_C(-4.90), SIMDE_FLOAT16_C(-4.10), SIMDE_FLOAT16_C(-2.80), SIMDE_FLOAT16_C(0.60), SIMDE_FLOAT16_C(-3.20), SIMDE_FLOAT16_C(-4.20), SIMDE_FLOAT16_C(2.20) },
      { SIMDE_FLOAT16_C(-16.91), SIMDE_FLOAT16_C(-8.44), SIMDE_FLOAT16_C(25.50), SIMDE_FLOAT16_C(-41.44), SIMDE_FLOAT16_C(-16.70), SIMDE_FLOAT16_C(-36.97), SIMDE_FLOAT16_C(6.67), SIMDE_FLOAT16_C(41.34) } },
    { { SIMDE_FLOAT16_C(34.59), SIMDE_FLOAT16_C(47.00), SIMDE_FLOAT16_C(-23.30), SIMDE_FLOAT16_C(-23.59), SIMDE_FLOAT16_C(34.81), SIMDE_FLOAT16_C(14.20), SIMDE_FLOAT16_C(27.20), SIMDE_FLOAT16_C(16.91) },
      { SIMDE_FLOAT16_C(1.60), SIMDE_FLOAT16_C(-4.90), SIMDE_FLOAT16_C(3.30), SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(1.10), SIMDE_FLOAT16_C(1.60), SIMDE_FLOAT16_C(0.40) },
      { SIMDE_FLOAT16_C(-0.40), SIMDE_FLOAT16_C(-4.50), SIMDE_FLOAT16_C(-4.10), SIMDE_FLOAT16_C(0.30), SIMDE_FLOAT16_C(0.20), SIMDE_FLOAT16_C(1.20), SIMDE_FLOAT16_C(3.20), SIMDE_FLOAT16_C(4.70) },
      { SIMDE_FLOAT16_C(33.97), SIMDE_FLOAT16_C(69.06), SIMDE_FLOAT16_C(-36.84), SIMDE_FLOAT16_C(-24.38), SIMDE_FLOAT16_C(34.69), SIMDE_FLOAT16_C(15.52), SIMDE_FLOAT16_C(32.31), SIMDE_FLOAT16_C(18.78) } },
    { { SIMDE_FLOAT16_C(18.09), SIMDE_FLOAT16_C(2.60), SIMDE_FLOAT16_C(-42.81), SIMDE_FLOAT16_C(34.59), SIMDE_FLOAT16_C(4.00), SIMDE_FLOAT16_C(6.60), SIMDE_FLOAT16_C(29.80), SIMDE_FLOAT16_C(-46.09) },
      { SIMDE_FLOAT16_C(5.00), SIMDE_FLOAT16_C(-3.50), SIMDE_FLOAT16_C(1.90), SIMDE_FLOAT16_C(-0.20), SIMDE_FLOAT16_C(1.20), SIMDE_FLOAT16_C(-0.10), SIMDE_FLOAT16_C(1.50), SIMDE_FLOAT16_C(-0.70) },
      { SIMDE_FLOAT16_C(2.80), SIMDE_FLOAT16_C(-4.00), SIMDE_FLOAT16_C(-3.50), SIMDE_FLOAT16_C(3.00), SIMDE_FLOAT16_C(2.80), SIMDE_FLOAT16_C(-4.70), SIMDE_FLOAT16_C(-2.90), SIMDE_FLOAT16_C(3.50) },
      { SIMDE_FLOAT16_C(32.09), SIMDE_FLOAT16_C(16.59), SIMDE_FLOAT16_C(-49.47), SIMDE_FLOAT16_C(34.00), SIMDE_FLOAT16_C(7.36), SIMDE_FLOAT16_C(7.07), SIMDE_FLOAT16_C(25.44), SIMDE_FLOAT16_C(-48.53) } },
    { { SIMDE_FLOAT16_C(21.30), SIMDE_FLOAT16_C(31.59), SIMDE_FLOAT16_C(7.20), SIMDE_FLOAT16_C(45.00), SIMDE_FLOAT16_C(-30.59), SIMDE_FLOAT16_C(-22.91), SIMDE_FLOAT16_C(-26.20), SIMDE_FLOAT16_C(10.00) },
      { SIMDE_FLOAT16_C(-2.50), SIMDE_FLOAT16_C(3.90), SIMDE_FLOAT16_C(-1.70), SIMDE_FLOAT16_C(-0.50), SIMDE_FLOAT16_C(2.90), SIMDE_FLOAT16_C(0.60), SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(-1.90) },
      { SIMDE_FLOAT16_C(-0.10), SIMDE_FLOAT16_C(-4.20), SIMDE_FLOAT16_C(-4.10), SIMDE_FLOAT16_C(3.80), SIMDE_FLOAT16_C(-1.40), SIMDE_FLOAT16_C(-1.80), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(-0.80) },
      { SIMDE_FLOAT16_C(21.55), SIMDE_FLOAT16_C(15.22), SIMDE_FLOAT16_C(14.17), SIMDE_FLOAT16_C(43.09), SIMDE_FLOAT16_C(-34.66), SIMDE_FLOAT16_C(-23.98), SIMDE_FLOAT16_C(-24.38), SIMDE_FLOAT16_C(11.52) } },
    { { SIMDE_FLOAT16_C(22.20), SIMDE_FLOAT16_C(-18.09), SIMDE_FLOAT16_C(12.90), SIMDE_FLOAT16_C(-21.20), SIMDE_FLOAT16_C(1.70), SIMDE_FLOAT16_C(-48.00), SIMDE_FLOAT16_C(10.00), SIMDE_FLOAT16_C(1.60) },
      { SIMDE_FLOAT16_C(-3.10), SIMDE_FLOAT16_C(3.20), SIMDE_FLOAT16_C(0.30), SIMDE_FLOAT16_C(-4.20), SIMDE_FLOAT16_C(-0.80), SIMDE_FLOAT16_C(-2.40), SIMDE_FLOAT16_C(2.90), SIMDE_FLOAT16_C(0.90) },
      { SIMDE_FLOAT16_C(-4.60), SIMDE_FLOAT16_C(-3.00), SIMDE_FLOAT16_C(4.90), SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(3.80), SIMDE_FLOAT16_C(2.30), SIMDE_FLOAT16_C(4.90), SIMDE_FLOAT16_C(0.80) },
      { SIMDE_FLOAT16_C(36.47), SIMDE_FLOAT16_C(-27.69), SIMDE_FLOAT16_C(14.37), SIMDE_FLOAT16_C(-36.75), SIMDE_FLOAT16_C(-1.34), SIMDE_FLOAT16_C(-53.53), SIMDE_FLOAT16_C(24.22), SIMDE_FLOAT16_C(2.32) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    simde_float16x8_t r = simde_vfmaq_f16(a, b, c);
...
SIMDE_TEST_FUNC_LIST_ENTRY(vfmaq_f16)
