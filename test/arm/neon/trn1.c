...
test_simde_vtrn1_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { {  SIMDE_FLOAT16_C( 11.105), -SIMDE_FLOAT16_C( 63.267), -SIMDE_FLOAT16_C( 15.443), -SIMDE_FLOAT16_C( 77.497) },
      {  SIMDE_FLOAT16_C( 99.692), -SIMDE_FLOAT16_C( 68.474), -SIMDE_FLOAT16_C( 55.887), -SIMDE_FLOAT16_C( 21.106) },
      {  SIMDE_FLOAT16_C( 11.105),  SIMDE_FLOAT16_C( 99.692), -SIMDE_FLOAT16_C( 15.443), -SIMDE_FLOAT16_C( 55.887) } },
    { { -SIMDE_FLOAT16_C( 52.862), -SIMDE_FLOAT16_C( 88.095),  SIMDE_FLOAT16_C( 55.948), -SIMDE_FLOAT16_C( 84.989) },
      { -SIMDE_FLOAT16_C( 27.479), -SIMDE_FLOAT16_C( 14.155),  SIMDE_FLOAT16_C( 73.644), -SIMDE_FLOAT16_C( 71.624) },
      { -SIMDE_FLOAT16_C( 52.862), -SIMDE_FLOAT16_C( 27.479),  SIMDE_FLOAT16_C( 55.948),  SIMDE_FLOAT16_C( 73.644) } },
    { {  SIMDE_FLOAT16_C( 57.467), -SIMDE_FLOAT16_C( 90.025),  SIMDE_FLOAT16_C( 11.725),  SIMDE_FLOAT16_C( 82.468) },
      {  SIMDE_FLOAT16_C( 85.913), -SIMDE_FLOAT16_C( 65.687), -SIMDE_FLOAT16_C( 18.534), -SIMDE_FLOAT16_C( 19.093) },
      {  SIMDE_FLOAT16_C( 57.467),  SIMDE_FLOAT16_C( 85.913),  SIMDE_FLOAT16_C( 11.725), -SIMDE_FLOAT16_C( 18.534) } },
    { { -SIMDE_FLOAT16_C( 27.762),  SIMDE_FLOAT16_C( 58.179), -SIMDE_FLOAT16_C( 53.292), -SIMDE_FLOAT16_C( 33.595) },
      { -SIMDE_FLOAT16_C( 49.071), -SIMDE_FLOAT16_C( 66.212), -SIMDE_FLOAT16_C( 65.087),  SIMDE_FLOAT16_C( 86.615) },
      { -SIMDE_FLOAT16_C( 27.762), -SIMDE_FLOAT16_C( 49.071), -SIMDE_FLOAT16_C( 53.292), -SIMDE_FLOAT16_C( 65.087) } },
    { {  SIMDE_FLOAT16_C( 38.277), -SIMDE_FLOAT16_C( 95.558),  SIMDE_FLOAT16_C( 26.475), -SIMDE_FLOAT16_C( 96.782) },
      {  SIMDE_FLOAT16_C( 68.464), -SIMDE_FLOAT16_C( 65.232),  SIMDE_FLOAT16_C( 26.296),  SIMDE_FLOAT16_C( 11.376) },
      {  SIMDE_FLOAT16_C( 38.277),  SIMDE_FLOAT16_C( 68.464),  SIMDE_FLOAT16_C( 26.475),  SIMDE_FLOAT16_C( 26.296) } },
    { { -SIMDE_FLOAT16_C( 48.285),  SIMDE_FLOAT16_C( 24.604),  SIMDE_FLOAT16_C( 69.617),  SIMDE_FLOAT16_C( 66.002) },
      {  SIMDE_FLOAT16_C(  0.920), -SIMDE_FLOAT16_C( 90.358),  SIMDE_FLOAT16_C(  2.468), -SIMDE_FLOAT16_C( 37.903) },
      { -SIMDE_FLOAT16_C( 48.285),  SIMDE_FLOAT16_C(  0.920),  SIMDE_FLOAT16_C( 69.617),  SIMDE_FLOAT16_C(  2.468) } },
    { { -SIMDE_FLOAT16_C( 46.735), -SIMDE_FLOAT16_C( 76.326), -SIMDE_FLOAT16_C( 33.544),  SIMDE_FLOAT16_C(  0.423) },
      { -SIMDE_FLOAT16_C( 37.682), -SIMDE_FLOAT16_C( 51.421),  SIMDE_FLOAT16_C( 98.911),  SIMDE_FLOAT16_C( 97.679) },
      { -SIMDE_FLOAT16_C( 46.735), -SIMDE_FLOAT16_C( 37.682), -SIMDE_FLOAT16_C( 33.544),  SIMDE_FLOAT16_C( 98.911) } },
    { { -SIMDE_FLOAT16_C( 98.472), -SIMDE_FLOAT16_C(  2.386), -SIMDE_FLOAT16_C( 66.666),  SIMDE_FLOAT16_C( 27.183) },
      {  SIMDE_FLOAT16_C( 23.202),  SIMDE_FLOAT16_C(  1.710),  SIMDE_FLOAT16_C( 58.950), -SIMDE_FLOAT16_C( 44.528) },
      { -SIMDE_FLOAT16_C( 98.472),  SIMDE_FLOAT16_C( 23.202), -SIMDE_FLOAT16_C( 66.666),  SIMDE_FLOAT16_C( 58.950) } },
  };
...
test_simde_vtrn1q_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { -SIMDE_FLOAT16_C( 50.625),  SIMDE_FLOAT16_C( 30.747),  SIMDE_FLOAT16_C( 18.487),  SIMDE_FLOAT16_C( 57.491),
        -SIMDE_FLOAT16_C( 21.129),  SIMDE_FLOAT16_C( 15.440), -SIMDE_FLOAT16_C( 52.593), -SIMDE_FLOAT16_C(  4.727) },
      {  SIMDE_FLOAT16_C( 44.277), -SIMDE_FLOAT16_C( 25.789), -SIMDE_FLOAT16_C( 25.136),  SIMDE_FLOAT16_C( 33.647),
        -SIMDE_FLOAT16_C( 95.841),  SIMDE_FLOAT16_C( 52.244), -SIMDE_FLOAT16_C( 21.627),  SIMDE_FLOAT16_C( 66.122) },
      { -SIMDE_FLOAT16_C( 50.625),  SIMDE_FLOAT16_C( 44.277),  SIMDE_FLOAT16_C( 18.487), -SIMDE_FLOAT16_C( 25.136),
        -SIMDE_FLOAT16_C( 21.129), -SIMDE_FLOAT16_C( 95.841), -SIMDE_FLOAT16_C( 52.593), -SIMDE_FLOAT16_C( 21.627) } },
    { { -SIMDE_FLOAT16_C(  6.913), -SIMDE_FLOAT16_C( 94.272),  SIMDE_FLOAT16_C( 11.297),  SIMDE_FLOAT16_C(  3.058),
        -SIMDE_FLOAT16_C(  5.001), -SIMDE_FLOAT16_C(  7.243),  SIMDE_FLOAT16_C( 48.542), -SIMDE_FLOAT16_C( 21.366) },
      {  SIMDE_FLOAT16_C( 18.542),  SIMDE_FLOAT16_C( 92.836), -SIMDE_FLOAT16_C( 53.782), -SIMDE_FLOAT16_C( 54.711),
         SIMDE_FLOAT16_C( 46.595),  SIMDE_FLOAT16_C( 50.270),  SIMDE_FLOAT16_C( 64.443), -SIMDE_FLOAT16_C( 32.873) },
      { -SIMDE_FLOAT16_C(  6.913),  SIMDE_FLOAT16_C( 18.542),  SIMDE_FLOAT16_C( 11.297), -SIMDE_FLOAT16_C( 53.782),
        -SIMDE_FLOAT16_C(  5.001),  SIMDE_FLOAT16_C( 46.595),  SIMDE_FLOAT16_C( 48.542),  SIMDE_FLOAT16_C( 64.443) } },
    { {  SIMDE_FLOAT16_C( 92.715),  SIMDE_FLOAT16_C( 49.477),  SIMDE_FLOAT16_C( 85.205),  SIMDE_FLOAT16_C( 90.565),
        -SIMDE_FLOAT16_C( 47.228), -SIMDE_FLOAT16_C( 61.293),  SIMDE_FLOAT16_C( 80.419),  SIMDE_FLOAT16_C( 32.831) },
      { -SIMDE_FLOAT16_C( 59.790),  SIMDE_FLOAT16_C( 90.991),  SIMDE_FLOAT16_C(  9.151),  SIMDE_FLOAT16_C( 81.903),
         SIMDE_FLOAT16_C( 36.535), -SIMDE_FLOAT16_C(  5.406), -SIMDE_FLOAT16_C( 73.592),  SIMDE_FLOAT16_C( 52.041) },
      {  SIMDE_FLOAT16_C( 92.715), -SIMDE_FLOAT16_C( 59.790),  SIMDE_FLOAT16_C( 85.205),  SIMDE_FLOAT16_C(  9.151),
        -SIMDE_FLOAT16_C( 47.228),  SIMDE_FLOAT16_C( 36.535),  SIMDE_FLOAT16_C( 80.419), -SIMDE_FLOAT16_C( 73.592) } },
    { { -SIMDE_FLOAT16_C(  5.048), -SIMDE_FLOAT16_C( 15.367), -SIMDE_FLOAT16_C( 85.673),  SIMDE_FLOAT16_C( 94.930),
         SIMDE_FLOAT16_C( 82.348), -SIMDE_FLOAT16_C(  3.141),  SIMDE_FLOAT16_C( 83.294),  SIMDE_FLOAT16_C( 25.936) },
      {  SIMDE_FLOAT16_C( 96.385), -SIMDE_FLOAT16_C( 79.579), -SIMDE_FLOAT16_C(  4.256), -SIMDE_FLOAT16_C( 34.022),
         SIMDE_FLOAT16_C( 82.922), -SIMDE_FLOAT16_C(  1.174),  SIMDE_FLOAT16_C( 40.213),  SIMDE_FLOAT16_C( 55.100) },
      { -SIMDE_FLOAT16_C(  5.048),  SIMDE_FLOAT16_C( 96.385), -SIMDE_FLOAT16_C( 85.673), -SIMDE_FLOAT16_C(  4.256),
         SIMDE_FLOAT16_C( 82.348),  SIMDE_FLOAT16_C( 82.922),  SIMDE_FLOAT16_C( 83.294),  SIMDE_FLOAT16_C( 40.213) } },
    { {  SIMDE_FLOAT16_C( 19.062),  SIMDE_FLOAT16_C( 43.816), -SIMDE_FLOAT16_C( 30.166), -SIMDE_FLOAT16_C( 39.978),
        -SIMDE_FLOAT16_C( 39.433),  SIMDE_FLOAT16_C( 11.691),  SIMDE_FLOAT16_C(  7.837),  SIMDE_FLOAT16_C( 17.290) },
      {  SIMDE_FLOAT16_C(  8.433),  SIMDE_FLOAT16_C( 16.426), -SIMDE_FLOAT16_C( 43.558),  SIMDE_FLOAT16_C( 96.327),
        -SIMDE_FLOAT16_C( 25.953), -SIMDE_FLOAT16_C( 22.456), -SIMDE_FLOAT16_C( 81.824),  SIMDE_FLOAT16_C( 87.942) },
      {  SIMDE_FLOAT16_C( 19.062),  SIMDE_FLOAT16_C(  8.433), -SIMDE_FLOAT16_C( 30.166), -SIMDE_FLOAT16_C( 43.558),
        -SIMDE_FLOAT16_C( 39.433), -SIMDE_FLOAT16_C( 25.953),  SIMDE_FLOAT16_C(  7.837), -SIMDE_FLOAT16_C( 81.824) } },
    { { -SIMDE_FLOAT16_C( 11.648), -SIMDE_FLOAT16_C( 29.171),  SIMDE_FLOAT16_C( 80.053), -SIMDE_FLOAT16_C( 68.578),
        -SIMDE_FLOAT16_C( 48.654), -SIMDE_FLOAT16_C( 99.755), -SIMDE_FLOAT16_C( 90.352),  SIMDE_FLOAT16_C( 89.383) },
      { -SIMDE_FLOAT16_C( 33.866), -SIMDE_FLOAT16_C( 47.474), -SIMDE_FLOAT16_C( 66.626), -SIMDE_FLOAT16_C( 97.760),
        -SIMDE_FLOAT16_C( 84.997),  SIMDE_FLOAT16_C( 67.434), -SIMDE_FLOAT16_C( 97.087), -SIMDE_FLOAT16_C( 32.962) },
      { -SIMDE_FLOAT16_C( 11.648), -SIMDE_FLOAT16_C( 33.866),  SIMDE_FLOAT16_C( 80.053), -SIMDE_FLOAT16_C( 66.626),
        -SIMDE_FLOAT16_C( 48.654), -SIMDE_FLOAT16_C( 84.997), -SIMDE_FLOAT16_C( 90.352), -SIMDE_FLOAT16_C( 97.087) } },
    { {  SIMDE_FLOAT16_C( 99.618), -SIMDE_FLOAT16_C( 77.016), -SIMDE_FLOAT16_C( 80.554), -SIMDE_FLOAT16_C( 81.723),
         SIMDE_FLOAT16_C( 10.169),  SIMDE_FLOAT16_C( 23.695), -SIMDE_FLOAT16_C( 19.190),  SIMDE_FLOAT16_C( 95.941) },
      { -SIMDE_FLOAT16_C( 51.304), -SIMDE_FLOAT16_C( 96.429),  SIMDE_FLOAT16_C( 13.144), -SIMDE_FLOAT16_C(  7.245),
         SIMDE_FLOAT16_C( 29.744),  SIMDE_FLOAT16_C( 29.133),  SIMDE_FLOAT16_C( 74.282), -SIMDE_FLOAT16_C( 74.127) },
      {  SIMDE_FLOAT16_C( 99.618), -SIMDE_FLOAT16_C( 51.304), -SIMDE_FLOAT16_C( 80.554),  SIMDE_FLOAT16_C( 13.144),
         SIMDE_FLOAT16_C( 10.169),  SIMDE_FLOAT16_C( 29.744), -SIMDE_FLOAT16_C( 19.190),  SIMDE_FLOAT16_C( 74.282) } },
    { {  SIMDE_FLOAT16_C( 83.161), -SIMDE_FLOAT16_C(  1.215),  SIMDE_FLOAT16_C( 78.312), -SIMDE_FLOAT16_C( 84.448),
         SIMDE_FLOAT16_C( 81.889),  SIMDE_FLOAT16_C(  3.516),  SIMDE_FLOAT16_C( 29.221), -SIMDE_FLOAT16_C( 43.978) },
      {  SIMDE_FLOAT16_C(  5.808), -SIMDE_FLOAT16_C( 80.158), -SIMDE_FLOAT16_C( 16.019),  SIMDE_FLOAT16_C( 94.441),
         SIMDE_FLOAT16_C( 76.241),  SIMDE_FLOAT16_C( 17.818), -SIMDE_FLOAT16_C( 76.931),  SIMDE_FLOAT16_C( 91.708) },
      {  SIMDE_FLOAT16_C( 83.161),  SIMDE_FLOAT16_C(  5.808),  SIMDE_FLOAT16_C( 78.312), -SIMDE_FLOAT16_C( 16.019),
         SIMDE_FLOAT16_C( 81.889),  SIMDE_FLOAT16_C( 76.241),  SIMDE_FLOAT16_C( 29.221), -SIMDE_FLOAT16_C( 76.931) } },
  };
