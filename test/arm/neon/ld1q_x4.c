...
test_simde_vld1q_p8_x4 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {  UINT8_C(     7),  UINT8_C(   175),  UINT8_C(   237),  UINT8_C(   214),
         UINT8_C(   190),  UINT8_C(   186),  UINT8_C(   113),  UINT8_C(    23),
         UINT8_C(   144),  UINT8_C(   116),  UINT8_C(    71),  UINT8_C(   111),
         UINT8_C(   216),  UINT8_C(   247),  UINT8_C(   213),  UINT8_C(    99),
         UINT8_C(   182),  UINT8_C(   149),  UINT8_C(   180),  UINT8_C(   250),
         UINT8_C(   253),  UINT8_C(   173),  UINT8_C(     8),  UINT8_C(   111),
         UINT8_C(   114),  UINT8_C(   165),  UINT8_C(    56),  UINT8_C(   140),
         UINT8_C(   166),  UINT8_C(   167),  UINT8_C(   236),  UINT8_C(   107),
         UINT8_C(   125),  UINT8_C(   100),  UINT8_C(   150),  UINT8_C(   183),
         UINT8_C(    68),  UINT8_C(    98),  UINT8_C(   107),  UINT8_C(   210),
         UINT8_C(    60),  UINT8_C(    94),  UINT8_C(    63),  UINT8_C(   117),
         UINT8_C(   211),  UINT8_C(   109),  UINT8_C(   120),  UINT8_C(   222),
         UINT8_C(   111),  UINT8_C(    21),  UINT8_C(    49),  UINT8_C(   119),
         UINT8_C(   220),  UINT8_C(   179),  UINT8_C(    43),  UINT8_C(    62),
         UINT8_C(   233),  UINT8_C(   169),  UINT8_C(   192),  UINT8_C(   248),
         UINT8_C(   114),  UINT8_C(   126),  UINT8_C(   149),  UINT8_C(    88) },
    { {  UINT8_C(     7),  UINT8_C(   175),  UINT8_C(   237),  UINT8_C(   214),
         UINT8_C(   190),  UINT8_C(   186),  UINT8_C(   113),  UINT8_C(    23),
         UINT8_C(   144),  UINT8_C(   116),  UINT8_C(    71),  UINT8_C(   111),
         UINT8_C(   216),  UINT8_C(   247),  UINT8_C(   213),  UINT8_C(    99)  },
      ...
      {  UINT8_C(   111),  UINT8_C(    21),  UINT8_C(    49),  UINT8_C(   119),
         ...
         UINT8_C(   233),  UINT8_C(   169),  UINT8_C(   192),  UINT8_C(   248),
         UINT8_C(   114),  UINT8_C(   126),  UINT8_C(   149),  UINT8_C(    88)  } } },
    { {  UINT8_C(   157),  UINT8_C(    24),  UINT8_C(     9),  UINT8_C(   188),
         UINT8_C(    27),  UINT8_C(    88),  UINT8_C(   241),  UINT8_C(   252),
         UINT8_C(   203),  UINT8_C(   149),  UINT8_C(   208),  UINT8_C(   197),
         UINT8_C(   245),  UINT8_C(    87),  UINT8_C(   192),  UINT8_C(    69),
         UINT8_C(   181),  UINT8_C(   178),  UINT8_C(    80),  UINT8_C(    64),
         UINT8_C(   106),  UINT8_C(   183),  UINT8_C(   155),  UINT8_C(   247),
         UINT8_C(     8),  UINT8_C(   199),  UINT8_C(   133),  UINT8_C(   171),
         UINT8_C(    54),  UINT8_C(    42),  UINT8_C(    30),  UINT8_C(    81),
         UINT8_C(    74),  UINT8_C(   224),  UINT8_C(    64),  UINT8_C(   143),
         UINT8_C(   241),  UINT8_C(   239),  UINT8_C(   250),  UINT8_C(   151),
         UINT8_C(    71),  UINT8_C(    36),  UINT8_C(    96),  UINT8_C(   236),
         UINT8_C(   118),  UINT8_C(     7),  UINT8_C(    56),  UINT8_C(   220),
         UINT8_C(    90),  UINT8_C(   118),  UINT8_C(    62),  UINT8_C(   215),
         UINT8_C(   105),  UINT8_C(    39),  UINT8_C(    27),  UINT8_C(    36),
         UINT8_C(   180),  UINT8_C(    27),  UINT8_C(    45),  UINT8_C(   124),
         UINT8_C(   247),  UINT8_C(   129),  UINT8_C(   235),  UINT8_C(    67) },
    { {  UINT8_C(   157),  UINT8_C(    24),  UINT8_C(     9),  UINT8_C(   188),
         UINT8_C(    27),  UINT8_C(    88),  UINT8_C(   241),  UINT8_C(   252),
         UINT8_C(   203),  UINT8_C(   149),  UINT8_C(   208),  UINT8_C(   197),
         UINT8_C(   245),  UINT8_C(    87),  UINT8_C(   192),  UINT8_C(    69)  },
      ...
      {  UINT8_C(    90),  UINT8_C(   118),  UINT8_C(    62),  UINT8_C(   215),
         ...
         UINT8_C(   180),  UINT8_C(    27),  UINT8_C(    45),  UINT8_C(   124),
         UINT8_C(   247),  UINT8_C(   129),  UINT8_C(   235),  UINT8_C(    67)  } } },
    { {  UINT8_C(   119),  UINT8_C(   241),  UINT8_C(     4),  UINT8_C(    19),
         UINT8_C(    81),  UINT8_C(   139),  UINT8_C(   226),  UINT8_C(   128),
         UINT8_C(   207),  UINT8_C(    17),  UINT8_C(   209),  UINT8_C(   187),
         UINT8_C(    33),  UINT8_C(    68),  UINT8_C(    80),  UINT8_C(   174),
         UINT8_C(   209),  UINT8_C(   121),  UINT8_C(    32),  UINT8_C(   156),
         UINT8_C(    17),  UINT8_C(   165),  UINT8_C(    75),  UINT8_C(    81),
         UINT8_C(    75),  UINT8_C(     3),  UINT8_C(   162),  UINT8_C(   244),
         UINT8_C(   186),  UINT8_C(   113),  UINT8_C(   225),  UINT8_C(   178),
         UINT8_C(    59),  UINT8_C(    35),  UINT8_C(   145),  UINT8_C(   219),
         UINT8_C(   217),  UINT8_C(   213),  UINT8_C(   230),  UINT8_C(   190),
         UINT8_C(   233),  UINT8_C(   193),  UINT8_C(   141),  UINT8_C(   136),
         UINT8_C(   139),  UINT8_C(    75),  UINT8_C(   144),  UINT8_C(   206),
         UINT8_C(   112),  UINT8_C(   172),  UINT8_C(   171),  UINT8_C(   100),
         UINT8_C(   150),  UINT8_C(   194),  UINT8_C(    50),  UINT8_C(   181),
         UINT8_C(    80),  UINT8_C(   109),  UINT8_C(   199),  UINT8_C(   178),
         UINT8_C(   225),  UINT8_C(    37),  UINT8_C(   218),  UINT8_C(   253) },
    { {  UINT8_C(   119),  UINT8_C(   241),  UINT8_C(     4),  UINT8_C(    19),
         UINT8_C(    81),  UINT8_C(   139),  UINT8_C(   226),  UINT8_C(   128),
         UINT8_C(   207),  UINT8_C(    17),  UINT8_C(   209),  UINT8_C(   187),
         UINT8_C(    33),  UINT8_C(    68),  UINT8_C(    80),  UINT8_C(   174)  },
      ...
      {  UINT8_C(   112),  UINT8_C(   172),  UINT8_C(   171),  UINT8_C(   100),
         ...
         UINT8_C(    80),  UINT8_C(   109),  UINT8_C(   199),  UINT8_C(   178),
         UINT8_C(   225),  UINT8_C(    37),  UINT8_C(   218),  UINT8_C(   253)  } } },
    { {  UINT8_C(   239),  UINT8_C(    10),  UINT8_C(   163),  UINT8_C(    73),
         UINT8_C(   180),  UINT8_C(   140),  UINT8_C(    65),  UINT8_C(   144),
         UINT8_C(    43),  UINT8_C(    83),  UINT8_C(     8),  UINT8_C(   207),
         UINT8_C(    26),  UINT8_C(   183),  UINT8_C(   207),  UINT8_C(   142),
         UINT8_C(   117),  UINT8_C(    70),  UINT8_C(    65),  UINT8_C(    74),
         UINT8_C(   132),  UINT8_C(    62),  UINT8_C(   129),  UINT8_C(   236),
         UINT8_C(   170),  UINT8_C(     1),  UINT8_C(    64),  UINT8_C(   209),
         UINT8_C(   131),  UINT8_C(    31),  UINT8_C(    61),  UINT8_C(    26),
         UINT8_C(   185),  UINT8_C(    27),  UINT8_C(   202),  UINT8_C(    14),
         UINT8_C(   103),  UINT8_C(    16),  UINT8_C(    26),  UINT8_C(   218),
         UINT8_C(    87),  UINT8_C(    66),  UINT8_C(   101),  UINT8_C(   139),
         UINT8_C(    55),  UINT8_C(   217),  UINT8_C(   149),  UINT8_C(    45),
         UINT8_C(   202),  UINT8_C(    90),  UINT8_C(    48),  UINT8_C(   244),
         UINT8_C(    99),  UINT8_C(   154),  UINT8_C(    37),  UINT8_C(   140),
         UINT8_C(    48),  UINT8_C(   236),  UINT8_C(   130),  UINT8_C(    93),
         UINT8_C(   197),  UINT8_C(   217),  UINT8_C(   147),  UINT8_C(   241) },
    { {  UINT8_C(   239),  UINT8_C(    10),  UINT8_C(   163),  UINT8_C(    73),
         UINT8_C(   180),  UINT8_C(   140),  UINT8_C(    65),  UINT8_C(   144),
         UINT8_C(    43),  UINT8_C(    83),  UINT8_C(     8),  UINT8_C(   207),
         UINT8_C(    26),  UINT8_C(   183),  UINT8_C(   207),  UINT8_C(   142)  },
      ...
      {  UINT8_C(   202),  UINT8_C(    90),  UINT8_C(    48),  UINT8_C(   244),
         ...
         UINT8_C(    48),  UINT8_C(   236),  UINT8_C(   130),  UINT8_C(    93),
         UINT8_C(   197),  UINT8_C(   217),  UINT8_C(   147),  UINT8_C(   241)  } } },
    { {  UINT8_C(    39),  UINT8_C(   250),  UINT8_C(    44),  UINT8_C(   209),
         UINT8_C(   155),  UINT8_C(   109),  UINT8_C(   113),  UINT8_C(   205),
         UINT8_C(     5),  UINT8_C(   138),  UINT8_C(   243),  UINT8_C(   135),
         UINT8_C(   101),  UINT8_C(   248),  UINT8_C(    51),  UINT8_C(   160),
         UINT8_C(   152),  UINT8_C(   154),  UINT8_C(   174),  UINT8_C(   136),
         UINT8_C(   201),  UINT8_C(   157),  UINT8_C(   166),  UINT8_C(    74),
         UINT8_C(    39),  UINT8_C(    29),  UINT8_C(   163),  UINT8_C(   119),
         UINT8_C(   134),  UINT8_C(     6),  UINT8_C(    34),  UINT8_C(   225),
         UINT8_C(   101),  UINT8_C(    20),  UINT8_C(   191),  UINT8_C(   190),
         UINT8_C(   154),  UINT8_C(    86),  UINT8_C(    10),  UINT8_C(    40),
         UINT8_C(    94),  UINT8_C(   151),  UINT8_C(   150),  UINT8_C(   119),
         UINT8_C(   139),  UINT8_C(   123),  UINT8_C(    36),  UINT8_C(    90),
         UINT8_C(    47),  UINT8_C(   185),  UINT8_C(   127),  UINT8_C(   246),
         UINT8_C(    28),  UINT8_C(   149),  UINT8_C(    44),  UINT8_C(   138),
         UINT8_C(   125),  UINT8_C(   186),  UINT8_C(   202),  UINT8_C(    54),
         UINT8_C(   199),  UINT8_C(   240),  UINT8_C(    13),  UINT8_C(   253) },
    { {  UINT8_C(    39),  UINT8_C(   250),  UINT8_C(    44),  UINT8_C(   209),
         UINT8_C(   155),  UINT8_C(   109),  UINT8_C(   113),  UINT8_C(   205),
         UINT8_C(     5),  UINT8_C(   138),  UINT8_C(   243),  UINT8_C(   135),
         UINT8_C(   101),  UINT8_C(   248),  UINT8_C(    51),  UINT8_C(   160)  },
      ...
      {  UINT8_C(    47),  UINT8_C(   185),  UINT8_C(   127),  UINT8_C(   246),
         ...
         UINT8_C(   125),  UINT8_C(   186),  UINT8_C(   202),  UINT8_C(    54),
         UINT8_C(   199),  UINT8_C(   240),  UINT8_C(    13),  UINT8_C(   253)  } } },
    { {  UINT8_C(   208),  UINT8_C(    31),  UINT8_C(    99),  UINT8_C(    76),
         UINT8_C(    22),  UINT8_C(    34),  UINT8_C(    83),  UINT8_C(   143),
         UINT8_C(   141),  UINT8_C(   139),  UINT8_C(   234),  UINT8_C(   250),
         UINT8_C(    27),  UINT8_C(   135),  UINT8_C(   177),  UINT8_C(   104),
         UINT8_C(   218),  UINT8_C(   200),  UINT8_C(    49),  UINT8_C(    41),
         UINT8_C(   195),  UINT8_C(   115),  UINT8_C(   141),  UINT8_C(   178),
         UINT8_C(    42),  UINT8_C(   106),  UINT8_C(   117),  UINT8_C(    57),
         UINT8_C(   231),  UINT8_C(    93),  UINT8_C(    46),  UINT8_C(    69),
         UINT8_C(   151),  UINT8_C(    11),  UINT8_C(   169),  UINT8_C(   178),
         UINT8_C(   145),  UINT8_C(    43),  UINT8_C(    29),  UINT8_C(    94),
         UINT8_C(   183),  UINT8_C(    41),  UINT8_C(    52),  UINT8_C(   205),
         UINT8_C(    57),  UINT8_C(    66),  UINT8_C(   146),  UINT8_C(   141),
         UINT8_C(   167),  UINT8_C(    51),  UINT8_C(    24),  UINT8_C(    79),
         UINT8_C(   130),  UINT8_C(   229),  UINT8_C(   213),  UINT8_C(   210),
         UINT8_C(   171),  UINT8_C(   160),  UINT8_C(   105),  UINT8_C(    36),
         UINT8_C(   186),  UINT8_C(   236),  UINT8_C(    65),  UINT8_C(   198) },
    { {  UINT8_C(   208),  UINT8_C(    31),  UINT8_C(    99),  UINT8_C(    76),
         UINT8_C(    22),  UINT8_C(    34),  UINT8_C(    83),  UINT8_C(   143),
         UINT8_C(   141),  UINT8_C(   139),  UINT8_C(   234),  UINT8_C(   250),
         UINT8_C(    27),  UINT8_C(   135),  UINT8_C(   177),  UINT8_C(   104)  },
      ...
      {  UINT8_C(   167),  UINT8_C(    51),  UINT8_C(    24),  UINT8_C(    79),
         ...
         UINT8_C(   171),  UINT8_C(   160),  UINT8_C(   105),  UINT8_C(    36),
         UINT8_C(   186),  UINT8_C(   236),  UINT8_C(    65),  UINT8_C(   198)  } } },
    { {  UINT8_C(   235),  UINT8_C(    94),  UINT8_C(    58),  UINT8_C(    92),
         UINT8_C(   123),  UINT8_C(   112),  UINT8_C(    72),  UINT8_C(   151),
         UINT8_C(   248),  UINT8_C(   134),  UINT8_C(   223),  UINT8_C(    94),
         UINT8_C(   246),  UINT8_C(   226),  UINT8_C(    81),  UINT8_C(    76),
         UINT8_C(   250),  UINT8_C(   223),  UINT8_C(   254),  UINT8_C(    49),
         UINT8_C(    30),   UINT8_MAX,  UINT8_C(   111),  UINT8_C(   210),
         UINT8_C(    26),  UINT8_C(    67),  UINT8_C(   215),  UINT8_C(   254),
         UINT8_C(   163),  UINT8_C(   182),  UINT8_C(   123),  UINT8_C(   128),
         UINT8_C(   242),  UINT8_C(   125),  UINT8_C(   218),  UINT8_C(    58),
         UINT8_C(   163),  UINT8_C(   102),  UINT8_C(   180),  UINT8_C(   149),
         UINT8_C(   246),  UINT8_C(    41),  UINT8_C(    55),  UINT8_C(   232),
         UINT8_C(   119),  UINT8_C(    76),  UINT8_C(    21),  UINT8_C(   237),
         UINT8_C(    80),  UINT8_C(   163),  UINT8_C(   185),  UINT8_C(    46),
         UINT8_C(   215),  UINT8_C(   228),  UINT8_C(   219),  UINT8_C(   140),
         UINT8_C(    35),  UINT8_C(   143),  UINT8_C(   203),  UINT8_C(    87),
         UINT8_C(    10),  UINT8_C(   217),  UINT8_C(    74),  UINT8_C(    43) },
    { {  UINT8_C(   235),  UINT8_C(    94),  UINT8_C(    58),  UINT8_C(    92),
         UINT8_C(   123),  UINT8_C(   112),  UINT8_C(    72),  UINT8_C(   151),
         UINT8_C(   248),  UINT8_C(   134),  UINT8_C(   223),  UINT8_C(    94),
         UINT8_C(   246),  UINT8_C(   226),  UINT8_C(    81),  UINT8_C(    76)  },
      ...
      {  UINT8_C(    80),  UINT8_C(   163),  UINT8_C(   185),  UINT8_C(    46),
         ...
         UINT8_C(    35),  UINT8_C(   143),  UINT8_C(   203),  UINT8_C(    87),
         UINT8_C(    10),  UINT8_C(   217),  UINT8_C(    74),  UINT8_C(    43)  } } },
    { {  UINT8_C(   220),  UINT8_C(   165),  UINT8_C(   244),  UINT8_C(   253),
         UINT8_C(   197),  UINT8_C(   225),  UINT8_C(    84),  UINT8_C(   212),
         UINT8_C(   141),  UINT8_C(   135),  UINT8_C(    10),  UINT8_C(    77),
         UINT8_C(    22),  UINT8_C(    64),  UINT8_C(   146),  UINT8_C(   154),
         UINT8_C(    56),  UINT8_C(   143),  UINT8_C(   198),  UINT8_C(    74),
         UINT8_C(    31),  UINT8_C(   176),  UINT8_C(   183),  UINT8_C(    16),
         UINT8_C(    88),  UINT8_C(   108),  UINT8_C(   247),  UINT8_C(   114),
         UINT8_C(   130),  UINT8_C(   225),  UINT8_C(   220),  UINT8_C(    87),
         UINT8_C(    40),  UINT8_C(   144),  UINT8_C(   115),  UINT8_C(   185),
         UINT8_C(   244),  UINT8_C(   114),  UINT8_C(   193),  UINT8_C(    70),
         UINT8_C(    14),  UINT8_C(   101),  UINT8_C(    28),  UINT8_C(    76),
         UINT8_C(   231),  UINT8_C(   230),  UINT8_C(   174),  UINT8_C(   245),
         UINT8_C(    66),  UINT8_C(   137),  UINT8_C(    74),  UINT8_C(   194),
         UINT8_C(   230),  UINT8_C(   192),  UINT8_C(   217),  UINT8_C(   104),
         UINT8_C(    29),  UINT8_C(   169),  UINT8_C(   246),  UINT8_C(    17),
         UINT8_C(   209),  UINT8_C(    85),  UINT8_C(   123),  UINT8_C(   114) },
    { {  UINT8_C(   220),  UINT8_C(   165),  UINT8_C(   244),  UINT8_C(   253),
         UINT8_C(   197),  UINT8_C(   225),  UINT8_C(    84),  UINT8_C(   212),
         UINT8_C(   141),  UINT8_C(   135),  UINT8_C(    10),  UINT8_C(    77),
         UINT8_C(    22),  UINT8_C(    64),  UINT8_C(   146),  UINT8_C(   154)  },
...
test_simde_vld1q_p16_x4 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {  UINT16_C(    9211),  UINT16_C(   39452),  UINT16_C(    4935),  UINT16_C(   15539),
         UINT16_C(   48549),  UINT16_C(   42965),  UINT16_C(   61226),  UINT16_C(   34775),
         UINT16_C(    9725),  UINT16_C(    3147),  UINT16_C(   51032),  UINT16_C(   55478),
         UINT16_C(   62541),  UINT16_C(   38304),  UINT16_C(   34081),  UINT16_C(   20991),
         UINT16_C(    7737),  UINT16_C(   34597),  UINT16_C(   59596),  UINT16_C(    5318),
         UINT16_C(   35020),  UINT16_C(   42516),  UINT16_C(   42605),  UINT16_C(    5246),
         UINT16_C(   22217),  UINT16_C(   53797),  UINT16_C(   26936),  UINT16_C(   38455),
         UINT16_C(   62563),  UINT16_C(   20249),  UINT16_C(   52279),  UINT16_C(   54173) },
    { {  UINT16_C(    9211),  UINT16_C(   39452),  UINT16_C(    4935),  UINT16_C(   15539),
         UINT16_C(   48549),  UINT16_C(   42965),  UINT16_C(   61226),  UINT16_C(   34775)  },
      {  UINT16_C(    9725),  UINT16_C(    3147),  UINT16_C(   51032),  UINT16_C(   55478),
         UINT16_C(   62541),  UINT16_C(   38304),  UINT16_C(   34081),  UINT16_C(   20991)  },
      ...
      {  UINT16_C(   22217),  UINT16_C(   53797),  UINT16_C(   26936),  UINT16_C(   38455),
         UINT16_C(   62563),  UINT16_C(   20249),  UINT16_C(   52279),  UINT16_C(   54173)  } } },
    { {  UINT16_C(   57377),  UINT16_C(   27181),  UINT16_C(   64446),  UINT16_C(    8160),
         UINT16_C(   64885),  UINT16_C(   42693),  UINT16_C(   29020),  UINT16_C(   31081),
         UINT16_C(   64073),  UINT16_C(   55128),  UINT16_C(   55382),  UINT16_C(   62642),
         UINT16_C(   37174),  UINT16_C(    5095),  UINT16_C(   30611),  UINT16_C(   64105),
         UINT16_C(   57623),  UINT16_C(   37393),  UINT16_C(   29223),  UINT16_C(   12888),
         UINT16_C(   36880),  UINT16_C(   60664),  UINT16_C(   60759),  UINT16_C(   54490),
         UINT16_C(   51568),  UINT16_C(    1624),  UINT16_C(   50818),  UINT16_C(   14003),
         UINT16_C(   64849),  UINT16_C(   43105),  UINT16_C(   27288),  UINT16_C(   39589) },
    { {  UINT16_C(   57377),  UINT16_C(   27181),  UINT16_C(   64446),  UINT16_C(    8160),
         UINT16_C(   64885),  UINT16_C(   42693),  UINT16_C(   29020),  UINT16_C(   31081)  },
      {  UINT16_C(   64073),  UINT16_C(   55128),  UINT16_C(   55382),  UINT16_C(   62642),
         UINT16_C(   37174),  UINT16_C(    5095),  UINT16_C(   30611),  UINT16_C(   64105)  },
      ...
      {  UINT16_C(   51568),  UINT16_C(    1624),  UINT16_C(   50818),  UINT16_C(   14003),
         UINT16_C(   64849),  UINT16_C(   43105),  UINT16_C(   27288),  UINT16_C(   39589)  } } },
    { {  UINT16_C(   22885),  UINT16_C(    9193),  UINT16_C(   42669),  UINT16_C(   48457),
         UINT16_C(   24273),  UINT16_C(   63157),  UINT16_C(   49338),  UINT16_C(   33741),
         UINT16_C(   64092),  UINT16_C(   34683),  UINT16_C(   27886),  UINT16_C(   33101),
         UINT16_C(   62103),  UINT16_C(   32975),  UINT16_C(   64112),  UINT16_C(     759),
         UINT16_C(   16051),  UINT16_C(   63406),  UINT16_C(     697),  UINT16_C(   62169),
         UINT16_C(   36599),  UINT16_C(   58674),  UINT16_C(   64649),  UINT16_C(   11150),
         UINT16_C(   13996),  UINT16_C(   21952),  UINT16_C(   53055),  UINT16_C(   29660),
         UINT16_C(   21646),  UINT16_C(   59671),  UINT16_C(   54186),  UINT16_C(   22229) },
    { {  UINT16_C(   22885),  UINT16_C(    9193),  UINT16_C(   42669),  UINT16_C(   48457),
         UINT16_C(   24273),  UINT16_C(   63157),  UINT16_C(   49338),  UINT16_C(   33741)  },
      {  UINT16_C(   64092),  UINT16_C(   34683),  UINT16_C(   27886),  UINT16_C(   33101),
         UINT16_C(   62103),  UINT16_C(   32975),  UINT16_C(   64112),  UINT16_C(     759)  },
      ...
      {  UINT16_C(   13996),  UINT16_C(   21952),  UINT16_C(   53055),  UINT16_C(   29660),
         UINT16_C(   21646),  UINT16_C(   59671),  UINT16_C(   54186),  UINT16_C(   22229)  } } },
    { {  UINT16_C(    5398),  UINT16_C(   23804),  UINT16_C(   13577),  UINT16_C(   21473),
         UINT16_C(   60753),  UINT16_C(   41456),  UINT16_C(    6042),  UINT16_C(   51993),
         UINT16_C(   24249),  UINT16_C(   18986),  UINT16_C(   31377),  UINT16_C(   17037),
         UINT16_C(    2368),  UINT16_C(   14280),  UINT16_C(    2148),  UINT16_C(   27191),
         UINT16_C(   36932),  UINT16_C(   33038),  UINT16_C(   13186),  UINT16_C(   31448),
         UINT16_C(   35102),  UINT16_C(   34202),  UINT16_C(   10565),  UINT16_C(    7769),
         UINT16_C(   45014),  UINT16_C(   27739),  UINT16_C(   50651),  UINT16_C(   39667),
         UINT16_C(   18123),  UINT16_C(     892),  UINT16_C(    6979),  UINT16_C(   36040) },
    { {  UINT16_C(    5398),  UINT16_C(   23804),  UINT16_C(   13577),  UINT16_C(   21473),
         UINT16_C(   60753),  UINT16_C(   41456),  UINT16_C(    6042),  UINT16_C(   51993)  },
      {  UINT16_C(   24249),  UINT16_C(   18986),  UINT16_C(   31377),  UINT16_C(   17037),
         UINT16_C(    2368),  UINT16_C(   14280),  UINT16_C(    2148),  UINT16_C(   27191)  },
      ...
      {  UINT16_C(   45014),  UINT16_C(   27739),  UINT16_C(   50651),  UINT16_C(   39667),
         UINT16_C(   18123),  UINT16_C(     892),  UINT16_C(    6979),  UINT16_C(   36040)  } } },
    { {  UINT16_C(   32709),  UINT16_C(     490),  UINT16_C(    7781),  UINT16_C(     410),
         UINT16_C(   61115),  UINT16_C(   46474),  UINT16_C(   47471),  UINT16_C(   53366),
         UINT16_C(   43807),  UINT16_C(    1888),  UINT16_C(    2125),  UINT16_C(   31231),
         UINT16_C(    3053),  UINT16_C(   43903),  UINT16_C(   36297),  UINT16_C(   38471),
         UINT16_C(   19487),  UINT16_C(   32429),  UINT16_C(   32113),  UINT16_C(   44776),
         UINT16_C(   37793),  UINT16_C(   49689),  UINT16_C(   13261),  UINT16_C(   20645),
         UINT16_C(   30182),  UINT16_C(   58155),  UINT16_C(   50887),  UINT16_C(   10141),
         UINT16_C(    6116),  UINT16_C(     586),  UINT16_C(   50271),  UINT16_C(    4947) },
    { {  UINT16_C(   32709),  UINT16_C(     490),  UINT16_C(    7781),  UINT16_C(     410),
         UINT16_C(   61115),  UINT16_C(   46474),  UINT16_C(   47471),  UINT16_C(   53366)  },
      {  UINT16_C(   43807),  UINT16_C(    1888),  UINT16_C(    2125),  UINT16_C(   31231),
         UINT16_C(    3053),  UINT16_C(   43903),  UINT16_C(   36297),  UINT16_C(   38471)  },
      ...
      {  UINT16_C(   30182),  UINT16_C(   58155),  UINT16_C(   50887),  UINT16_C(   10141),
         UINT16_C(    6116),  UINT16_C(     586),  UINT16_C(   50271),  UINT16_C(    4947)  } } },
    { {  UINT16_C(   63949),  UINT16_C(   34343),  UINT16_C(   44122),  UINT16_C(   32560),
         UINT16_C(   30269),  UINT16_C(   47651),  UINT16_C(   34285),  UINT16_C(   37297),
         UINT16_C(   29073),  UINT16_C(   60772),  UINT16_C(   48633),  UINT16_C(   21142),
         UINT16_C(   39718),  UINT16_C(   42704),  UINT16_C(   59201),  UINT16_C(   57993),
         UINT16_C(     289),  UINT16_C(   14234),  UINT16_C(   19850),  UINT16_C(   28746),
         UINT16_C(   42831),  UINT16_C(   22459),  UINT16_C(   54607),  UINT16_C(   61012),
         UINT16_C(   36536),  UINT16_C(   64154),  UINT16_C(    1698),  UINT16_C(   47409),
         UINT16_C(   41498),  UINT16_C(   41570),  UINT16_C(   16190),  UINT16_C(   52647) },
    { {  UINT16_C(   63949),  UINT16_C(   34343),  UINT16_C(   44122),  UINT16_C(   32560),
         UINT16_C(   30269),  UINT16_C(   47651),  UINT16_C(   34285),  UINT16_C(   37297)  },
      {  UINT16_C(   29073),  UINT16_C(   60772),  UINT16_C(   48633),  UINT16_C(   21142),
         UINT16_C(   39718),  UINT16_C(   42704),  UINT16_C(   59201),  UINT16_C(   57993)  },
      ...
      {  UINT16_C(   36536),  UINT16_C(   64154),  UINT16_C(    1698),  UINT16_C(   47409),
         UINT16_C(   41498),  UINT16_C(   41570),  UINT16_C(   16190),  UINT16_C(   52647)  } } },
    { {  UINT16_C(   16768),  UINT16_C(   53260),  UINT16_C(   24013),  UINT16_C(    2282),
         UINT16_C(   37040),  UINT16_C(   64633),  UINT16_C(   49536),  UINT16_C(   64904),
         UINT16_C(   58863),  UINT16_C(   17978),  UINT16_C(   22451),  UINT16_C(   16159),
         UINT16_C(   28037),  UINT16_C(   22399),  UINT16_C(   30094),  UINT16_C(   55247),
         UINT16_C(   19699),  UINT16_C(   47970),  UINT16_C(   45844),  UINT16_C(   24235),
         UINT16_C(   59049),  UINT16_C(   49638),  UINT16_C(    7539),  UINT16_C(   38514),
         UINT16_C(   57105),  UINT16_C(   10123),  UINT16_C(   37500),  UINT16_C(   41722),
         UINT16_C(   30289),  UINT16_C(   64955),  UINT16_C(   19812),  UINT16_C(   16718) },
    { {  UINT16_C(   16768),  UINT16_C(   53260),  UINT16_C(   24013),  UINT16_C(    2282),
         UINT16_C(   37040),  UINT16_C(   64633),  UINT16_C(   49536),  UINT16_C(   64904)  },
      {  UINT16_C(   58863),  UINT16_C(   17978),  UINT16_C(   22451),  UINT16_C(   16159),
         UINT16_C(   28037),  UINT16_C(   22399),  UINT16_C(   30094),  UINT16_C(   55247)  },
      ...
      {  UINT16_C(   57105),  UINT16_C(   10123),  UINT16_C(   37500),  UINT16_C(   41722),
         UINT16_C(   30289),  UINT16_C(   64955),  UINT16_C(   19812),  UINT16_C(   16718)  } } },
    { {  UINT16_C(   48084),  UINT16_C(   11401),  UINT16_C(   58753),  UINT16_C(   21223),
         UINT16_C(   11160),  UINT16_C(   52673),  UINT16_C(   39163),  UINT16_C(   42176),
         UINT16_C(   29254),  UINT16_C(   56153),  UINT16_C(   29831),  UINT16_C(   16282),
         UINT16_C(   13127),  UINT16_C(   27796),  UINT16_C(   45505),  UINT16_C(   48730),
         UINT16_C(   38982),  UINT16_C(   33987),  UINT16_C(   41156),  UINT16_C(   22188),
         UINT16_C(   19278),  UINT16_C(   53240),  UINT16_C(    2079),  UINT16_C(   29839),
         UINT16_C(    7685),  UINT16_C(   27349),  UINT16_C(    7293),  UINT16_C(   34477),
         UINT16_C(    2832),  UINT16_C(   53944),  UINT16_C(   25153),  UINT16_C(   52336) },
    { {  UINT16_C(   48084),  UINT16_C(   11401),  UINT16_C(   58753),  UINT16_C(   21223),
         UINT16_C(   11160),  UINT16_C(   52673),  UINT16_C(   39163),  UINT16_C(   42176)  },
      {  UINT16_C(   29254),  UINT16_C(   56153),  UINT16_C(   29831),  UINT16_C(   16282),
         UINT16_C(   13127),  UINT16_C(   27796),  UINT16_C(   45505),  UINT16_C(   48730)  },
...
test_simde_vld1q_p64_x4 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {  UINT64_C( 7154771678769626112),  UINT64_C(11740551762359005184),  UINT64_C( 2558810697885233152),  UINT64_C( 9038240114452687872),
         UINT64_C( 9689586260292292608),  UINT64_C( 8453835509798581248),  UINT64_C( 2446519755765603328),  UINT64_C(13195139351724742656) },
    { {  UINT64_C( 7154771678769626112),  UINT64_C(11740551762359005184)  },
      {  UINT64_C( 2558810697885233152),  UINT64_C( 9038240114452687872)  },
      {  UINT64_C( 9689586260292292608),  UINT64_C( 8453835509798581248)  },
      {  UINT64_C( 2446519755765603328),  UINT64_C(13195139351724742656)  } } },
    { {  UINT64_C( 2965742671226290176),  UINT64_C(16262349869982175232),  UINT64_C( 1767178712773100288),  UINT64_C(15406718886057752576),
         UINT64_C(10176412470495139840),  UINT64_C( 5139116504646875136),  UINT64_C( 8542861413016699904),  UINT64_C(16398499435288463360) },
    { {  UINT64_C( 2965742671226290176),  UINT64_C(16262349869982175232)  },
      {  UINT64_C( 1767178712773100288),  UINT64_C(15406718886057752576)  },
      {  UINT64_C(10176412470495139840),  UINT64_C( 5139116504646875136)  },
      {  UINT64_C( 8542861413016699904),  UINT64_C(16398499435288463360)  } } },
    { {  UINT64_C(13129160896330913792),  UINT64_C(11653861199254679552),  UINT64_C( 6548853626855996416),  UINT64_C(   50780021194548144),
         UINT64_C(13003130330100856832),  UINT64_C(15321112471868461056),  UINT64_C(12981714533540315136),  UINT64_C( 1524660169325070592) },
    { {  UINT64_C(13129160896330913792),  UINT64_C(11653861199254679552)  },
      {  UINT64_C( 6548853626855996416),  UINT64_C(   50780021194548144)  },
      {  UINT64_C(13003130330100856832),  UINT64_C(15321112471868461056)  },
      {  UINT64_C(12981714533540315136),  UINT64_C( 1524660169325070592)  } } },
    { {  UINT64_C( 4361622925913683456),  UINT64_C(16377642044138067968),  UINT64_C(  331363660145348160),  UINT64_C( 5176577585641760768),
         UINT64_C( 1997210542406237952),  UINT64_C( 3701712683818038784),  UINT64_C(10910947553430177792),  UINT64_C( 6140276109593777152) },
    { {  UINT64_C( 4361622925913683456),  UINT64_C(16377642044138067968)  },
      {  UINT64_C(  331363660145348160),  UINT64_C( 5176577585641760768)  },
      {  UINT64_C( 1997210542406237952),  UINT64_C( 3701712683818038784)  },
      {  UINT64_C(10910947553430177792),  UINT64_C( 6140276109593777152)  } } },
    { {  UINT64_C(11500646624398737408),  UINT64_C( 4812253297631222784),  UINT64_C(  934275217705044992),  UINT64_C( 5081625958934144000),
         UINT64_C(  231407268129284864),  UINT64_C( 1174668535850460160),  UINT64_C(17522447699125241856),  UINT64_C( 1324911946478663680) },
    { {  UINT64_C(11500646624398737408),  UINT64_C( 4812253297631222784)  },
      {  UINT64_C(  934275217705044992),  UINT64_C( 5081625958934144000)  },
      {  UINT64_C(  231407268129284864),  UINT64_C( 1174668535850460160)  },
      {  UINT64_C(17522447699125241856),  UINT64_C( 1324911946478663680)  } } },
    { {  UINT64_C(15418430532032768000),  UINT64_C( 2327311759404552704),  UINT64_C( 3584291740155686912),  UINT64_C( 8581611500293403648),
         UINT64_C(12145144056983136256),  UINT64_C( 3729746299359272960),  UINT64_C(12053117506648639488),  UINT64_C(10424225148697991168) },
    { {  UINT64_C(15418430532032768000),  UINT64_C( 2327311759404552704)  },
      {  UINT64_C( 3584291740155686912),  UINT64_C( 8581611500293403648)  },
      {  UINT64_C(12145144056983136256),  UINT64_C( 3729746299359272960)  },
      {  UINT64_C(12053117506648639488),  UINT64_C(10424225148697991168)  } } },
    { {  UINT64_C( 1651450853129206272),  UINT64_C(16341763446066487296),  UINT64_C(13044680224269965312),  UINT64_C( 4124398320380595712),
         UINT64_C(13534054801995773952),  UINT64_C(  916711590638048896),  UINT64_C(16705291349055799296),  UINT64_C( 6443038053583837184) },
    { {  UINT64_C( 1651450853129206272),  UINT64_C(16341763446066487296)  },
      {  UINT64_C(13044680224269965312),  UINT64_C( 4124398320380595712)  },
      {  UINT64_C(13534054801995773952),  UINT64_C(  916711590638048896)  },
      {  UINT64_C(16705291349055799296),  UINT64_C( 6443038053583837184)  } } },
    { {  UINT64_C( 7935729934559820800),  UINT64_C(11814025298976110592),  UINT64_C(12020925996906377216),  UINT64_C( 2528350986698477056),
         UINT64_C(17232887307707269120),  UINT64_C(15608656846327992320),  UINT64_C( 6223780687902315520),  UINT64_C( 5812876555485938688) },
    { {  UINT64_C( 7935729934559820800),  UINT64_C(11814025298976110592)  },
      {  UINT64_C(12020925996906377216),  UINT64_C( 2528350986698477056)  },
      {  UINT64_C(17232887307707269120),  UINT64_C(15608656846327992320)  },
      {  UINT64_C( 6223780687902315520),  UINT64_C( 5812876555485938688)  } } },
  };
