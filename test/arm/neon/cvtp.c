...
test_simde_vcvtph_u64_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    {    SIMDE_FLOAT16_VALUE(     9.136),
         UINT64_C(        10) },
    {   SIMDE_FLOAT16_VALUE( -10.194),
         UINT64_C(         0) },
    {   SIMDE_FLOAT16_VALUE( -24.774),
         UINT64_C(         0) },
    {   SIMDE_FLOAT16_VALUE( -14.346),
         UINT64_C(         0) },
    {   SIMDE_FLOAT16_VALUE( -10.756),
         UINT64_C(         0) },
    {    SIMDE_FLOAT16_VALUE(     8.945),
         UINT64_C(         9) },
    {    SIMDE_FLOAT16_VALUE(     4.916),
         UINT64_C(         5) },
    {   SIMDE_FLOAT16_VALUE( -4.343),
         UINT64_C(         0) },
  };
  ...
  static const struct {
    ...
    uint32_t r;
      ...
      { SIMDE_FLOAT16_VALUE(-1000.0),
        UINT32_C(         0) },
    #endif
    {   SIMDE_FLOAT16_VALUE( -27.684),
         UINT32_C(         0) },
    {   SIMDE_FLOAT16_VALUE( -26.915),
         UINT32_C(         0) },
    {    SIMDE_FLOAT16_VALUE(    14.954),
         UINT32_C(        15) },
    {   SIMDE_FLOAT16_VALUE( -27.780),
         UINT32_C(         0) },
    {   SIMDE_FLOAT16_VALUE( -5.217),
         UINT32_C(         0) },
    {    SIMDE_FLOAT16_VALUE(    17.106),
         UINT32_C(        18) },
    {   SIMDE_FLOAT16_VALUE( -20.283),
         UINT32_C(         0) },
    {   SIMDE_FLOAT16_VALUE( -21.315),
         UINT32_C(         0) },
  };
...
test_simde_vcvtph_u16_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    {    SIMDE_FLOAT16_VALUE(     2.456),
         UINT16_C(         3) },
    {   SIMDE_FLOAT16_VALUE( -2.731),
         UINT16_C(         0) },
    {    SIMDE_FLOAT16_VALUE(    25.255),
         UINT16_C(        26) },
    {   SIMDE_FLOAT16_VALUE( -26.507),
         UINT16_C(         0) },
...
test_simde_vcvtpq_u16_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { {  SIMDE_FLOAT16_VALUE(     8.412), SIMDE_FLOAT16_VALUE( -20.676),  SIMDE_FLOAT16_VALUE(    20.459), SIMDE_FLOAT16_VALUE( -13.452),
        SIMDE_FLOAT16_VALUE( -29.146), SIMDE_FLOAT16_VALUE( -14.819),  SIMDE_FLOAT16_VALUE(    20.802), SIMDE_FLOAT16_VALUE( -24.492) },
      {  UINT16_C(         9),  UINT16_C(         0),  UINT16_C(        21),  UINT16_C(         0),
         UINT16_C(         0),  UINT16_C(         0),  UINT16_C(        21),  UINT16_C(         0) } },
    { { SIMDE_FLOAT16_VALUE( -2.614), SIMDE_FLOAT16_VALUE( -15.601),  SIMDE_FLOAT16_VALUE(     8.786), SIMDE_FLOAT16_VALUE( -6.447),
         SIMDE_FLOAT16_VALUE(    10.565), SIMDE_FLOAT16_VALUE( -2.841), SIMDE_FLOAT16_VALUE( -22.172), SIMDE_FLOAT16_VALUE( -29.225) },
      {  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(         9),  UINT16_C(         0),
         UINT16_C(        11),  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(         0) } },
    { { SIMDE_FLOAT16_VALUE( -14.661), SIMDE_FLOAT16_VALUE( -19.655),  SIMDE_FLOAT16_VALUE(    20.945), SIMDE_FLOAT16_VALUE( -14.723),
        SIMDE_FLOAT16_VALUE( -6.795), SIMDE_FLOAT16_VALUE( -15.668), SIMDE_FLOAT16_VALUE( -14.611), SIMDE_FLOAT16_VALUE( -1.305) },
      {  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(        21),  UINT16_C(         0),
         UINT16_C(         0),  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(         0) } },
    { {  SIMDE_FLOAT16_VALUE(    19.446), SIMDE_FLOAT16_VALUE( -4.649),  SIMDE_FLOAT16_VALUE(    15.291),  SIMDE_FLOAT16_VALUE(    27.089),
         SIMDE_FLOAT16_VALUE(    21.245),  SIMDE_FLOAT16_VALUE(    26.014), SIMDE_FLOAT16_VALUE( -26.170), SIMDE_FLOAT16_VALUE( -5.297) },
      {  UINT16_C(        20),  UINT16_C(         0),  UINT16_C(        16),  UINT16_C(        28),
         UINT16_C(        22),  UINT16_C(        27),  UINT16_C(         0),  UINT16_C(         0) } },
    { { SIMDE_FLOAT16_VALUE( -24.950), SIMDE_FLOAT16_VALUE( -6.918),  SIMDE_FLOAT16_VALUE(     0.448), SIMDE_FLOAT16_VALUE( -15.577),
        SIMDE_FLOAT16_VALUE( -0.695),  SIMDE_FLOAT16_VALUE(     5.113),  SIMDE_FLOAT16_VALUE(    25.849),  SIMDE_FLOAT16_VALUE(    14.897) },
      {  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(         1),  UINT16_C(         0),
         UINT16_C(         0),  UINT16_C(         6),  UINT16_C(        26),  UINT16_C(        15) } },
    { {  SIMDE_FLOAT16_VALUE(     1.047),  SIMDE_FLOAT16_VALUE(    24.092), SIMDE_FLOAT16_VALUE( -1.801), SIMDE_FLOAT16_VALUE( -17.346),
         SIMDE_FLOAT16_VALUE(    29.217), SIMDE_FLOAT16_VALUE( -9.152),  SIMDE_FLOAT16_VALUE(    28.523), SIMDE_FLOAT16_VALUE( -4.282) },
      {  UINT16_C(         2),  UINT16_C(        25),  UINT16_C(         0),  UINT16_C(         0),
         UINT16_C(        30),  UINT16_C(         0),  UINT16_C(        29),  UINT16_C(         0) } },
    { {  SIMDE_FLOAT16_VALUE(     4.652),  SIMDE_FLOAT16_VALUE(     7.864), SIMDE_FLOAT16_VALUE( -17.356), SIMDE_FLOAT16_VALUE( -28.063),
         SIMDE_FLOAT16_VALUE(     6.314),  SIMDE_FLOAT16_VALUE(     6.172),  SIMDE_FLOAT16_VALUE(    26.258),  SIMDE_FLOAT16_VALUE(     9.995) },
      {  UINT16_C(         5),  UINT16_C(         8),  UINT16_C(         0),  UINT16_C(         0),
         UINT16_C(         7),  UINT16_C(         7),  UINT16_C(        27),  UINT16_C(        10) } },
    { {  SIMDE_FLOAT16_VALUE(    18.260), SIMDE_FLOAT16_VALUE( -10.321),  SIMDE_FLOAT16_VALUE(    22.847), SIMDE_FLOAT16_VALUE( -0.938),
        SIMDE_FLOAT16_VALUE( -14.103), SIMDE_FLOAT16_VALUE( -19.351), SIMDE_FLOAT16_VALUE( -14.925),  SIMDE_FLOAT16_VALUE(     9.615) },
...
test_simde_vcvtp_u16_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { SIMDE_FLOAT16_VALUE( -28.193), SIMDE_FLOAT16_VALUE( -5.895), SIMDE_FLOAT16_VALUE( -19.920),  SIMDE_FLOAT16_VALUE(     6.564) },
      {  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(         7) } },
    { {  SIMDE_FLOAT16_VALUE(     0.585), SIMDE_FLOAT16_VALUE( -6.201), SIMDE_FLOAT16_VALUE( -22.634),  SIMDE_FLOAT16_VALUE(    24.041) },
      {  UINT16_C(         1),  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(        25) } },
    { {  SIMDE_FLOAT16_VALUE(     4.740),  SIMDE_FLOAT16_VALUE(    23.654),  SIMDE_FLOAT16_VALUE(    11.130), SIMDE_FLOAT16_VALUE( -5.253) },
      {  UINT16_C(         5),  UINT16_C(        24),  UINT16_C(        12),  UINT16_C(         0) } },
    { {  SIMDE_FLOAT16_VALUE(     1.349),  SIMDE_FLOAT16_VALUE(     2.498),  SIMDE_FLOAT16_VALUE(    13.681), SIMDE_FLOAT16_VALUE( -29.260) },
      {  UINT16_C(         2),  UINT16_C(         3),  UINT16_C(        14),  UINT16_C(         0) } },
    { { SIMDE_FLOAT16_VALUE( -23.131), SIMDE_FLOAT16_VALUE( -13.650), SIMDE_FLOAT16_VALUE( -17.659), SIMDE_FLOAT16_VALUE( -13.515) },
      {  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(         0),  UINT16_C(         0) } },
    { {  SIMDE_FLOAT16_VALUE(     8.833), SIMDE_FLOAT16_VALUE( -2.183),  SIMDE_FLOAT16_VALUE(    18.027), SIMDE_FLOAT16_VALUE( -17.240) },
      {  UINT16_C(         9),  UINT16_C(         0),  UINT16_C(        19),  UINT16_C(         0) } },
    { {  SIMDE_FLOAT16_VALUE(    10.889), SIMDE_FLOAT16_VALUE( -11.836),  SIMDE_FLOAT16_VALUE(    29.920), SIMDE_FLOAT16_VALUE( -7.524) },
      {  UINT16_C(        11),  UINT16_C(         0),  UINT16_C(        30),  UINT16_C(         0) } },
    { { SIMDE_FLOAT16_VALUE( -29.853),  SIMDE_FLOAT16_VALUE(    19.538),  SIMDE_FLOAT16_VALUE(    25.232),  SIMDE_FLOAT16_VALUE(    12.122) },
