...
test_simde_vminv_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {            SIMDE_MATH_NANF, SIMDE_FLOAT32_C(   534.24), SIMDE_FLOAT32_C(  -385.00),            SIMDE_MATH_NANF },
                 SIMDE_MATH_NANF },
    #endif
    { {  SIMDE_FLOAT16_C(    26.103), -SIMDE_FLOAT16_C(    29.074), -SIMDE_FLOAT16_C(     9.550), -SIMDE_FLOAT16_C(    11.583) },
        -SIMDE_FLOAT16_C(    29.074) },
    { {  SIMDE_FLOAT16_C(     3.922),  SIMDE_FLOAT16_C(     3.525),  SIMDE_FLOAT16_C(    29.159), -SIMDE_FLOAT16_C(    12.263) },
        -SIMDE_FLOAT16_C(    12.263) },
    { {  SIMDE_FLOAT16_C(    27.707),  SIMDE_FLOAT16_C(     5.731), -SIMDE_FLOAT16_C(     2.397),  SIMDE_FLOAT16_C(    16.716) },
        -SIMDE_FLOAT16_C(     2.397) },
    { { -SIMDE_FLOAT16_C(    25.607),  SIMDE_FLOAT16_C(    16.223),  SIMDE_FLOAT16_C(     1.569), -SIMDE_FLOAT16_C(    24.663) },
        -SIMDE_FLOAT16_C(    25.607) },
    { { -SIMDE_FLOAT16_C(     4.989), -SIMDE_FLOAT16_C(    15.567), -SIMDE_FLOAT16_C(    20.471),  SIMDE_FLOAT16_C(    19.764) },
        -SIMDE_FLOAT16_C(    20.471) },
    { {  SIMDE_FLOAT16_C(     3.673),  SIMDE_FLOAT16_C(     8.357), -SIMDE_FLOAT16_C(    27.243), -SIMDE_FLOAT16_C(     5.935) },
        -SIMDE_FLOAT16_C(    27.243) },
    { { -SIMDE_FLOAT16_C(    22.371), -SIMDE_FLOAT16_C(    26.752),  SIMDE_FLOAT16_C(     2.042), -SIMDE_FLOAT16_C(     4.293) },
        -SIMDE_FLOAT16_C(    26.752) },
    { {  SIMDE_FLOAT16_C(    21.702), -SIMDE_FLOAT16_C(     4.233),  SIMDE_FLOAT16_C(    18.232),  SIMDE_FLOAT16_C(    17.454) },
        -SIMDE_FLOAT16_C(     4.233) },
  };
...
test_simde_vminvq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { -SIMDE_FLOAT16_C(     7.802), -SIMDE_FLOAT16_C(    14.636), -SIMDE_FLOAT16_C(    19.173), -SIMDE_FLOAT16_C(     6.257),
         SIMDE_FLOAT16_C(    21.795),  SIMDE_FLOAT16_C(     2.253),  SIMDE_FLOAT16_C(    18.110),  SIMDE_FLOAT16_C(    24.278) },
        -SIMDE_FLOAT16_C(    19.173) },
    { {  SIMDE_FLOAT16_C(    10.986), -SIMDE_FLOAT16_C(    27.164), -SIMDE_FLOAT16_C(     2.224), -SIMDE_FLOAT16_C(    12.372),
         SIMDE_FLOAT16_C(    12.401),  SIMDE_FLOAT16_C(    26.015), -SIMDE_FLOAT16_C(    12.175), -SIMDE_FLOAT16_C(    13.037) },
        -SIMDE_FLOAT16_C(    27.164) },
    { { -SIMDE_FLOAT16_C(     8.697),  SIMDE_FLOAT16_C(    25.921), -SIMDE_FLOAT16_C(     1.831), -SIMDE_FLOAT16_C(    15.758),
        -SIMDE_FLOAT16_C(     8.006), -SIMDE_FLOAT16_C(     8.784),  SIMDE_FLOAT16_C(    24.917), -SIMDE_FLOAT16_C(    27.220) },
        -SIMDE_FLOAT16_C(    27.220) },
    { { -SIMDE_FLOAT16_C(    27.111),  SIMDE_FLOAT16_C(     4.677), -SIMDE_FLOAT16_C(    22.995), -SIMDE_FLOAT16_C(     9.014),
         SIMDE_FLOAT16_C(    10.078),  SIMDE_FLOAT16_C(    23.163), -SIMDE_FLOAT16_C(     8.547),  SIMDE_FLOAT16_C(    13.946) },
        -SIMDE_FLOAT16_C(    27.111) },
    { { -SIMDE_FLOAT16_C(    21.544), -SIMDE_FLOAT16_C(    15.795), -SIMDE_FLOAT16_C(    27.216),  SIMDE_FLOAT16_C(     9.338),
         SIMDE_FLOAT16_C(    19.959), -SIMDE_FLOAT16_C(    21.015),  SIMDE_FLOAT16_C(    20.228), -SIMDE_FLOAT16_C(     1.016) },
        -SIMDE_FLOAT16_C(    27.216) },
    { {  SIMDE_FLOAT16_C(     5.321),  SIMDE_FLOAT16_C(     8.278),  SIMDE_FLOAT16_C(    18.787),  SIMDE_FLOAT16_C(    18.709),
         SIMDE_FLOAT16_C(    21.395),  SIMDE_FLOAT16_C(    10.903),  SIMDE_FLOAT16_C(    21.233), -SIMDE_FLOAT16_C(    20.705) },
        -SIMDE_FLOAT16_C(    20.705) },
    { {  SIMDE_FLOAT16_C(    20.160),  SIMDE_FLOAT16_C(     8.412), -SIMDE_FLOAT16_C(    11.280), -SIMDE_FLOAT16_C(     7.804),
         SIMDE_FLOAT16_C(    28.085),  SIMDE_FLOAT16_C(    11.409),  SIMDE_FLOAT16_C(     2.788), -SIMDE_FLOAT16_C(    16.372) },
        -SIMDE_FLOAT16_C(    16.372) },
    { { -SIMDE_FLOAT16_C(    25.223),  SIMDE_FLOAT16_C(     6.338),  SIMDE_FLOAT16_C(    28.329),  SIMDE_FLOAT16_C(    18.799),
         SIMDE_FLOAT16_C(     7.252), -SIMDE_FLOAT16_C(     0.266), -SIMDE_FLOAT16_C(    17.624),  SIMDE_FLOAT16_C(    28.093) },
        -SIMDE_FLOAT16_C(    25.223) },
  };
