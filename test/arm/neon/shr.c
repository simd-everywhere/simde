#define SIMDE_TEST_ARM_NEON_INSN shr

#include <test/arm/neon/test-neon.h>
#include <simde/arm/neon/shr.h>

static int
test_simde_vshr_n_s8 (void) {
  struct {
    int8_t a[8];
    int8_t r1[8];
    int8_t r3[8];
