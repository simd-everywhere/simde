...
test_simde_vqdmlsl_s16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    int32_t r[4];
     ...
     { {   INT32_C(  INT32_MAX),  INT32_C(  INT32_MIN),  INT32_C(          0),  INT32_C(   36300877) },
       {   INT16_C(          1),  INT16_C(          1),  INT16_C(  INT16_MIN),  INT16_C(       8600) },
       {  -INT16_C(          1),  INT16_C(          1),  INT16_C(  INT16_MIN), -INT16_C(       6795) },
       {   INT32_C(  INT32_MAX),  INT32_C(  INT32_MIN),  INT32_C(INT32_MIN+1),  INT32_C(  153174877) } },
  };
