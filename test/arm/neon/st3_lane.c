...
test_simde_vst3_lane_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { -SIMDE_FLOAT16_C( 94.290), -SIMDE_FLOAT16_C( 50.509),  SIMDE_FLOAT16_C( 23.704) },
    { { -SIMDE_FLOAT16_C(  0.571), -SIMDE_FLOAT16_C( 94.290),  SIMDE_FLOAT16_C( 93.093),  SIMDE_FLOAT16_C( 89.891)  },
      { -SIMDE_FLOAT16_C( 59.956), -SIMDE_FLOAT16_C( 50.509),  SIMDE_FLOAT16_C( 35.194),  SIMDE_FLOAT16_C( 22.787)  },
      { -SIMDE_FLOAT16_C( 24.560),  SIMDE_FLOAT16_C( 23.704), -SIMDE_FLOAT16_C( 11.110), -SIMDE_FLOAT16_C( 19.691)  } },
         INT8_C(      1) },
    { { -SIMDE_FLOAT16_C(  6.814), -SIMDE_FLOAT16_C( 31.127), -SIMDE_FLOAT16_C( 34.824) },
    { { -SIMDE_FLOAT16_C( 17.965), -SIMDE_FLOAT16_C(  6.814), -SIMDE_FLOAT16_C( 65.421),  SIMDE_FLOAT16_C( 26.500)  },
      {  SIMDE_FLOAT16_C( 84.515), -SIMDE_FLOAT16_C( 31.127),  SIMDE_FLOAT16_C( 85.025), -SIMDE_FLOAT16_C( 51.272)  },
      { -SIMDE_FLOAT16_C( 38.529), -SIMDE_FLOAT16_C( 34.824), -SIMDE_FLOAT16_C( 81.647),  SIMDE_FLOAT16_C( 47.194)  } },
         INT8_C(      1) },
    { { -SIMDE_FLOAT16_C( 73.789), -SIMDE_FLOAT16_C(  3.383), -SIMDE_FLOAT16_C( 13.801) },
    { { -SIMDE_FLOAT16_C( 94.005), -SIMDE_FLOAT16_C( 35.738), -SIMDE_FLOAT16_C( 73.789), -SIMDE_FLOAT16_C( 45.230)  },
      {  SIMDE_FLOAT16_C( 12.330),  SIMDE_FLOAT16_C( 74.051), -SIMDE_FLOAT16_C(  3.383), -SIMDE_FLOAT16_C( 10.054)  },
      { -SIMDE_FLOAT16_C( 64.841),  SIMDE_FLOAT16_C(  8.563), -SIMDE_FLOAT16_C( 13.801),  SIMDE_FLOAT16_C( 10.504)  } },
         INT8_C(      2) },
    { {  SIMDE_FLOAT16_C(  0.435),  SIMDE_FLOAT16_C( 62.466),  SIMDE_FLOAT16_C( 94.721) },
    { {  SIMDE_FLOAT16_C(  0.435), -SIMDE_FLOAT16_C( 13.638),  SIMDE_FLOAT16_C(  0.530), -SIMDE_FLOAT16_C( 61.496)  },
      {  SIMDE_FLOAT16_C( 62.466),  SIMDE_FLOAT16_C( 24.828),  SIMDE_FLOAT16_C(  9.968), -SIMDE_FLOAT16_C( 50.721)  },
      {  SIMDE_FLOAT16_C( 94.721),  SIMDE_FLOAT16_C( 44.136),  SIMDE_FLOAT16_C( 78.905), -SIMDE_FLOAT16_C( 55.458)  } },
         INT8_C(      0) },
    { { -SIMDE_FLOAT16_C( 22.144),  SIMDE_FLOAT16_C( 90.977), -SIMDE_FLOAT16_C(  5.890) },
    { {  SIMDE_FLOAT16_C( 26.172), -SIMDE_FLOAT16_C( 89.305), -SIMDE_FLOAT16_C( 59.818), -SIMDE_FLOAT16_C( 22.144)  },
      { -SIMDE_FLOAT16_C( 44.719), -SIMDE_FLOAT16_C( 60.282),  SIMDE_FLOAT16_C( 94.935),  SIMDE_FLOAT16_C( 90.977)  },
      {  SIMDE_FLOAT16_C( 80.867), -SIMDE_FLOAT16_C( 45.339), -SIMDE_FLOAT16_C( 19.747), -SIMDE_FLOAT16_C(  5.890)  } },
         INT8_C(      3) },
    { {  SIMDE_FLOAT16_C( 23.224),  SIMDE_FLOAT16_C( 49.585),  SIMDE_FLOAT16_C( 78.018) },
    { { -SIMDE_FLOAT16_C( 48.686),  SIMDE_FLOAT16_C( 23.224),  SIMDE_FLOAT16_C( 40.332),  SIMDE_FLOAT16_C( 74.959)  },
      { -SIMDE_FLOAT16_C( 65.641),  SIMDE_FLOAT16_C( 49.585),  SIMDE_FLOAT16_C(  6.886),  SIMDE_FLOAT16_C( 98.862)  },
      { -SIMDE_FLOAT16_C( 29.125),  SIMDE_FLOAT16_C( 78.018), -SIMDE_FLOAT16_C(  4.487),  SIMDE_FLOAT16_C( 50.278)  } },
         INT8_C(      1) },
    { { -SIMDE_FLOAT16_C( 90.627), -SIMDE_FLOAT16_C(  1.372), -SIMDE_FLOAT16_C( 87.387) },
    { { -SIMDE_FLOAT16_C( 58.435),  SIMDE_FLOAT16_C( 67.021), -SIMDE_FLOAT16_C( 90.627),  SIMDE_FLOAT16_C( 69.960)  },
      {  SIMDE_FLOAT16_C( 62.852),  SIMDE_FLOAT16_C( 29.780), -SIMDE_FLOAT16_C(  1.372),  SIMDE_FLOAT16_C( 41.058)  },
      {  SIMDE_FLOAT16_C( 43.350), -SIMDE_FLOAT16_C( 69.931), -SIMDE_FLOAT16_C( 87.387),  SIMDE_FLOAT16_C( 98.569)  } },
         INT8_C(      2) },
    { {  SIMDE_FLOAT16_C( 33.021),  SIMDE_FLOAT16_C( 22.025),  SIMDE_FLOAT16_C( 69.528) },
    { {  SIMDE_FLOAT16_C( 40.864),  SIMDE_FLOAT16_C( 81.943), -SIMDE_FLOAT16_C( 40.609),  SIMDE_FLOAT16_C( 33.021)  },
      {  SIMDE_FLOAT16_C( 93.909),  SIMDE_FLOAT16_C( 69.201),  SIMDE_FLOAT16_C( 43.541),  SIMDE_FLOAT16_C( 22.025)  },
      {  SIMDE_FLOAT16_C( 45.748), -SIMDE_FLOAT16_C( 89.541),  SIMDE_FLOAT16_C( 49.879),  SIMDE_FLOAT16_C( 69.528)  } },
         INT8_C(      3) },
  };
...
test_simde_vst3q_lane_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {  SIMDE_FLOAT16_C( 56.833),  SIMDE_FLOAT16_C( 73.442), -SIMDE_FLOAT16_C( 22.618) },
    { {  SIMDE_FLOAT16_C( 90.228),  SIMDE_FLOAT16_C(  1.415), -SIMDE_FLOAT16_C( 54.694),  SIMDE_FLOAT16_C( 41.258),
         SIMDE_FLOAT16_C( 74.577),  SIMDE_FLOAT16_C( 13.483),  SIMDE_FLOAT16_C( 56.833),  SIMDE_FLOAT16_C( 68.200)  },
      { -SIMDE_FLOAT16_C( 65.650), -SIMDE_FLOAT16_C( 68.388), -SIMDE_FLOAT16_C( 13.278), -SIMDE_FLOAT16_C( 65.890),
         SIMDE_FLOAT16_C( 16.926), -SIMDE_FLOAT16_C( 26.315),  SIMDE_FLOAT16_C( 73.442),  SIMDE_FLOAT16_C( 26.641)  },
      { -SIMDE_FLOAT16_C( 42.649),  SIMDE_FLOAT16_C( 80.336),  SIMDE_FLOAT16_C( 27.756),  SIMDE_FLOAT16_C(  8.267),
         SIMDE_FLOAT16_C( 24.942),  SIMDE_FLOAT16_C( 96.066), -SIMDE_FLOAT16_C( 22.618), -SIMDE_FLOAT16_C( 58.346)  } },
         INT8_C(      6) },
    { { -SIMDE_FLOAT16_C( 74.185), -SIMDE_FLOAT16_C( 78.069), -SIMDE_FLOAT16_C( 86.364) },
    { { -SIMDE_FLOAT16_C( 69.189), -SIMDE_FLOAT16_C( 74.185),  SIMDE_FLOAT16_C(  5.043), -SIMDE_FLOAT16_C( 18.088),
         SIMDE_FLOAT16_C( 14.723),  SIMDE_FLOAT16_C(  9.202),  SIMDE_FLOAT16_C( 78.389), -SIMDE_FLOAT16_C( 87.305)  },
      { -SIMDE_FLOAT16_C( 12.507), -SIMDE_FLOAT16_C( 78.069), -SIMDE_FLOAT16_C( 96.953), -SIMDE_FLOAT16_C( 96.401),
         SIMDE_FLOAT16_C( 42.165),  SIMDE_FLOAT16_C( 75.353), -SIMDE_FLOAT16_C( 82.128),  SIMDE_FLOAT16_C( 17.448)  },
      {  SIMDE_FLOAT16_C( 57.653), -SIMDE_FLOAT16_C( 86.364),  SIMDE_FLOAT16_C( 30.786), -SIMDE_FLOAT16_C( 50.101),
         SIMDE_FLOAT16_C( 60.669), -SIMDE_FLOAT16_C( 26.173),  SIMDE_FLOAT16_C( 10.148), -SIMDE_FLOAT16_C( 92.619)  } },
         INT8_C(      1) },
    { { -SIMDE_FLOAT16_C( 30.210), -SIMDE_FLOAT16_C( 13.667), -SIMDE_FLOAT16_C( 47.603) },
    { { -SIMDE_FLOAT16_C( 96.908), -SIMDE_FLOAT16_C( 14.691),  SIMDE_FLOAT16_C( 67.605),  SIMDE_FLOAT16_C( 52.785),
         SIMDE_FLOAT16_C( 10.770),  SIMDE_FLOAT16_C( 49.923),  SIMDE_FLOAT16_C( 79.174), -SIMDE_FLOAT16_C( 30.210)  },
      { -SIMDE_FLOAT16_C( 86.230), -SIMDE_FLOAT16_C( 40.180),  SIMDE_FLOAT16_C( 81.322), -SIMDE_FLOAT16_C(  4.303),
        -SIMDE_FLOAT16_C( 25.810),  SIMDE_FLOAT16_C( 19.169), -SIMDE_FLOAT16_C(  7.542), -SIMDE_FLOAT16_C( 13.667)  },
      {  SIMDE_FLOAT16_C( 48.690), -SIMDE_FLOAT16_C( 84.400), -SIMDE_FLOAT16_C( 42.388), -SIMDE_FLOAT16_C( 71.989),
         SIMDE_FLOAT16_C( 81.668),  SIMDE_FLOAT16_C( 61.074),  SIMDE_FLOAT16_C( 68.365), -SIMDE_FLOAT16_C( 47.603)  } },
         INT8_C(      7) },
    { { -SIMDE_FLOAT16_C( 74.022),  SIMDE_FLOAT16_C( 72.818),  SIMDE_FLOAT16_C( 75.403) },
    { {  SIMDE_FLOAT16_C( 65.684),  SIMDE_FLOAT16_C( 92.561), -SIMDE_FLOAT16_C( 76.038),  SIMDE_FLOAT16_C( 75.659),
        -SIMDE_FLOAT16_C( 74.022),  SIMDE_FLOAT16_C( 74.037), -SIMDE_FLOAT16_C( 67.037),  SIMDE_FLOAT16_C( 61.026)  },
      {  SIMDE_FLOAT16_C( 43.862), -SIMDE_FLOAT16_C( 42.260), -SIMDE_FLOAT16_C(  8.530),  SIMDE_FLOAT16_C( 15.388),
         SIMDE_FLOAT16_C( 72.818), -SIMDE_FLOAT16_C(  3.493),  SIMDE_FLOAT16_C( 29.692),  SIMDE_FLOAT16_C( 78.968)  },
      { -SIMDE_FLOAT16_C( 91.120),  SIMDE_FLOAT16_C( 22.041), -SIMDE_FLOAT16_C( 61.013), -SIMDE_FLOAT16_C( 71.187),
         SIMDE_FLOAT16_C( 75.403),  SIMDE_FLOAT16_C( 95.292),  SIMDE_FLOAT16_C( 21.707), -SIMDE_FLOAT16_C( 88.034)  } },
         INT8_C(      4) },
    { {  SIMDE_FLOAT16_C( 66.250),  SIMDE_FLOAT16_C( 86.996), -SIMDE_FLOAT16_C( 40.809) },
    { {  SIMDE_FLOAT16_C( 56.098), -SIMDE_FLOAT16_C( 69.469), -SIMDE_FLOAT16_C( 38.141),  SIMDE_FLOAT16_C( 95.730),
         SIMDE_FLOAT16_C( 66.250),  SIMDE_FLOAT16_C( 88.246), -SIMDE_FLOAT16_C( 73.861),  SIMDE_FLOAT16_C( 88.929)  },
      {  SIMDE_FLOAT16_C( 91.342),  SIMDE_FLOAT16_C( 25.976),  SIMDE_FLOAT16_C( 27.770),  SIMDE_FLOAT16_C( 57.030),
         SIMDE_FLOAT16_C( 86.996),  SIMDE_FLOAT16_C( 24.429),  SIMDE_FLOAT16_C( 36.571),  SIMDE_FLOAT16_C( 25.024)  },
      { -SIMDE_FLOAT16_C( 51.937),  SIMDE_FLOAT16_C(  0.024),  SIMDE_FLOAT16_C( 26.121),  SIMDE_FLOAT16_C( 82.133),
        -SIMDE_FLOAT16_C( 40.809), -SIMDE_FLOAT16_C( 89.179), -SIMDE_FLOAT16_C( 45.771), -SIMDE_FLOAT16_C( 76.817)  } },
         INT8_C(      4) },
    { {  SIMDE_FLOAT16_C( 41.869), -SIMDE_FLOAT16_C( 27.827), -SIMDE_FLOAT16_C( 92.856) },
    { { -SIMDE_FLOAT16_C( 35.175),  SIMDE_FLOAT16_C( 47.619),  SIMDE_FLOAT16_C( 41.869),  SIMDE_FLOAT16_C( 17.848),
        -SIMDE_FLOAT16_C( 56.188), -SIMDE_FLOAT16_C( 50.409),  SIMDE_FLOAT16_C( 65.876), -SIMDE_FLOAT16_C( 32.688)  },
      {  SIMDE_FLOAT16_C(  3.311), -SIMDE_FLOAT16_C( 49.604), -SIMDE_FLOAT16_C( 27.827), -SIMDE_FLOAT16_C(  2.760),
         SIMDE_FLOAT16_C( 20.012),  SIMDE_FLOAT16_C( 66.946),  SIMDE_FLOAT16_C( 31.788), -SIMDE_FLOAT16_C( 52.736)  },
      { -SIMDE_FLOAT16_C( 93.576),  SIMDE_FLOAT16_C(  4.057), -SIMDE_FLOAT16_C( 92.856),  SIMDE_FLOAT16_C( 68.167),
        -SIMDE_FLOAT16_C( 17.311), -SIMDE_FLOAT16_C( 69.405),  SIMDE_FLOAT16_C( 82.245), -SIMDE_FLOAT16_C(  7.897)  } },
         INT8_C(      2) },
    { {  SIMDE_FLOAT16_C( 84.635), -SIMDE_FLOAT16_C( 34.646), -SIMDE_FLOAT16_C( 57.874) },
    { {  SIMDE_FLOAT16_C( 81.549), -SIMDE_FLOAT16_C(  2.028),  SIMDE_FLOAT16_C( 84.635), -SIMDE_FLOAT16_C( 29.533),
        -SIMDE_FLOAT16_C( 38.208),  SIMDE_FLOAT16_C( 73.008),  SIMDE_FLOAT16_C( 35.951), -SIMDE_FLOAT16_C( 30.779)  },
      {  SIMDE_FLOAT16_C( 42.215), -SIMDE_FLOAT16_C( 27.247), -SIMDE_FLOAT16_C( 34.646), -SIMDE_FLOAT16_C(  1.564),
         SIMDE_FLOAT16_C( 71.796), -SIMDE_FLOAT16_C( 51.547),  SIMDE_FLOAT16_C( 32.523), -SIMDE_FLOAT16_C( 43.421)  },
      {  SIMDE_FLOAT16_C(  0.439),  SIMDE_FLOAT16_C( 13.866), -SIMDE_FLOAT16_C( 57.874), -SIMDE_FLOAT16_C( 87.206),
        -SIMDE_FLOAT16_C( 61.660),  SIMDE_FLOAT16_C( 80.530), -SIMDE_FLOAT16_C( 56.810), -SIMDE_FLOAT16_C( 20.126)  } },
         INT8_C(      2) },
    { { -SIMDE_FLOAT16_C( 78.288),  SIMDE_FLOAT16_C( 36.942),  SIMDE_FLOAT16_C( 21.455) },
    { { -SIMDE_FLOAT16_C(  1.116),  SIMDE_FLOAT16_C( 88.525), -SIMDE_FLOAT16_C( 54.747),  SIMDE_FLOAT16_C( 70.086),
        -SIMDE_FLOAT16_C(  0.981), -SIMDE_FLOAT16_C( 78.288), -SIMDE_FLOAT16_C( 64.328),  SIMDE_FLOAT16_C( 72.247)  },
      {  SIMDE_FLOAT16_C( 50.505),  SIMDE_FLOAT16_C( 62.460),  SIMDE_FLOAT16_C( 55.021),  SIMDE_FLOAT16_C( 63.023),
         SIMDE_FLOAT16_C( 46.784),  SIMDE_FLOAT16_C( 36.942), -SIMDE_FLOAT16_C( 96.105), -SIMDE_FLOAT16_C( 30.818)  },
      { -SIMDE_FLOAT16_C( 28.408), -SIMDE_FLOAT16_C( 39.921),  SIMDE_FLOAT16_C(  8.839), -SIMDE_FLOAT16_C( 70.832),
         SIMDE_FLOAT16_C( 33.768),  SIMDE_FLOAT16_C( 21.455), -SIMDE_FLOAT16_C( 89.062),  SIMDE_FLOAT16_C( 97.215)  } },
         INT8_C(      5) },
  };
