...
test_simde_vrev64_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { -SIMDE_FLOAT16_C( 73.456), -SIMDE_FLOAT16_C( 25.018),  SIMDE_FLOAT16_C( 37.020),  SIMDE_FLOAT16_C( 60.928) },
      {  SIMDE_FLOAT16_C( 60.928),  SIMDE_FLOAT16_C( 37.020), -SIMDE_FLOAT16_C( 25.018), -SIMDE_FLOAT16_C( 73.456) } },
    { { -SIMDE_FLOAT16_C( 53.291),  SIMDE_FLOAT16_C( 85.800), -SIMDE_FLOAT16_C( 72.734),  SIMDE_FLOAT16_C( 43.151) },
      {  SIMDE_FLOAT16_C( 43.151), -SIMDE_FLOAT16_C( 72.734),  SIMDE_FLOAT16_C( 85.800), -SIMDE_FLOAT16_C( 53.291) } },
    { { -SIMDE_FLOAT16_C( 40.886), -SIMDE_FLOAT16_C( 28.870),  SIMDE_FLOAT16_C( 14.218),  SIMDE_FLOAT16_C(  9.978) },
      {  SIMDE_FLOAT16_C(  9.978),  SIMDE_FLOAT16_C( 14.218), -SIMDE_FLOAT16_C( 28.870), -SIMDE_FLOAT16_C( 40.886) } },
    { {  SIMDE_FLOAT16_C( 70.008), -SIMDE_FLOAT16_C( 19.874), -SIMDE_FLOAT16_C( 54.506),  SIMDE_FLOAT16_C( 52.049) },
      {  SIMDE_FLOAT16_C( 52.049), -SIMDE_FLOAT16_C( 54.506), -SIMDE_FLOAT16_C( 19.874),  SIMDE_FLOAT16_C( 70.008) } },
    { {  SIMDE_FLOAT16_C( 66.107), -SIMDE_FLOAT16_C( 68.033),  SIMDE_FLOAT16_C( 26.334), -SIMDE_FLOAT16_C( 33.368) },
      { -SIMDE_FLOAT16_C( 33.368),  SIMDE_FLOAT16_C( 26.334), -SIMDE_FLOAT16_C( 68.033),  SIMDE_FLOAT16_C( 66.107) } },
    { {  SIMDE_FLOAT16_C( 20.783),  SIMDE_FLOAT16_C(  6.506),  SIMDE_FLOAT16_C( 94.787),  SIMDE_FLOAT16_C( 39.080) },
      {  SIMDE_FLOAT16_C( 39.080),  SIMDE_FLOAT16_C( 94.787),  SIMDE_FLOAT16_C(  6.506),  SIMDE_FLOAT16_C( 20.783) } },
    { { -SIMDE_FLOAT16_C( 85.876), -SIMDE_FLOAT16_C( 43.674),  SIMDE_FLOAT16_C( 80.017),  SIMDE_FLOAT16_C( 92.475) },
      {  SIMDE_FLOAT16_C( 92.475),  SIMDE_FLOAT16_C( 80.017), -SIMDE_FLOAT16_C( 43.674), -SIMDE_FLOAT16_C( 85.876) } },
    { { -SIMDE_FLOAT16_C( 43.483),  SIMDE_FLOAT16_C( 42.449),  SIMDE_FLOAT16_C( 78.227),  SIMDE_FLOAT16_C( 19.386) },
      {  SIMDE_FLOAT16_C( 19.386),  SIMDE_FLOAT16_C( 78.227),  SIMDE_FLOAT16_C( 42.449), -SIMDE_FLOAT16_C( 43.483) } },
  };
...
test_simde_vrev64q_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { {  SIMDE_FLOAT16_C( 22.973),  SIMDE_FLOAT16_C( 82.785), -SIMDE_FLOAT16_C( 87.788),  SIMDE_FLOAT16_C( 54.222),
        -SIMDE_FLOAT16_C( 79.878),  SIMDE_FLOAT16_C( 61.120), -SIMDE_FLOAT16_C(  1.496),  SIMDE_FLOAT16_C( 87.003) },
      {  SIMDE_FLOAT16_C( 54.222), -SIMDE_FLOAT16_C( 87.788),  SIMDE_FLOAT16_C( 82.785),  SIMDE_FLOAT16_C( 22.973),
         SIMDE_FLOAT16_C( 87.003), -SIMDE_FLOAT16_C(  1.496),  SIMDE_FLOAT16_C( 61.120), -SIMDE_FLOAT16_C( 79.878) } },
    { {  SIMDE_FLOAT16_C( 47.119), -SIMDE_FLOAT16_C(  0.580),  SIMDE_FLOAT16_C( 95.794), -SIMDE_FLOAT16_C( 97.960),
        -SIMDE_FLOAT16_C( 80.926), -SIMDE_FLOAT16_C( 97.842),  SIMDE_FLOAT16_C( 16.229),  SIMDE_FLOAT16_C( 73.027) },
      { -SIMDE_FLOAT16_C( 97.960),  SIMDE_FLOAT16_C( 95.794), -SIMDE_FLOAT16_C(  0.580),  SIMDE_FLOAT16_C( 47.119),
         SIMDE_FLOAT16_C( 73.027),  SIMDE_FLOAT16_C( 16.229), -SIMDE_FLOAT16_C( 97.842), -SIMDE_FLOAT16_C( 80.926) } },
    { {  SIMDE_FLOAT16_C( 75.505), -SIMDE_FLOAT16_C( 43.371),  SIMDE_FLOAT16_C( 75.338), -SIMDE_FLOAT16_C( 74.826),
         SIMDE_FLOAT16_C( 63.128),  SIMDE_FLOAT16_C( 68.089),  SIMDE_FLOAT16_C( 68.500), -SIMDE_FLOAT16_C( 98.789) },
      { -SIMDE_FLOAT16_C( 74.826),  SIMDE_FLOAT16_C( 75.338), -SIMDE_FLOAT16_C( 43.371),  SIMDE_FLOAT16_C( 75.505),
        -SIMDE_FLOAT16_C( 98.789),  SIMDE_FLOAT16_C( 68.500),  SIMDE_FLOAT16_C( 68.089),  SIMDE_FLOAT16_C( 63.128) } },
    { {  SIMDE_FLOAT16_C(  7.539),  SIMDE_FLOAT16_C(  5.867),  SIMDE_FLOAT16_C( 59.154), -SIMDE_FLOAT16_C( 32.053),
        -SIMDE_FLOAT16_C( 73.720),  SIMDE_FLOAT16_C( 35.809), -SIMDE_FLOAT16_C( 55.954),  SIMDE_FLOAT16_C( 35.526) },
      { -SIMDE_FLOAT16_C( 32.053),  SIMDE_FLOAT16_C( 59.154),  SIMDE_FLOAT16_C(  5.867),  SIMDE_FLOAT16_C(  7.539),
         SIMDE_FLOAT16_C( 35.526), -SIMDE_FLOAT16_C( 55.954),  SIMDE_FLOAT16_C( 35.809), -SIMDE_FLOAT16_C( 73.720) } },
    { { -SIMDE_FLOAT16_C( 39.271),  SIMDE_FLOAT16_C( 97.957),  SIMDE_FLOAT16_C( 84.789), -SIMDE_FLOAT16_C( 41.728),
         SIMDE_FLOAT16_C( 93.209), -SIMDE_FLOAT16_C( 50.250),  SIMDE_FLOAT16_C( 72.873), -SIMDE_FLOAT16_C( 13.690) },
      { -SIMDE_FLOAT16_C( 41.728),  SIMDE_FLOAT16_C( 84.789),  SIMDE_FLOAT16_C( 97.957), -SIMDE_FLOAT16_C( 39.271),
        -SIMDE_FLOAT16_C( 13.690),  SIMDE_FLOAT16_C( 72.873), -SIMDE_FLOAT16_C( 50.250),  SIMDE_FLOAT16_C( 93.209) } },
    { { -SIMDE_FLOAT16_C( 18.105), -SIMDE_FLOAT16_C( 27.704),  SIMDE_FLOAT16_C( 34.737), -SIMDE_FLOAT16_C( 86.956),
         SIMDE_FLOAT16_C( 49.374),  SIMDE_FLOAT16_C( 11.743), -SIMDE_FLOAT16_C( 98.777),  SIMDE_FLOAT16_C( 42.229) },
      { -SIMDE_FLOAT16_C( 86.956),  SIMDE_FLOAT16_C( 34.737), -SIMDE_FLOAT16_C( 27.704), -SIMDE_FLOAT16_C( 18.105),
         SIMDE_FLOAT16_C( 42.229), -SIMDE_FLOAT16_C( 98.777),  SIMDE_FLOAT16_C( 11.743),  SIMDE_FLOAT16_C( 49.374) } },
    { {  SIMDE_FLOAT16_C( 80.882),  SIMDE_FLOAT16_C( 87.435),  SIMDE_FLOAT16_C( 55.813), -SIMDE_FLOAT16_C( 68.226),
        -SIMDE_FLOAT16_C( 69.733),  SIMDE_FLOAT16_C( 94.941),  SIMDE_FLOAT16_C( 24.856),  SIMDE_FLOAT16_C( 44.375) },
      { -SIMDE_FLOAT16_C( 68.226),  SIMDE_FLOAT16_C( 55.813),  SIMDE_FLOAT16_C( 87.435),  SIMDE_FLOAT16_C( 80.882),
         SIMDE_FLOAT16_C( 44.375),  SIMDE_FLOAT16_C( 24.856),  SIMDE_FLOAT16_C( 94.941), -SIMDE_FLOAT16_C( 69.733) } },
    { {  SIMDE_FLOAT16_C( 48.888), -SIMDE_FLOAT16_C( 56.159),  SIMDE_FLOAT16_C(  7.183), -SIMDE_FLOAT16_C( 75.051),
         SIMDE_FLOAT16_C( 67.973),  SIMDE_FLOAT16_C( 13.410), -SIMDE_FLOAT16_C( 45.628),  SIMDE_FLOAT16_C( 45.377) },
      { -SIMDE_FLOAT16_C( 75.051),  SIMDE_FLOAT16_C(  7.183), -SIMDE_FLOAT16_C( 56.159),  SIMDE_FLOAT16_C( 48.888),
         SIMDE_FLOAT16_C( 45.377), -SIMDE_FLOAT16_C( 45.628),  SIMDE_FLOAT16_C( 13.410),  SIMDE_FLOAT16_C( 67.973) } },
  };
