...
test_simde_vld4_lane_s32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    {
        { {  INT32_C(   860582810),  INT32_C(   403891559) },
          { -INT32_C(   394960499), -INT32_C(  1723777445) },
          {  INT32_C(  1874418253), -INT32_C(   826114031) },
          {  INT32_C(  1324400973), -INT32_C(   751287496) } },
      {  INT32_C(   486966198),  INT32_C(           0),  INT32_C(  1063663797),  INT32_C(  1073734480) },
        { {  INT32_C(   860582810),  INT32_C(   486966198) },
          { -INT32_C(   394960499),  INT32_C(           0) },
          {  INT32_C(  1874418253),  INT32_C(  1063663797) },
          {  INT32_C(  1324400973),  INT32_C(  1073734480) } },
    },
    {
        { { -INT32_C(   164292504), -INT32_C(   706827399) },
          {  INT32_C(   913186793), -INT32_C(  1968822407) },
          { -INT32_C(   195467097),  INT32_C(  1648511274) },
          {  INT32_C(  1110801292),  INT32_C(  1734360062) } },
      { -INT32_C(   849504941),  INT32_C(           0),  INT32_C(  1063663797),  INT32_C(  1073734480) },
        { { -INT32_C(   164292504), -INT32_C(   849504941) },
          {  INT32_C(   913186793),  INT32_C(           0) },
          { -INT32_C(   195467097),  INT32_C(  1063663797) },
          {  INT32_C(  1110801292),  INT32_C(  1073734480) } },
    },
    {
        { {  INT32_C(   698497856), -INT32_C(   731901862) },
          { -INT32_C(   564263369), -INT32_C(  1731020946) },
          { -INT32_C(  1912924927), -INT32_C(  1898958704) },
          { -INT32_C(  1074450324),  INT32_C(   109859525) } },
      { -INT32_C(   399561075),  INT32_C(           0),  INT32_C(  1063663797),  INT32_C(  1073734480) },
        { {  INT32_C(   698497856), -INT32_C(   399561075) },
          { -INT32_C(   564263369),  INT32_C(           0) },
          { -INT32_C(  1912924927),  INT32_C(  1063663797) },
          { -INT32_C(  1074450324),  INT32_C(  1073734480) } },
    },
    {
        { {  INT32_C(  1975291710),  INT32_C(    72555157) },
          { -INT32_C(   744741166), -INT32_C(   882862277) },
          {  INT32_C(   878260424),  INT32_C(   653479776) },
          {  INT32_C(   791445665), -INT32_C(   317236306) } },
      { -INT32_C(  2141006869),  INT32_C(           0),  INT32_C(  1063663797),  INT32_C(  1073734480) },
        { {  INT32_C(  1975291710), -INT32_C(  2141006869) },
          { -INT32_C(   744741166),  INT32_C(           0) },
          {  INT32_C(   878260424),  INT32_C(  1063663797) },
          {  INT32_C(   791445665),  INT32_C(  1073734480) } },
    },
    {
        { { -INT32_C(  1081821459),  INT32_C(   395452892) },
          { -INT32_C(  2132610120), -INT32_C(  2068563165) },
          {  INT32_C(   749381770), -INT32_C(   698624472) },
          {  INT32_C(   482570801),  INT32_C(   849159749) } },
      { -INT32_C(  1192091172),  INT32_C(           0),  INT32_C(  1063663797),  INT32_C(  1073734480) },
        { { -INT32_C(  1081821459), -INT32_C(  1192091172) },
          { -INT32_C(  2132610120),  INT32_C(           0) },
          {  INT32_C(   749381770),  INT32_C(  1063663797) },
          {  INT32_C(   482570801),  INT32_C(  1073734480) } },
    },
    {
        { { -INT32_C(    70286270), -INT32_C(  1686392457) },
          {  INT32_C(  1998532844),  INT32_C(    10734040) },
          { -INT32_C(   791216481), -INT32_C(  1242719632) },
          { -INT32_C(  1662547264), -INT32_C(   296429141) } },
      { -INT32_C(   706141346),  INT32_C(           0),  INT32_C(  1063663797),  INT32_C(  1073734480) },
        { { -INT32_C(    70286270), -INT32_C(   706141346) },
          {  INT32_C(  1998532844),  INT32_C(           0) },
          { -INT32_C(   791216481),  INT32_C(  1063663797) },
          { -INT32_C(  1662547264),  INT32_C(  1073734480) } },
    },
  };
...
test_simde_vld4_lane_u32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    {
        { { UINT32_C(3837699916), UINT32_C(3401205490) },
          { UINT32_C( 335447625), UINT32_C(2454934108) },
          { UINT32_C( 140300021), UINT32_C(1232196292) },
          { UINT32_C(2872971776), UINT32_C(3361012860) } },
      { UINT32_C(2527859363), UINT32_C(         0), UINT32_C(1063663797), UINT32_C(1073734480) },
        { { UINT32_C(3837699916), UINT32_C(2527859363) },
          { UINT32_C( 335447625), UINT32_C(         0) },
          { UINT32_C( 140300021), UINT32_C(1063663797) },
          { UINT32_C(2872971776), UINT32_C(1073734480) } },
    },
    {
        { { UINT32_C(2707449432), UINT32_C(1219845868) },
          { UINT32_C(2782595248), UINT32_C(2611820503) },
          { UINT32_C( 182722058), UINT32_C(2897551920) },
          { UINT32_C(3262384415), UINT32_C(1951932443) } },
      { UINT32_C(1930803334), UINT32_C(         0), UINT32_C(1063663797), UINT32_C(1073734480) },
        { { UINT32_C(2707449432), UINT32_C(1930803334) },
          { UINT32_C(2782595248), UINT32_C(         0) },
          { UINT32_C( 182722058), UINT32_C(1063663797) },
          { UINT32_C(3262384415), UINT32_C(1073734480) } },
    },
    {
        { { UINT32_C(3334195734), UINT32_C(2859177683) },
          { UINT32_C(3628406990), UINT32_C(1742874934) },
          { UINT32_C(1779668811), UINT32_C(3157100705) },
          { UINT32_C( 791709096), UINT32_C(1419920958) } },
      { UINT32_C(3810221328), UINT32_C(         0), UINT32_C(1063663797), UINT32_C(1073734480) },
        { { UINT32_C(3334195734), UINT32_C(3810221328) },
          { UINT32_C(3628406990), UINT32_C(         0) },
          { UINT32_C(1779668811), UINT32_C(1063663797) },
          { UINT32_C( 791709096), UINT32_C(1073734480) } },
    },
    {
        { { UINT32_C(3264055028), UINT32_C(3583693471) },
          { UINT32_C(1195146491), UINT32_C(3031519251) },
          { UINT32_C(2154946264), UINT32_C(2729419108) },
          { UINT32_C(4176892391), UINT32_C(2749043119) } },
      { UINT32_C( 929393048), UINT32_C(         0), UINT32_C(1063663797), UINT32_C(1073734480) },
        { { UINT32_C(3264055028), UINT32_C( 929393048) },
          { UINT32_C(1195146491), UINT32_C(         0) },
          { UINT32_C(2154946264), UINT32_C(1063663797) },
          { UINT32_C(4176892391), UINT32_C(1073734480) } },
    },
    {
        { { UINT32_C( 923598651), UINT32_C(2390641019) },
          { UINT32_C(1900228505), UINT32_C(1928442894) },
          { UINT32_C(1024762197), UINT32_C(2704607986) },
          { UINT32_C(3024359452), UINT32_C(3052120441) } },
      { UINT32_C( 602732456), UINT32_C(         0), UINT32_C(1063663797), UINT32_C(1073734480) },
        { { UINT32_C( 923598651), UINT32_C( 602732456) },
          { UINT32_C(1900228505), UINT32_C(         0) },
          { UINT32_C(1024762197), UINT32_C(1063663797) },
          { UINT32_C(3024359452), UINT32_C(1073734480) } },
    },
    {
        { { UINT32_C(3652348480), UINT32_C(2806707609) },
          { UINT32_C(4263066793), UINT32_C(3476762077) },
          { UINT32_C(1416720440), UINT32_C(4194874753) },
          { UINT32_C( 128971615), UINT32_C( 724278250) } },
      { UINT32_C(2667896069), UINT32_C(         0), UINT32_C(1063663797), UINT32_C(1073734480) },
        { { UINT32_C(3652348480), UINT32_C(2667896069) },
          { UINT32_C(4263066793), UINT32_C(         0) },
          { UINT32_C(1416720440), UINT32_C(1063663797) },
          { UINT32_C( 128971615), UINT32_C(1073734480) } },
    },
  };
