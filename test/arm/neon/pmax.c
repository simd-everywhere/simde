...
test_simde_vpmax_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    simde_float16x4_t r = simde_vpmax_f16(a, b);
...
static int
test_simde_vpmaxq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    simde_float16 a[8];
    simde_float16 b[8];
    simde_float16 r[8];
  } test_vec[] = {
    { {  SIMDE_FLOAT16_C(    29.303), -SIMDE_FLOAT16_C(    15.473),  SIMDE_FLOAT16_C(     1.006), -SIMDE_FLOAT16_C(    21.583),
         SIMDE_FLOAT16_C(    22.970), -SIMDE_FLOAT16_C(     5.299), -SIMDE_FLOAT16_C(    14.205), -SIMDE_FLOAT16_C(    15.176) },
      {  SIMDE_FLOAT16_C(    17.990),  SIMDE_FLOAT16_C(    11.602), -SIMDE_FLOAT16_C(    20.495), -SIMDE_FLOAT16_C(     8.082),
        -SIMDE_FLOAT16_C(    27.004), -SIMDE_FLOAT16_C(    11.946),  SIMDE_FLOAT16_C(    25.843),  SIMDE_FLOAT16_C(     6.779) },
      {  SIMDE_FLOAT16_C(    29.303),  SIMDE_FLOAT16_C(     1.006),  SIMDE_FLOAT16_C(    22.970), -SIMDE_FLOAT16_C(    14.205),
         SIMDE_FLOAT16_C(    17.990), -SIMDE_FLOAT16_C(     8.082), -SIMDE_FLOAT16_C(    11.946),  SIMDE_FLOAT16_C(    25.843) } },
    { { -SIMDE_FLOAT16_C(    25.501), -SIMDE_FLOAT16_C(    24.669), -SIMDE_FLOAT16_C(    29.118), -SIMDE_FLOAT16_C(     5.219),
         SIMDE_FLOAT16_C(    28.104),  SIMDE_FLOAT16_C(     0.654), -SIMDE_FLOAT16_C(    27.808), -SIMDE_FLOAT16_C(    18.743) },
      { -SIMDE_FLOAT16_C(    20.813), -SIMDE_FLOAT16_C(    26.402),  SIMDE_FLOAT16_C(    13.606),  SIMDE_FLOAT16_C(    10.476),
         SIMDE_FLOAT16_C(    29.613),  SIMDE_FLOAT16_C(    19.062),  SIMDE_FLOAT16_C(    27.849),  SIMDE_FLOAT16_C(     9.536) },
      { -SIMDE_FLOAT16_C(    24.669), -SIMDE_FLOAT16_C(     5.219),  SIMDE_FLOAT16_C(    28.104), -SIMDE_FLOAT16_C(    18.743),
        -SIMDE_FLOAT16_C(    20.813),  SIMDE_FLOAT16_C(    13.606),  SIMDE_FLOAT16_C(    29.613),  SIMDE_FLOAT16_C(    27.849) } },
    { {  SIMDE_FLOAT16_C(    16.289), -SIMDE_FLOAT16_C(    19.184), -SIMDE_FLOAT16_C(    22.617), -SIMDE_FLOAT16_C(    15.017),
        -SIMDE_FLOAT16_C(    27.645),  SIMDE_FLOAT16_C(    29.031),  SIMDE_FLOAT16_C(    26.470), -SIMDE_FLOAT16_C(    26.000) },
      { -SIMDE_FLOAT16_C(    12.853), -SIMDE_FLOAT16_C(     3.232),  SIMDE_FLOAT16_C(     4.567), -SIMDE_FLOAT16_C(    26.692),
         SIMDE_FLOAT16_C(    24.562), -SIMDE_FLOAT16_C(    29.933),  SIMDE_FLOAT16_C(    21.969),  SIMDE_FLOAT16_C(     7.783) },
      {  SIMDE_FLOAT16_C(    16.289), -SIMDE_FLOAT16_C(    15.017),  SIMDE_FLOAT16_C(    29.031),  SIMDE_FLOAT16_C(    26.470),
        -SIMDE_FLOAT16_C(     3.232),  SIMDE_FLOAT16_C(     4.567),  SIMDE_FLOAT16_C(    24.562),  SIMDE_FLOAT16_C(    21.969) } },
    { {  SIMDE_FLOAT16_C(     0.999), -SIMDE_FLOAT16_C(    29.129),  SIMDE_FLOAT16_C(    27.988), -SIMDE_FLOAT16_C(    19.096),
         SIMDE_FLOAT16_C(    13.789),  SIMDE_FLOAT16_C(     8.234),  SIMDE_FLOAT16_C(    24.437),  SIMDE_FLOAT16_C(    21.721) },
      {  SIMDE_FLOAT16_C(    26.278),  SIMDE_FLOAT16_C(    16.547),  SIMDE_FLOAT16_C(    10.034), -SIMDE_FLOAT16_C(    25.632),
        -SIMDE_FLOAT16_C(    21.337),  SIMDE_FLOAT16_C(    22.587),  SIMDE_FLOAT16_C(     2.778),  SIMDE_FLOAT16_C(     4.957) },
      {  SIMDE_FLOAT16_C(     0.999),  SIMDE_FLOAT16_C(    27.988),  SIMDE_FLOAT16_C(    13.789),  SIMDE_FLOAT16_C(    24.437),
         SIMDE_FLOAT16_C(    26.278),  SIMDE_FLOAT16_C(    10.034),  SIMDE_FLOAT16_C(    22.587),  SIMDE_FLOAT16_C(     4.957) } },
    { { -SIMDE_FLOAT16_C(    13.860),  SIMDE_FLOAT16_C(    26.535),  SIMDE_FLOAT16_C(     8.539),  SIMDE_FLOAT16_C(    12.470),
        -SIMDE_FLOAT16_C(    24.032),  SIMDE_FLOAT16_C(    21.137),  SIMDE_FLOAT16_C(    14.371),  SIMDE_FLOAT16_C(     5.670) },
      {  SIMDE_FLOAT16_C(    26.851), -SIMDE_FLOAT16_C(    13.040),  SIMDE_FLOAT16_C(     3.688), -SIMDE_FLOAT16_C(     9.966),
         SIMDE_FLOAT16_C(     6.679), -SIMDE_FLOAT16_C(    25.728), -SIMDE_FLOAT16_C(    16.073),  SIMDE_FLOAT16_C(     1.650) },
      {  SIMDE_FLOAT16_C(    26.535),  SIMDE_FLOAT16_C(    12.470),  SIMDE_FLOAT16_C(    21.137),  SIMDE_FLOAT16_C(    14.371),
         SIMDE_FLOAT16_C(    26.851),  SIMDE_FLOAT16_C(     3.688),  SIMDE_FLOAT16_C(     6.679),  SIMDE_FLOAT16_C(     1.650) } },
    { { -SIMDE_FLOAT16_C(    19.296), -SIMDE_FLOAT16_C(    18.339), -SIMDE_FLOAT16_C(    13.951),  SIMDE_FLOAT16_C(    23.736),
         SIMDE_FLOAT16_C(    21.581),  SIMDE_FLOAT16_C(     4.304),  SIMDE_FLOAT16_C(     1.910),  SIMDE_FLOAT16_C(    10.399) },
      {  SIMDE_FLOAT16_C(    25.274), -SIMDE_FLOAT16_C(    28.803), -SIMDE_FLOAT16_C(    20.109), -SIMDE_FLOAT16_C(    22.088),
         SIMDE_FLOAT16_C(    20.071),  SIMDE_FLOAT16_C(    15.667), -SIMDE_FLOAT16_C(    24.469),  SIMDE_FLOAT16_C(    18.492) },
      { -SIMDE_FLOAT16_C(    18.339),  SIMDE_FLOAT16_C(    23.736),  SIMDE_FLOAT16_C(    21.581),  SIMDE_FLOAT16_C(    10.399),
         SIMDE_FLOAT16_C(    25.274), -SIMDE_FLOAT16_C(    20.109),  SIMDE_FLOAT16_C(    20.071),  SIMDE_FLOAT16_C(    18.492) } },
    { { -SIMDE_FLOAT16_C(     3.637),  SIMDE_FLOAT16_C(     3.472),  SIMDE_FLOAT16_C(    14.644), -SIMDE_FLOAT16_C(    16.247),
         SIMDE_FLOAT16_C(     1.467), -SIMDE_FLOAT16_C(     9.306),  SIMDE_FLOAT16_C(     9.252),  SIMDE_FLOAT16_C(    18.437) },
      { -SIMDE_FLOAT16_C(     2.944), -SIMDE_FLOAT16_C(     1.079), -SIMDE_FLOAT16_C(    18.689),  SIMDE_FLOAT16_C(    24.492),
        -SIMDE_FLOAT16_C(    25.720),  SIMDE_FLOAT16_C(    26.654),  SIMDE_FLOAT16_C(    12.162), -SIMDE_FLOAT16_C(    11.528) },
      {  SIMDE_FLOAT16_C(     3.472),  SIMDE_FLOAT16_C(    14.644),  SIMDE_FLOAT16_C(     1.467),  SIMDE_FLOAT16_C(    18.437),
        -SIMDE_FLOAT16_C(     1.079),  SIMDE_FLOAT16_C(    24.492),  SIMDE_FLOAT16_C(    26.654),  SIMDE_FLOAT16_C(    12.162) } },
    { {  SIMDE_FLOAT16_C(     7.740),  SIMDE_FLOAT16_C(    19.127),  SIMDE_FLOAT16_C(    11.877), -SIMDE_FLOAT16_C(    25.942),
         SIMDE_FLOAT16_C(     7.124),  SIMDE_FLOAT16_C(    12.554),  SIMDE_FLOAT16_C(    28.406), -SIMDE_FLOAT16_C(     5.830) },
      { -SIMDE_FLOAT16_C(    22.509), -SIMDE_FLOAT16_C(    22.856),  SIMDE_FLOAT16_C(     9.728), -SIMDE_FLOAT16_C(    17.513),
         SIMDE_FLOAT16_C(     0.430),  SIMDE_FLOAT16_C(    18.796), -SIMDE_FLOAT16_C(    17.154), -SIMDE_FLOAT16_C(     2.826) },
      {  SIMDE_FLOAT16_C(    19.127),  SIMDE_FLOAT16_C(    11.877),  SIMDE_FLOAT16_C(    12.554),  SIMDE_FLOAT16_C(    28.406),
        -SIMDE_FLOAT16_C(    22.509),  SIMDE_FLOAT16_C(     9.728),  SIMDE_FLOAT16_C(    18.796), -SIMDE_FLOAT16_C(     2.826) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_float16x8_t a = simde_vld1q_f16(test_vec[i].a);
    simde_float16x8_t b = simde_vld1q_f16(test_vec[i].b);
    simde_float16x8_t r = simde_vpmaxq_f16(a, b);
...
SIMDE_TEST_FUNC_LIST_ENTRY(vpmax_f16)
...
SIMDE_TEST_FUNC_LIST_ENTRY(vpmaxq_f16)
