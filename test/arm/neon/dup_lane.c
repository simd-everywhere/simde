...
test_simde_vdup_lane_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { SIMDE_FLOAT16_C(-7.6), SIMDE_FLOAT16_C(11.4), SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(-0.1) },
        INT32_C(2),
      { SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(10.7) } },
    { { SIMDE_FLOAT16_C(1.4), SIMDE_FLOAT16_C(-5.5), SIMDE_FLOAT16_C(3.7), SIMDE_FLOAT16_C(-12.5) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(1.4), SIMDE_FLOAT16_C(1.4), SIMDE_FLOAT16_C(1.4), SIMDE_FLOAT16_C(1.4) } },
    { { SIMDE_FLOAT16_C(13.3), SIMDE_FLOAT16_C(-11.6), SIMDE_FLOAT16_C(4.4), SIMDE_FLOAT16_C(-1.3) },
        INT32_C(2),
      { SIMDE_FLOAT16_C(4.4), SIMDE_FLOAT16_C(4.4), SIMDE_FLOAT16_C(4.4), SIMDE_FLOAT16_C(4.4) } },
    { { SIMDE_FLOAT16_C(-11.5), SIMDE_FLOAT16_C(-10.6), SIMDE_FLOAT16_C(13.5), SIMDE_FLOAT16_C(-5.6) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(-11.5), SIMDE_FLOAT16_C(-11.5), SIMDE_FLOAT16_C(-11.5), SIMDE_FLOAT16_C(-11.5) } },
    { { SIMDE_FLOAT16_C(-12.6), SIMDE_FLOAT16_C(-12.4), SIMDE_FLOAT16_C(11.3), SIMDE_FLOAT16_C(11.8) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(-12.6), SIMDE_FLOAT16_C(-12.6), SIMDE_FLOAT16_C(-12.6), SIMDE_FLOAT16_C(-12.6) } },
    { { SIMDE_FLOAT16_C(1.7), SIMDE_FLOAT16_C(-12.1), SIMDE_FLOAT16_C(-11.1), SIMDE_FLOAT16_C(-11.3) },
        INT32_C(1),
      { SIMDE_FLOAT16_C(-12.1), SIMDE_FLOAT16_C(-12.1), SIMDE_FLOAT16_C(-12.1), SIMDE_FLOAT16_C(-12.1) } },
    { { SIMDE_FLOAT16_C(-2.9), SIMDE_FLOAT16_C(0.3), SIMDE_FLOAT16_C(11.1), SIMDE_FLOAT16_C(8.8) },
        INT32_C(1),
      { SIMDE_FLOAT16_C(0.3), SIMDE_FLOAT16_C(0.3), SIMDE_FLOAT16_C(0.3), SIMDE_FLOAT16_C(0.3) } },
    { { SIMDE_FLOAT16_C(8.0), SIMDE_FLOAT16_C(-13.7), SIMDE_FLOAT16_C(-3.6), SIMDE_FLOAT16_C(5.8) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(8.0), SIMDE_FLOAT16_C(8.0), SIMDE_FLOAT16_C(8.0), SIMDE_FLOAT16_C(8.0) } },
    { { SIMDE_FLOAT16_C(1.1), SIMDE_FLOAT16_C(10.1), SIMDE_FLOAT16_C(1.2), SIMDE_FLOAT16_C(-11.7) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(1.1), SIMDE_FLOAT16_C(1.1), SIMDE_FLOAT16_C(1.1), SIMDE_FLOAT16_C(1.1) } },
    { { SIMDE_FLOAT16_C(-2.0), SIMDE_FLOAT16_C(-14.0), SIMDE_FLOAT16_C(-13.7), SIMDE_FLOAT16_C(-10.2) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(-2.0), SIMDE_FLOAT16_C(-2.0), SIMDE_FLOAT16_C(-2.0), SIMDE_FLOAT16_C(-2.0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    SIMDE_CONSTIFY_4_(simde_vdup_lane_f16, r, (HEDLEY_UNREACHABLE(), simde_vdup_n_f16(0.0f)), test_vec[i].lane, vec);
...
test_simde_vdupq_lane_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { SIMDE_FLOAT16_C(-3.4), SIMDE_FLOAT16_C(6.4), SIMDE_FLOAT16_C(-7.4), SIMDE_FLOAT16_C(0.5),
        SIMDE_FLOAT16_C(-4.8), SIMDE_FLOAT16_C(-3.4), SIMDE_FLOAT16_C(-7.0), SIMDE_FLOAT16_C(-0.6) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(-3.4), SIMDE_FLOAT16_C(-3.4), SIMDE_FLOAT16_C(-3.4), SIMDE_FLOAT16_C(-3.4),
        SIMDE_FLOAT16_C(-3.4), SIMDE_FLOAT16_C(-3.4), SIMDE_FLOAT16_C(-3.4), SIMDE_FLOAT16_C(-3.4) } },
    { { SIMDE_FLOAT16_C(0.9), SIMDE_FLOAT16_C(7.0), SIMDE_FLOAT16_C(-4.9), SIMDE_FLOAT16_C(-8.8),
        SIMDE_FLOAT16_C(-14.5), SIMDE_FLOAT16_C(-5.3), SIMDE_FLOAT16_C(-4.5), SIMDE_FLOAT16_C(2.8) },
        INT32_C(7),
      { SIMDE_FLOAT16_C(2.8), SIMDE_FLOAT16_C(2.8), SIMDE_FLOAT16_C(2.8), SIMDE_FLOAT16_C(2.8),
        SIMDE_FLOAT16_C(2.8), SIMDE_FLOAT16_C(2.8), SIMDE_FLOAT16_C(2.8), SIMDE_FLOAT16_C(2.8) } },
    { { SIMDE_FLOAT16_C(8.1), SIMDE_FLOAT16_C(-0.0), SIMDE_FLOAT16_C(6.2), SIMDE_FLOAT16_C(-5.5),
        SIMDE_FLOAT16_C(-13.0), SIMDE_FLOAT16_C(1.1), SIMDE_FLOAT16_C(-2.9), SIMDE_FLOAT16_C(3.7) },
        INT32_C(3),
      { SIMDE_FLOAT16_C(-5.5), SIMDE_FLOAT16_C(-5.5), SIMDE_FLOAT16_C(-5.5), SIMDE_FLOAT16_C(-5.5),
        SIMDE_FLOAT16_C(-5.5), SIMDE_FLOAT16_C(-5.5), SIMDE_FLOAT16_C(-5.5), SIMDE_FLOAT16_C(-5.5) } },
    { { SIMDE_FLOAT16_C(-9.6), SIMDE_FLOAT16_C(6.7), SIMDE_FLOAT16_C(1.4), SIMDE_FLOAT16_C(10.7),
        SIMDE_FLOAT16_C(-7.3), SIMDE_FLOAT16_C(-4.4), SIMDE_FLOAT16_C(2.6), SIMDE_FLOAT16_C(6.9) },
        INT32_C(3),
      { SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(10.7),
        SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(10.7) } },
    { { SIMDE_FLOAT16_C(10.1), SIMDE_FLOAT16_C(8.6), SIMDE_FLOAT16_C(3.2), SIMDE_FLOAT16_C(-0.5),
        SIMDE_FLOAT16_C(-0.8), SIMDE_FLOAT16_C(-10.9), SIMDE_FLOAT16_C(-14.6), SIMDE_FLOAT16_C(-13.8) },
        INT32_C(4),
      { SIMDE_FLOAT16_C(-0.8), SIMDE_FLOAT16_C(-0.8), SIMDE_FLOAT16_C(-0.8), SIMDE_FLOAT16_C(-0.8),
        SIMDE_FLOAT16_C(-0.8), SIMDE_FLOAT16_C(-0.8), SIMDE_FLOAT16_C(-0.8), SIMDE_FLOAT16_C(-0.8) } },
    { { SIMDE_FLOAT16_C(2.9), SIMDE_FLOAT16_C(-15.0), SIMDE_FLOAT16_C(14.8), SIMDE_FLOAT16_C(-2.2),
        SIMDE_FLOAT16_C(-13.0), SIMDE_FLOAT16_C(-6.8), SIMDE_FLOAT16_C(-10.5), SIMDE_FLOAT16_C(-14.0) },
        INT32_C(1),
      { SIMDE_FLOAT16_C(-15.0), SIMDE_FLOAT16_C(-15.0), SIMDE_FLOAT16_C(-15.0), SIMDE_FLOAT16_C(-15.0),
        SIMDE_FLOAT16_C(-15.0), SIMDE_FLOAT16_C(-15.0), SIMDE_FLOAT16_C(-15.0), SIMDE_FLOAT16_C(-15.0) } },
    { { SIMDE_FLOAT16_C(13.8), SIMDE_FLOAT16_C(5.4), SIMDE_FLOAT16_C(-5.5), SIMDE_FLOAT16_C(-14.2),
        SIMDE_FLOAT16_C(-12.6), SIMDE_FLOAT16_C(-14.9), SIMDE_FLOAT16_C(14.7), SIMDE_FLOAT16_C(-1.6) },
        INT32_C(5),
      { SIMDE_FLOAT16_C(-14.9), SIMDE_FLOAT16_C(-14.9), SIMDE_FLOAT16_C(-14.9), SIMDE_FLOAT16_C(-14.9),
        SIMDE_FLOAT16_C(-14.9), SIMDE_FLOAT16_C(-14.9), SIMDE_FLOAT16_C(-14.9), SIMDE_FLOAT16_C(-14.9) } },
    { { SIMDE_FLOAT16_C(0.4), SIMDE_FLOAT16_C(0.2), SIMDE_FLOAT16_C(7.5), SIMDE_FLOAT16_C(-14.7),
        SIMDE_FLOAT16_C(-2.9), SIMDE_FLOAT16_C(14.0), SIMDE_FLOAT16_C(-5.5), SIMDE_FLOAT16_C(3.6) },
        INT32_C(2),
      { SIMDE_FLOAT16_C(7.5), SIMDE_FLOAT16_C(7.5), SIMDE_FLOAT16_C(7.5), SIMDE_FLOAT16_C(7.5),
        SIMDE_FLOAT16_C(7.5), SIMDE_FLOAT16_C(7.5), SIMDE_FLOAT16_C(7.5), SIMDE_FLOAT16_C(7.5) } },
    { { SIMDE_FLOAT16_C(14.2), SIMDE_FLOAT16_C(12.6), SIMDE_FLOAT16_C(2.6), SIMDE_FLOAT16_C(-8.4),
        SIMDE_FLOAT16_C(10.7), SIMDE_FLOAT16_C(11.2), SIMDE_FLOAT16_C(7.2), SIMDE_FLOAT16_C(-12.6) },
        INT32_C(6),
      { SIMDE_FLOAT16_C(7.2), SIMDE_FLOAT16_C(7.2), SIMDE_FLOAT16_C(7.2), SIMDE_FLOAT16_C(7.2),
        SIMDE_FLOAT16_C(7.2), SIMDE_FLOAT16_C(7.2), SIMDE_FLOAT16_C(7.2), SIMDE_FLOAT16_C(7.2) } },
    { { SIMDE_FLOAT16_C(-6.0), SIMDE_FLOAT16_C(0.4), SIMDE_FLOAT16_C(-8.9), SIMDE_FLOAT16_C(-11.3),
        SIMDE_FLOAT16_C(-10.6), SIMDE_FLOAT16_C(-1.3), SIMDE_FLOAT16_C(-1.3), SIMDE_FLOAT16_C(12.2) },
        INT32_C(3),
      { SIMDE_FLOAT16_C(-11.3), SIMDE_FLOAT16_C(-11.3), SIMDE_FLOAT16_C(-11.3), SIMDE_FLOAT16_C(-11.3),
        SIMDE_FLOAT16_C(-11.3), SIMDE_FLOAT16_C(-11.3), SIMDE_FLOAT16_C(-11.3), SIMDE_FLOAT16_C(-11.3) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    SIMDE_CONSTIFY_8_(simde_vdupq_lane_f16, r, (HEDLEY_UNREACHABLE(), simde_vdupq_n_f16(0.0f)), test_vec[i].lane, vec);
