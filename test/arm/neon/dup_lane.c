...
test_simde_vdup_laneq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { {  SIMDE_FLOAT16_C(     9.056),  SIMDE_FLOAT16_C(     1.677),  SIMDE_FLOAT16_C(     7.053),  SIMDE_FLOAT16_C(    28.437),
         SIMDE_FLOAT16_C(    14.165),  SIMDE_FLOAT16_C(    18.651), -SIMDE_FLOAT16_C(    23.860),  SIMDE_FLOAT16_C(     2.771) },
         INT8_C(         6),
      { -SIMDE_FLOAT16_C(    23.860), -SIMDE_FLOAT16_C(    23.860), -SIMDE_FLOAT16_C(    23.860), -SIMDE_FLOAT16_C(    23.860) } },
    { {  SIMDE_FLOAT16_C(    24.258), -SIMDE_FLOAT16_C(    13.828), -SIMDE_FLOAT16_C(    26.370),  SIMDE_FLOAT16_C(    19.116),
        -SIMDE_FLOAT16_C(     8.063),  SIMDE_FLOAT16_C(    29.418), -SIMDE_FLOAT16_C(    20.107),  SIMDE_FLOAT16_C(     7.234) },
         INT8_C(         2),
      { -SIMDE_FLOAT16_C(    26.370), -SIMDE_FLOAT16_C(    26.370), -SIMDE_FLOAT16_C(    26.370), -SIMDE_FLOAT16_C(    26.370) } },
    { { -SIMDE_FLOAT16_C(    11.462),  SIMDE_FLOAT16_C(    22.959), -SIMDE_FLOAT16_C(    17.969), -SIMDE_FLOAT16_C(     9.845),
         SIMDE_FLOAT16_C(     7.748), -SIMDE_FLOAT16_C(    18.327),  SIMDE_FLOAT16_C(    13.108), -SIMDE_FLOAT16_C(    16.811) },
         INT8_C(         7),
      { -SIMDE_FLOAT16_C(    16.811), -SIMDE_FLOAT16_C(    16.811), -SIMDE_FLOAT16_C(    16.811), -SIMDE_FLOAT16_C(    16.811) } },
    { {  SIMDE_FLOAT16_C(     8.525), -SIMDE_FLOAT16_C(    15.131),  SIMDE_FLOAT16_C(    14.364), -SIMDE_FLOAT16_C(     8.648),
        -SIMDE_FLOAT16_C(    10.759), -SIMDE_FLOAT16_C(     3.780),  SIMDE_FLOAT16_C(     3.004), -SIMDE_FLOAT16_C(    12.422) },
         INT8_C(         4),
      { -SIMDE_FLOAT16_C(    10.759), -SIMDE_FLOAT16_C(    10.759), -SIMDE_FLOAT16_C(    10.759), -SIMDE_FLOAT16_C(    10.759) } },
    { {  SIMDE_FLOAT16_C(    12.736),  SIMDE_FLOAT16_C(    10.408),  SIMDE_FLOAT16_C(    16.484), -SIMDE_FLOAT16_C(    11.569),
        -SIMDE_FLOAT16_C(    27.593), -SIMDE_FLOAT16_C(    22.388),  SIMDE_FLOAT16_C(     0.182),  SIMDE_FLOAT16_C(    27.270) },
         INT8_C(         1),
      {  SIMDE_FLOAT16_C(    10.408),  SIMDE_FLOAT16_C(    10.408),  SIMDE_FLOAT16_C(    10.408),  SIMDE_FLOAT16_C(    10.408) } },
    { { -SIMDE_FLOAT16_C(     8.778),  SIMDE_FLOAT16_C(     6.046),  SIMDE_FLOAT16_C(     1.558),  SIMDE_FLOAT16_C(     7.396),
         SIMDE_FLOAT16_C(    29.886), -SIMDE_FLOAT16_C(     0.845),  SIMDE_FLOAT16_C(    14.948),  SIMDE_FLOAT16_C(    17.996) },
         INT8_C(         6),
      {  SIMDE_FLOAT16_C(    14.948),  SIMDE_FLOAT16_C(    14.948),  SIMDE_FLOAT16_C(    14.948),  SIMDE_FLOAT16_C(    14.948) } },
    { { -SIMDE_FLOAT16_C(     9.902),  SIMDE_FLOAT16_C(    20.687), -SIMDE_FLOAT16_C(    25.203),  SIMDE_FLOAT16_C(    13.883),
        -SIMDE_FLOAT16_C(    14.370), -SIMDE_FLOAT16_C(    27.322), -SIMDE_FLOAT16_C(    24.150), -SIMDE_FLOAT16_C(    21.580) },
         INT8_C(         1),
      {  SIMDE_FLOAT16_C(    20.687),  SIMDE_FLOAT16_C(    20.687),  SIMDE_FLOAT16_C(    20.687),  SIMDE_FLOAT16_C(    20.687) } },
    { {  SIMDE_FLOAT16_C(    11.499), -SIMDE_FLOAT16_C(    13.869), -SIMDE_FLOAT16_C(    27.353),  SIMDE_FLOAT16_C(     6.786),
         SIMDE_FLOAT16_C(    29.577), -SIMDE_FLOAT16_C(     4.705), -SIMDE_FLOAT16_C(    25.496),  SIMDE_FLOAT16_C(    26.515) },
         INT8_C(         0),
      {  SIMDE_FLOAT16_C(    11.499),  SIMDE_FLOAT16_C(    11.499),  SIMDE_FLOAT16_C(    11.499),  SIMDE_FLOAT16_C(    11.499) } },
  };
...
test_simde_vdupq_laneq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { -SIMDE_FLOAT16_C(    14.944),  SIMDE_FLOAT16_C(    29.976),  SIMDE_FLOAT16_C(     8.148), -SIMDE_FLOAT16_C(     8.525),
         SIMDE_FLOAT16_C(     4.332), -SIMDE_FLOAT16_C(     8.444), -SIMDE_FLOAT16_C(    17.802),  SIMDE_FLOAT16_C(    18.658) },
         INT8_C(         3),
      { -SIMDE_FLOAT16_C(     8.525), -SIMDE_FLOAT16_C(     8.525), -SIMDE_FLOAT16_C(     8.525), -SIMDE_FLOAT16_C(     8.525),
        -SIMDE_FLOAT16_C(     8.525), -SIMDE_FLOAT16_C(     8.525), -SIMDE_FLOAT16_C(     8.525), -SIMDE_FLOAT16_C(     8.525) } },
    { {  SIMDE_FLOAT16_C(     2.837), -SIMDE_FLOAT16_C(     2.966), -SIMDE_FLOAT16_C(    13.207),  SIMDE_FLOAT16_C(     9.802),
        -SIMDE_FLOAT16_C(    11.553),  SIMDE_FLOAT16_C(     4.185), -SIMDE_FLOAT16_C(     2.087), -SIMDE_FLOAT16_C(    25.138) },
         INT8_C(         0),
      {  SIMDE_FLOAT16_C(     2.837),  SIMDE_FLOAT16_C(     2.837),  SIMDE_FLOAT16_C(     2.837),  SIMDE_FLOAT16_C(     2.837),
         SIMDE_FLOAT16_C(     2.837),  SIMDE_FLOAT16_C(     2.837),  SIMDE_FLOAT16_C(     2.837),  SIMDE_FLOAT16_C(     2.837) } },
    { { -SIMDE_FLOAT16_C(     9.082), -SIMDE_FLOAT16_C(    20.470), -SIMDE_FLOAT16_C(     2.951), -SIMDE_FLOAT16_C(    21.315),
        -SIMDE_FLOAT16_C(    22.110),  SIMDE_FLOAT16_C(     4.867), -SIMDE_FLOAT16_C(     1.873), -SIMDE_FLOAT16_C(     9.236) },
         INT8_C(         6),
      { -SIMDE_FLOAT16_C(     1.873), -SIMDE_FLOAT16_C(     1.873), -SIMDE_FLOAT16_C(     1.873), -SIMDE_FLOAT16_C(     1.873),
        -SIMDE_FLOAT16_C(     1.873), -SIMDE_FLOAT16_C(     1.873), -SIMDE_FLOAT16_C(     1.873), -SIMDE_FLOAT16_C(     1.873) } },
    { { -SIMDE_FLOAT16_C(     6.811), -SIMDE_FLOAT16_C(    18.944),  SIMDE_FLOAT16_C(    17.974),  SIMDE_FLOAT16_C(    23.871),
         SIMDE_FLOAT16_C(    22.903), -SIMDE_FLOAT16_C(    21.458), -SIMDE_FLOAT16_C(     7.777),  SIMDE_FLOAT16_C(    11.946) },
         INT8_C(         7),
      {  SIMDE_FLOAT16_C(    11.946),  SIMDE_FLOAT16_C(    11.946),  SIMDE_FLOAT16_C(    11.946),  SIMDE_FLOAT16_C(    11.946),
         SIMDE_FLOAT16_C(    11.946),  SIMDE_FLOAT16_C(    11.946),  SIMDE_FLOAT16_C(    11.946),  SIMDE_FLOAT16_C(    11.946) } },
    { {  SIMDE_FLOAT16_C(     4.721),  SIMDE_FLOAT16_C(    22.653), -SIMDE_FLOAT16_C(     5.854), -SIMDE_FLOAT16_C(     4.341),
         SIMDE_FLOAT16_C(     0.043), -SIMDE_FLOAT16_C(     3.823),  SIMDE_FLOAT16_C(     4.788),  SIMDE_FLOAT16_C(    11.244) },
         INT8_C(         4),
      {  SIMDE_FLOAT16_C(     0.043),  SIMDE_FLOAT16_C(     0.043),  SIMDE_FLOAT16_C(     0.043),  SIMDE_FLOAT16_C(     0.043),
         SIMDE_FLOAT16_C(     0.043),  SIMDE_FLOAT16_C(     0.043),  SIMDE_FLOAT16_C(     0.043),  SIMDE_FLOAT16_C(     0.043) } },
    { { -SIMDE_FLOAT16_C(    29.389),  SIMDE_FLOAT16_C(    25.831),  SIMDE_FLOAT16_C(     2.593),  SIMDE_FLOAT16_C(     0.655),
        -SIMDE_FLOAT16_C(    29.518),  SIMDE_FLOAT16_C(    21.627), -SIMDE_FLOAT16_C(     9.484),  SIMDE_FLOAT16_C(     9.197) },
         INT8_C(         7),
      {  SIMDE_FLOAT16_C(     9.197),  SIMDE_FLOAT16_C(     9.197),  SIMDE_FLOAT16_C(     9.197),  SIMDE_FLOAT16_C(     9.197),
         SIMDE_FLOAT16_C(     9.197),  SIMDE_FLOAT16_C(     9.197),  SIMDE_FLOAT16_C(     9.197),  SIMDE_FLOAT16_C(     9.197) } },
    { {  SIMDE_FLOAT16_C(     6.412), -SIMDE_FLOAT16_C(     2.948),  SIMDE_FLOAT16_C(    17.301),  SIMDE_FLOAT16_C(     9.426),
         SIMDE_FLOAT16_C(    23.317), -SIMDE_FLOAT16_C(     1.470), -SIMDE_FLOAT16_C(    28.086), -SIMDE_FLOAT16_C(     4.040) },
         INT8_C(         6),
      { -SIMDE_FLOAT16_C(    28.086), -SIMDE_FLOAT16_C(    28.086), -SIMDE_FLOAT16_C(    28.086), -SIMDE_FLOAT16_C(    28.086),
        -SIMDE_FLOAT16_C(    28.086), -SIMDE_FLOAT16_C(    28.086), -SIMDE_FLOAT16_C(    28.086), -SIMDE_FLOAT16_C(    28.086) } },
    { {  SIMDE_FLOAT16_C(    17.678),  SIMDE_FLOAT16_C(    12.177), -SIMDE_FLOAT16_C(    14.208), -SIMDE_FLOAT16_C(    15.268),
         SIMDE_FLOAT16_C(    15.600), -SIMDE_FLOAT16_C(    16.025),  SIMDE_FLOAT16_C(    24.952), -SIMDE_FLOAT16_C(     1.031) },
         INT8_C(         7),
      { -SIMDE_FLOAT16_C(     1.031), -SIMDE_FLOAT16_C(     1.031), -SIMDE_FLOAT16_C(     1.031), -SIMDE_FLOAT16_C(     1.031),
        -SIMDE_FLOAT16_C(     1.031), -SIMDE_FLOAT16_C(     1.031), -SIMDE_FLOAT16_C(     1.031), -SIMDE_FLOAT16_C(     1.031) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = simde_vld1q_f16(test_vec[i].vec);
    SIMDE_CONSTIFY_8_(simde_vdupq_laneq_f16, r, (HEDLEY_UNREACHABLE(), simde_vdupq_n_f16(0.0f)), test_vec[i].lane, vec);
...
test_simde_vduph_laneq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { -SIMDE_FLOAT16_C( 3.387), -SIMDE_FLOAT16_C( 9.632),  SIMDE_FLOAT16_C(19.992),  SIMDE_FLOAT16_C( 1.837),
         SIMDE_FLOAT16_C(10.218),  SIMDE_FLOAT16_C( 0.924),  SIMDE_FLOAT16_C(28.548),  SIMDE_FLOAT16_C(10.866) },
         INT16_C(     0),
        -SIMDE_FLOAT16_C( 3.387) },
    { {  SIMDE_FLOAT16_C(26.430),  SIMDE_FLOAT16_C(28.640), -SIMDE_FLOAT16_C(21.270), -SIMDE_FLOAT16_C(10.357),
         SIMDE_FLOAT16_C( 0.986), -SIMDE_FLOAT16_C(14.685),  SIMDE_FLOAT16_C(27.090),  SIMDE_FLOAT16_C(16.825) },
         INT16_C(     0),
         SIMDE_FLOAT16_C(26.430) },
    { {  SIMDE_FLOAT16_C(24.992),  SIMDE_FLOAT16_C( 2.837),  SIMDE_FLOAT16_C( 1.880),  SIMDE_FLOAT16_C( 1.855),
        -SIMDE_FLOAT16_C(26.001),  SIMDE_FLOAT16_C(25.433), -SIMDE_FLOAT16_C(25.054), -SIMDE_FLOAT16_C(18.612) },
         INT16_C(     1),
         SIMDE_FLOAT16_C( 2.837) },
    { { -SIMDE_FLOAT16_C(24.460), -SIMDE_FLOAT16_C(22.313), -SIMDE_FLOAT16_C(17.405),  SIMDE_FLOAT16_C( 7.420),
        -SIMDE_FLOAT16_C( 9.492), -SIMDE_FLOAT16_C(28.099), -SIMDE_FLOAT16_C(25.166), -SIMDE_FLOAT16_C(23.800) },
         INT16_C(     5),
        -SIMDE_FLOAT16_C(28.099) },
    { { -SIMDE_FLOAT16_C(20.270), -SIMDE_FLOAT16_C(10.763), -SIMDE_FLOAT16_C(20.068),  SIMDE_FLOAT16_C( 1.744),
         SIMDE_FLOAT16_C( 4.890), -SIMDE_FLOAT16_C(28.985), -SIMDE_FLOAT16_C(27.261), -SIMDE_FLOAT16_C( 5.649) },
         INT16_C(     6),
        -SIMDE_FLOAT16_C(27.261) },
    { {  SIMDE_FLOAT16_C( 2.648), -SIMDE_FLOAT16_C(19.666),  SIMDE_FLOAT16_C( 0.498), -SIMDE_FLOAT16_C(12.129),
        -SIMDE_FLOAT16_C( 6.541),  SIMDE_FLOAT16_C(20.271),  SIMDE_FLOAT16_C(11.576),  SIMDE_FLOAT16_C(26.583) },
         INT16_C(     5),
         SIMDE_FLOAT16_C(20.271) },
    { { -SIMDE_FLOAT16_C(15.363), -SIMDE_FLOAT16_C( 5.167),  SIMDE_FLOAT16_C( 4.732), -SIMDE_FLOAT16_C(14.807),
         SIMDE_FLOAT16_C(13.136),  SIMDE_FLOAT16_C(26.351),  SIMDE_FLOAT16_C(15.240), -SIMDE_FLOAT16_C(21.142) },
         INT16_C(     3),
        -SIMDE_FLOAT16_C(14.807) },
    { { -SIMDE_FLOAT16_C(22.512),  SIMDE_FLOAT16_C(15.536), -SIMDE_FLOAT16_C(20.898), -SIMDE_FLOAT16_C(24.975),
        -SIMDE_FLOAT16_C(28.439), -SIMDE_FLOAT16_C(28.696),  SIMDE_FLOAT16_C(12.933),  SIMDE_FLOAT16_C(20.260) },
         INT16_C(     7),
         SIMDE_FLOAT16_C(20.260) },
  };
...
test_simde_vdup_lane_p8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    SIMDE_CONSTIFY_8_(simde_vdup_lane_p8, r, (HEDLEY_UNREACHABLE(), simde_vdup_n_p8(UINT8_C(0))), test_vec[i].lane, vec);
...
test_simde_vdup_lane_p16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    SIMDE_CONSTIFY_4_(simde_vdup_lane_p16, r, (HEDLEY_UNREACHABLE(), simde_vdup_n_p16(UINT16_C(0))), test_vec[i].lane, vec);
...
test_simde_vdup_laneq_p8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    SIMDE_CONSTIFY_16_(simde_vdup_laneq_p8, r, (HEDLEY_UNREACHABLE(), simde_vdup_n_p8(UINT8_C(0))), test_vec[i].lane, vec);
...
test_simde_vdup_laneq_p16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    SIMDE_CONSTIFY_8_(simde_vdup_laneq_p16, r, (HEDLEY_UNREACHABLE(), simde_vdup_n_p16(UINT16_C(0))), test_vec[i].lane, vec);
...
test_simde_vdup_laneq_p64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    SIMDE_CONSTIFY_2_(simde_vdup_laneq_p64, r, (HEDLEY_UNREACHABLE(), simde_vdup_n_p64(UINT64_C(0))), test_vec[i].lane, vec);
...
test_simde_vdupq_laneq_p8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = simde_vld1q_p8(test_vec[i].vec);
    SIMDE_CONSTIFY_16_(simde_vdupq_laneq_p8, r, (HEDLEY_UNREACHABLE(), simde_vdupq_n_p8(UINT8_C(0))), test_vec[i].lane, vec);
...
test_simde_vdupq_laneq_p16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = simde_vld1q_p16(test_vec[i].vec);
    SIMDE_CONSTIFY_8_(simde_vdupq_laneq_p16, r, (HEDLEY_UNREACHABLE(), simde_vdupq_n_p16(UINT16_C(0))), test_vec[i].lane, vec);
...
test_simde_vdupq_laneq_p64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = simde_vld1q_p64(test_vec[i].vec);
    SIMDE_CONSTIFY_2_(simde_vdupq_laneq_p64, r, (HEDLEY_UNREACHABLE(), simde_vdupq_n_p64(UINT64_C(0))), test_vec[i].lane, vec);
