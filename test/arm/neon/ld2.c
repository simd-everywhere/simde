...
test_simde_vld2q_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(   793.71), SIMDE_FLOAT16_C(   221.62), SIMDE_FLOAT16_C(   781.57), SIMDE_FLOAT16_C(  -525.52),
        SIMDE_FLOAT16_C(   800.99), SIMDE_FLOAT16_C(  -411.87), SIMDE_FLOAT16_C(   483.99), SIMDE_FLOAT16_C(   852.73),
        SIMDE_FLOAT16_C(  -433.25), SIMDE_FLOAT16_C(  -811.76), SIMDE_FLOAT16_C(  -463.04), SIMDE_FLOAT16_C(   671.94),
        SIMDE_FLOAT16_C(   -60.94), SIMDE_FLOAT16_C(  -434.20), SIMDE_FLOAT16_C(  -263.89), SIMDE_FLOAT16_C(   754.63) },
      { { SIMDE_FLOAT16_C(   793.71), SIMDE_FLOAT16_C(   781.57), SIMDE_FLOAT16_C(   800.99), SIMDE_FLOAT16_C(   483.99),
          SIMDE_FLOAT16_C(  -433.25), SIMDE_FLOAT16_C(  -463.04), SIMDE_FLOAT16_C(   -60.94), SIMDE_FLOAT16_C(  -263.89) },
        { SIMDE_FLOAT16_C(   221.62), SIMDE_FLOAT16_C(  -525.52), SIMDE_FLOAT16_C(  -411.87), SIMDE_FLOAT16_C(   852.73),
          SIMDE_FLOAT16_C(  -811.76), SIMDE_FLOAT16_C(   671.94), SIMDE_FLOAT16_C(  -434.20), SIMDE_FLOAT16_C(   754.63) } } },
    { { SIMDE_FLOAT16_C(  -877.85), SIMDE_FLOAT16_C(  -225.98), SIMDE_FLOAT16_C(  -292.03), SIMDE_FLOAT16_C(   932.32),
        SIMDE_FLOAT16_C(  -463.10), SIMDE_FLOAT16_C(   171.18), SIMDE_FLOAT16_C(  -115.23), SIMDE_FLOAT16_C(  -867.52),
        SIMDE_FLOAT16_C(  -182.14), SIMDE_FLOAT16_C(   874.57), SIMDE_FLOAT16_C(  -306.44), SIMDE_FLOAT16_C(   180.87),
        SIMDE_FLOAT16_C(  -827.59), SIMDE_FLOAT16_C(  -449.53), SIMDE_FLOAT16_C(  -593.39), SIMDE_FLOAT16_C(   966.11) },
        { { SIMDE_FLOAT16_C(  -877.85), SIMDE_FLOAT16_C(  -292.03), SIMDE_FLOAT16_C(  -463.10), SIMDE_FLOAT16_C(  -115.23),
            SIMDE_FLOAT16_C(  -182.14), SIMDE_FLOAT16_C(  -306.44), SIMDE_FLOAT16_C(  -827.59), SIMDE_FLOAT16_C(  -593.39) },
          { SIMDE_FLOAT16_C(  -225.98), SIMDE_FLOAT16_C(   932.32), SIMDE_FLOAT16_C(   171.18), SIMDE_FLOAT16_C(  -867.52),
            SIMDE_FLOAT16_C(   874.57), SIMDE_FLOAT16_C(   180.87), SIMDE_FLOAT16_C(  -449.53), SIMDE_FLOAT16_C(   966.11) } } },
    { { SIMDE_FLOAT16_C(   772.09), SIMDE_FLOAT16_C(  -811.82), SIMDE_FLOAT16_C(  -559.40), SIMDE_FLOAT16_C(   573.08),
        SIMDE_FLOAT16_C(  -223.69), SIMDE_FLOAT16_C(   924.59), SIMDE_FLOAT16_C(   425.81), SIMDE_FLOAT16_C(   343.06),
        SIMDE_FLOAT16_C(  -887.17), SIMDE_FLOAT16_C(   962.76), SIMDE_FLOAT16_C(    15.01), SIMDE_FLOAT16_C(    51.89),
        SIMDE_FLOAT16_C(  -471.44), SIMDE_FLOAT16_C(   751.11), SIMDE_FLOAT16_C(  -193.48), SIMDE_FLOAT16_C(  -349.29) },
        { { SIMDE_FLOAT16_C(   772.09), SIMDE_FLOAT16_C(  -559.40), SIMDE_FLOAT16_C(  -223.69), SIMDE_FLOAT16_C(   425.81),
            SIMDE_FLOAT16_C(  -887.17), SIMDE_FLOAT16_C(    15.01), SIMDE_FLOAT16_C(  -471.44), SIMDE_FLOAT16_C(  -193.48) },
          { SIMDE_FLOAT16_C(  -811.82), SIMDE_FLOAT16_C(   573.08), SIMDE_FLOAT16_C(   924.59), SIMDE_FLOAT16_C(   343.06),
            SIMDE_FLOAT16_C(   962.76), SIMDE_FLOAT16_C(    51.89), SIMDE_FLOAT16_C(   751.11), SIMDE_FLOAT16_C(  -349.29) } } },
    { { SIMDE_FLOAT16_C(  -474.87), SIMDE_FLOAT16_C(   514.49), SIMDE_FLOAT16_C(  -416.97), SIMDE_FLOAT16_C(    62.03),
        SIMDE_FLOAT16_C(  -314.33), SIMDE_FLOAT16_C(   467.80), SIMDE_FLOAT16_C(   194.51), SIMDE_FLOAT16_C(   503.53),
        SIMDE_FLOAT16_C(   342.37), SIMDE_FLOAT16_C(   888.07), SIMDE_FLOAT16_C(  -315.60), SIMDE_FLOAT16_C(   514.77),
        SIMDE_FLOAT16_C(  -561.46), SIMDE_FLOAT16_C(    91.01), SIMDE_FLOAT16_C(   480.89), SIMDE_FLOAT16_C(  -789.37) },
        { { SIMDE_FLOAT16_C(  -474.87), SIMDE_FLOAT16_C(  -416.97), SIMDE_FLOAT16_C(  -314.33), SIMDE_FLOAT16_C(   194.51),
            SIMDE_FLOAT16_C(   342.37), SIMDE_FLOAT16_C(  -315.60), SIMDE_FLOAT16_C(  -561.46), SIMDE_FLOAT16_C(   480.89) },
          { SIMDE_FLOAT16_C(   514.49), SIMDE_FLOAT16_C(    62.03), SIMDE_FLOAT16_C(   467.80), SIMDE_FLOAT16_C(   503.53),
            SIMDE_FLOAT16_C(   888.07), SIMDE_FLOAT16_C(   514.77), SIMDE_FLOAT16_C(    91.01), SIMDE_FLOAT16_C(  -789.37) }  } },
  };
