...
test_simde_vrecpe_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(-3.50), SIMDE_FLOAT16_C(-3.90), SIMDE_FLOAT16_C(5.70), SIMDE_FLOAT16_C(-7.70) },
      { SIMDE_FLOAT16_C(-0.29), SIMDE_FLOAT16_C(-0.26), SIMDE_FLOAT16_C(0.18), SIMDE_FLOAT16_C(-0.13) } },
    { { SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(3.40), SIMDE_FLOAT16_C(-7.20), SIMDE_FLOAT16_C(-7.50) },
      { SIMDE_FLOAT16_C(0.27), SIMDE_FLOAT16_C(0.29), SIMDE_FLOAT16_C(-0.14), SIMDE_FLOAT16_C(-0.13) } },
    { { SIMDE_FLOAT16_C(-9.70), SIMDE_FLOAT16_C(7.30), SIMDE_FLOAT16_C(7.80), SIMDE_FLOAT16_C(8.90) },
      { SIMDE_FLOAT16_C(-0.10), SIMDE_FLOAT16_C(0.14), SIMDE_FLOAT16_C(0.13), SIMDE_FLOAT16_C(0.11) } },
    { { SIMDE_FLOAT16_C(5.10), SIMDE_FLOAT16_C(-8.90), SIMDE_FLOAT16_C(-4.90), SIMDE_FLOAT16_C(-1.50) },
      { SIMDE_FLOAT16_C(0.20), SIMDE_FLOAT16_C(-0.11), SIMDE_FLOAT16_C(-0.20), SIMDE_FLOAT16_C(-0.67) } },
    { { SIMDE_FLOAT16_C(10.00), SIMDE_FLOAT16_C(7.00), SIMDE_FLOAT16_C(-0.20), SIMDE_FLOAT16_C(-5.20) },
      { SIMDE_FLOAT16_C(0.10), SIMDE_FLOAT16_C(0.14), SIMDE_FLOAT16_C(-5.00), SIMDE_FLOAT16_C(-0.19) } },
    { { SIMDE_FLOAT16_C(-6.40), SIMDE_FLOAT16_C(2.40), SIMDE_FLOAT16_C(8.90), SIMDE_FLOAT16_C(-0.90) },
      { SIMDE_FLOAT16_C(-0.16), SIMDE_FLOAT16_C(0.42), SIMDE_FLOAT16_C(0.11), SIMDE_FLOAT16_C(-1.11) } },
    { { SIMDE_FLOAT16_C(2.10), SIMDE_FLOAT16_C(7.50), SIMDE_FLOAT16_C(0.60), SIMDE_FLOAT16_C(-2.50) },
      { SIMDE_FLOAT16_C(0.48), SIMDE_FLOAT16_C(0.13), SIMDE_FLOAT16_C(1.67), SIMDE_FLOAT16_C(-0.40) } },
    { { SIMDE_FLOAT16_C(-3.50), SIMDE_FLOAT16_C(-9.40), SIMDE_FLOAT16_C(-3.00), SIMDE_FLOAT16_C(7.00) },
      { SIMDE_FLOAT16_C(-0.29), SIMDE_FLOAT16_C(-0.11), SIMDE_FLOAT16_C(-0.33), SIMDE_FLOAT16_C(0.14) } },
    { { SIMDE_FLOAT16_C(-6.10), SIMDE_FLOAT16_C(9.00), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(2.20) },
      { SIMDE_FLOAT16_C(-0.16), SIMDE_FLOAT16_C(0.11), SIMDE_FLOAT16_C(-0.50), SIMDE_FLOAT16_C(0.45) } },
    { { SIMDE_FLOAT16_C(4.00), SIMDE_FLOAT16_C(4.20), SIMDE_FLOAT16_C(-4.90), SIMDE_FLOAT16_C(1.60) },
      { SIMDE_FLOAT16_C(0.25), SIMDE_FLOAT16_C(0.24), SIMDE_FLOAT16_C(-0.20), SIMDE_FLOAT16_C(0.63) } },
  };
...
test_simde_vrecpeq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(7.50), SIMDE_FLOAT16_C(-9.30), SIMDE_FLOAT16_C(7.50), SIMDE_FLOAT16_C(-3.10), SIMDE_FLOAT16_C(5.00), SIMDE_FLOAT16_C(-3.50), SIMDE_FLOAT16_C(-3.70), SIMDE_FLOAT16_C(9.10) },
      { SIMDE_FLOAT16_C(0.13), SIMDE_FLOAT16_C(-0.11), SIMDE_FLOAT16_C(0.13), SIMDE_FLOAT16_C(-0.32), SIMDE_FLOAT16_C(0.20), SIMDE_FLOAT16_C(-0.29), SIMDE_FLOAT16_C(-0.27), SIMDE_FLOAT16_C(0.11) } },
    { { SIMDE_FLOAT16_C(5.50), SIMDE_FLOAT16_C(-9.60), SIMDE_FLOAT16_C(3.80), SIMDE_FLOAT16_C(9.10), SIMDE_FLOAT16_C(4.80), SIMDE_FLOAT16_C(-9.30), SIMDE_FLOAT16_C(6.60), SIMDE_FLOAT16_C(-5.20) },
      { SIMDE_FLOAT16_C(0.18), SIMDE_FLOAT16_C(-0.10), SIMDE_FLOAT16_C(0.26), SIMDE_FLOAT16_C(0.11), SIMDE_FLOAT16_C(0.21), SIMDE_FLOAT16_C(-0.11), SIMDE_FLOAT16_C(0.15), SIMDE_FLOAT16_C(-0.19) } },
    { { SIMDE_FLOAT16_C(-4.20), SIMDE_FLOAT16_C(-3.20), SIMDE_FLOAT16_C(7.60), SIMDE_FLOAT16_C(5.30), SIMDE_FLOAT16_C(2.60), SIMDE_FLOAT16_C(-3.40), SIMDE_FLOAT16_C(9.40), SIMDE_FLOAT16_C(-8.60) },
      { SIMDE_FLOAT16_C(-0.24), SIMDE_FLOAT16_C(-0.31), SIMDE_FLOAT16_C(0.13), SIMDE_FLOAT16_C(0.19), SIMDE_FLOAT16_C(0.38), SIMDE_FLOAT16_C(-0.29), SIMDE_FLOAT16_C(0.11), SIMDE_FLOAT16_C(-0.12) } },
    { { SIMDE_FLOAT16_C(-3.40), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(1.50), SIMDE_FLOAT16_C(4.50), SIMDE_FLOAT16_C(8.60), SIMDE_FLOAT16_C(6.60), SIMDE_FLOAT16_C(4.30), SIMDE_FLOAT16_C(9.10) },
      { SIMDE_FLOAT16_C(-0.29), SIMDE_FLOAT16_C(-1.43), SIMDE_FLOAT16_C(0.67), SIMDE_FLOAT16_C(0.22), SIMDE_FLOAT16_C(0.12), SIMDE_FLOAT16_C(0.15), SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.11) } },
    { { SIMDE_FLOAT16_C(-5.80), SIMDE_FLOAT16_C(6.00), SIMDE_FLOAT16_C(-9.00), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(4.90), SIMDE_FLOAT16_C(0.30), SIMDE_FLOAT16_C(-9.30) },
      { SIMDE_FLOAT16_C(-0.17), SIMDE_FLOAT16_C(0.17), SIMDE_FLOAT16_C(-0.11), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(-0.37), SIMDE_FLOAT16_C(0.20), SIMDE_FLOAT16_C(3.33), SIMDE_FLOAT16_C(-0.11) } },
    { { SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(8.80), SIMDE_FLOAT16_C(-6.10), SIMDE_FLOAT16_C(6.70), SIMDE_FLOAT16_C(-3.90), SIMDE_FLOAT16_C(8.40), SIMDE_FLOAT16_C(4.40), SIMDE_FLOAT16_C(4.10) },
      { SIMDE_FLOAT16_C(-0.37), SIMDE_FLOAT16_C(0.11), SIMDE_FLOAT16_C(-0.16), SIMDE_FLOAT16_C(0.15), SIMDE_FLOAT16_C(-0.26), SIMDE_FLOAT16_C(0.12), SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.24) } },
    { { SIMDE_FLOAT16_C(-1.40), SIMDE_FLOAT16_C(-9.20), SIMDE_FLOAT16_C(9.00), SIMDE_FLOAT16_C(7.20), SIMDE_FLOAT16_C(-4.30), SIMDE_FLOAT16_C(8.60), SIMDE_FLOAT16_C(1.70), SIMDE_FLOAT16_C(6.70) },
      { SIMDE_FLOAT16_C(-0.71), SIMDE_FLOAT16_C(-0.11), SIMDE_FLOAT16_C(0.11), SIMDE_FLOAT16_C(0.14), SIMDE_FLOAT16_C(-0.23), SIMDE_FLOAT16_C(0.12), SIMDE_FLOAT16_C(0.59), SIMDE_FLOAT16_C(0.15) } },
    { { SIMDE_FLOAT16_C(-7.20), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(-3.10), SIMDE_FLOAT16_C(6.00), SIMDE_FLOAT16_C(1.70), SIMDE_FLOAT16_C(7.20), SIMDE_FLOAT16_C(-9.80), SIMDE_FLOAT16_C(9.90) },
      { SIMDE_FLOAT16_C(-0.14), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(-0.32), SIMDE_FLOAT16_C(0.17), SIMDE_FLOAT16_C(0.59), SIMDE_FLOAT16_C(0.14), SIMDE_FLOAT16_C(-0.10), SIMDE_FLOAT16_C(0.10) } },
    { { SIMDE_FLOAT16_C(1.40), SIMDE_FLOAT16_C(-4.00), SIMDE_FLOAT16_C(-6.20), SIMDE_FLOAT16_C(6.00), SIMDE_FLOAT16_C(6.90), SIMDE_FLOAT16_C(2.40), SIMDE_FLOAT16_C(6.60), SIMDE_FLOAT16_C(3.00) },
      { SIMDE_FLOAT16_C(0.71), SIMDE_FLOAT16_C(-0.25), SIMDE_FLOAT16_C(-0.16), SIMDE_FLOAT16_C(0.17), SIMDE_FLOAT16_C(0.14), SIMDE_FLOAT16_C(0.42), SIMDE_FLOAT16_C(0.15), SIMDE_FLOAT16_C(0.33) } },
    { { SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(-0.40), SIMDE_FLOAT16_C(9.50), SIMDE_FLOAT16_C(-4.70), SIMDE_FLOAT16_C(7.10), SIMDE_FLOAT16_C(4.30), SIMDE_FLOAT16_C(3.00), SIMDE_FLOAT16_C(-7.70) },
      { SIMDE_FLOAT16_C(-1.43), SIMDE_FLOAT16_C(-2.50), SIMDE_FLOAT16_C(0.11), SIMDE_FLOAT16_C(-0.21), SIMDE_FLOAT16_C(0.14), SIMDE_FLOAT16_C(0.23), SIMDE_FLOAT16_C(0.33), SIMDE_FLOAT16_C(-0.13) } },
  };
