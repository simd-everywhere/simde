...
test_simde_vrsqrts_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(    -1.81), SIMDE_FLOAT16_C(     6.08),
        SIMDE_FLOAT16_C(     4.44), SIMDE_FLOAT16_C(     6.63) },
      { SIMDE_FLOAT16_C(    -0.75), SIMDE_FLOAT16_C(     3.06),
        SIMDE_FLOAT16_C(     5.97), SIMDE_FLOAT16_C(    -5.82) },
      { SIMDE_FLOAT16_C(     0.82), SIMDE_FLOAT16_C(    -7.80),
        SIMDE_FLOAT16_C(   -11.75), SIMDE_FLOAT16_C(    20.79) } },
    { { SIMDE_FLOAT16_C(    -4.07), SIMDE_FLOAT16_C(     2.30),
        SIMDE_FLOAT16_C(    -7.18), SIMDE_FLOAT16_C(    -5.76) },
      { SIMDE_FLOAT16_C(    -2.84), SIMDE_FLOAT16_C(    -2.53),
        SIMDE_FLOAT16_C(     0.29), SIMDE_FLOAT16_C(    -6.65) },
      { SIMDE_FLOAT16_C(    -4.28), SIMDE_FLOAT16_C(     4.41),
        SIMDE_FLOAT16_C(     2.54), SIMDE_FLOAT16_C(   -17.65) } },
    { { SIMDE_FLOAT16_C(    -6.30), SIMDE_FLOAT16_C(    -9.44),
        SIMDE_FLOAT16_C(     9.05), SIMDE_FLOAT16_C(     4.99) },
      { SIMDE_FLOAT16_C(    -1.04), SIMDE_FLOAT16_C(     1.58),
        SIMDE_FLOAT16_C(     3.75), SIMDE_FLOAT16_C(    -1.14) },
      { SIMDE_FLOAT16_C(    -1.78), SIMDE_FLOAT16_C(     8.96),
        SIMDE_FLOAT16_C(   -15.47), SIMDE_FLOAT16_C(     4.34) } },
    { { SIMDE_FLOAT16_C(    -6.57), SIMDE_FLOAT16_C(    -6.46),
        SIMDE_FLOAT16_C(     4.91), SIMDE_FLOAT16_C(     1.78) },
      { SIMDE_FLOAT16_C(    -0.70), SIMDE_FLOAT16_C(     8.06),
        SIMDE_FLOAT16_C(     6.18), SIMDE_FLOAT16_C(    -6.90) },
      { SIMDE_FLOAT16_C(    -0.80), SIMDE_FLOAT16_C(    27.53),
        SIMDE_FLOAT16_C(   -13.67), SIMDE_FLOAT16_C(     7.64) } },
  };
...
test_simde_vrsqrtsq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(    -2.14), SIMDE_FLOAT16_C(    -4.57), SIMDE_FLOAT16_C(     6.16), SIMDE_FLOAT16_C(    -7.69),
        SIMDE_FLOAT16_C(    -5.58), SIMDE_FLOAT16_C(     3.64), SIMDE_FLOAT16_C(     5.46), SIMDE_FLOAT16_C(    -2.76) },
      { SIMDE_FLOAT16_C(    -7.94), SIMDE_FLOAT16_C(     2.13), SIMDE_FLOAT16_C(    -3.52), SIMDE_FLOAT16_C(    -2.01),
        SIMDE_FLOAT16_C(     7.89), SIMDE_FLOAT16_C(    -4.25), SIMDE_FLOAT16_C(     0.59), SIMDE_FLOAT16_C(    -8.41) },
      { SIMDE_FLOAT16_C(    -7.00), SIMDE_FLOAT16_C(     6.37), SIMDE_FLOAT16_C(    12.34), SIMDE_FLOAT16_C(    -6.23),
        SIMDE_FLOAT16_C(    23.51), SIMDE_FLOAT16_C(     9.24), SIMDE_FLOAT16_C(    -0.11), SIMDE_FLOAT16_C(   -10.11) } },
    { { SIMDE_FLOAT16_C(    -3.70), SIMDE_FLOAT16_C(     9.56), SIMDE_FLOAT16_C(     3.17), SIMDE_FLOAT16_C(    -4.64),
        SIMDE_FLOAT16_C(     0.47), SIMDE_FLOAT16_C(    -6.48), SIMDE_FLOAT16_C(     6.04), SIMDE_FLOAT16_C(    -4.62) },
      { SIMDE_FLOAT16_C(     4.55), SIMDE_FLOAT16_C(    -3.08), SIMDE_FLOAT16_C(     4.22), SIMDE_FLOAT16_C(     7.98),
        SIMDE_FLOAT16_C(     5.30), SIMDE_FLOAT16_C(     2.22), SIMDE_FLOAT16_C(    -1.53), SIMDE_FLOAT16_C(    -6.84) },
      { SIMDE_FLOAT16_C(     9.92), SIMDE_FLOAT16_C(    16.22), SIMDE_FLOAT16_C(    -5.19), SIMDE_FLOAT16_C(    20.01),
        SIMDE_FLOAT16_C(     0.25), SIMDE_FLOAT16_C(     8.69), SIMDE_FLOAT16_C(     6.12), SIMDE_FLOAT16_C(   -14.30) } },
    { { SIMDE_FLOAT16_C(     7.64), SIMDE_FLOAT16_C(    -5.37), SIMDE_FLOAT16_C(    -4.53), SIMDE_FLOAT16_C(     9.70),
        SIMDE_FLOAT16_C(    -4.41), SIMDE_FLOAT16_C(    -6.85), SIMDE_FLOAT16_C(    -1.58), SIMDE_FLOAT16_C(    -6.52) },
      { SIMDE_FLOAT16_C(     6.76), SIMDE_FLOAT16_C(     1.95), SIMDE_FLOAT16_C(    -2.31), SIMDE_FLOAT16_C(    -8.82),
        SIMDE_FLOAT16_C(    -1.10), SIMDE_FLOAT16_C(     9.02), SIMDE_FLOAT16_C(    -4.93), SIMDE_FLOAT16_C(     5.20) },
      { SIMDE_FLOAT16_C(   -24.32), SIMDE_FLOAT16_C(     6.74), SIMDE_FLOAT16_C(    -3.73), SIMDE_FLOAT16_C(    44.28),
        SIMDE_FLOAT16_C(    -0.93), SIMDE_FLOAT16_C(    32.39), SIMDE_FLOAT16_C(    -2.39), SIMDE_FLOAT16_C(    18.45) } },
    { { SIMDE_FLOAT16_C(     8.57), SIMDE_FLOAT16_C(     8.24), SIMDE_FLOAT16_C(    -9.44), SIMDE_FLOAT16_C(     3.12),
        SIMDE_FLOAT16_C(     8.30), SIMDE_FLOAT16_C(    -2.87), SIMDE_FLOAT16_C(    -8.99), SIMDE_FLOAT16_C(     3.60) },
      { SIMDE_FLOAT16_C(    -4.83), SIMDE_FLOAT16_C(     4.78), SIMDE_FLOAT16_C(     1.10), SIMDE_FLOAT16_C(     5.63),
        SIMDE_FLOAT16_C(     9.35), SIMDE_FLOAT16_C(    -0.52), SIMDE_FLOAT16_C(     6.77), SIMDE_FLOAT16_C(     6.99) },
      { SIMDE_FLOAT16_C(    22.20), SIMDE_FLOAT16_C(   -18.19), SIMDE_FLOAT16_C(     6.69), SIMDE_FLOAT16_C(    -7.28),
        SIMDE_FLOAT16_C(   -37.30), SIMDE_FLOAT16_C(     0.75), SIMDE_FLOAT16_C(    31.93), SIMDE_FLOAT16_C(   -11.08) } }
  };
...
test_simde_vrsqrtsh_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { SIMDE_FLOAT16_C(    -1.81),
      SIMDE_FLOAT16_C(    -0.75),
      SIMDE_FLOAT16_C(     0.82) },
    { SIMDE_FLOAT16_C(     4.44),
      SIMDE_FLOAT16_C(     5.97),
      SIMDE_FLOAT16_C(   -11.75) },
    { SIMDE_FLOAT16_C(    -4.07),
      SIMDE_FLOAT16_C(    -2.84),
      SIMDE_FLOAT16_C(    -4.28) },
    { SIMDE_FLOAT16_C(    -7.18),
      SIMDE_FLOAT16_C(     0.29),
      SIMDE_FLOAT16_C(     2.54) },
    { SIMDE_FLOAT16_C(    -6.30),
      SIMDE_FLOAT16_C(    -1.04),
      SIMDE_FLOAT16_C(    -1.78) },
    { SIMDE_FLOAT16_C(     9.05),
      SIMDE_FLOAT16_C(     3.75),
      SIMDE_FLOAT16_C(   -15.47) },
    { SIMDE_FLOAT16_C(    -6.57),
      SIMDE_FLOAT16_C(    -0.70),
      SIMDE_FLOAT16_C(    -0.80) },
    { SIMDE_FLOAT16_C(     4.91),
      SIMDE_FLOAT16_C(     6.18),
      SIMDE_FLOAT16_C(   -13.67) },
    { SIMDE_FLOAT16_C(     6.08),
      SIMDE_FLOAT16_C(     3.06),
      SIMDE_FLOAT16_C(    -7.80) },
    { SIMDE_FLOAT16_C(     6.63),
      SIMDE_FLOAT16_C(    -5.82),
      SIMDE_FLOAT16_C(    20.79) },
    { SIMDE_FLOAT16_C(     2.30),
      SIMDE_FLOAT16_C(    -2.53),
      SIMDE_FLOAT16_C(     4.41) },
    { SIMDE_FLOAT16_C(    -5.76),
      SIMDE_FLOAT16_C(    -6.65),
      SIMDE_FLOAT16_C(   -17.65) },
    { SIMDE_FLOAT16_C(    -9.44),
      SIMDE_FLOAT16_C(     1.58),
      SIMDE_FLOAT16_C(     8.96) },
    { SIMDE_FLOAT16_C(     4.99),
      SIMDE_FLOAT16_C(    -1.14),
      SIMDE_FLOAT16_C(     4.34) },
    { SIMDE_FLOAT16_C(    -6.46),
      SIMDE_FLOAT16_C(     8.06),
      SIMDE_FLOAT16_C(    27.53) },
    { SIMDE_FLOAT16_C(     1.78),
      SIMDE_FLOAT16_C(    -6.90),
      SIMDE_FLOAT16_C(     7.64) }
 };
