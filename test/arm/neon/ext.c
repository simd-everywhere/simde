...
test_simde_vext_f32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_float32x2_t r = simde_vext_f32(a, b, n);
...
test_simde_vext_f64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_float64x1_t r = simde_vext_f64(a, b, n);
...
test_simde_vext_s8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_int8x8_t r = simde_vext_s8(a, b, n);
...
test_simde_vext_s16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_int16x4_t r = simde_vext_s16(a, b, n);
...
test_simde_vext_s32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_int32x2_t r = simde_vext_s32(a, b, n);
...
test_simde_vext_s64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_int64x1_t r = simde_vext_s64(a, b, n);
...
test_simde_vext_u8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_uint8x8_t r = simde_vext_u8(a, b, n);
...
test_simde_vext_u16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_uint16x4_t r = simde_vext_u16(a, b, n);
...
test_simde_vext_u32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_uint32x2_t r = simde_vext_u32(a, b, n);
...
test_simde_vext_u64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_uint64x1_t r = simde_vext_u64(a, b, n);
...
test_simde_vextq_f32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_float32x4_t r = simde_vextq_f32(a, b, n);
...
test_simde_vextq_f64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_float64x2_t r = simde_vextq_f64(a, b, n);
...
test_simde_vextq_s8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_int8x16_t r = simde_vextq_s8(a, b, n);
...
test_simde_vextq_s16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_int16x8_t r = simde_vextq_s16(a, b, n);
...
test_simde_vextq_s32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_int32x4_t r = simde_vextq_s32(a, b, n);
...
test_simde_vextq_s64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_int64x2_t r = simde_vextq_s64(a, b, n);
...
test_simde_vextq_u8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_uint8x16_t r = simde_vextq_u8(a, b, n);
...
test_simde_vextq_u16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_uint16x8_t r = simde_vextq_u16(a, b, n);
...
test_simde_vextq_u32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_uint32x4_t r = simde_vextq_u32(a, b, n);
...
test_simde_vextq_u64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    simde_uint64x2_t r = simde_vextq_u64(a, b, n);
