...
test_simde_vext_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    { { SIMDE_FLOAT16_C(-13.7), SIMDE_FLOAT16_C(-11.7), SIMDE_FLOAT16_C(-14.2), SIMDE_FLOAT16_C(-6.9) },
      { SIMDE_FLOAT16_C(-1.5), SIMDE_FLOAT16_C(-6.5), SIMDE_FLOAT16_C(-12.9), SIMDE_FLOAT16_C(7.6) },
        INT32_C(3),
      { SIMDE_FLOAT16_C(-6.9), SIMDE_FLOAT16_C(-1.5), SIMDE_FLOAT16_C(-6.5), SIMDE_FLOAT16_C(-12.9) } },
    { { SIMDE_FLOAT16_C(-11.0), SIMDE_FLOAT16_C(0.5), SIMDE_FLOAT16_C(0.4), SIMDE_FLOAT16_C(-9.1) },
      { SIMDE_FLOAT16_C(8.7), SIMDE_FLOAT16_C(-5.3), SIMDE_FLOAT16_C(5.4), SIMDE_FLOAT16_C(5.8) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(-11.0), SIMDE_FLOAT16_C(0.5), SIMDE_FLOAT16_C(0.4), SIMDE_FLOAT16_C(-9.1) } },
    { { SIMDE_FLOAT16_C(-6.9), SIMDE_FLOAT16_C(-14.8), SIMDE_FLOAT16_C(13.5), SIMDE_FLOAT16_C(-10.6) },
      { SIMDE_FLOAT16_C(11.1), SIMDE_FLOAT16_C(12.9), SIMDE_FLOAT16_C(2.9), SIMDE_FLOAT16_C(-7.8) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(-6.9), SIMDE_FLOAT16_C(-14.8), SIMDE_FLOAT16_C(13.5), SIMDE_FLOAT16_C(-10.6) } },
    { { SIMDE_FLOAT16_C(0.5), SIMDE_FLOAT16_C(12.8), SIMDE_FLOAT16_C(6.3), SIMDE_FLOAT16_C(11.0) },
      { SIMDE_FLOAT16_C(11.2), SIMDE_FLOAT16_C(8.6), SIMDE_FLOAT16_C(8.6), SIMDE_FLOAT16_C(-0.5) },
        INT32_C(2),
      { SIMDE_FLOAT16_C(6.3), SIMDE_FLOAT16_C(11.0), SIMDE_FLOAT16_C(11.2), SIMDE_FLOAT16_C(8.6) } },
    { { SIMDE_FLOAT16_C(-6.9), SIMDE_FLOAT16_C(-7.3), SIMDE_FLOAT16_C(10.8), SIMDE_FLOAT16_C(-5.3) },
      { SIMDE_FLOAT16_C(10.8), SIMDE_FLOAT16_C(-6.5), SIMDE_FLOAT16_C(11.4), SIMDE_FLOAT16_C(2.7) },
        INT32_C(2),
      { SIMDE_FLOAT16_C(10.8), SIMDE_FLOAT16_C(-5.3), SIMDE_FLOAT16_C(10.8), SIMDE_FLOAT16_C(-6.5) } },
    { { SIMDE_FLOAT16_C(-8.3), SIMDE_FLOAT16_C(-14.3), SIMDE_FLOAT16_C(14.6), SIMDE_FLOAT16_C(-0.7) },
      { SIMDE_FLOAT16_C(-1.5), SIMDE_FLOAT16_C(14.2), SIMDE_FLOAT16_C(-14.9), SIMDE_FLOAT16_C(8.1) },
        INT32_C(1),
      { SIMDE_FLOAT16_C(-14.3), SIMDE_FLOAT16_C(14.6), SIMDE_FLOAT16_C(-0.7), SIMDE_FLOAT16_C(-1.5) } },
    { { SIMDE_FLOAT16_C(15.0), SIMDE_FLOAT16_C(1.1), SIMDE_FLOAT16_C(11.7), SIMDE_FLOAT16_C(-13.5) },
      { SIMDE_FLOAT16_C(-0.2), SIMDE_FLOAT16_C(-4.4), SIMDE_FLOAT16_C(-9.7), SIMDE_FLOAT16_C(6.9) },
        INT32_C(0),
      { SIMDE_FLOAT16_C(15.0), SIMDE_FLOAT16_C(1.1), SIMDE_FLOAT16_C(11.7), SIMDE_FLOAT16_C(-13.5) } },
    { { SIMDE_FLOAT16_C(1.0), SIMDE_FLOAT16_C(9.5), SIMDE_FLOAT16_C(-12.1), SIMDE_FLOAT16_C(-3.7) },
      { SIMDE_FLOAT16_C(8.1), SIMDE_FLOAT16_C(2.0), SIMDE_FLOAT16_C(-12.1), SIMDE_FLOAT16_C(8.3) },
        INT32_C(1),
      { SIMDE_FLOAT16_C(9.5), SIMDE_FLOAT16_C(-12.1), SIMDE_FLOAT16_C(-3.7), SIMDE_FLOAT16_C(8.1) } },
    { { SIMDE_FLOAT16_C(-0.4), SIMDE_FLOAT16_C(-12.9), SIMDE_FLOAT16_C(-7.7), SIMDE_FLOAT16_C(0.4) },
      { SIMDE_FLOAT16_C(-3.6), SIMDE_FLOAT16_C(-0.0), SIMDE_FLOAT16_C(-0.1), SIMDE_FLOAT16_C(2.6) },
        INT32_C(3),
      { SIMDE_FLOAT16_C(0.4), SIMDE_FLOAT16_C(-3.6), SIMDE_FLOAT16_C(-0.0), SIMDE_FLOAT16_C(-0.1) } },
    { { SIMDE_FLOAT16_C(-8.6), SIMDE_FLOAT16_C(9.3), SIMDE_FLOAT16_C(2.0), SIMDE_FLOAT16_C(-9.2) },
      { SIMDE_FLOAT16_C(2.4), SIMDE_FLOAT16_C(14.3), SIMDE_FLOAT16_C(-3.8), SIMDE_FLOAT16_C(-12.6) },
        INT32_C(1),
      { SIMDE_FLOAT16_C(9.3), SIMDE_FLOAT16_C(2.0), SIMDE_FLOAT16_C(-9.2), SIMDE_FLOAT16_C(2.4) } },
  };
