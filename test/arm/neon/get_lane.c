...
test_simde_vget_lane_f32 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    simde_float32 r = simde_vget_lane_f32(a, b);
...
test_simde_vget_lane_f64 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    simde_float64 r = simde_vget_lane_f64(a, b);
...
test_simde_vget_lane_s8 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int8_t r = simde_vget_lane_s8(a, b);
...
test_simde_vget_lane_s16 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int16_t r = simde_vget_lane_s16(a, b);
...
test_simde_vget_lane_s32 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int32_t r = simde_vget_lane_s32(a, b);
...
test_simde_vget_lane_s64 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int64_t r = simde_vget_lane_s64(a, b);
...
test_simde_vget_lane_u8 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint8_t r = simde_vget_lane_u8(a, b);
...
test_simde_vget_lane_u16 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint16_t r = simde_vget_lane_u16(a, b);
...
test_simde_vget_lane_u32 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint32_t r = simde_vget_lane_u32(a, b);
...
test_simde_vget_lane_u64 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint64_t r = simde_vget_lane_u64(a, b);
...
static int
test_simde_vgetq_lane_f32 (void) {
  struct {
    simde_float32 a[4];
    int b;
    simde_float32 r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    simde_float32 r = simde_vgetq_lane_f32(a, b);
...
static int
test_simde_vgetq_lane_f64 (void) {
  struct {
    simde_float64 a[2];
    int b;
    simde_float64 r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    simde_float64 r = simde_vgetq_lane_f64(a, b);
...
static int
test_simde_vgetq_lane_s16 (void) {
  struct {
    int16_t a[8];
    int b;
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int16_t r = simde_vgetq_lane_s16(a, b);
...
static int
test_simde_vgetq_lane_s32 (void) {
  struct {
    int32_t a[4];
    int b;
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int32_t r = simde_vgetq_lane_s32(a, b);
    simde_assert_equal_i32(r, test_vec[i].r);
  }
...
static int
test_simde_vgetq_lane_s64 (void) {
  struct {
    int64_t a[2];
    int b;
    int64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int64_t r = simde_vgetq_lane_s64(a, b);
    simde_assert_equal_i64(r, test_vec[i].r);
  }
...
test_simde_vgetq_lane_u8 (void) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint8_t r = simde_vgetq_lane_u8(a, b);
...
static int
test_simde_vgetq_lane_u16 (void) {
  struct {
    uint16_t a[8];
    int b;
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint16_t r = simde_vgetq_lane_u16(a, b);
    simde_assert_equal_u16(r, test_vec[i].r);
  }
...
static int
test_simde_vgetq_lane_u32 (void) {
  struct {
    uint32_t a[4];
    int b;
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint32_t r = simde_vgetq_lane_u32(a, b);
...
static int
test_simde_vgetq_lane_u64 (void) {
  struct {
    uint64_t a[2];
    int b;
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint64_t r = simde_vgetq_lane_u64(a, b);
    simde_assert_equal_u64(r, test_vec[i].r);
  }
