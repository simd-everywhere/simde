...
test_simde_vmaxh_f16 (SIMDE_MUNIT_TEST_ARGS) {
  static const struct {
    ...
    {    SIMDE_FLOAT16_C(    27.944),
         SIMDE_FLOAT16_C(     4.766),
         SIMDE_FLOAT16_C(    27.944) },
    {   -SIMDE_FLOAT16_C(     6.101),
         SIMDE_FLOAT16_C(     6.573),
         SIMDE_FLOAT16_C(     6.573) },
    {    SIMDE_FLOAT16_C(    16.846),
         SIMDE_FLOAT16_C(     3.658),
         SIMDE_FLOAT16_C(    16.846) },
    {   -SIMDE_FLOAT16_C(     4.194),
        -SIMDE_FLOAT16_C(    13.220),
        -SIMDE_FLOAT16_C(     4.194) },
    {    SIMDE_FLOAT16_C(    12.582),
         SIMDE_FLOAT16_C(     4.663),
         SIMDE_FLOAT16_C(    12.582) },
    {    SIMDE_FLOAT16_C(    14.203),
        -SIMDE_FLOAT16_C(    15.993),
         SIMDE_FLOAT16_C(    14.203) },
    {    SIMDE_FLOAT16_C(    13.812),
         SIMDE_FLOAT16_C(     1.543),
         SIMDE_FLOAT16_C(    13.812) },
    {    SIMDE_FLOAT16_C(    25.248),
         SIMDE_FLOAT16_C(     4.234),
         SIMDE_FLOAT16_C(    25.248) },
  };
