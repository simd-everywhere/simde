...
test_simde_vuzp1q_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { -SIMDE_FLOAT16_C( 97.687), -SIMDE_FLOAT16_C( 79.004), -SIMDE_FLOAT16_C( 89.890),  SIMDE_FLOAT16_C( 40.738),
        -SIMDE_FLOAT16_C( 65.793), -SIMDE_FLOAT16_C( 23.168), -SIMDE_FLOAT16_C(  5.072),  SIMDE_FLOAT16_C( 43.484) },
      { -SIMDE_FLOAT16_C( 84.405),  SIMDE_FLOAT16_C( 65.922), -SIMDE_FLOAT16_C( 58.324), -SIMDE_FLOAT16_C( 27.090),
         SIMDE_FLOAT16_C( 15.688), -SIMDE_FLOAT16_C( 30.522),  SIMDE_FLOAT16_C( 24.014), -SIMDE_FLOAT16_C( 74.725) },
      { -SIMDE_FLOAT16_C( 97.687), -SIMDE_FLOAT16_C( 89.890), -SIMDE_FLOAT16_C( 65.793), -SIMDE_FLOAT16_C(  5.072),
        -SIMDE_FLOAT16_C( 84.405), -SIMDE_FLOAT16_C( 58.324),  SIMDE_FLOAT16_C( 15.688),  SIMDE_FLOAT16_C( 24.014) } },
    { { -SIMDE_FLOAT16_C( 75.826), -SIMDE_FLOAT16_C( 94.734), -SIMDE_FLOAT16_C( 19.540),  SIMDE_FLOAT16_C( 46.550),
         SIMDE_FLOAT16_C( 82.958),  SIMDE_FLOAT16_C( 77.773),  SIMDE_FLOAT16_C( 19.467),  SIMDE_FLOAT16_C( 62.504) },
      {  SIMDE_FLOAT16_C( 18.734),  SIMDE_FLOAT16_C( 47.806),  SIMDE_FLOAT16_C(  3.703), -SIMDE_FLOAT16_C( 50.129),
        -SIMDE_FLOAT16_C(  8.807), -SIMDE_FLOAT16_C( 57.665),  SIMDE_FLOAT16_C( 19.634), -SIMDE_FLOAT16_C( 49.723) },
      { -SIMDE_FLOAT16_C( 75.826), -SIMDE_FLOAT16_C( 19.540),  SIMDE_FLOAT16_C( 82.958),  SIMDE_FLOAT16_C( 19.467),
         SIMDE_FLOAT16_C( 18.734),  SIMDE_FLOAT16_C(  3.703), -SIMDE_FLOAT16_C(  8.807),  SIMDE_FLOAT16_C( 19.634) } },
    { { -SIMDE_FLOAT16_C( 22.928), -SIMDE_FLOAT16_C( 24.929), -SIMDE_FLOAT16_C( 92.576),  SIMDE_FLOAT16_C( 66.926),
        -SIMDE_FLOAT16_C( 61.278), -SIMDE_FLOAT16_C( 16.213),  SIMDE_FLOAT16_C( 46.549),  SIMDE_FLOAT16_C( 41.416) },
      {  SIMDE_FLOAT16_C(  2.906),  SIMDE_FLOAT16_C( 40.984),  SIMDE_FLOAT16_C( 33.772),  SIMDE_FLOAT16_C( 94.502),
         SIMDE_FLOAT16_C( 29.055),  SIMDE_FLOAT16_C( 48.251), -SIMDE_FLOAT16_C( 53.444), -SIMDE_FLOAT16_C( 10.038) },
      { -SIMDE_FLOAT16_C( 22.928), -SIMDE_FLOAT16_C( 92.576), -SIMDE_FLOAT16_C( 61.278),  SIMDE_FLOAT16_C( 46.549),
         SIMDE_FLOAT16_C(  2.906),  SIMDE_FLOAT16_C( 33.772),  SIMDE_FLOAT16_C( 29.055), -SIMDE_FLOAT16_C( 53.444) } },
    { { -SIMDE_FLOAT16_C( 43.188), -SIMDE_FLOAT16_C( 66.409),  SIMDE_FLOAT16_C( 35.235), -SIMDE_FLOAT16_C( 72.208),
        -SIMDE_FLOAT16_C( 97.543),  SIMDE_FLOAT16_C( 90.132), -SIMDE_FLOAT16_C( 47.254),  SIMDE_FLOAT16_C( 89.145) },
      { -SIMDE_FLOAT16_C( 92.430), -SIMDE_FLOAT16_C( 24.436), -SIMDE_FLOAT16_C( 87.694),  SIMDE_FLOAT16_C( 77.935),
        -SIMDE_FLOAT16_C( 17.203), -SIMDE_FLOAT16_C( 52.392),  SIMDE_FLOAT16_C( 38.656),  SIMDE_FLOAT16_C( 26.074) },
      { -SIMDE_FLOAT16_C( 43.188),  SIMDE_FLOAT16_C( 35.235), -SIMDE_FLOAT16_C( 97.543), -SIMDE_FLOAT16_C( 47.254),
        -SIMDE_FLOAT16_C( 92.430), -SIMDE_FLOAT16_C( 87.694), -SIMDE_FLOAT16_C( 17.203),  SIMDE_FLOAT16_C( 38.656) } },
    { { -SIMDE_FLOAT16_C( 65.868),  SIMDE_FLOAT16_C( 10.356), -SIMDE_FLOAT16_C( 59.186),  SIMDE_FLOAT16_C( 59.722),
        -SIMDE_FLOAT16_C( 89.649), -SIMDE_FLOAT16_C( 81.545),  SIMDE_FLOAT16_C(  7.064),  SIMDE_FLOAT16_C( 29.273) },
      {  SIMDE_FLOAT16_C( 99.268),  SIMDE_FLOAT16_C( 59.929),  SIMDE_FLOAT16_C( 54.246), -SIMDE_FLOAT16_C(  9.983),
         SIMDE_FLOAT16_C( 23.574), -SIMDE_FLOAT16_C( 94.576), -SIMDE_FLOAT16_C( 16.893),  SIMDE_FLOAT16_C( 24.448) },
      { -SIMDE_FLOAT16_C( 65.868), -SIMDE_FLOAT16_C( 59.186), -SIMDE_FLOAT16_C( 89.649),  SIMDE_FLOAT16_C(  7.064),
         SIMDE_FLOAT16_C( 99.268),  SIMDE_FLOAT16_C( 54.246),  SIMDE_FLOAT16_C( 23.574), -SIMDE_FLOAT16_C( 16.893) } },
    { { -SIMDE_FLOAT16_C( 24.032), -SIMDE_FLOAT16_C( 24.501), -SIMDE_FLOAT16_C( 16.286), -SIMDE_FLOAT16_C( 43.379),
        -SIMDE_FLOAT16_C( 89.719), -SIMDE_FLOAT16_C( 44.948), -SIMDE_FLOAT16_C( 26.410),  SIMDE_FLOAT16_C( 47.907) },
      {  SIMDE_FLOAT16_C( 80.290), -SIMDE_FLOAT16_C( 61.861),  SIMDE_FLOAT16_C( 99.823), -SIMDE_FLOAT16_C( 33.955),
        -SIMDE_FLOAT16_C( 96.942), -SIMDE_FLOAT16_C( 21.953), -SIMDE_FLOAT16_C( 83.239), -SIMDE_FLOAT16_C( 80.026) },
      { -SIMDE_FLOAT16_C( 24.032), -SIMDE_FLOAT16_C( 16.286), -SIMDE_FLOAT16_C( 89.719), -SIMDE_FLOAT16_C( 26.410),
         SIMDE_FLOAT16_C( 80.290),  SIMDE_FLOAT16_C( 99.823), -SIMDE_FLOAT16_C( 96.942), -SIMDE_FLOAT16_C( 83.239) } },
    { { -SIMDE_FLOAT16_C( 55.230), -SIMDE_FLOAT16_C( 23.393),  SIMDE_FLOAT16_C( 12.967), -SIMDE_FLOAT16_C(  8.488),
         SIMDE_FLOAT16_C( 32.610), -SIMDE_FLOAT16_C( 20.642), -SIMDE_FLOAT16_C( 49.605),  SIMDE_FLOAT16_C( 85.964) },
      {  SIMDE_FLOAT16_C( 86.315),  SIMDE_FLOAT16_C( 91.729), -SIMDE_FLOAT16_C(  6.684),  SIMDE_FLOAT16_C( 31.160),
        -SIMDE_FLOAT16_C( 10.924), -SIMDE_FLOAT16_C( 90.352),  SIMDE_FLOAT16_C( 33.044), -SIMDE_FLOAT16_C( 55.391) },
      { -SIMDE_FLOAT16_C( 55.230),  SIMDE_FLOAT16_C( 12.967),  SIMDE_FLOAT16_C( 32.610), -SIMDE_FLOAT16_C( 49.605),
         SIMDE_FLOAT16_C( 86.315), -SIMDE_FLOAT16_C(  6.684), -SIMDE_FLOAT16_C( 10.924),  SIMDE_FLOAT16_C( 33.044) } },
    { {  SIMDE_FLOAT16_C( 63.752), -SIMDE_FLOAT16_C( 40.489), -SIMDE_FLOAT16_C( 58.676), -SIMDE_FLOAT16_C( 83.592),
         SIMDE_FLOAT16_C( 74.115), -SIMDE_FLOAT16_C( 76.605),  SIMDE_FLOAT16_C( 25.040),  SIMDE_FLOAT16_C( 69.197) },
      {  SIMDE_FLOAT16_C( 16.183),  SIMDE_FLOAT16_C( 14.003), -SIMDE_FLOAT16_C( 41.902), -SIMDE_FLOAT16_C( 14.309),
        -SIMDE_FLOAT16_C( 63.990), -SIMDE_FLOAT16_C( 92.928), -SIMDE_FLOAT16_C( 54.163),  SIMDE_FLOAT16_C( 94.671) },
      {  SIMDE_FLOAT16_C( 63.752), -SIMDE_FLOAT16_C( 58.676),  SIMDE_FLOAT16_C( 74.115),  SIMDE_FLOAT16_C( 25.040),
         SIMDE_FLOAT16_C( 16.183), -SIMDE_FLOAT16_C( 41.902), -SIMDE_FLOAT16_C( 63.990), -SIMDE_FLOAT16_C( 54.163) } },
  };
