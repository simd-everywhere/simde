...
test_simde_vcaleh_f16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r = simde_vcaleh_f16(simde_float16_from_float32(test_vec[i].a), simde_float16_from_float32(test_vec[i].b));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t r = simde_vcaleh_f16(simde_float16_from_float32(a), simde_float16_from_float32(b));
...
static int
test_simde_vcales_f32 (SIMDE_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    simde_float32 b;
    simde_float32 a;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = simde_vcales_f32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = simde_vcales_f32(a, b);
...
static int
test_simde_vcaled_f64 (SIMDE_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    simde_float64 b;
    simde_float64 a;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = simde_vcaled_f64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = simde_vcaled_f64(a, b);
...
test_simde_vcale_f16 (SIMDE_MUNIT_TEST_ARGS) {
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      ...
      simde_uint16x4_t r = simde_vcale_f16(a, b);
...
static int
test_simde_vcale_f32 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    simde_float32 b[2];
    simde_float32 a[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    simde_uint32x2_t r = simde_vcale_f32(a, b);
...
static int
test_simde_vcale_f64 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    simde_float64 b[1];
    simde_float64 a[1];
    uint64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    simde_uint64x1_t r = simde_vcale_f64(a, b);
...
test_simde_vcaleq_f16 (SIMDE_MUNIT_TEST_ARGS) {
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      ...
      simde_uint16x8_t r = simde_vcaleq_f16(a, b);
...
static int
test_simde_vcaleq_f32 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    simde_float32 b[4];
    simde_float32 a[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    simde_uint32x4_t r = simde_vcaleq_f32(a, b);
...
static int
test_simde_vcaleq_f64 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    simde_float64 b[2];
    simde_float64 a[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    simde_uint64x2_t r = simde_vcaleq_f64(a, b);
...
SIMDE_TEST_FUNC_LIST_ENTRY(vcaleh_f16)
SIMDE_TEST_FUNC_LIST_ENTRY(vcales_f32)
SIMDE_TEST_FUNC_LIST_ENTRY(vcaled_f64)

SIMDE_TEST_FUNC_LIST_ENTRY(vcale_f16)
SIMDE_TEST_FUNC_LIST_ENTRY(vcale_f32)
SIMDE_TEST_FUNC_LIST_ENTRY(vcale_f64)

SIMDE_TEST_FUNC_LIST_ENTRY(vcaleq_f16)
SIMDE_TEST_FUNC_LIST_ENTRY(vcaleq_f32)
SIMDE_TEST_FUNC_LIST_ENTRY(vcaleq_f64)
