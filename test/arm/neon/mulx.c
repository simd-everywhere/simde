...
test_simde_vmulxh_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    {    SIMDE_FLOAT16_C(      12.121),
        -SIMDE_FLOAT16_C(      10.345),
        -SIMDE_FLOAT16_C(     125.392) },
    {    SIMDE_FLOAT16_C(       2.046),
        -SIMDE_FLOAT16_C(      12.841),
        -SIMDE_FLOAT16_C(      26.273) },
    {   -SIMDE_FLOAT16_C(      15.182),
         SIMDE_FLOAT16_C(      13.387),
        -SIMDE_FLOAT16_C(     203.241) },
    {   -SIMDE_FLOAT16_C(      13.502),
         SIMDE_FLOAT16_C(      14.474),
        -SIMDE_FLOAT16_C(     195.428) },
    {    SIMDE_FLOAT16_C(       2.788),
        -SIMDE_FLOAT16_C(      16.350),
        -SIMDE_FLOAT16_C(      45.584) },
    {    SIMDE_FLOAT16_C(       3.122),
        -SIMDE_FLOAT16_C(      28.460),
        -SIMDE_FLOAT16_C(      88.852) },
    {   -SIMDE_FLOAT16_C(      12.098),
         SIMDE_FLOAT16_C(       4.041),
        -SIMDE_FLOAT16_C(      48.888) },
    {   -SIMDE_FLOAT16_C(       6.972),
        -SIMDE_FLOAT16_C(       0.271),
         SIMDE_FLOAT16_C(       1.889) },
  };
...
test_simde_vmulx_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { {  SIMDE_FLOAT16_C(  11.884), -SIMDE_FLOAT16_C(  12.117), -SIMDE_FLOAT16_C(   4.469), -SIMDE_FLOAT16_C(   3.678) },
      { -SIMDE_FLOAT16_C(   7.801), -SIMDE_FLOAT16_C(   6.994),  SIMDE_FLOAT16_C(  12.408), -SIMDE_FLOAT16_C(  10.779) },
      { -SIMDE_FLOAT16_C(  92.707),  SIMDE_FLOAT16_C(  84.746), -SIMDE_FLOAT16_C(  55.451),  SIMDE_FLOAT16_C(  39.645) } },
    { { -SIMDE_FLOAT16_C(   4.989),  SIMDE_FLOAT16_C(   8.946), -SIMDE_FLOAT16_C(   9.959),  SIMDE_FLOAT16_C(   6.504) },
      {  SIMDE_FLOAT16_C(  14.524),  SIMDE_FLOAT16_C(  10.306),  SIMDE_FLOAT16_C(   3.340),  SIMDE_FLOAT16_C(   6.852) },
      { -SIMDE_FLOAT16_C(  72.460),  SIMDE_FLOAT16_C(  92.197), -SIMDE_FLOAT16_C(  33.263),  SIMDE_FLOAT16_C(  44.565) } },
    { { -SIMDE_FLOAT16_C(   3.851), -SIMDE_FLOAT16_C(   4.284), -SIMDE_FLOAT16_C(   4.962), -SIMDE_FLOAT16_C(  11.512) },
      { -SIMDE_FLOAT16_C(  11.588),  SIMDE_FLOAT16_C(   2.430), -SIMDE_FLOAT16_C(  11.397), -SIMDE_FLOAT16_C(  10.014) },
      {  SIMDE_FLOAT16_C(  44.625), -SIMDE_FLOAT16_C(  10.410),  SIMDE_FLOAT16_C(  56.552),  SIMDE_FLOAT16_C( 115.281) } },
    { {  SIMDE_FLOAT16_C(  12.957),  SIMDE_FLOAT16_C(   1.372),  SIMDE_FLOAT16_C(   0.880),  SIMDE_FLOAT16_C(  11.068) },
      { -SIMDE_FLOAT16_C(   8.646),  SIMDE_FLOAT16_C(   1.274), -SIMDE_FLOAT16_C(   4.545), -SIMDE_FLOAT16_C(  14.868) },
      { -SIMDE_FLOAT16_C( 112.026),  SIMDE_FLOAT16_C(   1.748), -SIMDE_FLOAT16_C(   4.000), -SIMDE_FLOAT16_C( 164.650) } },
    { { -SIMDE_FLOAT16_C(  12.078),  SIMDE_FLOAT16_C(  11.549),  SIMDE_FLOAT16_C(   5.313), -SIMDE_FLOAT16_C(   8.893) },
      { -SIMDE_FLOAT16_C(   8.061),  SIMDE_FLOAT16_C(   3.262),  SIMDE_FLOAT16_C(   7.153), -SIMDE_FLOAT16_C(   2.053) },
      {  SIMDE_FLOAT16_C(  97.361),  SIMDE_FLOAT16_C(  37.673),  SIMDE_FLOAT16_C(  38.004),  SIMDE_FLOAT16_C(  18.257) } },
    { {  SIMDE_FLOAT16_C(   6.445), -SIMDE_FLOAT16_C(   2.210),  SIMDE_FLOAT16_C(   0.604), -SIMDE_FLOAT16_C(   5.514) },
      {  SIMDE_FLOAT16_C(   0.727), -SIMDE_FLOAT16_C(   4.909),  SIMDE_FLOAT16_C(   1.339),  SIMDE_FLOAT16_C(   5.500) },
      {  SIMDE_FLOAT16_C(   4.686),  SIMDE_FLOAT16_C(  10.849),  SIMDE_FLOAT16_C(   0.809), -SIMDE_FLOAT16_C(  30.327) } },
    { {  SIMDE_FLOAT16_C(   9.710), -SIMDE_FLOAT16_C(  13.103),  SIMDE_FLOAT16_C(  14.405), -SIMDE_FLOAT16_C(   4.243) },
      {  SIMDE_FLOAT16_C(   9.862),  SIMDE_FLOAT16_C(   6.144), -SIMDE_FLOAT16_C(   4.625),  SIMDE_FLOAT16_C(  13.226) },
      {  SIMDE_FLOAT16_C(  95.760), -SIMDE_FLOAT16_C(  80.505), -SIMDE_FLOAT16_C(  66.623), -SIMDE_FLOAT16_C(  56.118) } },
    { { -SIMDE_FLOAT16_C(   0.018),  SIMDE_FLOAT16_C(   5.611),  SIMDE_FLOAT16_C(   5.991),  SIMDE_FLOAT16_C(   9.121) },
      { -SIMDE_FLOAT16_C(  10.315), -SIMDE_FLOAT16_C(   5.140),  SIMDE_FLOAT16_C(   8.418),  SIMDE_FLOAT16_C(  13.944) },
      {  SIMDE_FLOAT16_C(   0.186), -SIMDE_FLOAT16_C(  28.841),  SIMDE_FLOAT16_C(  50.432),  SIMDE_FLOAT16_C( 127.183) } },
  };
...
test_simde_vmulxq_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { {  SIMDE_FLOAT16_C(   0.818),  SIMDE_FLOAT16_C(  12.583),  SIMDE_FLOAT16_C(   2.255),  SIMDE_FLOAT16_C(   1.948),
         SIMDE_FLOAT16_C(   1.614),  SIMDE_FLOAT16_C(   2.633), -SIMDE_FLOAT16_C(   5.124), -SIMDE_FLOAT16_C(  13.340) },
      { -SIMDE_FLOAT16_C(   2.767), -SIMDE_FLOAT16_C(  11.911),  SIMDE_FLOAT16_C(  14.884), -SIMDE_FLOAT16_C(   4.149),
        -SIMDE_FLOAT16_C(   6.114),  SIMDE_FLOAT16_C(   6.690),  SIMDE_FLOAT16_C(  13.414),  SIMDE_FLOAT16_C(   8.851) },
      { -SIMDE_FLOAT16_C(   2.263), -SIMDE_FLOAT16_C( 150.000),  SIMDE_FLOAT16_C(  33.563), -SIMDE_FLOAT16_C(   8.082),
        -SIMDE_FLOAT16_C(   9.868),  SIMDE_FLOAT16_C(  17.615), -SIMDE_FLOAT16_C(  68.733), -SIMDE_FLOAT16_C( 118.072) } },
    { {  SIMDE_FLOAT16_C(   9.919),  SIMDE_FLOAT16_C(   5.810),  SIMDE_FLOAT16_C(   6.655), -SIMDE_FLOAT16_C(   6.660),
        -SIMDE_FLOAT16_C(   2.737),  SIMDE_FLOAT16_C(   9.028), -SIMDE_FLOAT16_C(   4.465),  SIMDE_FLOAT16_C(   3.449) },
      {  SIMDE_FLOAT16_C(   2.092),  SIMDE_FLOAT16_C(  10.711),  SIMDE_FLOAT16_C(  12.038), -SIMDE_FLOAT16_C(   8.015),
         SIMDE_FLOAT16_C(   0.549), -SIMDE_FLOAT16_C(   0.735), -SIMDE_FLOAT16_C(   5.604), -SIMDE_FLOAT16_C(  13.525) },
      {  SIMDE_FLOAT16_C(  20.751),  SIMDE_FLOAT16_C(  62.231),  SIMDE_FLOAT16_C(  80.113),  SIMDE_FLOAT16_C(  53.380),
        -SIMDE_FLOAT16_C(   1.503), -SIMDE_FLOAT16_C(   6.636),  SIMDE_FLOAT16_C(  25.022), -SIMDE_FLOAT16_C(  46.648) } },
    { {  SIMDE_FLOAT16_C(   2.914), -SIMDE_FLOAT16_C(  10.256),  SIMDE_FLOAT16_C(  13.016),  SIMDE_FLOAT16_C(  14.909),
        -SIMDE_FLOAT16_C(   9.884), -SIMDE_FLOAT16_C(   7.674),  SIMDE_FLOAT16_C(   5.650),  SIMDE_FLOAT16_C(  14.896) },
      {  SIMDE_FLOAT16_C(  13.592), -SIMDE_FLOAT16_C(   8.769), -SIMDE_FLOAT16_C(  13.596),  SIMDE_FLOAT16_C(  10.636),
        -SIMDE_FLOAT16_C(   4.322), -SIMDE_FLOAT16_C(  14.667), -SIMDE_FLOAT16_C(  11.936),  SIMDE_FLOAT16_C(   6.353) },
      {  SIMDE_FLOAT16_C(  39.607),  SIMDE_FLOAT16_C(  89.935), -SIMDE_FLOAT16_C( 176.875),  SIMDE_FLOAT16_C( 158.500),
         SIMDE_FLOAT16_C(  42.719),  SIMDE_FLOAT16_C( 112.555), -SIMDE_FLOAT16_C(  67.438),  SIMDE_FLOAT16_C(  94.634) } },
    { { -SIMDE_FLOAT16_C(  14.335), -SIMDE_FLOAT16_C(   0.489),  SIMDE_FLOAT16_C(  14.410),  SIMDE_FLOAT16_C(  12.424),
         SIMDE_FLOAT16_C(  13.209), -SIMDE_FLOAT16_C(   4.835), -SIMDE_FLOAT16_C(  12.749),  SIMDE_FLOAT16_C(   9.087) },
      { -SIMDE_FLOAT16_C(  14.724),  SIMDE_FLOAT16_C(  12.785), -SIMDE_FLOAT16_C(  13.619), -SIMDE_FLOAT16_C(   3.702),
        -SIMDE_FLOAT16_C(   5.130), -SIMDE_FLOAT16_C(   7.200), -SIMDE_FLOAT16_C(   3.170), -SIMDE_FLOAT16_C(  12.809) },
      {  SIMDE_FLOAT16_C( 211.069), -SIMDE_FLOAT16_C(   6.252), -SIMDE_FLOAT16_C( 196.125), -SIMDE_FLOAT16_C(  45.994),
        -SIMDE_FLOAT16_C(  67.762),  SIMDE_FLOAT16_C(  34.812),  SIMDE_FLOAT16_C(  40.414), -SIMDE_FLOAT16_C( 116.395) } },
    { {  SIMDE_FLOAT16_C(  13.181),  SIMDE_FLOAT16_C(  13.543),  SIMDE_FLOAT16_C(  13.333), -SIMDE_FLOAT16_C(   6.331),
         SIMDE_FLOAT16_C(   4.540), -SIMDE_FLOAT16_C(  10.557),  SIMDE_FLOAT16_C(  10.807),  SIMDE_FLOAT16_C(   5.947) },
      { -SIMDE_FLOAT16_C(  13.643), -SIMDE_FLOAT16_C(   2.075),  SIMDE_FLOAT16_C(   7.184), -SIMDE_FLOAT16_C(   4.202),
        -SIMDE_FLOAT16_C(   0.541),  SIMDE_FLOAT16_C(   0.728),  SIMDE_FLOAT16_C(   4.217),  SIMDE_FLOAT16_C(  10.131) },
      { -SIMDE_FLOAT16_C( 179.750), -SIMDE_FLOAT16_C(  28.102),  SIMDE_FLOAT16_C(  95.784),  SIMDE_FLOAT16_C(  26.603),
        -SIMDE_FLOAT16_C(   2.456), -SIMDE_FLOAT16_C(   7.685),  SIMDE_FLOAT16_C(  45.573),  SIMDE_FLOAT16_C(  60.249) } },
    { { -SIMDE_FLOAT16_C(   6.567), -SIMDE_FLOAT16_C(   9.550),  SIMDE_FLOAT16_C(   0.753),  SIMDE_FLOAT16_C(   6.529),
         SIMDE_FLOAT16_C(  10.369),  SIMDE_FLOAT16_C(   4.970),  SIMDE_FLOAT16_C(  14.205),  SIMDE_FLOAT16_C(  11.933) },
      { -SIMDE_FLOAT16_C(  12.415),  SIMDE_FLOAT16_C(  12.896),  SIMDE_FLOAT16_C(   4.421),  SIMDE_FLOAT16_C(  13.922),
        -SIMDE_FLOAT16_C(  12.445), -SIMDE_FLOAT16_C(   2.663),  SIMDE_FLOAT16_C(   7.585),  SIMDE_FLOAT16_C(   9.726) },
      {  SIMDE_FLOAT16_C(  81.529), -SIMDE_FLOAT16_C( 123.157),  SIMDE_FLOAT16_C(   3.329),  SIMDE_FLOAT16_C(  90.897),
        -SIMDE_FLOAT16_C( 129.042), -SIMDE_FLOAT16_C(  13.235),  SIMDE_FLOAT16_C( 107.745),  SIMDE_FLOAT16_C( 116.060) } },
    { { -SIMDE_FLOAT16_C(   6.489),  SIMDE_FLOAT16_C(  10.432),  SIMDE_FLOAT16_C(   5.392), -SIMDE_FLOAT16_C(   9.475),
         SIMDE_FLOAT16_C(   5.624),  SIMDE_FLOAT16_C(  13.628), -SIMDE_FLOAT16_C(   3.195),  SIMDE_FLOAT16_C(   5.403) },
      { -SIMDE_FLOAT16_C(   5.621), -SIMDE_FLOAT16_C(   0.470),  SIMDE_FLOAT16_C(   3.713), -SIMDE_FLOAT16_C(   3.216),
         SIMDE_FLOAT16_C(   7.516),  SIMDE_FLOAT16_C(   3.058),  SIMDE_FLOAT16_C(   5.566), -SIMDE_FLOAT16_C(   7.336) },
      {  SIMDE_FLOAT16_C(  36.475), -SIMDE_FLOAT16_C(   4.903),  SIMDE_FLOAT16_C(  20.020),  SIMDE_FLOAT16_C(  30.472),
         SIMDE_FLOAT16_C(  42.270),  SIMDE_FLOAT16_C(  41.674), -SIMDE_FLOAT16_C(  17.783), -SIMDE_FLOAT16_C(  39.636) } },
    { {  SIMDE_FLOAT16_C(  12.245), -SIMDE_FLOAT16_C(   0.428), -SIMDE_FLOAT16_C(  10.456),  SIMDE_FLOAT16_C(   4.327),
         SIMDE_FLOAT16_C(   5.673), -SIMDE_FLOAT16_C(   9.628),  SIMDE_FLOAT16_C(   5.260),  SIMDE_FLOAT16_C(  10.089) },
      {  SIMDE_FLOAT16_C(  11.177),  SIMDE_FLOAT16_C(   3.546), -SIMDE_FLOAT16_C(   3.457),  SIMDE_FLOAT16_C(  10.459),
         SIMDE_FLOAT16_C(   2.200), -SIMDE_FLOAT16_C(   1.955), -SIMDE_FLOAT16_C(   3.125),  SIMDE_FLOAT16_C(   9.213) },
      {  SIMDE_FLOAT16_C( 136.862), -SIMDE_FLOAT16_C(   1.518),  SIMDE_FLOAT16_C(  36.146),  SIMDE_FLOAT16_C(  45.256),
         SIMDE_FLOAT16_C(  12.481),  SIMDE_FLOAT16_C(  18.823), -SIMDE_FLOAT16_C(  16.438),  SIMDE_FLOAT16_C(  92.950) } },
  };
