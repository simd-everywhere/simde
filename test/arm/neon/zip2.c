...
test_simde_vzip2_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { SIMDE_FLOAT16_C(-7.80), SIMDE_FLOAT16_C(3.70), SIMDE_FLOAT16_C(4.10), SIMDE_FLOAT16_C(5.50) },
      { SIMDE_FLOAT16_C(-6.10), SIMDE_FLOAT16_C(1.40), SIMDE_FLOAT16_C(5.30), SIMDE_FLOAT16_C(4.90) },
      { SIMDE_FLOAT16_C(4.10), SIMDE_FLOAT16_C(5.30), SIMDE_FLOAT16_C(5.50), SIMDE_FLOAT16_C(4.90) } },
    { { SIMDE_FLOAT16_C(3.90), SIMDE_FLOAT16_C(4.50), SIMDE_FLOAT16_C(4.60), SIMDE_FLOAT16_C(3.60) },
      { SIMDE_FLOAT16_C(6.30), SIMDE_FLOAT16_C(-1.60), SIMDE_FLOAT16_C(4.20), SIMDE_FLOAT16_C(8.40) },
      { SIMDE_FLOAT16_C(4.60), SIMDE_FLOAT16_C(4.20), SIMDE_FLOAT16_C(3.60), SIMDE_FLOAT16_C(8.40) } },
    { { SIMDE_FLOAT16_C(1.10), SIMDE_FLOAT16_C(5.00), SIMDE_FLOAT16_C(1.50), SIMDE_FLOAT16_C(1.60) },
      { SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(-8.10), SIMDE_FLOAT16_C(-4.10), SIMDE_FLOAT16_C(-6.60) },
      { SIMDE_FLOAT16_C(1.50), SIMDE_FLOAT16_C(-4.10), SIMDE_FLOAT16_C(1.60), SIMDE_FLOAT16_C(-6.60) } },
    { { SIMDE_FLOAT16_C(-6.90), SIMDE_FLOAT16_C(-8.40), SIMDE_FLOAT16_C(0.60), SIMDE_FLOAT16_C(9.60) },
      { SIMDE_FLOAT16_C(-0.90), SIMDE_FLOAT16_C(2.00), SIMDE_FLOAT16_C(-2.30), SIMDE_FLOAT16_C(7.80) },
      { SIMDE_FLOAT16_C(0.60), SIMDE_FLOAT16_C(-2.30), SIMDE_FLOAT16_C(9.60), SIMDE_FLOAT16_C(7.80) } },
    { { SIMDE_FLOAT16_C(-5.80), SIMDE_FLOAT16_C(9.60), SIMDE_FLOAT16_C(-1.90), SIMDE_FLOAT16_C(8.80) },
      { SIMDE_FLOAT16_C(-0.50), SIMDE_FLOAT16_C(3.40), SIMDE_FLOAT16_C(2.50), SIMDE_FLOAT16_C(-3.40) },
      { SIMDE_FLOAT16_C(-1.90), SIMDE_FLOAT16_C(2.50), SIMDE_FLOAT16_C(8.80), SIMDE_FLOAT16_C(-3.40) } },
    { { SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(6.10), SIMDE_FLOAT16_C(7.80), SIMDE_FLOAT16_C(6.40) },
      { SIMDE_FLOAT16_C(8.60), SIMDE_FLOAT16_C(8.80), SIMDE_FLOAT16_C(-8.00), SIMDE_FLOAT16_C(-8.80) },
      { SIMDE_FLOAT16_C(7.80), SIMDE_FLOAT16_C(-8.00), SIMDE_FLOAT16_C(6.40), SIMDE_FLOAT16_C(-8.80) } },
    { { SIMDE_FLOAT16_C(3.00), SIMDE_FLOAT16_C(6.20), SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(6.00) },
      { SIMDE_FLOAT16_C(-5.60), SIMDE_FLOAT16_C(-5.10), SIMDE_FLOAT16_C(2.90), SIMDE_FLOAT16_C(-6.70) },
      { SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(2.90), SIMDE_FLOAT16_C(6.00), SIMDE_FLOAT16_C(-6.70) } },
    { { SIMDE_FLOAT16_C(-9.50), SIMDE_FLOAT16_C(-4.40), SIMDE_FLOAT16_C(1.30), SIMDE_FLOAT16_C(9.80) },
      { SIMDE_FLOAT16_C(-5.40), SIMDE_FLOAT16_C(-6.20), SIMDE_FLOAT16_C(-9.50), SIMDE_FLOAT16_C(-3.00) },
      { SIMDE_FLOAT16_C(1.30), SIMDE_FLOAT16_C(-9.50), SIMDE_FLOAT16_C(9.80), SIMDE_FLOAT16_C(-3.00) } },
    { { SIMDE_FLOAT16_C(9.40), SIMDE_FLOAT16_C(-1.10), SIMDE_FLOAT16_C(4.60), SIMDE_FLOAT16_C(2.20) },
      { SIMDE_FLOAT16_C(2.40), SIMDE_FLOAT16_C(-5.90), SIMDE_FLOAT16_C(8.40), SIMDE_FLOAT16_C(-7.20) },
      { SIMDE_FLOAT16_C(4.60), SIMDE_FLOAT16_C(8.40), SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(-7.20) } },
    { { SIMDE_FLOAT16_C(-6.70), SIMDE_FLOAT16_C(2.90), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(-5.40) },
      { SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(8.50), SIMDE_FLOAT16_C(-7.00), SIMDE_FLOAT16_C(-6.10) },
      { SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(-7.00), SIMDE_FLOAT16_C(-5.40), SIMDE_FLOAT16_C(-6.10) } },
  };
...
test_simde_vzip2q_f16 (SIMDE_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { SIMDE_FLOAT16_C(9.60), SIMDE_FLOAT16_C(6.90), SIMDE_FLOAT16_C(7.80), SIMDE_FLOAT16_C(7.90), SIMDE_FLOAT16_C(-5.80), SIMDE_FLOAT16_C(1.70), SIMDE_FLOAT16_C(-8.70), SIMDE_FLOAT16_C(8.20) },
      { SIMDE_FLOAT16_C(1.80), SIMDE_FLOAT16_C(4.00), SIMDE_FLOAT16_C(-1.80), SIMDE_FLOAT16_C(9.70), SIMDE_FLOAT16_C(7.10), SIMDE_FLOAT16_C(4.80), SIMDE_FLOAT16_C(6.70), SIMDE_FLOAT16_C(-0.60) },
      { SIMDE_FLOAT16_C(-5.80), SIMDE_FLOAT16_C(7.10), SIMDE_FLOAT16_C(1.70), SIMDE_FLOAT16_C(4.80), SIMDE_FLOAT16_C(-8.70), SIMDE_FLOAT16_C(6.70), SIMDE_FLOAT16_C(8.20), SIMDE_FLOAT16_C(-0.60) } },
    { { SIMDE_FLOAT16_C(-7.70), SIMDE_FLOAT16_C(1.10), SIMDE_FLOAT16_C(0.70), SIMDE_FLOAT16_C(1.50), SIMDE_FLOAT16_C(6.60), SIMDE_FLOAT16_C(3.40), SIMDE_FLOAT16_C(7.10), SIMDE_FLOAT16_C(7.20) },
      { SIMDE_FLOAT16_C(-5.50), SIMDE_FLOAT16_C(-7.70), SIMDE_FLOAT16_C(-6.50), SIMDE_FLOAT16_C(-5.60), SIMDE_FLOAT16_C(-1.30), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(3.60), SIMDE_FLOAT16_C(-1.80) },
      { SIMDE_FLOAT16_C(6.60), SIMDE_FLOAT16_C(-1.30), SIMDE_FLOAT16_C(3.40), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(7.10), SIMDE_FLOAT16_C(3.60), SIMDE_FLOAT16_C(7.20), SIMDE_FLOAT16_C(-1.80) } },
    { { SIMDE_FLOAT16_C(3.40), SIMDE_FLOAT16_C(9.40), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(4.70), SIMDE_FLOAT16_C(5.40), SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(8.50), SIMDE_FLOAT16_C(-10.00) },
      { SIMDE_FLOAT16_C(2.70), SIMDE_FLOAT16_C(-7.30), SIMDE_FLOAT16_C(8.40), SIMDE_FLOAT16_C(7.10), SIMDE_FLOAT16_C(-9.50), SIMDE_FLOAT16_C(9.90), SIMDE_FLOAT16_C(-9.70), SIMDE_FLOAT16_C(6.00) },
      { SIMDE_FLOAT16_C(5.40), SIMDE_FLOAT16_C(-9.50), SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(9.90), SIMDE_FLOAT16_C(8.50), SIMDE_FLOAT16_C(-9.70), SIMDE_FLOAT16_C(-10.00), SIMDE_FLOAT16_C(6.00) } },
    { { SIMDE_FLOAT16_C(-3.60), SIMDE_FLOAT16_C(-8.20), SIMDE_FLOAT16_C(-1.30), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(-2.80), SIMDE_FLOAT16_C(9.00), SIMDE_FLOAT16_C(1.60), SIMDE_FLOAT16_C(-9.60) },
      { SIMDE_FLOAT16_C(-4.10), SIMDE_FLOAT16_C(-5.20), SIMDE_FLOAT16_C(-5.80), SIMDE_FLOAT16_C(4.80), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(5.80), SIMDE_FLOAT16_C(-5.10), SIMDE_FLOAT16_C(-4.20) },
      { SIMDE_FLOAT16_C(-2.80), SIMDE_FLOAT16_C(1.00), SIMDE_FLOAT16_C(9.00), SIMDE_FLOAT16_C(5.80), SIMDE_FLOAT16_C(1.60), SIMDE_FLOAT16_C(-5.10), SIMDE_FLOAT16_C(-9.60), SIMDE_FLOAT16_C(-4.20) } },
    { { SIMDE_FLOAT16_C(4.50), SIMDE_FLOAT16_C(0.10), SIMDE_FLOAT16_C(4.20), SIMDE_FLOAT16_C(-0.40), SIMDE_FLOAT16_C(-3.90), SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(7.50), SIMDE_FLOAT16_C(-5.50) },
      { SIMDE_FLOAT16_C(2.60), SIMDE_FLOAT16_C(-3.70), SIMDE_FLOAT16_C(-0.10), SIMDE_FLOAT16_C(-5.50), SIMDE_FLOAT16_C(-9.50), SIMDE_FLOAT16_C(8.50), SIMDE_FLOAT16_C(8.80), SIMDE_FLOAT16_C(5.00) },
      { SIMDE_FLOAT16_C(-3.90), SIMDE_FLOAT16_C(-9.50), SIMDE_FLOAT16_C(2.20), SIMDE_FLOAT16_C(8.50), SIMDE_FLOAT16_C(7.50), SIMDE_FLOAT16_C(8.80), SIMDE_FLOAT16_C(-5.50), SIMDE_FLOAT16_C(5.00) } },
    { { SIMDE_FLOAT16_C(9.20), SIMDE_FLOAT16_C(5.90), SIMDE_FLOAT16_C(-1.20), SIMDE_FLOAT16_C(-3.00), SIMDE_FLOAT16_C(-1.20), SIMDE_FLOAT16_C(9.40), SIMDE_FLOAT16_C(-3.20), SIMDE_FLOAT16_C(-3.40) },
      { SIMDE_FLOAT16_C(-6.80), SIMDE_FLOAT16_C(-8.80), SIMDE_FLOAT16_C(-6.60), SIMDE_FLOAT16_C(-7.30), SIMDE_FLOAT16_C(8.80), SIMDE_FLOAT16_C(-9.90), SIMDE_FLOAT16_C(0.90), SIMDE_FLOAT16_C(-6.90) },
      { SIMDE_FLOAT16_C(-1.20), SIMDE_FLOAT16_C(8.80), SIMDE_FLOAT16_C(9.40), SIMDE_FLOAT16_C(-9.90), SIMDE_FLOAT16_C(-3.20), SIMDE_FLOAT16_C(0.90), SIMDE_FLOAT16_C(-3.40), SIMDE_FLOAT16_C(-6.90) } },
    { { SIMDE_FLOAT16_C(-8.80), SIMDE_FLOAT16_C(-4.00), SIMDE_FLOAT16_C(-0.80), SIMDE_FLOAT16_C(5.20), SIMDE_FLOAT16_C(5.20), SIMDE_FLOAT16_C(-3.00), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(2.80) },
      { SIMDE_FLOAT16_C(-8.50), SIMDE_FLOAT16_C(2.90), SIMDE_FLOAT16_C(-0.80), SIMDE_FLOAT16_C(2.70), SIMDE_FLOAT16_C(-0.60), SIMDE_FLOAT16_C(-9.30), SIMDE_FLOAT16_C(-8.50), SIMDE_FLOAT16_C(-6.80) },
      { SIMDE_FLOAT16_C(5.20), SIMDE_FLOAT16_C(-0.60), SIMDE_FLOAT16_C(-3.00), SIMDE_FLOAT16_C(-9.30), SIMDE_FLOAT16_C(-0.70), SIMDE_FLOAT16_C(-8.50), SIMDE_FLOAT16_C(2.80), SIMDE_FLOAT16_C(-6.80) } },
    { { SIMDE_FLOAT16_C(6.70), SIMDE_FLOAT16_C(3.80), SIMDE_FLOAT16_C(8.80), SIMDE_FLOAT16_C(-0.40), SIMDE_FLOAT16_C(5.30), SIMDE_FLOAT16_C(-5.00), SIMDE_FLOAT16_C(-3.80), SIMDE_FLOAT16_C(-2.00) },
      { SIMDE_FLOAT16_C(-5.30), SIMDE_FLOAT16_C(0.60), SIMDE_FLOAT16_C(7.70), SIMDE_FLOAT16_C(0.90), SIMDE_FLOAT16_C(7.90), SIMDE_FLOAT16_C(3.10), SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(2.20) },
      { SIMDE_FLOAT16_C(5.30), SIMDE_FLOAT16_C(7.90), SIMDE_FLOAT16_C(-5.00), SIMDE_FLOAT16_C(3.10), SIMDE_FLOAT16_C(-3.80), SIMDE_FLOAT16_C(-2.70), SIMDE_FLOAT16_C(-2.00), SIMDE_FLOAT16_C(2.20) } },
    { { SIMDE_FLOAT16_C(-7.90), SIMDE_FLOAT16_C(-3.30), SIMDE_FLOAT16_C(3.20), SIMDE_FLOAT16_C(4.60), SIMDE_FLOAT16_C(-9.00), SIMDE_FLOAT16_C(-0.30), SIMDE_FLOAT16_C(-3.10), SIMDE_FLOAT16_C(2.50) },
      { SIMDE_FLOAT16_C(9.40), SIMDE_FLOAT16_C(0.90), SIMDE_FLOAT16_C(4.50), SIMDE_FLOAT16_C(6.90), SIMDE_FLOAT16_C(0.80), SIMDE_FLOAT16_C(-1.70), SIMDE_FLOAT16_C(-0.50), SIMDE_FLOAT16_C(-3.40) },
      { SIMDE_FLOAT16_C(-9.00), SIMDE_FLOAT16_C(0.80), SIMDE_FLOAT16_C(-0.30), SIMDE_FLOAT16_C(-1.70), SIMDE_FLOAT16_C(-3.10), SIMDE_FLOAT16_C(-0.50), SIMDE_FLOAT16_C(2.50), SIMDE_FLOAT16_C(-3.40) } },
    { { SIMDE_FLOAT16_C(6.10), SIMDE_FLOAT16_C(-8.00), SIMDE_FLOAT16_C(8.60), SIMDE_FLOAT16_C(9.70), SIMDE_FLOAT16_C(8.40), SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(8.70), SIMDE_FLOAT16_C(-1.30) },
      { SIMDE_FLOAT16_C(-1.30), SIMDE_FLOAT16_C(-9.90), SIMDE_FLOAT16_C(7.30), SIMDE_FLOAT16_C(1.20), SIMDE_FLOAT16_C(1.70), SIMDE_FLOAT16_C(5.20), SIMDE_FLOAT16_C(-8.60), SIMDE_FLOAT16_C(5.90) },
      { SIMDE_FLOAT16_C(8.40), SIMDE_FLOAT16_C(1.70), SIMDE_FLOAT16_C(-2.60), SIMDE_FLOAT16_C(5.20), SIMDE_FLOAT16_C(8.70), SIMDE_FLOAT16_C(-8.60), SIMDE_FLOAT16_C(-1.30), SIMDE_FLOAT16_C(5.90) } },
  };
