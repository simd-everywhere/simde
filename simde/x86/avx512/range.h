...
simde_mm_range_pd (simde__m128d a, simde__m128d b, int imm8)
    ...
    switch (imm8 & 12) {
      case 0:
        ...
        break;
      case 8:
        r = simde_x_mm_copysign_pd(r, simde_mm_set1_pd(SIMDE_FLOAT64_C(0.0)));
        break;
      case 12:
        r = simde_x_mm_copysign_pd(r, simde_mm_set1_pd(SIMDE_FLOAT64_C(-0.0)));
        break;
    ...
    simde__m256d r;
      ...
      switch (imm8 & 12) {
        case 0:
          ...
          break;
        case 8:
          r = simde_x_mm256_copysign_pd(r, simde_mm256_set1_pd(SIMDE_FLOAT64_C(0.0)));
          break;
        case 12:
          r = simde_x_mm256_copysign_pd(r, simde_mm256_set1_pd(SIMDE_FLOAT64_C(-0.0)));
          break;
...
simde_mm_range_ps (simde__m128 a, simde__m128 b, int imm8)
    ...
    switch (imm8 & 12) {
      case 0:
        ...
        break;
      case 8:
        r = simde_x_mm_copysign_ps(r, simde_mm_set1_ps(SIMDE_FLOAT32_C(0.0)));
        break;
      case 12:
        r = simde_x_mm_copysign_ps(r, simde_mm_set1_ps(SIMDE_FLOAT32_C(-0.0)));
        break;
    ...
    simde__m256 r;
      ...
      switch (imm8 & 12) {
        case 0:
          ...
          break;
        case 8:
          r = simde_x_mm256_copysign_ps(r, simde_mm256_set1_ps(SIMDE_FLOAT32_C(0.0)));
          break;
        case 12:
          r = simde_x_mm256_copysign_ps(r, simde_mm256_set1_ps(SIMDE_FLOAT32_C(-0.0)));
          break;
