...
simde_mm_popcnt_epi32 (simde__m128i a) {
    ...
    simde__m128i_private
    ...
    #elif defined(SIMDE_WASM_SIMD128_NATIVE)
      r_.wasm_v128 = simde_wasm_i32x4_extadd_pairwise_i16x8(wasm_i16x8_extadd_pairwise_i8x16(wasm_i8x16_popcnt(a_.wasm_v128)));
    #elif defined(SIMDE_POWER_ALTIVEC_P8_NATIVE)
    ...
    #elif defined(SIMDE_VECTOR_SUBSCRIPT_SCALAR)
      a_.u32 -= ((a_.u32 >> 1) & 0x55555555);
      a_.u32  = ((a_.u32 & 0x33333333) + ((a_.u32 >> 2) & 0x33333333));
      a_.u32  = (a_.u32 + (a_.u32 >> 4)) & 0x0f0f0f0f;
      r_.u32  = (a_.u32 * 0x01010101) >> ((sizeof(uint32_t) - 1) * CHAR_BIT);
    #else
      SIMDE_VECTORIZE
      for (size_t i = 0 ; i < (sizeof(r_.u32) / sizeof(r_.u32[0])) ; i++) {
        ...
        v  = (v + (v >> 4)) & 0x0f0f0f0f;
        r_.u32[i] = HEDLEY_STATIC_CAST(uint32_t, (v * 0x01010101)) >> ((sizeof(uint32_t) - 1) * CHAR_BIT);
      }
    #endif
...
simde_mm_popcnt_epi64 (simde__m128i a) {
    ...
    simde__m128i_private
    ...
    #elif defined(SIMDE_VECTOR_SUBSCRIPT_SCALAR)
      a_.u64 -= ((a_.u64 >> 1) & 0x5555555555555555);
      a_.u64  = ((a_.u64 & 0x3333333333333333) + ((a_.u64 >> 2) & 0x3333333333333333));
      a_.u64  = (a_.u64 + (a_.u64 >> 4)) & 0x0f0f0f0f0f0f0f0f;
      r_.u64  = (a_.u64 * 0x0101010101010101) >> ((sizeof(uint64_t) - 1) * CHAR_BIT);
    #else
      SIMDE_VECTORIZE
      for (size_t i = 0 ; i < (sizeof(r_.u64) / sizeof(r_.u64[0])) ; i++) {
        ...
        r_.u64[i] = HEDLEY_STATIC_CAST(uint64_t, (v * 0x0101010101010101)) >> ((sizeof(uint64_t) - 1) * CHAR_BIT);
      }
    #endif
